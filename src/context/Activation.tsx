 ...
 */
function Activation(): React.ReactElement | null {
  const {
  ...
  // ignoring this rule here, because we can return an array of components, and React.memo() complains
  // if its not a single Element | null
