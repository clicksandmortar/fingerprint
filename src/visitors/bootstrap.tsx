...
export const updateCookieUUID = (cookieData: string | undefined, uuid: string): string | null => {
...
export const bootstrapVisitor = ({
  ...
  if (typeof window !== 'undefined') {
    ...
    // ------------ NEVER EVER EVER BE SETTING THIS:----------------------------//
...
const getSessionIdAndEndTime = (cookieData: string | undefined): { sessionId: string; endTime: Date } => {
  const t = new Date();
