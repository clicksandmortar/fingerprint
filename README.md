...
| initialDelay    | `number`  | `0`         | The initial delay in seconds before the Fingerprint will start tracking data and provide the first trigger.                                                           |
| minimumDelay    | `number`  | `15`        | The minimum delay in seconds between triggers (on a given page)                                                                                                       |
