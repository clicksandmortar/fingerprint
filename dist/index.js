...
var FollowContext = React__default.createContext({
  enabled: false
});
...
var FollowProvider = function FollowProvider(_ref) {
  var children = _ref.children,
    enabled = _ref.enabled;
  React__default.useEffect(function () {
    document.addEventListener('click', follow);
  }, []);
  return React__default.createElement(FollowContext.Provider, {
    value: {
      enabled: enabled
    }
  }, children);
...
var FingerprintProvider = function FingerprintProvider(_ref) {
  var appId = _ref.appId,
    ...
    _ref$config$follow = _ref$config.follow,
    follow = _ref$config$follow === void 0 ? true : _ref$config$follow,
    _ref$config$consentCa = _ref$config.consentCallback,
    consentCallback = _ref$config$consentCa === void 0 ? undefined : _ref$config$consentCa,
    _ref$config$debug = _ref$config.debug,
    debug = _ref$config$debug === void 0 ? false : _ref$config$debug,
    _ref$config$defaultHa = _ref$config.defaultHandlers,
    defaultHandlers = _ref$config$defaultHa === void 0 ? undefined : _ref$config$defaultHa,
    _ref$config$initialDe = _ref$config.initialDelay,
    initialDelay = _ref$config$initialDe === void 0 ? 0 : _ref$config$initialDe,
    _ref$config$exitInten = _ref$config.exitIntentTriggers,
    exitIntentTriggers = _ref$config$exitInten === void 0 ? true : _ref$config$exitInten,
    _ref$config$idleTrigg = _ref$config.idleTriggers,
    idleTriggers = _ref$config$idleTrigg === void 0 ? true : _ref$config$idleTrigg;
  ...
  }, React__default.createElement(VisitorProvider, null, React__default.createElement(FollowProvider, {
    enabled: follow
  }, React__default.createElement(MixpanelProvider, null, React__default.createElement(CollectorProvider, {
    handlers: handlers
