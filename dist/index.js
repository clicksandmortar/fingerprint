...
var bootstrapVisitor = function bootstrapVisitor(_ref) {
  ...
  if (getCookie('_cm_id')) {
    ...
    setCookie(
      '_cm_id',
      _visitorId + '|' + _sessionId + '|' + _endTime.toISOString(),
      365
    )
...
function CollectorProvider(_ref) {
  ...
  React.useEffect(
    function () {
      ...
      var runningInterval = setInterval(function () {
        var locatedIntentlyScript = document.querySelectorAll(
  ...
  var TriggerComponent = React__default.useCallback(
    function () {
      ...
      if (
        potentialComponent &&
        React__default.isValidElement(potentialComponent)
      )
  ...
  var fireExitTrigger = React.useCallback(
    function () {
  ...
  var resetDisplayTrigger = React.useCallback(
    function () {
  ...
  var registerWatcher = function registerWatcher(
    configuredSelector,
    configuredSearch
  ) {
  ...
  var setTrigger = React__default.useCallback(
    function (trigger) {
  ...
  var collectorContextVal = React__default.useMemo(
    function () {
      return {
...
var FingerprintProvider = function FingerprintProvider(_ref) {
  ...
  var addAnotherHandler = React__default.useCallback(
    function (trigger) {
