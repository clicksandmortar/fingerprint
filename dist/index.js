...
var MixpanelProvider = function MixpanelProvider(_ref) {
  ...
  React.useEffect(
    function () {
      ...
      log(
        'MixpanelProvider: registering visitor ' + visitor.id + ' to mixpanel'
      )
...
var CollectorProvider = function CollectorProvider(_ref) {
  ...
  var showTrigger = function showTrigger(displayTrigger) {
    ...
    var trigger = pageTriggers.find(function (trigger) {
      return (
        ...
        (handlers === null || handlers === void 0
          ? void 0
          : handlers.find(function (handler) {
    ...
    if (handler.delay) {
      var tId = setTimeout(function () {
        var _handler$invoke
        return (_handler$invoke = handler.invoke) === null ||
          _handler$invoke === void 0
          ? void 0
          : _handler$invoke.call(handler, trigger)
      }, handler.delay)
      setTimeoutId(tId)
      return null
    }
  ...
  var fireIdleTrigger = React.useCallback(
    function () {
              ...
              return Promise.resolve(response.json()).then(function (payload) {
                ...
                setPageTriggers(
                  (payload === null || payload === void 0
                    ? void 0
                    : (_payload$pageTriggers = payload.pageTriggers) === null ||
                      _payload$pageTriggers === void 0
                    ? void 0
                    : _payload$pageTriggers.filter(function (trigger) {
                        return (
  ...
  var renderedTrigger = React__default.useMemo(
    function () {
  ...
  return React__default.createElement(
    reactIdleTimer.IdleTimerProvider,
    {
      timeout: idleTimeout,
          ...
          React__default.createElement(
            'a',
            {
              href:
                trigger === null || trigger === void 0
                  ? void 0
                  : (_trigger$data6 = trigger.data) === null ||
                    _trigger$data6 === void 0
                  ? void 0
                  : _trigger$data6.buttonURL,
            ...
            trigger === null || trigger === void 0
              ? void 0
              : (_trigger$data7 = trigger.data) === null ||
                _trigger$data7 === void 0
              ? void 0
              : _trigger$data7.buttonText
          )
        )
      )
    )
...
var Voucher = function Voucher(_ref2) {
  ...
  return React.createElement(
    'div',
    null,
    React.createElement('h3', null, 'Terms of Voucher'),
    React.createElement(
      'p',
      {
        className: 'text-sm'
...
var TriggerInverse = function TriggerInverse(_ref3) {
  ...
  if (state.complete === true) {
    return React.createElement(
      ...
      React.createElement('h2', null, 'Voucher Sent!'),
      React.createElement(
        'p',
        {
          className: 'text-md'
  ...
  if (state.responseStatusCode === 409) {
    return React.createElement(
      ...
      React.createElement(
        'p',
        null,
        "It seems that you already received this voucher. Please get in touch if this doesn't seem right:\xA0",
        React.createElement(
          'a',
          {
            href: '/help',
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement('h2', null, 'Get Your Voucher'),
          React.createElement(
            'p',
            null,
          ...
          React.createElement(
            ...
            {
              className:
                'bar-title border-l-4 border-solid border-' +
                (landingPage === null || landingPage === void 0
                  ? void 0
                  : landingPage.colour)
            },
          ...
          React.createElement(
            ...
            React.createElement(
              'div',
              null,
              React.createElement('p', null, '* Required Field')
            ),
            React.createElement(
              'div',
              {
...
var FingerprintProvider = function FingerprintProvider(_ref) {
  var appId = _ref.appId,
    ...
    exitIntentTriggers =
      _ref$exitIntentTrigge === void 0 ? true : _ref$exitIntentTrigge,
  ...
  var registerHandler = React__default.useCallback(
    function (trigger) {
...
var FingerprintContext = React.createContext(
  _extends({}, defaultFingerprintState)
)
