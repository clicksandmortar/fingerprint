...
import React__default, { useContext, createContext, useEffect, useState, useMemo, useCallback, useRef, createElement } from 'react';
...
const tenantAwareHost = (isDev = false, tenant = 'mab') => {
...
const useEnvVars = () => {
  ...
  env.MIXPANEL_TOKEN = isDev ? 'd122fa924e1ea97d6b98569440c65a95' : 'cfca3a93becd5735a4f04dc8e10ede27';
...
const useCollectorMutation = () => {
  ...
  return useMutation(data => {
    return request.post(FINGERPRINT_API_HOSTNAME + '/collector/' + (visitor === null || visitor === void 0 ? void 0 : visitor.id), {
      ...data,
      appId,
      visitor,
