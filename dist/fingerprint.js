...
// ...
(o+="="+i[s].split(";")[0]));return document.cookie=t+"="+n.write(a,t)+o}}return Object.create({set:a,get:function(e){if("undefined"!=typeof document&&(!arguments.length||e)){for(var t=document.cookie?document.cookie.split("; "):[],r={},a=0;a<t.length;a++){var i=t[a].split("="),o=i.slice(1).join("=");try{var s=decodeURIComponent(i[0]);if(r[s]=n.read(o,s),e===s)break}catch(e){}}return e?r[e]:r}},remove:function(t,n){a(t,"",e({},n,{expires:-1}))},withAttributes:function(n){return t(this.converter,e({},this.attributes,n))},withConverter:function(n){return t(e({},this.converter,n),this.attributes)}},{attributes:{value:Object.freeze(r)},converter:{value:Object.freeze(n)}})}({read:function(e){return'"'===e[0]&&(e=e.slice(1,-1)),e.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent)},write:function(e){return encodeURIComponent(e).replace(/%(2[346BF]|3[AC-F]|40|5[BDE]|60|7[BCD])/g,decodeURIComponent)}},{path:"/"})}();let n9=(e,t,n)=>/*@__PURE__*/r(n7).set(e,t,{expires:n||365,sameSite:"strict"}),re=e=>/*@__PURE__*/r(n7).get(e),rt=({appId:e,setSession:t})=>{let n={firstVisit:void 0};if(!re("_cm")||re("_cm")!==e){n9("_cm",e,365),t(n);return}re("_cm")&&re("_cm")===e&&(n.firstVisit=!1,t(n))},rn="undefined"!=typeof crypto&&crypto.randomUUID&&crypto.randomUUID.bind(crypto);var rr={randomUUID:rn};let ra=new Uint8Array(16);var ri=/^(?:[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}|00000000-0000-0000-0000-000000000000)$/i,ro=function(e){return"string"==typeof e&&ri.test(e)};/**
 * Convert array of 16 byte values to UUID string format of the form:
 * XXXXXXXX-XXXX-XXXX-XXXX-XXXXXXXXXXXX
 */let rs=[];for(let e=0;e<256;++e)rs.push((e+256).toString(16).slice(1));var rl=function(t,n,r){if(rr.randomUUID&&!n&&!t)return rr.randomUUID();t=t||{};let a=t.random||(t.rng||function(){// lazy load so that environments that need to polyfill have a chance to do so
if(!e&&!// getRandomValues needs to be invoked in a context where "this" is a Crypto implementation.
(e="undefined"!=typeof crypto&&crypto.getRandomValues&&crypto.getRandomValues.bind(crypto)))throw Error("crypto.getRandomValues() not supported. See https://github.com/uuidjs/uuid#getrandomvalues-not-supported");return e(ra)})();// Per 4.4, set bits for version and `clock_seq_hi_and_reserved`
...
return rs[e[t+0]]+rs[e[t+1]]+rs[e[t+2]]+rs[e[t+3]]+"-"+rs[e[t+4]]+rs[e[t+5]]+"-"+rs[e[t+6]]+rs[e[t+7]]+"-"+rs[e[t+8]]+rs[e[t+9]]+"-"+rs[e[t+10]]+rs[e[t+11]]+rs[e[t+12]]+rs[e[t+13]]+rs[e[t+14]]+rs[e[t+15]]}(a)},ru=function(e){if(!ro(e))throw TypeError("Invalid UUID");return parseInt(e.slice(14,15),16)};let rc=e=>ro(e)&&4===ru(e),rd=e=>rc(e),rf=({setVisitor:e})=>{let t={id:void 0};if(!re("_cm_id")||!rd(re("_cm_id"))){let n=rl();n9("_cm_id",n,365),t.id=n,e(t);return}re("_cm_id")&&(t.id=re("_cm_id"),e(t))},rp=({children:e})=>{let{appId:t,booted:n}=n8(),{log:a}=ew(),[i,o]=(0,D.useState)({}),[s,l]=(0,D.useState)({});return(0,D.useEffect)(()=>{if(!n){a("VisitorProvider: not booted");return}a("VisitorProvider: booting");let e=async()=>{await rt({appId:t,setSession:o}),await rf({setVisitor:l})};e(),a("VisitorProvider: booted",i,s)},[t,n]),/*@__PURE__*/r(D).createElement(rh.Provider,{value:{session:i,visitor:s}},e)},rh=/*#__PURE__*/(0,D.createContext)({session:{},visitor:{}}),rm=()=>(0,D.useContext)(rh);var rv={},rg={DEBUG:!1,LIB_VERSION:"2.47.0"};if("undefined"==typeof window){var ry={hostname:""};E={navigator:{userAgent:""},document:{location:ry,referrer:""},screen:{width:0,height:0},location:ry}}else E=window;/*
 * Saved references to long variable names, so that closure compiler can
 * minimize file size.
 */var rb=Array.prototype,rw=Function.prototype,r_=Object.prototype,rk=rb.slice,rx=r_.toString,rS=r_.hasOwnProperty,rE=E.console,rC=E.navigator,rT=E.document,rO=E.opera,rR=E.screen,rP=rC.userAgent,rI=rw.bind,rD=rb.forEach,rN=rb.indexOf,rL=rb.map,rM=Array.isArray,rA={},rU={trim:function(e){// https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String/Trim#Polyfill
return e.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,"")}},rz={/** @type {function(...*)} */log:function(){if(rg.DEBUG&&!rU.isUndefined(rE)&&rE)try{rE.log.apply(rE,arguments)}catch(e){rU.each(arguments,function(e){rE.log(e)})}},/** @type {function(...*)} */warn:function(){if(rg.DEBUG&&!rU.isUndefined(rE)&&rE){var e=["Mixpanel warning:"].concat(rU.toArray(arguments));try{rE.warn.apply(rE,e)}catch(t){rU.each(e,function(e){rE.warn(e)})}}},/** @type {function(...*)} */error:function(){if(rg.DEBUG&&!rU.isUndefined(rE)&&rE){var e=["Mixpanel error:"].concat(rU.toArray(arguments));try{rE.error.apply(rE,e)}catch(t){rU.each(e,function(e){rE.error(e)})}}},/** @type {function(...*)} */critical:function(){if(!rU.isUndefined(rE)&&rE){var e=["Mixpanel error:"].concat(rU.toArray(arguments));try{rE.error.apply(rE,e)}catch(t){rU.each(e,function(e){rE.error(e)})}}}},rF=function(e,t){return function(){return arguments[0]="["+t+"] "+arguments[0],e.apply(rz,arguments)}},rj=function(e){return{log:rF(rz.log,e),error:rF(rz.error,e),critical:rF(rz.critical,e)}};// UNDERSCORE
// Embed part of the Underscore Library
rU.bind=function(e,t){var n,r;if(rI&&e.bind===rI)return rI.apply(e,rk.call(arguments,1));if(!rU.isFunction(e))throw TypeError();return n=rk.call(arguments,2),r=function(){if(!(this instanceof r))return e.apply(t,n.concat(rk.call(arguments)));var a={};a.prototype=e.prototype;var i=new a;a.prototype=null;var o=e.apply(i,n.concat(rk.call(arguments)));return Object(o)===o?o:i}},/**
 * @param {*=} obj
 * @param {function(...*)=} iterator
 * @param {Object=} context
 */rU.each=function(e,t,n){if(null!=e){if(rD&&e.forEach===rD)e.forEach(t,n);else if(e.length===+e.length){for(var r=0,a=e.length;r<a;r++)if(r in e&&t.call(n,e[r],r,e)===rA)return}else for(var i in e)if(rS.call(e,i)&&t.call(n,e[i],i,e)===rA)return}},rU.extend=function(e){return rU.each(rk.call(arguments,1),function(t){for(var n in t)void 0!==t[n]&&(e[n]=t[n])}),e},rU.isArray=rM||function(e){return"[object Array]"===rx.call(e)},// from a comment on http://dbj.org/dbj/?p=286
// fails on only one very rare and deliberate custom object:
// var bomb = { toString : undefined, valueOf: function(o) { return "function BOMBA!"; }};
rU.isFunction=function(e){try{return/^\s*\bfunction\b/.test(e)}catch(e){return!1}},rU.isArguments=function(e){return!!(e&&rS.call(e,"callee"))},rU.toArray=function(e){return e?e.toArray?e.toArray():rU.isArray(e)||rU.isArguments(e)?rk.call(e):rU.values(e):[]},rU.map=function(e,t,n){if(rL&&e.map===rL)return e.map(t,n);var r=[];return rU.each(e,function(e){r.push(t.call(n,e))}),r},rU.keys=function(e){var t=[];return null===e||rU.each(e,function(e,n){t[t.length]=n}),t},rU.values=function(e){var t=[];return null===e||rU.each(e,function(e){t[t.length]=e}),t},rU.include=function(e,t){var n=!1;return null===e?n:rN&&e.indexOf===rN?-1!=e.indexOf(t):(rU.each(e,function(e){if(n||(n=e===t))return rA}),n)},rU.includes=function(e,t){return -1!==e.indexOf(t)},// Underscore Addons
rU.inherit=function(e,t){return e.prototype=new t,e.prototype.constructor=e,e.superclass=t.prototype,e},rU.isObject=function(e){return e===Object(e)&&!rU.isArray(e)},rU.isEmptyObject=function(e){if(rU.isObject(e)){for(var t in e)if(rS.call(e,t))return!1;return!0}return!1},rU.isUndefined=function(e){return void 0===e},rU.isString=function(e){return"[object String]"==rx.call(e)},rU.isDate=function(e){return"[object Date]"==rx.call(e)},rU.isNumber=function(e){return"[object Number]"==rx.call(e)},rU.isElement=function(e){return!!(e&&1===e.nodeType)},rU.encodeDates=function(e){return rU.each(e,function(t,n){rU.isDate(t)?e[n]=rU.formatDate(t):rU.isObject(t)&&(e[n]=rU.encodeDates(t));// recurse
}),e},rU.timestamp=function(){return Date.now=Date.now||function(){return+new Date},Date.now()},rU.formatDate=function(e){// YYYY-MM-DDTHH:MM:SS in UTC
function t(e){return e<10?"0"+e:e}return e.getUTCFullYear()+"-"+t(e.getUTCMonth()+1)+"-"+t(e.getUTCDate())+"T"+t(e.getUTCHours())+":"+t(e.getUTCMinutes())+":"+t(e.getUTCSeconds())},rU.strip_empty_properties=function(e){var t={};return rU.each(e,function(e,n){rU.isString(e)&&e.length>0&&(t[n]=e)}),t},/*
 * this function returns a copy of object after truncating it.  If
 * passed an Array or Object it will iterate through obj and
 * truncate all the values recursively.
 */rU.truncate=function(e,t){var n;return"string"==typeof e?n=e.slice(0,t):rU.isArray(e)?(n=[],rU.each(e,function(e){n.push(rU.truncate(e,t))})):rU.isObject(e)?(n={},rU.each(e,function(e,r){n[r]=rU.truncate(e,t)})):n=e,n},rU.JSONEncode=function(e){var t=function(e){var t=/[\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,n={"\b":"\\b","	":"\\t","\n":"\\n","\f":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"};// eslint-disable-line no-control-regex
...
a+="    ",c=[],"[object Array]"===rx.apply(d)){for(i=0,// The value is an array. Stringify every element. Use null as a placeholder
// for non-JSON values.
...
for(o in d)rS.call(d,o)&&(s=n(o,d))&&c.push(t(o)+(a?": ":":")+s);return(// Join all of the member texts together, separated with commas,
...
// a number, or a word.
b(),d){case"{":return k();case"[":return _();case'"':return y();case"-":return g();default:return d>="0"&&d<="9"?g():w()}},function(e){var t;return f=e,c=0,d=" ",t=p(),b(),d&&m("Syntax error"),t}),rU.base64Encode=function(e){var t,n,r,a,i,o="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",s=0,l=0,u="",c=[];if(!e)return e;e=rU.utf8Encode(e);do t=(i=e.charCodeAt(s++)<<16|e.charCodeAt(s++)<<8|e.charCodeAt(s++))>>18&63,n=i>>12&63,r=i>>6&63,a=63&i,// use hexets to index into b64, and append result to encoded string
c[l++]=o.charAt(t)+o.charAt(n)+o.charAt(r)+o.charAt(a);while(s<e.length)switch(u=c.join(""),e.length%3){case 1:u=u.slice(0,-2)+"==";break;case 2:u=u.slice(0,-1)+"="}return u},rU.utf8Encode=function(e){e=(e+"").replace(/\r\n/g,"\n").replace(/\r/g,"\n");var t,n,r,a="",i=0;for(r=0,t=n=0,i=e.length;r<i;r++){var o=e.charCodeAt(r),s=null;o<128?n++:s=o>127&&o<2048?String.fromCharCode(o>>6|192,63&o|128):String.fromCharCode(o>>12|224,o>>6&63|128,63&o|128),null!==s&&(n>t&&(a+=e.substring(t,n)),a+=s,t=n=r+1)}return n>t&&(a+=e.substring(t,e.length)),a},rU.UUID=(x=function(){var e,t=1*new Date;// cross-browser version of Date.now()
...
e=0;t==1*new Date;)e++;return t.toString(16)+Math.floor(e).toString(16)},S=function(){var e,t,n=[],r=0;function a(e,t){var r,a=0;for(r=0;r<t.length;r++)a|=n[r]<<8*r;return e^a}for(e=0;e<rP.length;e++)t=rP.charCodeAt(e),n.unshift(255&t),n.length>=4&&(r=a(r,n),n=[]);return n.length>0&&(r=a(r,n)),r.toString(16)},function(){var e=(rR.height*rR.width).toString(16);return x()+"-"+Math.random().toString(16).replace(".","")+"-"+S()+"-"+e+"-"+x()});// _.isBlockedUA()
// This is to block various web spiders from executing our JS and
// sending false tracking data
var rq=["ahrefsbot","baiduspider","bingbot","bingpreview","facebookexternal","petalbot","pinterest","screaming frog","yahoo! slurp","yandexbot",// a whole bunch of goog-specific crawlers
// https://developers.google.com/search/docs/advanced/crawling/overview-google-crawlers
"adsbot-google","apis-google","duplexweb-google","feedfetcher-google","google favicon","google web preview","google-read-aloud","googlebot","googleweblight","mediapartners-google","storebot-google"];rU.isBlockedUA=function(e){var t;for(t=0,e=e.toLowerCase();t<rq.length;t++)if(-1!==e.indexOf(rq[t]))return!0;return!1},/**
 * @param {Object=} formdata
 * @param {string=} arg_separator
 */rU.HTTPBuildQuery=function(e,t){var n,r,a=[];return rU.isUndefined(t)&&(t="&"),rU.each(e,function(e,t){n=encodeURIComponent(e.toString()),r=encodeURIComponent(t),a[a.length]=r+"="+n}),a.join(t)},rU.getQueryParam=function(e,t){var n="[\\?&]"+// Expects a raw URL
(t=t.replace(/[[]/,"\\[").replace(/[\]]/,"\\]"))+"=([^&#]*)",r=new RegExp(n).exec(e);if(null===r||r&&"string"!=typeof r[1]&&r[1].length)return"";var a=r[1];try{a=decodeURIComponent(a)}catch(e){rz.error("Skipping decoding for malformed query param: "+a)}return a.replace(/\+/g," ")},// _.cookie
// Methods partially borrowed from quirksmode.org/js/cookies.html
rU.cookie={get:function(e){for(var t=e+"=",n=rT.cookie.split(";"),r=0;r<n.length;r++){for(var a=n[r];" "==a.charAt(0);)a=a.substring(1,a.length);if(0===a.indexOf(t))return decodeURIComponent(a.substring(t.length,a.length))}return null},parse:function(e){var t;try{t=rU.JSONDecode(rU.cookie.get(e))||{}}catch(e){// noop
}return t},set_seconds:function(e,t,n,r,a,i,o){var s="",l="",u="";if(o)s="; domain="+o;else if(r){var c=rG(rT.location.hostname);s=c?"; domain=."+c:""}if(n){var d=new Date;d.setTime(d.getTime()+1e3*n),l="; expires="+d.toGMTString()}i&&(a=!0,u="; SameSite=None"),a&&(u+="; secure"),rT.cookie=e+"="+encodeURIComponent(t)+l+"; path=/"+s+u},set:function(e,t,n,r,a,i,o){var s="",l="",u="";if(o)s="; domain="+o;else if(r){var c=rG(rT.location.hostname);s=c?"; domain=."+c:""}if(n){var d=new Date;d.setTime(d.getTime()+864e5*n),l="; expires="+d.toGMTString()}i&&(a=!0,u="; SameSite=None"),a&&(u+="; secure");var f=e+"="+encodeURIComponent(t)+l+"; path=/"+s+u;return rT.cookie=f,f},remove:function(e,t,n){rU.cookie.set(e,"",-1,t,!1,!1,n)}};var rB=null,rV=function(e,t){if(null!==rB&&!t)return rB;var n=!0;try{e=e||window.localStorage;var r="__mplss_"+rY(8);e.setItem(r,"xyz"),"xyz"!==e.getItem(r)&&(n=!1),e.removeItem(r)}catch(e){n=!1}return rB=n,n};// _.localStorage
rU.localStorage={is_supported:function(e){var t=rV(null,e);return t||rz.error("localStorage unsupported; falling back to cookie store"),t},error:function(e){rz.error("localStorage error: "+e)},get:function(e){try{return window.localStorage.getItem(e)}catch(e){rU.localStorage.error(e)}return null},parse:function(e){try{return rU.JSONDecode(rU.localStorage.get(e))||{}}catch(e){// noop
}return null},set:function(e,t){try{window.localStorage.setItem(e,t)}catch(e){rU.localStorage.error(e)}},remove:function(e){try{window.localStorage.removeItem(e)}catch(e){rU.localStorage.error(e)}}},rU.register_event=function(){function e(t){return t&&(t.preventDefault=e.preventDefault,t.stopPropagation=e.stopPropagation),t}return e.preventDefault=function(){this.returnValue=!1},e.stopPropagation=function(){this.cancelBubble=!0},function(t,n,r,a,i){if(!t){rz.error("No valid element provided to register_event");return}if(t.addEventListener&&!a)t.addEventListener(n,r,!!i);else{var o="on"+n,s=t[o];t[o]=function(n){// this basically happens in firefox whenever another script
// overwrites the onload callback and doesn't pass the event
// object to previously defined callbacks.  All the browsers
// that don't define window.event implement addEventListener
// so the dom_loaded handler will still be fired as usual.
if(n=n||e(window.event)){var a,i,o=!0;return rU.isFunction(s)&&(a=s(n)),i=r.call(t,n),(!1===a||!1===i)&&(o=!1),o}}}}}();var rW=RegExp('^(\\w*)\\[(\\w+)([=~\\|\\^\\$\\*]?)=?"?([^\\]"]*)"?\\]$');rU.dom_query=function(){/* document.getElementsBySelector(selector)
...
if(!rT.getElementsByTagName)return[];// Split selector in to tokens
var r=n.split(" "),a=[rT];for(h=0;h<r.length;h++){if((u=r[h].replace(/^\s+/,"").replace(/\s+$/,"")).indexOf("#")>-1){d=// Token is an ID selector
(c=u.split("#"))[0];var i=c[1],o=rT.getElementById(i);if(!o||d&&o.nodeName.toLowerCase()!=d)return[];// Set currentContext to contain just this element
...
f=[],p=0,m=0;m<a.length;m++)for(v=0,g="*"==d?e(a[m]):a[m].getElementsByTagName(d);v<g.length;v++)f[p++]=g[v];for(m=0,a=[],y=0;m<f.length;m++)f[m].className&&rU.isString(f[m].className)&&(" "+f[m].className+" ").replace(t," ").indexOf(" "+s+" ")>=0&&(a[y++]=f[m]);continue;// Skip to next token
}// Code to deal with attribute selectors
var l=u.match(rW);if(l){d=l[1];var u,c,d,f,p,h,m,v,g,y,b,w=l[2],_=l[3],k=l[4];for(d||(d="*"),// Grab all of the tagName elements within current context
...
d=u,f=[],p=0;m<a.length;m++)for(v=0,g=a[m].getElementsByTagName(d);v<g.length;v++)f[p++]=g[v];a=f}return a}return function(e){return rU.isElement(e)?[e]:rU.isObject(e)&&!rU.isUndefined(e.length)?e:n.call(this,e)}}();var r$=["utm_source","utm_medium","utm_campaign","utm_content","utm_term"],rH=["dclid","fbclid","gclid","ko_click_id","li_fat_id","msclkid","ttclid","twclid","wbraid"];rU.info={campaignParams:function(e){var t="",n={};return rU.each(r$,function(r){(t=rU.getQueryParam(rT.URL,r)).length?n[r]=t:void 0!==e&&(n[r]=e)}),n},clickParams:function(){var e="",t={};return rU.each(rH,function(n){(e=rU.getQueryParam(rT.URL,n)).length&&(t[n]=e)}),t},marketingParams:function(){return rU.extend(rU.info.campaignParams(),rU.info.clickParams())},searchEngine:function(e){return 0===e.search("https?://(.*)google.([^/?]*)")?"google":0===e.search("https?://(.*)bing.com")?"bing":0===e.search("https?://(.*)yahoo.com")?"yahoo":0===e.search("https?://(.*)duckduckgo.com")?"duckduckgo":null},searchInfo:function(e){var t=rU.info.searchEngine(e),n="yahoo"!=t?"q":"p",r={};if(null!==t){r.$search_engine=t;var a=rU.getQueryParam(e,n);a.length&&(r.mp_keyword=a)}return r},/**
     * This function detects which browser is running this script.
     * The order of the checks are important since many user agents
     * include key words used in later checks.
     */browser:function(e,t,n){if(t=t||"",n||rU.includes(e," OPR/"))return rU.includes(e,"Mini")?"Opera Mini":"Opera";if(/(BlackBerry|PlayBook|BB10)/i.test(e))return"BlackBerry";if(rU.includes(e,"IEMobile")||rU.includes(e,"WPDesktop"))return"Internet Explorer Mobile";if(rU.includes(e,"SamsungBrowser/"))return"Samsung Internet";if(rU.includes(e,"Edge")||rU.includes(e,"Edg/"))return"Microsoft Edge";if(rU.includes(e,"FBIOS"))return"Facebook Mobile";if(rU.includes(e,"Chrome"))return"Chrome";else if(rU.includes(e,"CriOS"))return"Chrome iOS";else if(rU.includes(e,"UCWEB")||rU.includes(e,"UCBrowser"))return"UC Browser";else if(rU.includes(e,"FxiOS"))return"Firefox iOS";else if(rU.includes(t,"Apple"))return rU.includes(e,"Mobile")?"Mobile Safari":"Safari";else if(rU.includes(e,"Android"))return"Android Mobile";else if(rU.includes(e,"Konqueror"))return"Konqueror";else if(rU.includes(e,"Firefox"))return"Firefox";else if(rU.includes(e,"MSIE")||rU.includes(e,"Trident/"))return"Internet Explorer";else if(rU.includes(e,"Gecko"))return"Mozilla";else return""},/**
     * This function detects which browser version is running this script,
     * parsing major and minor version (e.g., 42.1). User agent strings from:
     * http://www.useragentstring.com/pages/useragentstring.php
     */browserVersion:function(e,t,n){var r={"Internet Explorer Mobile":/rv:(\d+(\.\d+)?)/,"Microsoft Edge":/Edge?\/(\d+(\.\d+)?)/,Chrome:/Chrome\/(\d+(\.\d+)?)/,"Chrome iOS":/CriOS\/(\d+(\.\d+)?)/,"UC Browser":/(UCBrowser|UCWEB)\/(\d+(\.\d+)?)/,Safari:/Version\/(\d+(\.\d+)?)/,"Mobile Safari":/Version\/(\d+(\.\d+)?)/,Opera:/(Opera|OPR)\/(\d+(\.\d+)?)/,Firefox:/Firefox\/(\d+(\.\d+)?)/,"Firefox iOS":/FxiOS\/(\d+(\.\d+)?)/,Konqueror:/Konqueror:(\d+(\.\d+)?)/,BlackBerry:/BlackBerry (\d+(\.\d+)?)/,"Android Mobile":/android\s(\d+(\.\d+)?)/,"Samsung Internet":/SamsungBrowser\/(\d+(\.\d+)?)/,"Internet Explorer":/(rv:|MSIE )(\d+(\.\d+)?)/,Mozilla:/rv:(\d+(\.\d+)?)/}[rU.info.browser(e,t,n)];if(void 0===r)return null;var a=e.match(r);return a?parseFloat(a[a.length-2]):null},os:function(){if(/Windows/i.test(rP))return/Phone/.test(rP)||/WPDesktop/.test(rP)?"Windows Phone":"Windows";if(/(iPhone|iPad|iPod)/.test(rP))return"iOS";if(/Android/.test(rP))return"Android";if(/(BlackBerry|PlayBook|BB10)/i.test(rP))return"BlackBerry";if(/Mac/i.test(rP))return"Mac OS X";if(/Linux/.test(rP))return"Linux";if(/CrOS/.test(rP))return"Chrome OS";else return""},device:function(e){return/Windows Phone/i.test(e)||/WPDesktop/.test(e)?"Windows Phone":/iPad/.test(e)?"iPad":/iPod/.test(e)?"iPod Touch":/iPhone/.test(e)?"iPhone":/(BlackBerry|PlayBook|BB10)/i.test(e)?"BlackBerry":/Android/.test(e)?"Android":""},referringDomain:function(e){var t=e.split("/");return t.length>=3?t[2]:""},properties:function(){return rU.extend(rU.strip_empty_properties({$os:rU.info.os(),$browser:rU.info.browser(rP,rC.vendor,rO),$referrer:rT.referrer,$referring_domain:rU.info.referringDomain(rT.referrer),$device:rU.info.device(rP)}),{$current_url:E.location.href,$browser_version:rU.info.browserVersion(rP,rC.vendor,rO),$screen_height:rR.height,$screen_width:rR.width,mp_lib:"web",$lib_version:rg.LIB_VERSION,$insert_id:rY(),time:rU.timestamp()/1e3// epoch time in seconds
})},people_properties:function(){return rU.extend(rU.strip_empty_properties({$os:rU.info.os(),$browser:rU.info.browser(rP,rC.vendor,rO)}),{$browser_version:rU.info.browserVersion(rP,rC.vendor,rO)})},mpPageViewProperties:function(){return rU.strip_empty_properties({current_page_title:rT.title,current_domain:E.location.hostname,current_url_path:E.location.pathname,current_url_protocol:E.location.protocol,current_url_search:E.location.search})}};var rY=function(e){var t=Math.random().toString(36).substring(2,10)+Math.random().toString(36).substring(2,10);return e?t.substring(0,e):t},rQ=/[a-z0-9][a-z0-9-]*\.[a-z]+$/i,rK=/[a-z0-9][a-z0-9-]+\.[a-z.]{2,6}$/i,rG=function(e){var t=rK,n=e.split("."),r=n[n.length-1];(r.length>4||"com"===r||"org"===r)&&(t=rQ);var a=e.match(t);return a?a[0]:""},rX=null,rJ=null;"undefined"!=typeof JSON&&(rX=JSON.stringify,rJ=JSON.parse),rX=rX||rU.JSONEncode,rJ=rJ||rU.JSONDecode,// EXPORTS (for closure compiler)
rU.toArray=rU.toArray,rU.isObject=rU.isObject,rU.JSONEncode=rU.JSONEncode,rU.JSONDecode=rU.JSONDecode,rU.isBlockedUA=rU.isBlockedUA,rU.isEmptyObject=rU.isEmptyObject,rU.info=rU.info,rU.info.device=rU.info.device,rU.info.browser=rU.info.browser,rU.info.browserVersion=rU.info.browserVersion,rU.info.properties=rU.info.properties;/**
 * DomTracker Object
 * @constructor
 */var rZ=function(){};// interface
rZ.prototype.create_properties=function(){},rZ.prototype.event_handler=function(){},rZ.prototype.after_track_handler=function(){},rZ.prototype.init=function(e){return this.mp=e,this},/**
 * @param {Object|string} query
 * @param {string} event_name
 * @param {Object=} properties
 * @param {function=} user_callback
 */rZ.prototype.track=function(e,t,n,r){var a=this,i=rU.dom_query(e);if(0===i.length){rz.error("The DOM query ("+e+") returned 0 elements");return}return rU.each(i,function(e){rU.register_event(e,this.override_event,function(e){var i={},o=a.create_properties(n,this),s=a.mp.get_config("track_links_timeout");a.event_handler(e,this,i),// in case the mixpanel servers don't get back to us in time
window.setTimeout(a.track_callback(r,o,i,!0),s),// fire the tracking event
a.mp.track(t,o,a.track_callback(r,o,i))})},this),!0},/**
 * @param {function} user_callback
 * @param {Object} props
 * @param {boolean=} timeout_occured
 */rZ.prototype.track_callback=function(e,t,n,r){r=r||!1;var a=this;return function(){// options is referenced from both callbacks, so we can have
// a 'lock' of sorts to ensure only one fires
!n.callback_fired&&(n.callback_fired=!0,e&&!1===e(r,t)||a.after_track_handler(t,n,r))}},rZ.prototype.create_properties=function(e,t){return"function"==typeof e?e(t):rU.extend({},e)};/**
 * LinkTracker Object
 * @constructor
 * @extends DomTracker
 */var r0=function(){this.override_event="click"};rU.inherit(r0,rZ),r0.prototype.create_properties=function(e,t){var n=r0.superclass.create_properties.apply(this,arguments);return t.href&&(n.url=t.href),n},r0.prototype.event_handler=function(e,t,n){n.new_tab=2===e.which||e.metaKey||e.ctrlKey||"_blank"===t.target,n.href=t.href,n.new_tab||e.preventDefault()},r0.prototype.after_track_handler=function(e,t){t.new_tab||setTimeout(function(){window.location=t.href},0)};/**
 * FormTracker Object
 * @constructor
 * @extends DomTracker
 */var r1=function(){this.override_event="submit"};rU.inherit(r1,rZ),r1.prototype.event_handler=function(e,t,n){n.element=t,e.preventDefault()},r1.prototype.after_track_handler=function(e,t){setTimeout(function(){t.element.submit()},0)};// eslint-disable-line camelcase
var r2=rj("lock"),r3=function(e,t){t=t||{},this.storageKey=e,this.storage=t.storage||window.localStorage,this.pollIntervalMS=t.pollIntervalMS||100,this.timeoutMS=t.timeoutMS||2e3};// pass in a specific pid to test contention scenarios; otherwise
// it is chosen randomly for each acquisition attempt
r3.prototype.withLock=function(e,t,n){n||"function"==typeof t||(n=t,t=null);var r=n||new Date().getTime()+"|"+Math.random(),a=new Date().getTime(),i=this.storageKey,o=this.pollIntervalMS,s=this.timeoutMS,l=this.storage,u=i+":X",c=i+":Y",d=i+":Z",f=function(e){t&&t(e)},p=function(e){if(new Date().getTime()-a>s){r2.error("Timeout waiting for mutex on "+i+"; clearing lock. ["+r+"]"),l.removeItem(d),l.removeItem(c),v();return}setTimeout(function(){try{e()}catch(e){f(e)}},o*(Math.random()+.1))},h=function(e,t){e()?t():p(function(){h(e,t)})},m=function(){var e=l.getItem(c);if(e&&e!==r)return!1;if(l.setItem(c,r),l.getItem(c)===r)return!0;if(!rV(l,!0))throw Error("localStorage support dropped while acquiring lock");return!1},v=function(){l.setItem(u,r),h(m,function(){if(l.getItem(u)===r){g();return}p(function(){if(l.getItem(c)!==r){v();return}h(function(){return!l.getItem(d)},g)})})},g=function(){l.setItem(d,"1");try{e()}finally{l.removeItem(d),l.getItem(c)===r&&l.removeItem(c),l.getItem(u)===r&&l.removeItem(u)}};try{if(rV(l,!0))v();else throw Error("localStorage support check failed")}catch(e){f(e)}};// eslint-disable-line camelcase
var r5=rj("batch"),r4=function(e,t){t=t||{},this.storageKey=e,this.storage=t.storage||window.localStorage,this.reportError=t.errorReporter||rU.bind(r5.error,r5),this.lock=new r3(e,{storage:this.storage}),this.pid=t.pid||null,this.memQueue=[]};/**
 ...
 */r4.prototype.enqueue=function(e,t,n){var r={id:rY(),flushAfter:new Date().getTime()+2*t,payload:e};this.lock.withLock(rU.bind(function(){var t;try{var a=this.readFromStorage();a.push(r),(t=this.saveToStorage(a))&&this.memQueue.push(r)}catch(n){this.reportError("Error enqueueing item",e),t=!1}n&&n(t)},this),rU.bind(function(e){this.reportError("Error acquiring storage lock",e),n&&n(!1)},this),this.pid)},/**
 * Read out the given number of queue entries. If this.memQueue
 * has fewer than batchSize items, then look for "orphaned" items
 * in the persisted queue (items where the 'flushAfter' time has
 * already passed).
 */r4.prototype.fillBatch=function(e){var t=this.memQueue.slice(0,e);if(t.length<e){// don't need lock just to read events; localStorage is thread-safe
...
rU.each(t,function(e){r[e.id]=!0});for(var a=0;a<n.length;a++){var i=n[a];if(new Date().getTime()>i.flushAfter&&!r[i.id]&&(i.orphaned=!0,t.push(i),t.length>=e))break}}}return t};/**
 * Remove items with matching 'id' from array (immutably)
 * also remove any item without a valid id (e.g., malformed
 * storage entries).
 */var r6=function(e,t){var n=[];return rU.each(e,function(e){e.id&&!t[e.id]&&n.push(e)}),n};/**
 * Remove items with matching IDs from both in-memory queue
 * and persisted queue
 */r4.prototype.removeItemsByID=function(e,t){var n={};// poor man's Set
rU.each(e,function(e){n[e]=!0}),this.memQueue=r6(this.memQueue,n);var r=rU.bind(function(){var t;try{var r=this.readFromStorage();// an extra check: did storage report success but somehow
// the items are still there?
if(r=r6(r,n),t=this.saveToStorage(r)){r=this.readFromStorage();for(var a=0;a<r.length;a++){var i=r[a];if(i.id&&n[i.id])return this.reportError("Item not removed from storage"),!1}}}catch(n){this.reportError("Error removing items",e),t=!1}return t},this);this.lock.withLock(function(){var e=r();t&&t(e)},rU.bind(function(e){var n=!1;if(this.reportError("Error acquiring storage lock",e),!rV(this.storage,!0)&&!// Looks like localStorage writes have stopped working sometime after
...
var r8=function(e,t){var n=[];return rU.each(e,function(e){var r=e.id;if(r in t){var a=t[r];null!==a&&(e.payload=a,n.push(e))}else n.push(e)}),n};/**
 * Update payloads of given items in both in-memory queue and
 * persisted queue. Items set to null are removed from queues.
 */r4.prototype.updatePayloads=function(e,t){this.memQueue=r8(this.memQueue,e),this.lock.withLock(rU.bind(function(){var n;try{var r=this.readFromStorage();r=r8(r,e),n=this.saveToStorage(r)}catch(t){this.reportError("Error updating items",e),n=!1}t&&t(n)},this),rU.bind(function(e){this.reportError("Error acquiring storage lock",e),t&&t(!1)},this),this.pid)},/**
 * Read and parse items array from localStorage entry, handling
 * malformed/missing data if necessary.
 */r4.prototype.readFromStorage=function(){var e;try{(e=this.storage.getItem(this.storageKey))&&(e=rJ(e),rU.isArray(e)||(this.reportError("Invalid storage entry:",e),e=null))}catch(t){this.reportError("Error retrieving queue",t),e=null}return e||[]},/**
 * Serialize the given items array to localStorage.
 */r4.prototype.saveToStorage=function(e){try{return this.storage.setItem(this.storageKey,rX(e)),!0}catch(e){return this.reportError("Error saving queue",e),!1}},/**
 * Clear out queues (memory and localStorage).
 */r4.prototype.clear=function(){this.memQueue=[],this.storage.removeItem(this.storageKey)};var r7=rj("batch"),r9=function(e,t){this.errorReporter=t.errorReporter,this.queue=new r4(e,{errorReporter:rU.bind(this.reportError,this),storage:t.storage}),this.libConfig=t.libConfig,this.sendRequest=t.sendRequestFunc,this.beforeSendHook=t.beforeSendHook,this.stopAllBatching=t.stopAllBatchingFunc,// seed variable batch size + flush interval with configured values
 ...
 */function an(e,t){return"1"===ac(e,t)}/**
 ...
 */function(e){if(e&&e.ignoreDnt)return!1;var t=e&&e.window||E,n=t.navigator||{},r=!1;return rU.each([n.doNotTrack,n.msDoNotTrack,t.doNotTrack],function(e){rU.includes([!0,1,"1","yes"],e)&&(r=!0)}),r}(t))return rz.warn('This browser has "Do Not Track" enabled. This will prevent the Mixpanel SDK from sending any data. To ignore the "Do Not Track" browser setting, initialize the Mixpanel instance with the config "ignore_dnt: true"'),!0;var n="0"===ac(e,t);return n&&rz.warn("You are opted out of Mixpanel tracking. This will prevent the Mixpanel SDK from sending any data."),n}/**
 * Wrap a MixpanelLib method with a check for whether the user is opted out of data tracking and cookies/localstorage for the given token
 * If the user has opted out, return early instead of executing the method.
 * If a callback argument was provided, execute it passing the 0 error code.
 * @param {function} method - wrapped method to be executed if the user has not opted out
 * @returns {*} the result of executing method OR undefined if the user has opted out
 */function aa(e){return af(e,function(e){return this.get_config(e)})}/**
 * Wrap a MixpanelPeople method with a check for whether the user is opted out of data tracking and cookies/localstorage for the given token
 * If the user has opted out, return early instead of executing the method.
 * If a callback argument was provided, execute it passing the 0 error code.
 * @param {function} method - wrapped method to be executed if the user has not opted out
 * @returns {*} the result of executing method OR undefined if the user has opted out
 */function ai(e){return af(e,function(e){return this._get_config(e)})}/**
 * Wrap a MixpanelGroup method with a check for whether the user is opted out of data tracking and cookies/localstorage for the given token
 * If the user has opted out, return early instead of executing the method.
 * If a callback argument was provided, execute it passing the 0 error code.
 * @param {function} method - wrapped method to be executed if the user has not opted out
 * @returns {*} the result of executing method OR undefined if the user has opted out
 */function ao(e){return af(e,function(e){return this._get_config(e)})}/**
 ...
 * @param {boolean} [options.crossSubdomainCookie] - whether the opt-in cookie is set as cross-subdomain or not
 * @param {boolean} [options.secureCookie] - whether the opt-in cookie is set as secure or not
 */function as(e,t){al(t=t||{}).remove(au(e,t),!!t.crossSubdomainCookie,t.cookieDomain)}/** Private **//**
 * Get storage util
 * @param {Object} [options]
 * @param {string} [options.persistenceType]
 * @returns {object} either _.cookie or _.localstorage
 */function al(e){return"localStorage"===(e=e||{}).persistenceType?rU.localStorage:rU.cookie}/**
 * Get the name of the cookie that is used for the given opt type (tracking, cookie, etc.)
 * @param {string} token - Mixpanel project tracking token
 * @param {Object} [options]
 * @param {string} [options.persistencePrefix=__mp_opt_in_out] - custom prefix to be used in the cookie/localstorage name
 * @returns {string} the name of the cookie for the given opt type
 */function au(e,t){return((t=t||{}).persistencePrefix||"__mp_opt_in_out_")+e}/**
 * Get the value of the cookie that is used for the given opt type (tracking, cookie, etc.)
 * @param {string} token - Mixpanel project tracking token
 * @param {Object} [options]
 * @param {string} [options.persistencePrefix=__mp_opt_in_out] - custom prefix to be used in the cookie/localstorage name
 * @returns {string} the value of the cookie for the given opt type
 */function ac(e,t){return al(t).get(au(e,t))}/**
 ...
 * @param {boolean} [options.crossSubdomainCookie] - whether the opt-in cookie is set as cross-subdomain or not
 * @param {boolean} [options.secureCookie] - whether the opt-in cookie is set as secure or not
 */function ad(e,t,n){if(!rU.isString(t)||!t.length){rz.error("gdpr."+(e?"optIn":"optOut")+" called with an invalid token");return}al(n=n||{}).set(au(t,n),e?1:0,rU.isNumber(n.cookieExpiration)?n.cookieExpiration:null,!!n.crossSubdomainCookie,!!n.secureCookie,!!n.crossSiteCookie,n.cookieDomain),n.track&&e&&n.track(n.trackEventName||"$opt_in",n.trackProperties,{send_immediately:!0})}/**
 ...
 * @returns {*} the result of executing method OR undefined if the user has opted out
 */function af(e,t){return function(){var n=!1;try{var r=t.call(this,"token"),a=t.call(this,"ignore_dnt"),i=t.call(this,"opt_out_tracking_persistence_type"),o=t.call(this,"opt_out_tracking_cookie_prefix"),s=t.call(this,"window");r&&(n=ar(r,{ignoreDnt:a,persistenceType:i,persistencePrefix:o,window:s}))}catch(e){rz.error("Unexpected error when checking tracking opt-out status: "+e)}if(!n)return e.apply(this,arguments);var l=arguments[arguments.length-1];"function"==typeof l&&l(0)}}/**
 * Add one item to queue.
 */r9.prototype.enqueue=function(e,t){this.queue.enqueue(e,this.flushInterval,t)},/**
 * Start flushing batches at the configured time interval. Must call
 * this method upon SDK init in order to send anything over the network.
 */r9.prototype.start=function(){this.stopped=!1,this.consecutiveRemovalFailures=0,this.flush()},/**
 * Stop flushing batches. Can be restarted by calling start().
 */r9.prototype.stop=function(){this.stopped=!0,this.timeoutID&&(clearTimeout(this.timeoutID),this.timeoutID=null)},/**
 * Clear out queue.
 */r9.prototype.clear=function(){this.queue.clear()},/**
 * Restore batch size configuration to whatever is set in the main SDK.
 */r9.prototype.resetBatchSize=function(){this.batchSize=this.libConfig.batch_size},/**
 * Restore flush interval time configuration to whatever is set in the main SDK.
 */r9.prototype.resetFlush=function(){this.scheduleFlush(this.libConfig.batch_flush_interval_ms)},/**
 * Schedule the next flush in the given number of milliseconds.
 */r9.prototype.scheduleFlush=function(e){this.flushInterval=e,this.stopped||(this.timeoutID=setTimeout(rU.bind(this.flush,this),this.flushInterval))},/**
 ...
 */r9.prototype.flush=function(e){try{if(this.requestInProgress){r7.log("Flush: Request already in progress");return}e=e||{};var t=this.libConfig.batch_request_timeout_ms,n=new Date().getTime(),r=this.batchSize,a=this.queue.fillBatch(r),i=[],o={};if(rU.each(a,function(e){var t=e.payload;if(this.beforeSendHook&&!e.orphaned&&(t=this.beforeSendHook(t)),t){t.event&&t.properties&&(t.properties=rU.extend({},t.properties,{mp_sent_by_lib_version:rg.LIB_VERSION}));var n=!0,r=e.id;r?(this.itemIdsSentSuccessfully[r]||0)>5&&(this.reportError("[dupe] item ID sent too many times, not sending",{item:e,batchSize:a.length,timesSent:this.itemIdsSentSuccessfully[r]}),n=!1):this.reportError("[dupe] found item with no ID",{item:e}),n&&i.push(t)}o[e.id]=t},this),i.length<1){this.resetFlush();return;// nothing to do
}this.requestInProgress=!0;var s=rU.bind(function(i){this.requestInProgress=!1;try{// handle API response in a try-catch to make sure we can reset the
// flush operation if something goes wrong
var s=!1;if(e.unloading)this.queue.updatePayloads(o);else if(rU.isObject(i)&&"timeout"===i.error&&new Date().getTime()-n>=t)this.reportError("Network timeout; retrying"),this.flush();else if(rU.isObject(i)&&i.xhr_req&&(i.xhr_req.status>=500||429===i.xhr_req.status||"timeout"===i.error)){// network or API error, or 429 Too Many Requests, retry
var l=2*this.flushInterval,u=i.xhr_req.responseHeaders;if(u){var c=u["Retry-After"];c&&(l=1e3*parseInt(c,10)||l)}l=Math.min(6e5,l),this.reportError("Error; retry in "+l+" ms"),this.scheduleFlush(l)}else if(rU.isObject(i)&&i.xhr_req&&413===i.xhr_req.status){// 413 Payload Too Large
...
s=!0;s&&(this.queue.removeItemsByID(rU.map(a,function(e){return e.id}),rU.bind(function(e){e?(this.consecutiveRemovalFailures=0,this.flush()):(this.reportError("Failed to remove items from queue"),++this.consecutiveRemovalFailures>5?(this.reportError("Too many queue failures; disabling batching system."),this.stopAllBatching()):this.resetFlush())},this)),// client-side dedupe
rU.each(a,rU.bind(function(e){var t=e.id;t?(this.itemIdsSentSuccessfully[t]=this.itemIdsSentSuccessfully[t]||0,this.itemIdsSentSuccessfully[t]++,this.itemIdsSentSuccessfully[t]>5&&this.reportError("[dupe] item ID sent too many times",{item:e,batchSize:a.length,timesSent:this.itemIdsSentSuccessfully[t]})):this.reportError("[dupe] found item with no ID while removing",{item:e})},this)))}catch(e){this.reportError("Error handling API response",e),this.resetFlush()}},this),l={method:"POST",verbose:!0,ignore_json_errors:!0,timeout_ms:t// eslint-disable-line camelcase
};e.unloading&&(l.transport="sendBeacon"),r7.log("MIXPANEL REQUEST:",i),this.sendRequest(i,l,s)}catch(e){this.reportError("Error flushing request queue",e),this.resetFlush()}},/**
 * Log error to global logger and optional user-defined logger.
 */r9.prototype.reportError=function(e,t){if(r7.error.apply(r7.error,arguments),this.errorReporter)try{t instanceof Error||(t=Error(e)),this.errorReporter(e,t)}catch(e){r7.error(e)}};/** @const */var ap="$set",ah="$set_once",am="$unset",av="$add",ag="$append",ay="$union",ab="$remove",aw={set_action:function(e,t){var n={},r={};return rU.isObject(e)?rU.each(e,function(e,t){this._is_reserved_property(t)||(r[t]=e)},this):r[e]=t,n[ap]=r,n},unset_action:function(e){var t={},n=[];return rU.isArray(e)||(e=[e]),rU.each(e,function(e){this._is_reserved_property(e)||n.push(e)},this),t[am]=n,t},set_once_action:function(e,t){var n={},r={};return rU.isObject(e)?rU.each(e,function(e,t){this._is_reserved_property(t)||(r[t]=e)},this):r[e]=t,n[ah]=r,n},union_action:function(e,t){var n={},r={};return rU.isObject(e)?rU.each(e,function(e,t){this._is_reserved_property(t)||(r[t]=rU.isArray(e)?e:[e])},this):r[e]=rU.isArray(t)?t:[t],n[ay]=r,n},append_action:function(e,t){var n={},r={};return rU.isObject(e)?rU.each(e,function(e,t){this._is_reserved_property(t)||(r[t]=e)},this):r[e]=t,n[ag]=r,n},remove_action:function(e,t){var n={},r={};return rU.isObject(e)?rU.each(e,function(e,t){this._is_reserved_property(t)||(r[t]=e)},this):r[e]=t,n[ab]=r,n},delete_action:function(){var e={};return e.$delete="",e}},a_=function(){};rU.extend(a_.prototype,aw),a_.prototype._init=function(e,t,n){this._mixpanel=e,this._group_key=t,this._group_id=n},/**
 ...
 */a_.prototype.set=ao(function(e,t,n){var r=this.set_action(e,t);return rU.isObject(e)&&(n=t),this._send_request(r,n)}),/**
 ...
 * @param {*} [to] A value to set on the given property name
 * @param {Function} [callback] If provided, the callback will be called after the tracking event
 */a_.prototype.set_once=ao(function(e,t,n){var r=this.set_once_action(e,t);return rU.isObject(e)&&(n=t),this._send_request(r,n)}),/**
 ...
 * @param {Function} [callback] If provided, the callback will be called after the tracking event
 */a_.prototype.unset=ao(function(e,t){var n=this.unset_action(e);return this._send_request(n,t)}),/**
 ...
 * @param {Function} [callback] If provided, the callback will be called after the tracking event
 */a_.prototype.union=ao(function(e,t,n){rU.isObject(e)&&(n=t);var r=this.union_action(e,t);return this._send_request(r,n)}),/**
 ...
 *
 * @param {Function} [callback] If provided, the callback will be called after the tracking event
 */a_.prototype.delete=ao(function(e){// bracket notation above prevents a minification error related to reserved words
 ...
 * @param {Function} [callback] If provided, the callback will be called after the tracking event
 */a_.prototype.remove=ao(function(e,t,n){var r=this.remove_action(e,t);return this._send_request(r,n)}),a_.prototype._send_request=function(e,t){e.$group_key=this._group_key,e.$group_id=this._group_id,e.$token=this._get_config("token");var n=rU.encodeDates(e);return this._mixpanel._track_or_batch({type:"groups",data:n,endpoint:this._get_config("api_host")+"/groups/",batcher:this._mixpanel.request_batchers.groups},t)},a_.prototype._is_reserved_property=function(e){return"$group_key"===e||"$group_id"===e},a_.prototype._get_config=function(e){return this._mixpanel.get_config(e)},a_.prototype.toString=function(){return this._mixpanel.toString()+".group."+this._group_key+"."+this._group_id},// MixpanelGroup Exports
a_.prototype.remove=a_.prototype.remove,a_.prototype.set=a_.prototype.set,a_.prototype.set_once=a_.prototype.set_once,a_.prototype.union=a_.prototype.union,a_.prototype.unset=a_.prototype.unset,a_.prototype.toString=a_.prototype.toString;/**
 * Mixpanel People Object
 * @constructor
 */var ak=function(){};rU.extend(ak.prototype,aw),ak.prototype._init=function(e){this._mixpanel=e},/*
...
*/ak.prototype.set=ai(function(e,t,n){var r=this.set_action(e,t);return rU.isObject(e)&&(n=t),this._get_config("save_referrer")&&this._mixpanel.persistence.update_referrer_info(document.referrer),// update $set object with default people properties
r[ap]=rU.extend({},rU.info.people_properties(),this._mixpanel.persistence.get_referrer_info(),r[ap]),this._send_request(r,n)}),/*
...
* @param {*} [to] A value to set on the given property name
* @param {Function} [callback] If provided, the callback will be called after tracking the event.
*/ak.prototype.set_once=ai(function(e,t,n){var r=this.set_once_action(e,t);return rU.isObject(e)&&(n=t),this._send_request(r,n)}),/*
...
* @param {Function} [callback] If provided, the callback will be called after tracking the event.
*/ak.prototype.unset=ai(function(e,t){var n=this.unset_action(e);return this._send_request(n,t)}),/*
...
* @param {Function} [callback] If provided, the callback will be called after tracking the event.
*/ak.prototype.increment=ai(function(e,t,n){var r={},a={};return rU.isObject(e)?(rU.each(e,function(e,t){if(!this._is_reserved_property(t)){if(isNaN(parseFloat(e))){rz.error("Invalid increment value passed to mixpanel.people.increment - must be a number");return}a[t]=e}},this),n=t):(rU.isUndefined(t)&&(t=1),a[e]=t),r[av]=a,this._send_request(r,n)}),/*
...
* @param {Function} [callback] If provided, the callback will be called after tracking the event.
*/ak.prototype.append=ai(function(e,t,n){rU.isObject(e)&&(n=t);var r=this.append_action(e,t);return this._send_request(r,n)}),/*
...
* @param {Function} [callback] If provided, the callback will be called after tracking the event.
*/ak.prototype.remove=ai(function(e,t,n){rU.isObject(e)&&(n=t);var r=this.remove_action(e,t);return this._send_request(r,n)}),/*
...
* @param {Function} [callback] If provided, the callback will be called after tracking the event.
*/ak.prototype.union=ai(function(e,t,n){rU.isObject(e)&&(n=t);var r=this.union_action(e,t);return this._send_request(r,n)}),/*
 ...
 * @deprecated
 */ak.prototype.track_charge=ai(function(e,t,n){if(!rU.isNumber(e)&&isNaN(e=parseFloat(e))){rz.error("Invalid value passed to mixpanel.people.track_charge - must be a number");return}return this.append("$transactions",rU.extend({$amount:e},t),n)}),/*
 ...
 * @param {Function} [callback] If provided, the callback will be called after tracking the event.
 * @deprecated
 */ak.prototype.clear_charges=function(e){return this.set("$transactions",[],e)},/*
...
*
*/ak.prototype.delete_user=function(){if(!this._identify_called()){rz.error("mixpanel.people.delete_user() requires you to call identify() first");return}var e={$delete:this._mixpanel.get_distinct_id()};return this._send_request(e)},ak.prototype.toString=function(){return this._mixpanel.toString()+".people"},ak.prototype._send_request=function(e,t){e.$token=this._get_config("token"),e.$distinct_id=this._mixpanel.get_distinct_id();var n=this._mixpanel.get_property("$device_id"),r=this._mixpanel.get_property("$user_id"),a=this._mixpanel.get_property("$had_persisted_distinct_id");n&&(e.$device_id=n),r&&(e.$user_id=r),a&&(e.$had_persisted_distinct_id=a);var i=rU.encodeDates(e);return this._identify_called()?this._mixpanel._track_or_batch({type:"people",data:i,endpoint:this._get_config("api_host")+"/engage/",batcher:this._mixpanel.request_batchers.people},t):(this._enqueue(e),rU.isUndefined(t)||t(this._get_config("verbose")?{status:-1,error:null}:-1),rU.truncate(i,255))},ak.prototype._get_config=function(e){return this._mixpanel.get_config(e)},ak.prototype._identify_called=function(){return!0===this._mixpanel._flags.identify_called},// Queue up engage operations if identify hasn't been called yet.
ak.prototype._enqueue=function(e){ap in e?this._mixpanel.persistence._add_to_people_queue(ap,e):ah in e?this._mixpanel.persistence._add_to_people_queue(ah,e):am in e?this._mixpanel.persistence._add_to_people_queue(am,e):av in e?this._mixpanel.persistence._add_to_people_queue(av,e):ag in e?this._mixpanel.persistence._add_to_people_queue(ag,e):ab in e?this._mixpanel.persistence._add_to_people_queue(ab,e):ay in e?this._mixpanel.persistence._add_to_people_queue(ay,e):rz.error("Invalid call to _enqueue():",e)},ak.prototype._flush_one_queue=function(e,t,n,r){var a=this,i=rU.extend({},this._mixpanel.persistence._get_queue(e)),o=i;!rU.isUndefined(i)&&rU.isObject(i)&&!rU.isEmptyObject(i)&&(a._mixpanel.persistence._pop_from_people_queue(e,i),r&&(o=r(i)),t.call(a,o,function(t,r){0===t&&a._mixpanel.persistence._add_to_people_queue(e,i),rU.isUndefined(n)||n(t,r)}))},// Flush queued engage operations - order does not matter,
// and there are network level race conditions anyway
ak.prototype._flush=function(e,t,n,r,a,i,o){var s=this,l=this._mixpanel.persistence._get_queue(ag),u=this._mixpanel.persistence._get_queue(ab);// we have to fire off each $append individually since there is
// no concat method server side
if(this._flush_one_queue(ap,this.set,e),this._flush_one_queue(ah,this.set_once,r),this._flush_one_queue(am,this.unset,i,function(e){return rU.keys(e)}),this._flush_one_queue(av,this.increment,t),this._flush_one_queue(ay,this.union,a),!rU.isUndefined(l)&&rU.isArray(l)&&l.length){for(var c,d=function(e,t){0===e&&s._mixpanel.persistence._add_to_people_queue(ag,c),rU.isUndefined(n)||n(e,t)},f=l.length-1;f>=0;f--)c=l.pop(),rU.isEmptyObject(c)||s.append(c,d);// Save the shortened append queue
s._mixpanel.persistence.save()}// same for $remove
if(!rU.isUndefined(u)&&rU.isArray(u)&&u.length){for(var p,h=function(e,t){0===e&&s._mixpanel.persistence._add_to_people_queue(ab,p),rU.isUndefined(o)||o(e,t)},m=u.length-1;m>=0;m--)p=u.pop(),rU.isEmptyObject(p)||s.remove(p,h);s._mixpanel.persistence.save()}},ak.prototype._is_reserved_property=function(e){return"$distinct_id"===e||"$token"===e||"$device_id"===e||"$user_id"===e||"$had_persisted_distinct_id"===e},// MixpanelPeople Exports
ak.prototype.set=ak.prototype.set,ak.prototype.set_once=ak.prototype.set_once,ak.prototype.unset=ak.prototype.unset,ak.prototype.increment=ak.prototype.increment,ak.prototype.append=ak.prototype.append,ak.prototype.remove=ak.prototype.remove,ak.prototype.union=ak.prototype.union,ak.prototype.track_charge=ak.prototype.track_charge,ak.prototype.clear_charges=ak.prototype.clear_charges,ak.prototype.delete_user=ak.prototype.delete_user,ak.prototype.toString=ak.prototype.toString;/*
 * Constants
 *//** @const */var ax="__mps",aS="__mpso",aE="__mpus",aC="__mpa",aT="__mpap",aO="__mpr",aR="__mpu",aP="$people_distinct_id",aI="__alias",aD="__timers",aN=[ax,aS,aE,aC,aT,aO,aR,aP,aI,aD],aL=function(e){this.props={},this.campaign_params_saved=!1,e.persistence_name?this.name="mp_"+e.persistence_name:this.name="mp_"+e.token+"_mixpanel";var t=e.persistence;"cookie"!==t&&"localStorage"!==t&&(rz.critical("Unknown persistence type "+t+"; falling back to cookie"),t=e.persistence="cookie"),"localStorage"===t&&rU.localStorage.is_supported()?this.storage=rU.localStorage:this.storage=rU.cookie,this.load(),this.update_config(e),this.upgrade(e),this.save()};aL.prototype.properties=function(){var e={};return(// Filter out reserved properties
rU.each(this.props,function(t,n){rU.include(aN,n)||(e[n]=t)}),e)},aL.prototype.load=function(){if(!this.disabled){var e=this.storage.parse(this.name);e&&(this.props=rU.extend({},e))}},aL.prototype.upgrade=function(e){var t,n,r=e.upgrade;r&&(t="mp_super_properties","string"==typeof r&&(t=r),n=this.storage.parse(t),// remove the cookie
this.storage.remove(t),this.storage.remove(t,!0),n&&(this.props=rU.extend(this.props,n.all,n.events))),!e.cookie_name&&"mixpanel"!==e.name&&(// special case to handle people with cookies of the form
...
this.register_once(n))),this.storage===rU.localStorage&&(n=rU.cookie.parse(this.name),rU.cookie.remove(this.name),rU.cookie.remove(this.name,!0),n&&this.register_once(n))},aL.prototype.save=function(){this.disabled||this.storage.set(this.name,rU.JSONEncode(this.props),this.expire_days,this.cross_subdomain,this.secure,this.cross_site,this.cookie_domain)},aL.prototype.remove=function(){// remove both domain and subdomain cookies
...
aL.prototype.clear=function(){this.remove(),this.props={}},/**
* @param {Object} props
* @param {*=} default_value
* @param {number=} days
*/aL.prototype.register_once=function(e,t,n){return!!rU.isObject(e)&&(void 0===t&&(t="None"),this.expire_days=void 0===n?this.default_expiry:n,rU.each(e,function(e,n){this.props.hasOwnProperty(n)&&this.props[n]!==t||(this.props[n]=e)},this),this.save(),!0)},/**
* @param {Object} props
* @param {number=} days
*/aL.prototype.register=function(e,t){return!!rU.isObject(e)&&(this.expire_days=void 0===t?this.default_expiry:t,rU.extend(this.props,e),this.save(),!0)},aL.prototype.unregister=function(e){e in this.props&&(delete this.props[e],this.save())},aL.prototype.update_search_keyword=function(e){this.register(rU.info.searchInfo(e))},// EXPORTED METHOD, we test this directly.
aL.prototype.update_referrer_info=function(e){// If referrer doesn't exist, we want to note the fact that it was type-in traffic.
this.register_once({$initial_referrer:e||"$direct",$initial_referring_domain:rU.info.referringDomain(e)||"$direct"},"")},aL.prototype.get_referrer_info=function(){return rU.strip_empty_properties({$initial_referrer:this.props.$initial_referrer,$initial_referring_domain:this.props.$initial_referring_domain})},// safely fills the passed in object with stored properties,
// does not override any properties defined in both
// returns the passed in object
aL.prototype.safe_merge=function(e){return rU.each(this.props,function(t,n){n in e||(e[n]=t)}),e},aL.prototype.update_config=function(e){this.default_expiry=this.expire_days=e.cookie_expiration,this.set_disabled(e.disable_persistence),this.set_cookie_domain(e.cookie_domain),this.set_cross_site(e.cross_site_cookie),this.set_cross_subdomain(e.cross_subdomain_cookie),this.set_secure(e.secure_cookie)},aL.prototype.set_disabled=function(e){this.disabled=e,this.disabled?this.remove():this.save()},aL.prototype.set_cookie_domain=function(e){e!==this.cookie_domain&&(this.remove(),this.cookie_domain=e,this.save())},aL.prototype.set_cross_site=function(e){e!==this.cross_site&&(this.cross_site=e,this.remove(),this.save())},aL.prototype.set_cross_subdomain=function(e){e!==this.cross_subdomain&&(this.cross_subdomain=e,this.remove(),this.save())},aL.prototype.get_cross_subdomain=function(){return this.cross_subdomain},aL.prototype.set_secure=function(e){e!==this.secure&&(this.secure=!!e,this.remove(),this.save())},aL.prototype._add_to_people_queue=function(e,t){var n=this._get_queue_key(e),r=t[e],a=this._get_or_create_queue(ap),i=this._get_or_create_queue(ah),o=this._get_or_create_queue(am),s=this._get_or_create_queue(av),l=this._get_or_create_queue(ay),u=this._get_or_create_queue(ab,[]),c=this._get_or_create_queue(ag,[]);n===ax?(// Update the set queue - we can override any existing values
rU.extend(a,r),// if there was a pending increment, override it
// with the set.
this._pop_from_people_queue(av,r),// if there was a pending union, override it
// with the set.
this._pop_from_people_queue(ay,r),this._pop_from_people_queue(am,r)):n===aS?(// only queue the data if there is not already a set_once call for it.
rU.each(r,function(e,t){t in i||(i[t]=e)}),this._pop_from_people_queue(am,r)):n===aE?rU.each(r,function(e){// undo previously-queued actions on this key
rU.each([a,i,s,l],function(t){e in t&&delete t[e]}),rU.each(c,function(t){e in t&&delete t[e]}),o[e]=!0}):n===aC?(rU.each(r,function(e,t){// If it exists in the set queue, increment
// the value
t in a?a[t]+=e:(t in s||(s[t]=0),s[t]+=e)},this),this._pop_from_people_queue(am,r)):n===aR?(rU.each(r,function(e,t){rU.isArray(e)&&(t in l||(l[t]=[]),// We may send duplicates, the server will dedup them.
l[t]=l[t].concat(e))}),this._pop_from_people_queue(am,r)):n===aO?(u.push(r),this._pop_from_people_queue(ag,r)):n===aT&&(c.push(r),this._pop_from_people_queue(am,r)),rz.log("MIXPANEL PEOPLE REQUEST (QUEUED, PENDING IDENTIFY):"),rz.log(t),this.save()},aL.prototype._pop_from_people_queue=function(e,t){var n=this._get_queue(e);rU.isUndefined(n)||(rU.each(t,function(t,r){e===ag||e===ab?// e.g. remove should not override append in a case like
// append({foo: 'bar'}); remove({foo: 'qux'})
rU.each(n,function(e){e[r]===t&&delete e[r]}):delete n[r]},this),this.save())},aL.prototype._get_queue_key=function(e){return e===ap?ax:e===ah?aS:e===am?aE:e===av?aC:e===ag?aT:e===ab?aO:e===ay?aR:void rz.error("Invalid queue:",e)},aL.prototype._get_queue=function(e){return this.props[this._get_queue_key(e)]},aL.prototype._get_or_create_queue=function(e,t){var n=this._get_queue_key(e);return t=rU.isUndefined(t)?{}:t,this.props[n]||(this.props[n]=t)},aL.prototype.set_event_timer=function(e,t){var n=this.props[aD]||{};n[e]=t,this.props[aD]=n,this.save()},aL.prototype.remove_event_timer=function(e){var t=(this.props[aD]||{})[e];return rU.isUndefined(t)||(delete this.props[aD][e],this.save()),t};var aM=function(e){return e},aA=function(){},aU="mixpanel",az="base64",aF="$device:",aj=E.XMLHttpRequest&&"withCredentials"in new XMLHttpRequest,aq=!aj&&-1===rP.indexOf("MSIE")&&-1===rP.indexOf("Mozilla"),aB=null;rC.sendBeacon&&(aB=function(){// late reference to navigator.sendBeacon to allow patching/spying
return rC.sendBeacon.apply(rC,arguments)});/*
 * Module-level globals
 */var aV={api_host:"https://api-js.mixpanel.com",api_method:"POST",api_transport:"XHR",api_payload_format:az,app_host:"https://mixpanel.com",cdn:"https://cdn.mxpnl.com",cross_site_cookie:!1,cross_subdomain_cookie:!0,error_reporter:aA,persistence:"cookie",persistence_name:"",cookie_domain:"",cookie_name:"",loaded:aA,track_marketing:!0,track_pageview:!1,skip_first_touch_marketing:!1,store_google:!0,save_referrer:!0,test:!1,verbose:!1,img:!1,debug:!1,track_links_timeout:300,cookie_expiration:365,upgrade:!1,disable_persistence:!1,disable_cookie:!1,secure_cookie:!1,ip:!0,opt_out_tracking_by_default:!1,opt_out_persistence_by_default:!1,opt_out_tracking_persistence_type:"localStorage",opt_out_tracking_cookie_prefix:null,property_blacklist:[],xhr_headers:{},ignore_dnt:!1,batch_requests:!0,batch_size:50,batch_flush_interval_ms:5e3,batch_request_timeout_ms:9e4,batch_autostart:!0,hooks:{}},aW=!1,a$=function(){},aH=function(e,t,n){var r,a=n===aU?T:T[n];if(a&&0===C)r=a;else{if(a&&!rU.isArray(a)){rz.error("You have already initialized "+n);return}r=new a$}if(r._cached_groups={},r._init(e,t,n),r.people=new ak,r.people._init(r),!r.get_config("skip_first_touch_marketing")){// We need null UTM params in the object because
// UTM parameters act as a tuple. If any UTM param
// is present, then we set all UTM params including
// empty ones together
var i=rU.info.campaignParams(null),o={},s=!1;rU.each(i,function(e,t){o["initial_"+t]=e,e&&(s=!0)}),s&&r.people.set_once(o)}return(// if any instance on the page has debug = true, we set the
// global debug to be true
rg.DEBUG=rg.DEBUG||r.get_config("debug"),!rU.isUndefined(a)&&rU.isArray(a)&&(// Crunch through the people queue first - we queue this data up &
 ...
 */a$.prototype.init=function(e,t,n){if(rU.isUndefined(n)){this.report_error("You must name your new library: init(token, config, name)");return}if(n===aU){this.report_error("You must initialize the main mixpanel object right after you include the Mixpanel js snippet");return}var r=aH(e,t,n);return T[n]=r,r._loaded(),r},// mixpanel._init(token:string, config:object, name:string)
//
...
//
a$.prototype._init=function(e,t,n){t=t||{},this.__loaded=!0,this.config={};var r={};if(!("api_payload_format"in t)&&(t.api_host||aV.api_host).match(/\.mixpanel\.com/)&&(r.api_payload_format="json"),this.set_config(rU.extend({},aV,r,t,{name:n,token:e,callback_fn:(n===aU?n:aU+"."+n)+"._jsc"})),this._jsc=aA,this.__dom_loaded_queue=[],this.__request_queue=[],this.__disabled_events=[],this._flags={disable_all_events:!1,identify_called:!1},// set up request queueing/batching
this.request_batchers={},this._batch_requests=this.get_config("batch_requests"),this._batch_requests){if(rU.localStorage.is_supported(!0)&&aj){if(this.init_batchers(),aB&&E.addEventListener){// Before page closes or hides (user tabs away etc), attempt to flush any events
...
var a=rU.bind(function(){this.request_batchers.events.stopped||this.request_batchers.events.flush({unloading:!0})},this);E.addEventListener("pagehide",function(e){e.persisted&&a()}),E.addEventListener("visibilitychange",function(){"hidden"===rT.visibilityState&&a()})}}else this._batch_requests=!1,rz.log("Turning off Mixpanel request-queueing; needs XHR and localStorage support")}this.persistence=this.cookie=new aL(this.config),this.unpersisted_superprops={},this._gdpr_init();var i=rU.UUID();this.get_distinct_id()||// or the device id if something was already stored
// in the persitence
this.register_once({distinct_id:aF+i,$device_id:i},""),this.get_config("track_pageview")&&this.track_pageview()},// Private methods
a$.prototype._loaded=function(){this.get_config("loaded")(this),this._set_default_superprops()},// update persistence with info on referrer, UTM params, etc
a$.prototype._set_default_superprops=function(){this.persistence.update_search_keyword(rT.referrer),this.get_config("store_google")&&this.register(rU.info.campaignParams(),{persistent:!1}),this.get_config("save_referrer")&&this.persistence.update_referrer_info(rT.referrer)},a$.prototype._dom_loaded=function(){rU.each(this.__dom_loaded_queue,function(e){this._track_dom.apply(this,e)},this),this.has_opted_out_tracking()||rU.each(this.__request_queue,function(e){this._send_request.apply(this,e)},this),delete this.__dom_loaded_queue,delete this.__request_queue},a$.prototype._track_dom=function(e,t){if(this.get_config("img"))return this.report_error("You can't use DOM tracking functions with img = true."),!1;if(!aW)return this.__dom_loaded_queue.push([e,t]),!1;var n=new e().init(this);return n.track.apply(n,t)},/**
 ...
 * callback GET param.
 */a$.prototype._prepare_callback=function(e,t){if(rU.isUndefined(e))return null;if(aj)return function(n){e(n,t)};// if the user gives us a callback, we store as a random
// property on this instances jsc function and update our
// callback string to reflect that.
var n=this._jsc,r=""+Math.floor(1e8*Math.random()),a=this.get_config("callback_fn")+"["+r+"]";return n[r]=function(a){delete n[r],e(a,t)},a},a$.prototype._send_request=function(e,t,n,r){var a=!0;if(aq)return this.__request_queue.push(arguments),a;var i={method:this.get_config("api_method"),transport:this.get_config("api_transport"),verbose:this.get_config("verbose")},o=null;!r&&(rU.isFunction(n)||"string"==typeof n)&&(r=n,n=null),n=rU.extend(i,n||{}),aj||(n.method="GET");var s="POST"===n.method,l=aB&&s&&"sendbeacon"===n.transport.toLowerCase(),u=n.verbose;t.verbose&&(u=!0),this.get_config("test")&&(t.test=1),u&&(t.verbose=1),this.get_config("img")&&(t.img=1),!aj&&(r?t.callback=r:(u||this.get_config("test"))&&// which by itself is not valid javascript. Without a callback, this verbose output will
// cause an error when returned via jsonp, so we force a no-op callback param.
// See the ECMA script spec: http://www.ecma-international.org/ecma-262/5.1/#sec-12.4
(t.callback="(function(){})")),t.ip=this.get_config("ip")?1:0,t._=new Date().getTime().toString(),s&&(o="data="+encodeURIComponent(t.data),delete t.data),e+="?"+rU.HTTPBuildQuery(t);var c=this;if("img"in t){var d=rT.createElement("img");d.src=e,rT.body.appendChild(d)}else if(l){try{a=aB(e,o)}catch(e){c.report_error(e),a=!1}try{r&&r(a?1:0)}catch(e){c.report_error(e)}}else if(aj)try{var f=new XMLHttpRequest;f.open(n.method,e,!0);var p=this.get_config("xhr_headers");if(s&&(p["Content-Type"]="application/x-www-form-urlencoded"),rU.each(p,function(e,t){f.setRequestHeader(t,e)}),n.timeout_ms&&void 0!==f.timeout){f.timeout=n.timeout_ms;var h=new Date().getTime()}// send the mp_optout cookie
// withCredentials cannot be modified until after calling .open on Android and Mobile Safari
f.withCredentials=!0,f.onreadystatechange=function(){if(4===f.readyState){var e,t;if(200===f.status){if(r){if(u){try{e=rU.JSONDecode(f.responseText)}catch(t){if(c.report_error(t),!n.ignore_json_errors)return;e=f.responseText}r(e)}else r(Number(f.responseText))}}else t=f.timeout&&!f.status&&new Date().getTime()-h>=f.timeout?"timeout":"Bad HTTP status: "+f.status+" "+f.statusText,c.report_error(t),r&&(u?r({status:0,error:t,xhr_req:f}):r(0))}},f.send(o)}catch(e){c.report_error(e),a=!1}else{var m=rT.createElement("script");m.type="text/javascript",m.async=!0,m.defer=!0,m.src=e;var v=rT.getElementsByTagName("script")[0];v.parentNode.insertBefore(m,v)}return a},/**
 ...
 *
 * @param {Array} array
 */a$.prototype._execute_array=function(e){var t,n=[],r=[],a=[];rU.each(e,function(e){e&&(t=e[0],rU.isArray(t)?a.push(e):"function"==typeof e?e.call(this):rU.isArray(e)&&"alias"===t?n.push(e):rU.isArray(e)&&-1!==t.indexOf("track")&&"function"==typeof this[t]?a.push(e):r.push(e))},this);var i=function(e,t){rU.each(e,function(e){if(rU.isArray(e[0])){// chained call
var n=t;rU.each(e,function(e){n=n[e[0]].apply(n,e.slice(1))})}else this[e[0]].apply(this,e.slice(1))},t)};i(n,this),i(r,this),i(a,this)},// request queueing utils
a$.prototype.are_batchers_initialized=function(){return!!this.request_batchers.events},a$.prototype.init_batchers=function(){var e=this.get_config("token");if(!this.are_batchers_initialized()){var t=rU.bind(function(t){return new r9("__mpq_"+e+t.queue_suffix,{libConfig:this.config,sendRequestFunc:rU.bind(function(e,n,r){this._send_request(this.get_config("api_host")+t.endpoint,this._encode_data_for_request(e),n,this._prepare_callback(r,e))},this),beforeSendHook:rU.bind(function(e){return this._run_hook("before_send_"+t.type,e)},this),errorReporter:this.get_config("error_reporter"),stopAllBatchingFunc:rU.bind(this.stop_batch_senders,this)})},this);this.request_batchers={events:t({type:"events",endpoint:"/track/",queue_suffix:"_ev"}),people:t({type:"people",endpoint:"/engage/",queue_suffix:"_pp"}),groups:t({type:"groups",endpoint:"/groups/",queue_suffix:"_gr"})}}this.get_config("batch_autostart")&&this.start_batch_senders()},a$.prototype.start_batch_senders=function(){this.are_batchers_initialized()&&(this._batch_requests=!0,rU.each(this.request_batchers,function(e){e.start()}))},a$.prototype.stop_batch_senders=function(){this._batch_requests=!1,rU.each(this.request_batchers,function(e){e.stop(),e.clear()})},/**
 ...
 */a$.prototype.push=function(e){this._execute_array([e])},/**
 ...
 */a$.prototype.disable=function(e){void 0===e?this._flags.disable_all_events=!0:this.__disabled_events=this.__disabled_events.concat(e)},a$.prototype._encode_data_for_request=function(e){var t=rU.JSONEncode(e);return this.get_config("api_payload_format")===az&&(t=rU.base64Encode(t)),{data:t}},// internal method for handling track vs batch-enqueue logic
a$.prototype._track_or_batch=function(e,t){var n=rU.truncate(e.data,255),r=e.endpoint,a=e.batcher,i=e.should_send_immediately,o=e.send_request_options||{};t=t||aA;var s=!0,l=rU.bind(function(){return(o.skip_hooks||(n=this._run_hook("before_send_"+e.type,n)),n)?(rz.log("MIXPANEL REQUEST:"),rz.log(n),this._send_request(r,this._encode_data_for_request(n),o,this._prepare_callback(t,n))):null},this);return this._batch_requests&&!i?a.enqueue(n,function(e){e?t(1,n):l()}):s=l(),s&&n},/**
 ...
 */a$.prototype.track=aa(function(e,t,n,r){r||"function"!=typeof n||(r=n,n=null);var a=(n=n||{}).transport;// external API, don't minify 'transport' prop
a&&(n.transport=a);var i=n.send_immediately;if("function"!=typeof r&&(r=aA),rU.isUndefined(e)){this.report_error("No event name provided to mixpanel.track");return}if(this._event_is_disabled(e)){r(0);return}// set defaults
(t=t||{}).token=this.get_config("token");// set $duration if time_event was previously called for this event
var o=this.persistence.remove_event_timer(e);if(!rU.isUndefined(o)){var s=new Date().getTime()-o;t.$duration=parseFloat((s/1e3).toFixed(3))}this._set_default_superprops();var l=this.get_config("track_marketing")?rU.info.marketingParams():{};// note: extend writes to the first object, so lets make sure we
// don't write to the persistence properties object and info
// properties object by passing in a new object
// update properties with pageview info and super-properties
t=rU.extend({},rU.info.properties(),l,this.persistence.properties(),this.unpersisted_superprops,t);var u=this.get_config("property_blacklist");rU.isArray(u)?rU.each(u,function(e){delete t[e]}):this.report_error("Invalid value for property_blacklist config: "+u);var c={event:e,properties:t};return this._track_or_batch({type:"events",data:c,endpoint:this.get_config("api_host")+"/track/",batcher:this.request_batchers.events,should_send_immediately:i,send_request_options:n},r)}),/**
 ...
 * @param {Function} [callback] If provided, the callback will be called after tracking the event.
 *
 */a$.prototype.set_group=aa(function(e,t,n){rU.isArray(t)||(t=[t]);var r={};return r[e]=t,this.register(r),this.people.set(e,t,n)}),/**
 ...
 * @param {Function} [callback] If provided, the callback will be called after tracking the event.
 */a$.prototype.add_group=aa(function(e,t,n){var r=this.get_property(e);if(void 0===r){var a={};a[e]=[t],this.register(a)}else -1===r.indexOf(t)&&(r.push(t),this.register(a));return this.people.union(e,t,n)}),/**
 ...
 * @param {*} group_id A valid Mixpanel property type
 * @param {Function} [callback] If provided, the callback will be called after tracking the event.
 */a$.prototype.remove_group=aa(function(e,t,n){var r=this.get_property(e);// if the value doesn't exist, the persistent store is unchanged
 ...
 * @param {Function} [callback] If provided, the callback will be called after tracking the event.
 */a$.prototype.track_with_groups=aa(function(e,t,n,r){var a=rU.extend({},t||{});return rU.each(n,function(e,t){null!=e&&(a[t]=e)}),this.track(e,a,r)}),a$.prototype._create_map_key=function(e,t){return e+"_"+JSON.stringify(t)},a$.prototype._remove_group_from_cache=function(e,t){delete this._cached_groups[this._create_map_key(e,t)]},/**
 ...
 */a$.prototype.get_group=function(e,t){var n=this._create_map_key(e,t),r=this._cached_groups[n];return(void 0===r||r._group_key!==e||r._group_id!==t)&&((r=new a_)._init(this,e,t),this._cached_groups[n]=r),r},/**
 ...
 * @returns {Boolean|Object} If the tracking request was successfully initiated/queued, an object
 * with the tracking payload sent to the API server is returned; otherwise false.
 */a$.prototype.track_pageview=aa(function(e,t){"object"!=typeof e&&(e={});var n=(t=t||{}).event_name||"$mp_web_page_view",r=rU.extend(rU.info.mpPageViewProperties(),rU.info.campaignParams(),rU.info.clickParams()),a=rU.extend({},r,e);return this.track(n,a)}),/**
 ...
 */a$.prototype.track_links=function(){return this._track_dom.call(this,r0,arguments)},/**
 ...
 */a$.prototype.track_forms=function(){return this._track_dom.call(this,r1,arguments)},/**
 ...
 */a$.prototype.time_event=function(e){if(rU.isUndefined(e)){this.report_error("No event name provided to mixpanel.time_event");return}this._event_is_disabled(e)||this.persistence.set_event_timer(e,new Date().getTime())};var aY={persistent:!0},aQ=function(e){var t;return t=rU.isObject(e)?e:rU.isUndefined(e)?{}:{days:e},rU.extend({},aY,t)};/**
 ...
 */a$.prototype.register=function(e,t){var n=aQ(t);n.persistent?this.persistence.register(e,n.days):rU.extend(this.unpersisted_superprops,e)},/**
 ...
 * @param {boolean} [days_or_options.days] - number of days since the user's last visit to store the super properties (only valid for persisted props)
 * @param {boolean} [days_or_options.persistent=true] - whether to put in persistent storage (cookie/localStorage)
 */a$.prototype.register_once=function(e,t,n){var r=aQ(n);r.persistent?this.persistence.register_once(e,t,r.days):(void 0===t&&(t="None"),rU.each(e,function(e,n){this.unpersisted_superprops.hasOwnProperty(n)&&this.unpersisted_superprops[n]!==t||(this.unpersisted_superprops[n]=e)},this))},/**
 * Delete a super property stored with the current user.
 *
 * @param {String} property The name of the super property to remove
 * @param {Object} [options]
 * @param {boolean} [options.persistent=true] - whether to look in persistent storage (cookie/localStorage)
 */a$.prototype.unregister=function(e,t){(t=aQ(t)).persistent?this.persistence.unregister(e):delete this.unpersisted_superprops[e]},a$.prototype._register_single=function(e,t){var n={};n[e]=t,this.register(n)},/**
 ...
 */a$.prototype.identify=function(e,t,n,r,a,i,o,s){// Optional Parameters
...
if("string"==typeof e&&0===e.indexOf(aF))return this.report_error("distinct_id cannot have $device: prefix"),-1;this.register({$user_id:e})}this.get_property("$device_id")||this.register_once({$had_persisted_distinct_id:!0,$device_id:l},""),e!==l&&e!==this.get_property(aI)&&(this.unregister(aI),this.register({distinct_id:e})),this._flags.identify_called=!0,// Flush any queued up people requests
 ...
 */a$.prototype.reset=function(){this.persistence.clear(),this._flags.identify_called=!1;var e=rU.UUID();this.register_once({distinct_id:aF+e,$device_id:e},"")},/**
 ...
 *         }
 *     });
 */a$.prototype.get_distinct_id=function(){return this.get_property("distinct_id")},/**
 ...
 */a$.prototype.alias=function(e,t){// If the $people_distinct_id key exists in persistence, there has been a previous
// mixpanel.people.identify() call made for this user. It is VERY BAD to make an alias with
// this ID, as it will duplicate users.
if(e===this.get_property(aP))return this.report_error("Attempting to create alias for existing People user - aborting."),-2;var n=this;return(rU.isUndefined(t)&&(t=this.get_distinct_id()),e!==t)?(this._register_single(aI,e),this.track("$create_alias",{alias:e,distinct_id:t},{skip_hooks:!0},function(){// Flush the people queue
 ...
 * @deprecated
 */a$.prototype.name_tag=function(e){this._register_single("mp_name_tag",e)},/**
 ...
 */a$.prototype.set_config=function(e){rU.isObject(e)&&(rU.extend(this.config,e),e.batch_size&&rU.each(this.request_batchers,function(e){e.resetBatchSize()}),this.get_config("persistence_name")||(this.config.persistence_name=this.config.cookie_name),this.get_config("disable_persistence")||(this.config.disable_persistence=this.config.disable_cookie),this.persistence&&this.persistence.update_config(this.config),rg.DEBUG=rg.DEBUG||this.get_config("debug"))},/**
 * returns the current config object for the library.
 */a$.prototype.get_config=function(e){return this.config[e]},/**
 * Fetch a hook function from config, with safe default, and run it
 * against the given arguments
 * @param {string} hook_name which hook to retrieve
 * @returns {any|null} return value of user-provided hook, or null if nothing was returned
 */a$.prototype._run_hook=function(e){var t=(this.config.hooks[e]||aM).apply(this,rk.call(arguments,1));return void 0===t&&(this.report_error(e+" hook did not return a value"),t=null),t},/**
 ...
 */a$.prototype.get_property=function(e){return this.persistence.props[e]},a$.prototype.toString=function(){var e=this.get_config("name");return e!==aU&&(e=aU+"."+e),e},a$.prototype._event_is_disabled=function(e){return rU.isBlockedUA(rP)||this._flags.disable_all_events||rU.include(this.__disabled_events,e)},// perform some housekeeping around GDPR opt-in/out state
a$.prototype._gdpr_init=function(){"localStorage"===this.get_config("opt_out_tracking_persistence_type")&&rU.localStorage.is_supported()&&(!this.has_opted_in_tracking()&&this.has_opted_in_tracking({persistence_type:"cookie"})&&this.opt_in_tracking({enable_persistence:!1}),!this.has_opted_out_tracking()&&this.has_opted_out_tracking({persistence_type:"cookie"})&&this.opt_out_tracking({clear_persistence:!1}),this.clear_opt_in_out_tracking({persistence_type:"cookie",enable_persistence:!1})),this.has_opted_out_tracking()?this._gdpr_update_persistence({clear_persistence:!0}):!this.has_opted_in_tracking()&&(this.get_config("opt_out_tracking_by_default")||rU.cookie.get("mp_optout"))&&(rU.cookie.remove("mp_optout"),this.opt_out_tracking({clear_persistence:this.get_config("opt_out_persistence_by_default")}))},/**
 * Enable or disable persistence based on options
 * only enable/disable if persistence is not already in this state
 * @param {boolean} [options.clear_persistence] If true, will delete all data stored by the sdk in persistence and disable it
 * @param {boolean} [options.enable_persistence] If true, will re-enable sdk persistence
 */a$.prototype._gdpr_update_persistence=function(e){var t;if(e&&e.clear_persistence)t=!0;else{if(!e||!e.enable_persistence)return;t=!1}this.get_config("disable_persistence")||this.persistence.disabled===t||this.persistence.set_disabled(t),t&&rU.each(this.request_batchers,function(e){e.clear()})},// call a base gdpr function after constructing the appropriate token and options args
a$.prototype._gdpr_call_func=function(e,t){return t=rU.extend({track:rU.bind(this.track,this),persistence_type:this.get_config("opt_out_tracking_persistence_type"),cookie_prefix:this.get_config("opt_out_tracking_cookie_prefix"),cookie_expiration:this.get_config("cookie_expiration"),cross_site_cookie:this.get_config("cross_site_cookie"),cross_subdomain_cookie:this.get_config("cross_subdomain_cookie"),cookie_domain:this.get_config("cookie_domain"),secure_cookie:this.get_config("secure_cookie"),ignore_dnt:this.get_config("ignore_dnt")},t),rU.localStorage.is_supported()||(t.persistence_type="cookie"),e(this.get_config("token"),{track:t.track,trackEventName:t.track_event_name,trackProperties:t.track_properties,persistenceType:t.persistence_type,persistencePrefix:t.cookie_prefix,cookieDomain:t.cookie_domain,cookieExpiration:t.cookie_expiration,crossSiteCookie:t.cross_site_cookie,crossSubdomainCookie:t.cross_subdomain_cookie,secureCookie:t.secure_cookie,ignoreDnt:t.ignore_dnt})},/**
 ...
 */a$.prototype.opt_in_tracking=function(e){e=rU.extend({enable_persistence:!0},e),this._gdpr_call_func(ae,e),this._gdpr_update_persistence(e)},/**
 ...
 * @param {boolean} [options.cross_subdomain_cookie] Whether the opt-in cookie is set as cross-subdomain or not (overrides value specified in this Mixpanel instance's config)
 * @param {boolean} [options.secure_cookie] Whether the opt-in cookie is set as secure or not (overrides value specified in this Mixpanel instance's config)
 */a$.prototype.opt_out_tracking=function(e){(e=rU.extend({clear_persistence:!0,delete_user:!0},e)).delete_user&&this.people&&this.people._identify_called()&&(this.people.delete_user(),this.people.clear_charges()),this._gdpr_call_func(at,e),this._gdpr_update_persistence(e)},/**
 ...
 */a$.prototype.has_opted_in_tracking=function(e){return this._gdpr_call_func(an,e)},/**
 ...
 */a$.prototype.has_opted_out_tracking=function(e){return this._gdpr_call_func(ar,e)},/**
 ...
 * @param {boolean} [options.cross_subdomain_cookie] Whether the opt-in cookie is set as cross-subdomain or not (overrides value specified in this Mixpanel instance's config)
 * @param {boolean} [options.secure_cookie] Whether the opt-in cookie is set as secure or not (overrides value specified in this Mixpanel instance's config)
 */a$.prototype.clear_opt_in_out_tracking=function(e){e=rU.extend({enable_persistence:!0},e),this._gdpr_call_func(as,e),this._gdpr_update_persistence(e)},a$.prototype.report_error=function(e,t){rz.error.apply(rz.error,arguments);try{t||e instanceof Error||(e=Error(e)),this.get_config("error_reporter")(e,t)}catch(e){rz.error(e)}},// EXPORTS (for closure compiler)
// MixpanelLib Exports
a$.prototype.init=a$.prototype.init,a$.prototype.reset=a$.prototype.reset,a$.prototype.disable=a$.prototype.disable,a$.prototype.time_event=a$.prototype.time_event,a$.prototype.track=a$.prototype.track,a$.prototype.track_links=a$.prototype.track_links,a$.prototype.track_forms=a$.prototype.track_forms,a$.prototype.track_pageview=a$.prototype.track_pageview,a$.prototype.register=a$.prototype.register,a$.prototype.register_once=a$.prototype.register_once,a$.prototype.unregister=a$.prototype.unregister,a$.prototype.identify=a$.prototype.identify,a$.prototype.alias=a$.prototype.alias,a$.prototype.name_tag=a$.prototype.name_tag,a$.prototype.set_config=a$.prototype.set_config,a$.prototype.get_config=a$.prototype.get_config,a$.prototype.get_property=a$.prototype.get_property,a$.prototype.get_distinct_id=a$.prototype.get_distinct_id,a$.prototype.toString=a$.prototype.toString,a$.prototype.opt_out_tracking=a$.prototype.opt_out_tracking,a$.prototype.opt_in_tracking=a$.prototype.opt_in_tracking,a$.prototype.has_opted_out_tracking=a$.prototype.has_opted_out_tracking,a$.prototype.has_opted_in_tracking=a$.prototype.has_opted_in_tracking,a$.prototype.clear_opt_in_out_tracking=a$.prototype.clear_opt_in_out_tracking,a$.prototype.get_group=a$.prototype.get_group,a$.prototype.set_group=a$.prototype.set_group,a$.prototype.add_group=a$.prototype.add_group,a$.prototype.remove_group=a$.prototype.remove_group,a$.prototype.track_with_groups=a$.prototype.track_with_groups,a$.prototype.start_batch_senders=a$.prototype.start_batch_senders,a$.prototype.stop_batch_senders=a$.prototype.stop_batch_senders,// MixpanelPersistence Exports
aL.prototype.properties=aL.prototype.properties,aL.prototype.update_search_keyword=aL.prototype.update_search_keyword,aL.prototype.update_referrer_info=aL.prototype.update_referrer_info,aL.prototype.get_cross_subdomain=aL.prototype.get_cross_subdomain,aL.prototype.clear=aL.prototype.clear;var aK={},aG=function(){// add all the sub mixpanel instances
rU.each(aK,function(e,t){t!==aU&&(T[t]=e)}),// add private functions as _
T._=rU};C=0,// we override the snippets init function to handle the case where a
// user initializes the mixpanel library after the script loads & runs
(T=new a$).init=function(e,t,n){if(n)return T[n]||(T[n]=aK[n]=aH(e,t,n),T[n]._loaded()),T[n];var r=T;aK[aU]?r=aK[aU]:e&&(// intialize the main mixpanel lib
(r=aH(e,t,aU))._loaded(),aK[aU]=r),T=r,1===C&&(E[aU]=T),aG()},T.init(),function(){// Cross browser DOM Loaded support
function e(){// function flag since we only want to execute this once
e.done||(e.done=!0,aW=!0,aq=!1,rU.each(aK,function(e){e._dom_loaded()}))}if(rT.addEventListener)"complete"===rT.readyState?// external JS (including this file). you will see some copypasta
// on the internet that checks for 'complete' and 'loaded', but
// 'loaded' is an IE thing
e():rT.addEventListener("DOMContentLoaded",e,!1);else if(rT.attachEvent){// IE
rT.attachEvent("onreadystatechange",e);// check to make sure we arn't in a frame
var t=!1;try{t=null===E.frameElement}catch(e){// noop
}rT.documentElement.doScroll&&t&&function t(){try{rT.documentElement.doScroll("left")}catch(e){setTimeout(t,1);return}e()}()}// fallback handler, always will work
rU.register_event(E,"load",e,!0)}(),rv=T;let aX=e=>{/*@__PURE__*/r(rv).init("d122fa924e1ea97d6b98569440c65a95",{debug:e.debug,track_pageview:!0,persistence:"localStorage"})},aJ=(e,t,n)=>/*@__PURE__*/r(rv).track(e,t,n),aZ=({children:e})=>{let{appId:t}=n8(),{visitor:n}=rm(),{log:a}=ew();return(0,D.useEffect)(()=>{t&&n.id&&(a("MixpanelProvider: booting"),aX({debug:!0}),a("MixpanelProvider: registering visitor "+n.id+" to mixpanel"),/*@__PURE__*/r(rv).identify(n.id))},[t,n?.id]),/*@__PURE__*/r(D).createElement(a0.Provider,{value:{trackEvent:aJ}},e)},a0=/*#__PURE__*/(0,D.createContext)({trackEvent:()=>{}}),a1=()=>(0,D.useContext)(a0),a2=({children:e,handlers:t})=>{let{log:n,error:a}=ew(),{appId:i,booted:o,initialDelay:s,exitIntentTriggers:l,idleTriggers:u}=n8(),{visitor:c}=rm(),{trackEvent:d}=a1(),{mutateAsync:f}=n6(),{registerHandler:p}=function(e={}){let t=nZ(nJ({},nW),{cookie:nJ(nJ({},nW.cookie),e?.cookie),desktop:nJ(nJ({},nW.desktop),e?.desktop),mobile:nJ(nJ({},nW.mobile),e?.mobile)}),[n,r]=(0,D.useState)(t),[a,i]=(0,D.useState)(!1),[o,s]=(0,D.useState)(!1),l=(0,D.useRef)([]).current,u=(0,D.useRef)(!1),{mobile:c,desktop:d,cookie:f}=n;u.current=o||a;let p=(0,D.useCallback)(()=>{u.current||(i(!0),l.filter(e=>{var t,n;return(null==(t=e.context)?void 0:t.filter(e=>e!==nV.onDesktop&&e!==nV.onMobile).length)===0||(null==(n=e.context)?void 0:n.includes(nV.onTrigger))}).forEach(nF))},[]),h=(0,D.useCallback)(()=>{nM.set(f.key,"true",{expires:f.daysToExpire,sameSite:"Strict"}),l.filter(e=>{var t;return null==(t=e.context)?void 0:t.includes(nV.onUnsubscribe)}).forEach(nF),s(!0)},[f?.key]),m=(0,D.useCallback)(()=>{nM.remove(f?.key,{sameSite:"Strict"}),window.onbeforeunload=null,i(!1),s(!1)},[f?.key]),v=(0,D.useCallback)(()=>{m(),r(t)},[]),g=(0,D.useCallback)(e=>{let t=l.find(t=>t.id===e.id),n=nZ(nJ({},e),{context:e?.context||[]});if(t){l[l.indexOf(t)]=n;return}l.push(n)},[]),y=(0,D.useCallback)((e=nW)=>{m(),r(t=>nZ(nJ(nJ({},t||{}),e||{}),{cookie:nJ(nJ({},t?.cookie||{}),e?.cookie||{}),desktop:nJ(nJ({},t?.desktop||{}),e?.desktop||{}),mobile:nJ(nJ({},t?.mobile||{}),e?.mobile||{})}))},[n]);return(0,D.useEffect)(()=>{s("true"===nM.get(f.key))},[]),(0,D.useEffect)(()=>{if(nU()){let{execute:e,abort:t}=nB(p,1e3*c?.delayInSecondsToTrigger);if(u.current){nq(e);return}return nU()&&c?.triggerOnIdle&&(nq(e),nj(e)),()=>{t(),nq(e)}}if(nz()){let{execute:e,abort:t}=nB(p,1e3*d?.delayInSecondsToTrigger);return null!=d&&d.triggerOnIdle&&nj(e),null!=d&&d.triggerOnMouseLeave&&document.body.addEventListener("mouseleave",p),null!=d&&d.useBeforeUnload&&(window.onbeforeunload=()=>{if(!u.current)return p(),""}),()=>{t(),nq(e),document.body.removeEventListener("mouseleave",p)}}}),{settings:n,resetState:m,isTriggered:a,unsubscribe:h,resetSettings:v,updateSettings:y,isUnsubscribed:o,registerHandler:g,willBeTriggered:!(o||a)}}({cookie:{key:"_cm_exit",daysToExpire:0}}),[h,m]=(0,D.useState)(5e3),[v,g]=(0,D.useState)([]),[y,b]=(0,D.useState)(void 0),[w,_]=(0,D.useState)(null),[k,x]=(0,D.useState)(!1);n("CollectorProvider: user is on mobile?",e_.isMobile),// Removes the intently overlay, if intently is false
