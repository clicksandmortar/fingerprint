...
return()=>{e.forEach(e=>clearInterval(e))}},[c]);let N=/*@__PURE__*/O(D).useCallback(e=>{n("CollectorProvider: manually setting trigger",e),E([e]),w(e.invocation)},[n,v,w,E]),L=/*@__PURE__*/O(D).useMemo(()=>({addPageTriggers:E,resetDisplayTrigger:I,setTrigger:N,trackEvent:f}),[I,N,f]);return /*@__PURE__*/O(D).createElement(iB,{timeout:m,onPresenceChange:e=>{n("presence changed",e)},onIdle:R},/*@__PURE__*/O(D).createElement(au.Provider,{value:L},e),/*@__PURE__*/O(D).createElement(T,null))}let au=/*#__PURE__*/(0,D.createContext)({addPageTriggers:()=>{},resetDisplayTrigger:()=>{},setTrigger:()=>{},trackEvent:()=>{}}),al=()=>(0,D.useContext)(au),ac=()=>"undefined"==typeof window?null:window.location.host.startsWith("localhost")||window.location.host.includes("stonehouserestaurants.co.uk")?"Stonehouse":window.location.host.includes("browns-restaurants.co.uk")?"Browns":null;// @todo: Kill this with fire 🔥
