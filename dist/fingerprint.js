...
function ee(e){if(function(e){try{return!1}catch(e){return!0}}(e))return z("The provided key is an unsupported type %s. This value must be coerced to a string before before using it here.","function"==typeof Symbol&&Symbol.toStringTag&&e[Symbol.toStringTag]||e.constructor.name||"Object"),""+e;// throw (to help callers find troubleshooting comments)
...
function en(e){if(null==e)return null;if("number"==typeof e.tag&&z("Received an unexpected object in getComponentNameFromType(). This is likely a bug in React. Please file an issue."),"function"==typeof e)return e.displayName||e.name||null;if("string"==typeof e)return e;switch(e){case y:return"Fragment";case g:return"Portal";case w:return"Profiler";case b:return"StrictMode";case S:return"Suspense";case E:return"SuspenseList"}if("object"==typeof e)switch(e.$$typeof){case k:return et(e)+".Consumer";case _:return et(e._context)+".Provider";case x:return function(e,t,n){var r=e.displayName;if(r)return r;var a=t.displayName||t.name||"";return""!==a?n+"("+a+")":n}// Keep in sync with react-reconciler/getComponentNameFromFiber
...
if(e&&e.defaultProps){var m=e.defaultProps;for(o in m)void 0===s[o]&&(s[o]=m[o])}if(l||u){var v,g,y="function"==typeof e?e.displayName||e.name||"Unknown":e;l&&((v=function(){n||(n=!0,z("%s: `key` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)",y))}).isReactWarning=!0,Object.defineProperty(s,"key",{get:v,configurable:!0})),u&&((g=function(){r||(r=!0,z("%s: `ref` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)",y))}).isReactWarning=!0,Object.defineProperty(s,"ref",{get:g,configurable:!0}))}return es(e,l,u,c,d,L.current,s)}/**
...
b===x.entries&&(ed||F("Using Maps as children is not supported. Use an array of keyed ReactElements instead."),ed=!0);for(var S=b.call(x),E=0;!(k=S.next()).done;)_=m+eh(w=k.value,E++),h+=e(w,n,r,_,i)}else if("object"===o){// eslint-disable-next-line react-internal/safe-string-coercion
...
Object.defineProperties(console,{log:W({},e,{value:o}),info:W({},e,{value:s}),warn:W({},e,{value:l}),error:W({},e,{value:u}),group:W({},e,{value:c}),groupCollapsed:W({},e,{value:d}),groupEnd:W({},e,{value:f})});/* eslint-enable react-internal/no-production-logging */}eb<0&&z("disabledDepth fell below zero. This is a bug in React. Please file an issue.")}(),Error.prepareStackTrace=i}// Fallback to just using the name if we couldn't make it throw.
...
// assigning it a key.
var r="";e&&e._owner&&e._owner!==L.current&&(r=" It was passed a child from "+en(e._owner.type)+"."),eR(e),z('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.',n,r),eR(null)}}}/**
 ...
 */function(e){for(var t=Object.keys(e.props),n=0;n<t.length;n++){var r=t[n];if("children"!==r&&"key"!==r){eR(e),z("Invalid prop `%s` supplied to `React.Fragment`. React.Fragment can only have `key` and `children` props.",r),eR(null);break}}null!==e.ref&&(eR(e),z("Invalid attribute `ref` supplied to `React.Fragment`."),eR(null))}(s):eL(s),s}var eA=!1,eU=!1,eF=null,ez=0,ej=!1;function eq(e){e!==ez-1&&z("You seem to have overlapping act() calls, this is not supported. Be sure to await previous act() calls before making a new one. "),ez=e}function eB(t,n,r){var a=N.current;if(null!==a)try{eW(a),function(t){if(null===eF)try{// read require off the module object to get around the bundlers.
...
_defaultValue:null,_globalName:null};t.Provider={$$typeof:_,_context:t};var n=!1,r=!1,a=!1,i={$$typeof:k,_context:t};return Object.defineProperties(i,{Provider:{get:function(){return r||(r=!0,z("Rendering <Context.Consumer.Provider> is not supported and will be removed in a future major release. Did you mean to render <Context.Provider> instead?")),t.Provider},set:function(e){t.Provider=e}},_currentValue:{get:function(){return t._currentValue},set:function(e){t._currentValue=e}},_currentValue2:{get:function(){return t._currentValue2},set:function(e){t._currentValue2=e}},_threadCount:{get:function(){return t._threadCount},set:function(e){t._threadCount=e}},Consumer:{get:function(){return n||(n=!0,z("Rendering <Context.Consumer.Consumer> is not supported and will be removed in a future major release. Did you mean to render <Context.Consumer> instead?")),t.Consumer}},displayName:{get:function(){return t.displayName},set:function(e){a||(F("Setting `displayName` on Context.Consumer has no effect. You should set it directly on the context with Context.displayName = '%s'.",e),a=!0)}}}),t.Consumer=i,t._currentRenderer=null,t._currentRenderer2=null,t},t.createElement=eM,t.createFactory=function(e){var t=eM.bind(null,e);return t.type=e,eA||(eA=!0,F("React.createFactory() is deprecated and will be removed in a future major release. Consider using JSX or use React.createElement() directly instead.")),Object.defineProperty(t,"type",{enumerable:!1,get:function(){return F("Factory.type is deprecated. Access the class directly before passing it to createFactory."),Object.defineProperty(this,"type",{value:e}),e}}),t},t.createRef=// an immutable object with a single mutable value
function(){var e={current:null};return Object.seal(e),e},t.forwardRef=function(e){null!=e&&e.$$typeof===C?z("forwardRef requires a render function but received a `memo` component. Instead of forwardRef(memo(...)), use memo(forwardRef(...))."):"function"!=typeof e?z("forwardRef requires a render function but was given %s.",null===e?"null":typeof e):0!==e.length&&2!==e.length&&z("forwardRef render functions accept exactly two parameters: props and ref. %s",1===e.length?"Did you forget to use the ref parameter?":"Any additional parameter will be undefined."),null!=e&&(null!=e.defaultProps||null!=e.propTypes)&&z("forwardRef render functions do not support propTypes or defaultProps. Did you accidentally pass a React component?");var t,n={$$typeof:x,render:e};return Object.defineProperty(n,"displayName",{enumerable:!1,configurable:!0,get:function(){return t},set:function(n){t=n,e.name||e.displayName||(e.displayName=n)}}),n},t.isValidElement=ec,t.lazy=function(e){var t,n,r={$$typeof:T,_payload:{// We use these fields to store the result.
_status:-1,_result:e},_init:ev};return Object.defineProperties(r,{defaultProps:{configurable:!0,get:function(){return t},set:function(e){z("React.lazy(...): It is not supported to assign `defaultProps` to a lazy component import. Either specify them where the component is defined, or create a wrapping component around it."),t=e,// $FlowFixMe
Object.defineProperty(r,"defaultProps",{enumerable:!0})}},propTypes:{configurable:!0,get:function(){return n},set:function(e){z("React.lazy(...): It is not supported to assign `propTypes` to a lazy component import. Either specify them where the component is defined, or create a wrapping component around it."),n=e,// $FlowFixMe
Object.defineProperty(r,"propTypes",{enumerable:!0})}}}),r},t.memo=function(e,t){eg(e)||z("memo: The first argument must be a component. Instead received: %s",null===e?"null":typeof e);var n,r={$$typeof:C,type:e,compare:void 0===t?null:t};return Object.defineProperty(r,"displayName",{enumerable:!1,configurable:!0,get:function(){return n},set:function(t){n=t,e.name||e.displayName||(e.displayName=t)}}),r},t.startTransition=function(e,t){var n=D.transition;D.transition={};var r=D.transition;D.transition._updatedFibers=new Set;try{e()}finally{D.transition=n,null===n&&r._updatedFibers&&(r._updatedFibers.size>10&&F("Detected a large number of updates inside startTransition. If this is due to a subscription please re-write it to use React provided hooks. Otherwise concurrent mode guarantees are off the table."),r._updatedFibers.clear())}},t.unstable_act=function(e){// `act` calls can be nested, so we track the depth. This represents the
// number of `act` scopes on the stack.
var t,n=ez;ez++,null===N.current&&// will detect the queue and use it instead of Scheduler.
...
return ej||"undefined"==typeof Promise||Promise.resolve().then(function(){}).then(function(){o||(ej=!0,z("You called act(async () => ...) without await. This could lead to unexpected testing behaviour, interleaving multiple act calls and mixing their scopes. You should - await act(async () => ...);"))}),{then:function(e,t){o=!0,i.then(function(r){eq(n),0===ez?// queue until there's no remaining work.
...
eq(n),0!==ez)return{then:function(e,t){e(s)}};// Exiting the outermost act scope. Flush the queue.
...
return""}}var tU={button:!0,checkbox:!0,image:!0,hidden:!0,radio:!0,reset:!0,submit:!0};function tF(e,t){tU[t.type]||t.onChange||t.onInput||t.readOnly||t.disabled||null==t.value||eL("You provided a `value` prop to a form field without an `onChange` handler. This will render a read-only field. If the field should be mutable use `defaultValue`. Otherwise, set either `onChange` or `readOnly`."),t.onChange||t.readOnly||t.disabled||null==t.checked||eL("You provided a `checked` prop to a form field without an `onChange` handler. This will render a read-only field. If the field should be mutable use `defaultChecked`. Otherwise, set either `onChange` or `readOnly`.")}function tz(e){var t=e.type,n=e.nodeName;return n&&"input"===n.toLowerCase()&&("checkbox"===t||"radio"===t)}function tj(e){return e._valueTracker}function tq(e){tj(e)||// TODO: Once it's just Fiber we can move this to node._wrapperState
(e._valueTracker=function(e){var t=tz(e)?"checked":"value",n=Object.getOwnPropertyDescriptor(e.constructor.prototype,t);eH(e[t]);var r=""+e[t];// if someone has already defined a value or Safari, then bail
 ...
 *
 *
 */var aL=null,aM=null,aA=null;function aU(){if(aA)return aA;var e,t,n=aM,r=n.length,a=aF(),i=a.length;for(e=0;e<r&&n[e]===a[e];e++);var o=r-e;for(t=1;t<=o&&n[r-t]===a[i-t];t++);var s=t>1?1-t:void 0;return aA=a.slice(e,s)}function aF(){return"value"in aL?aL.value:aL.textContent}/**
 ...
 */function az(e){var t,n=e.keyCode;return(// Some non-printable keys are reported in `charCode`/`keyCode`, discard them.
...
if("keypress"===e.type){var n=az(e);// The enter-key is technically both printable and non-printable and can
...
"keypress"===e.type?az(e):0)},keyCode:function(e){return(// `keyCode` is the result of a KeyDown/Up event and represents the value of
...
// type of the event.
"keypress"===e.type?az(e):"keydown"===e.type||"keyup"===e.type?e.keyCode:0)}})),a6=aB(tg({},aY,{pointerId:0,width:0,height:0,pressure:0,tangentialPressure:0,tiltX:0,tiltY:0,twist:0,pointerType:0,isPrimary:0})),a8=aB(tg({},a$,{touches:0,targetTouches:0,changedTouches:0,altKey:0,metaKey:0,ctrlKey:0,shiftKey:0,getModifierState:a5})),a7=aB(tg({},aV,{propertyName:0,elapsedTime:0,pseudoElement:0})),a9=aB(tg({},aY,{deltaX:function(e){return"deltaX"in e?e.deltaX:"wheelDeltaX"in e?-e.wheelDeltaX:0},deltaY:function(e){return"deltaY"in e?e.deltaY:"wheelDeltaY"in e?-e.wheelDeltaY:"wheelDelta"in e?-e.wheelDelta:0},deltaZ:0,// Browsers without "deltaMode" is reporting in raw wheel delta where one
 ...
 */function iN(e){var t=e&&e.nodeName&&e.nodeName.toLowerCase();return t&&("input"===t&&("text"===e.type||"search"===e.type||"tel"===e.type||"url"===e.type||"password"===e.type)||"textarea"===t||"true"===e.contentEditable)}var iL=eq&&"documentMode"in document&&document.documentMode<=11,iM=null,iA=null,iU=null,iF=!1;/**
 * Poll selection to see whether it's changed.
 *
 * @param {object} nativeEvent
 * @param {object} nativeEventTarget
 * @return {?SyntheticEvent}
 */function iz(e,t,n){// Ensure we have the right element, and that the user is not dragging a
// selection (this matches native `select` event behavior). In HTML5, select
// fires only on input and textarea thus if there's no focused element we
// won't dispatch.
var r=n.window===n?n.document:9===n.nodeType?n:n.ownerDocument;if(!iF&&null!=iM&&iM===tV(r)){// Only fire when selection has actually changed.
var a=/**
...
if(0===az(r))return;/* falls through */case"keydown":case"keyup":l=a4;break;case"focusin":u="focus",l=aG;break;case"focusout":u="blur",l=aG;break;case"beforeblur":case"afterblur":l=aG;break;case"click":// Firefox creates a click event on right mouse clicks. This removes the
...
case"mousedown":iF=!0;break;case"contextmenu":case"mouseup":case"dragend":iF=!1,iz(e,r,a);break;// Chrome and IE fire non-standard event when selection is changed (and
...
webview:!0},U=function(e,t){nA(e,t)||function(e,t){var n=[];for(var r in t)!function(e,t){if(eB.call(nz,t)&&nz[t])return!0;if(nq.test(t)){var n="aria-"+t.slice(4).toLowerCase(),r=nF.hasOwnProperty(n)?n:null;// DOM properties, then it is an invalid aria-* attribute.
if(null==r)return eL("Invalid ARIA attribute `%s`. ARIA attributes follow the pattern aria-* and must be lowercase.",t),nz[t]=!0,!0;// aria-* attributes should be lowercase; suggest the lowercase version.
if(t!==r)return eL("Invalid ARIA attribute `%s`. Did you mean `%s`?",t,r),nz[t]=!0,!0}if(nj.test(t)){var a=t.toLowerCase(),i=nF.hasOwnProperty(a)?a:null;// DOM properties, then it is an invalid aria-* attribute.
if(null==i)return nz[t]=!0,!1;// aria-* attributes should be lowercase; suggest the lowercase version.
t!==i&&(eL("Unknown ARIA attribute `%s`. Did you mean `%s`?",t,i),nz[t]=!0)}return!0}(0,r)&&n.push(r);var a=n.map(function(e){return"`"+e+"`"}).join(", ");1===n.length?eL("Invalid aria prop %s on <%s> tag. For details, see https://reactjs.org/link/invalid-aria-props",a,e):n.length>1&&eL("Invalid aria props %s on <%s> tag. For details, see https://reactjs.org/link/invalid-aria-props",a,e)}(e,t),"input"!==e&&"textarea"!==e&&"select"!==e||null==t||null!==t.value||nB||(nB=!0,"select"===e&&t.multiple?eL("`value` prop on `%s` should not be null. Consider using an empty array when `multiple` is set to `true` to clear the component or `undefined` for uncontrolled components.",e):eL("`value` prop on `%s` should not be null. Consider using an empty string to clear the component or `undefined` for uncontrolled components.",e)),nA(e,t)||nK(e,t,{registrationNameDependencies:eU,possibleRegistrationNames:eF})},// browsers. It adds spaces and sorts the properties in some
...
var oA="function"==typeof setTimeout?setTimeout:void 0,oU="function"==typeof clearTimeout?clearTimeout:void 0,oF="function"==typeof Promise?Promise:void 0,oz="function"==typeof queueMicrotask?queueMicrotask:void 0!==oF?function(e){return oF.resolve(null).then(e).catch(oj)}:oA;function oj(e){setTimeout(function(){throw e})}// -------------------
...
if(3!==e.tag&&(5!==e.tag||"head"!==(t=e.type)&&"body"!==t&&!oM(e.type,e.memoizedProps))){var t,n=sz;if(n){if(sQ(e))sZ(e),sK();else for(;n;)sW(e,n),n=o$(n)}}return sX(e),sz=13===e.tag?function(e){var t=e.memoizedState,n=null!==t?t.dehydrated:null;if(!n)throw Error("Expected to have a hydrated suspense instance. This error is likely caused by a bug in React. Please file an issue.");return function(e){for(var t=e.nextSibling,n=0;t;){if(8===t.nodeType){var r=t.data;if("/$"===r){if(0===n)return o$(t);n--}else("$"===r||"$!"===r||"$?"===r)&&n++}t=t.nextSibling}// TODO: Warn, we didn't find the end comment boundary.
return null}// Returns the SuspenseInstance if this node is a direct child of a
(n)}(e):sF?o$(e.stateNode):null,!0}function sZ(e){for(var t=sz;t;)sV(e,t),t=o$(t)}function s0(){sF=null,sz=null,sj=!1,sq=!1}function s1(){null!==sB&&(// Successfully completed a forced client render. The errors that occurred
...
if(h=function(e,t,n,r,a,i){switch(n.tag){case 1:var o=n.payload;if("function"==typeof o){ld=!0;var s=o.call(i,r,a);if(8&e.mode){rF(!0);try{o.call(i,r,a)}finally{rF(!1)}}return ld=!1,s}// State object
return o;case 3:e.flags=-65537&e.flags|128;// Intentional fallthrough
case 0:var l,u=n.payload;if("function"==typeof u){if(ld=!0,l=u.call(i,r,a),8&e.mode){rF(!0);try{u.call(i,r,a)}finally{rF(!1)}}ld=!1}else l=u;if(null==l)break;// Merge the partial state and the previous state.
...
t.value=n,t.getSnapshot=r,uF(t)&&uz(e)}function uU(e,t,n){return n(function(){// The store changed. Check if the snapshot changed since the last time we
// read from the store.
uF(t)&&uz(e)})}function uF(e){var t=e.getSnapshot,n=e.value;try{var r=t();return!iT(n,r)}catch(e){return!0}}function uz(e){var t=l_(e,1);null!==t&&fN(t,e,1,-1)}function uj(e){var t=uS();"function"==typeof e&&(e=e()),t.memoizedState=t.baseState=e;var n={pending:null,interleaved:null,lanes:0,dispatch:null,lastRenderedReducer:uT,lastRenderedState:e};t.queue=n;var r=n.dispatch=cl.bind(null,ua,n);return[t.memoizedState,r]}function uq(e,t,n,r){var a={tag:e,create:t,destroy:n,deps:r,// Circular
...
setTimeout(function(){throw e})}}var cF="function"==typeof WeakMap?WeakMap:Map;function cz(e,t,n){var r=lE(-1,n);// Unmount the root by rendering null.
...
var r,a=e.pingCache;if(null===a?(a=e.pingCache=new cF,r=new Set,a.set(t,r)):void 0===(r=a.get(t))&&(r=new Set,a.set(t,r)),!r.has(n)){// Memoize using the thread ID to prevent redundant listeners.
...
var i,o,s=n.propTypes;s&&o8(s,r,"prop",tC(n))}var l=n.render,u=t.ref;if(lv(t,a),rB(t),cW.current=t,tI=!0,i=uw(e,t,l,r,u,a),o=u_(),8&t.mode){rF(!0);try{i=uw(e,t,l,r,u,a),o=u_()}finally{rF(!1)}}return(tI=!1,rV(),null===e||c$)?(sj&&o&&sL(t),// React DevTools reads this flag.
...
// because they're only guaranteed to be resolved here.
var i,o,s,l=n.propTypes;l&&o8(l,r,"prop",tC(n))}var u=ss(t,n,!0);if(i=su(t,u),lv(t,a),rB(t),cW.current=t,tI=!0,o=uw(e,t,n,r,i,a),s=u_(),8&t.mode){rF(!0);try{o=uw(e,t,n,r,i,a),s=u_()}finally{rF(!1)}}return(tI=!1,rV(),null===e||c$)?(sj&&s&&sL(t),// React DevTools reads this flag.
...
// because they're only guaranteed to be resolved here.
var p=n.propTypes;p&&o8(p,r,"prop",tC(n))}sd(n)?(i=!0,sv(t)):i=!1,lv(t,a),null===t.stateNode?(ds(e,t),lF(t,n,r),lj(t,n,r,a),o=!0):o=null===e?function(e,t,n,r){var a,i,o,s=e.stateNode,l=e.memoizedProps;s.props=l;var u=s.context,c=t.contextType,d=sr;if("object"==typeof c&&null!==c)d=lg(c);else{var f=ss(e,t,!0);d=su(e,f)}var p=t.getDerivedStateFromProps,h="function"==typeof p||"function"==typeof s.getSnapshotBeforeUpdate;h||"function"!=typeof s.UNSAFE_componentWillReceiveProps&&"function"!=typeof s.componentWillReceiveProps||l===n&&u===d||lz(e,s,n,d),lk=!1;var m=e.memoizedState,v=s.state=m;if(lR(e,n,s,r),v=e.memoizedState,l===n&&m===v&&!sc()&&!lk)return"function"==typeof s.componentDidMount&&(a=4194308,(16&e.mode)!=0&&(a|=16777216),e.flags|=a),!1;"function"==typeof p&&(lL(e,t,p,n),v=e.memoizedState);var g=lk||lA(e,t,l,n,m,v,d);return g?(h||"function"!=typeof s.UNSAFE_componentWillMount&&"function"!=typeof s.componentWillMount||("function"==typeof s.componentWillMount&&s.componentWillMount(),"function"==typeof s.UNSAFE_componentWillMount&&s.UNSAFE_componentWillMount()),"function"==typeof s.componentDidMount&&(i=4194308,(16&e.mode)!=0&&(i|=16777216),e.flags|=i)):("function"==typeof s.componentDidMount&&(o=4194308,(16&e.mode)!=0&&(o|=16777216),e.flags|=o),// memoized state to indicate that this work can be reused.
...
s=null,cE=-1;else{if(rB(t),tI=!0,s=u.render(),8&t.mode){rF(!0);try{u.render()}finally{rF(!1)}}tI=!1,rV()}// React DevTools reads this flag.
...
t.flags|=128,t.child=e.child;var T=f4.bind(null,e);return a._reactRetry=T,null}s=t,l=a,u=i.treeContext,sz=oW(l.nextSibling),sF=s,sj=!0,sB=null,sq=!1,null!==u&&(sU(),sT[sO++]=sP,sT[sO++]=sI,sT[sO++]=sR,sP=u.id,sI=u.overflow,sR=s);var O=c8(t,r.children);// Mark the children as hydrating. This is a fast path to know whether this
...
sz=oW(t.stateNode.containerInfo.firstChild),sF=t,sj=!0,sB=null,sq=!1;var d=lQ(t,null,s,n);t.child=d;for(var f=d;f;)// Mark each child as hydrating. This is a fast path to know whether this
...
// TODO: Only ignore them on controlled tags.
"value"===p||"checked"===p||"selected"===p);else if(p===oa){var g=e.innerHTML,y=h?h[oc]:void 0;if(null!=y){var b=B(e,y);b!==g&&F(p,g,b)}}else if(p===ou){if(// $FlowFixMe - Should be inferred as not undefined.
l.delete(p),q){var w=/**
 ...
 */function(e){var t="",n="";for(var r in e)if(e.hasOwnProperty(r)){var a=e[r];if(null!=a){var i=0===r.indexOf("--");t+=n+(i?r:r.replace(nv,"-$1").toLowerCase().replace(ng,"-ms-"))+":"+nm(r,a,i),n=";"}}return t||null}(h);w!==(m=e.getAttribute("style"))&&F(p,m,w)}}else if(s)// $FlowFixMe - Should be inferred as not undefined.
l.delete(p.toLowerCase()),m=te(e,p,h),h!==m&&F(p,m,h);else if(!eZ(p,v,s)&&!e1(p,h,v,s)){var _=!1;if(null!==v)// $FlowFixMe - Should be inferred as not undefined.
...
_=!0,l.delete(x)),l.delete(p)}m=te(e,p,h)}h===m||_||F(p,m,h)}}}switch(o&&l.size>0&&!0!==n[oo]&&z(l),t){case"input":// TODO: Make sure we check if this is still unmounted or do any clean
...
var r=n.child;null!==r;)dz(e,t,r),r=r.sibling}function dz(e,t,n){// into their subtree. There are simpler cases in the inner switch
...
case 6:var r,a,i,o,s=dA,l=dU;dA=null,dF(e,t,n),dA=s,dU=l,null!==dA&&(dU?(i=dA,o=n.stateNode,8===i.nodeType?i.parentNode.removeChild(o):i.removeChild(o)):function(e,t){e.removeChild(t)}(dA,n.stateNode));return;case 18:null!==dA&&(dU?(r=dA,a=n.stateNode,8===r.nodeType?oq(r.parentNode,a):1===r.nodeType&&oq(r,a),// Retry if any event replaying was blocked on this.
aE(r)):oq(dA,n.stateNode));return;case 4:// When we go into a portal, it becomes the parent to remove from.
var u=dA,c=dU;dA=n.stateNode.containerInfo,dU=!0,dF(e,t,n),dA=u,dU=c;return;case 0:case 11:case 14:case 15:if(!db){var d=n.updateQueue;if(null!==d){var f=d.lastEffect;if(null!==f){var p=f.next,h=p;do{var m=h,v=m.destroy,g=m.tag;void 0!==v&&((2&g)!=0?dR(n,t,v):(4&g)!=0&&(rW(n),2&n.mode?(cN(),dR(n,t,v),cI(n)):dR(n,t,v),r$())),h=h.next}while(h!==p)}}}dF(e,t,n);return;case 1:if(!db){dO(n,t);var y=n.stateNode;"function"==typeof y.componentWillUnmount&&dC(n,t,y)}dF(e,t,n);return;case 21:default:dF(e,t,n);return;case 22:if(1&n.mode){// If this offscreen component is hidden, we already unmounted it. Before
...
var b=db;db=b||null!==n.memoizedState,dF(e,t,n),db=b}else dF(e,t,n)}}function dj(e){// If this boundary just timed out, then it will have a set of wakeables.
...
var r,a=t;n:for(;null!==a;){switch(a.tag){case 5:dA=a.stateNode,dU=!1;break n;case 3:case 4:dA=a.stateNode.containerInfo,dU=!0;break n}a=a.return}if(null===dA)throw Error("Expected to find a host parent. This error is likely caused by a bug in React. Please file an issue.");dz(e,t,n),dA=null,dU=!1,null!==(r=n.alternate)&&(r.return=null),n.return=null}(e,t,i)}catch(e){f2(i,t,e)}}var o=tP;if(12854&t.subtreeFlags)for(var s=t.child;null!==s;)tM(s),dB(s,e),s=s.sibling;tM(o)}function dB(e,t,n){var r,a=e.alternate,i=e.flags;// because the fiber tag is more specific. An exception is any flag related
...
fF(e,d9)),fL(e,r),1===n&&0===d6&&(1&t.mode)==0&&// Treat `act` as if it's inside `batchedUpdates`, even in legacy mode.
...
null==i&&1!==l&&eL("Expected scheduled callback to exist. This error is likely caused by a bug in React. Please file an issue.");return}if(null!=i&&pi(i),1===s)0===e.tag?(null!==d4.isBatchingLegacy&&(d4.didScheduleLegacyUpdate=!0),n=fz.bind(null,e),sb=!0,s_(n)):s_(fz.bind(null,e)),null!==d4.current?// at the end of the current scope even when using the sync version
// of `act`.
d4.current.push(sk):oz(function(){// In Safari, appending an iframe forces microtasks to run.
...
var i=r3(e);0!==i&&(r=i,a=fA(e,i))}if(1===a){var o=fr;throw fW(e,0),fF(e,r),fL(e,rS()),o}if(6===a)// cases where need to exit the current render without producing a
...
(a=fQ(e,r))){var u=r3(e);0!==u&&(r=u,a=fA(e,u))}if(1===a){var c=fr;throw fW(e,0),fF(e,r),fL(e,rS()),c}}// We now have a consistent tree. The next step is either to commit it,
...
if(fF(e,n),r4(n)&&// do not delay if we're inside an act() scope
...
fX(e,fu,ff);break;case 4:if(fF(e,n),(4194240&n)===n)break;if(!po()){// This is not a transition, but we did trigger an avoided state.
...
// commit phase.
var i=fu;fu=n,null!==i&&fU(i)}return a}function fU(e){null===fu?fu=e:fu.push.apply(fu,e)}function fF(e,t){// When suspending, we should always exclude lanes that were pinged or (more
...
// through Scheduler
function fz(e){if(cT=cO,cO=!1,(6&d6)!=0)throw Error("Should not already be working.");fJ();var t=r2(e,0);if(!((1&t)!=0))return(// There's no remaining sync work left.
...
var r=r3(e);0!==r&&(t=r,n=fA(e,r))}if(1===n){var a=fr;throw fW(e,0),fF(e,t),fL(e,rS()),a}if(6===n)throw Error("Root did not complete. This is a bug in React.");// We now have a consistent tree. Because this is a sync render, we
...
// as an error.
var u=t;do{switch(u.tag){case 3:var c,d=r;u.flags|=65536;var f=(c=a)&-c;u.lanes=u.lanes|f;var p=cz(u,d,f);lO(u,p);return;case 1:// Capture and retry
...
fF(d8,d9)}function fQ(e,t){var n=d6;d6|=2;var r=fH();// If the root or lanes have changed, throw out the existing stack
// and prepare a fresh one. Otherwise we'll continue where we left off.
if(d8!==e||d9!==t){if(rU){var a=e.memoizedUpdaters;a.size>0&&(pn(e,d9),a.clear()),// If we bailout on this work, we'll move them back (like above).
// It's important to move them now in case the work spawns more work at the same priority with different updaters.
// That way we can keep the current update and future updates separate.
...
// As a result though, React will see the scheduled update as a noop and bailout.
// Shallow cloning props works as a workaround for now to bypass the bailout check.
e.memoizedProps=tg({},e.memoizedProps);var i=l_(e,1);null!==i&&fN(i,e,1,-1)}},pF=function(e,t,n,r){var a=pX(e,t);if(null!==a){var i=pQ(a.memoizedState,n,r);a.memoizedState=i,a.baseState=i,// because there is no update we can add for useReducer hooks that won't trigger an error.
// (There's no appropriate action type for DevTools overrides.)
// As a result though, React will see the scheduled update as a noop and bailout.
// Shallow cloning props works as a workaround for now to bypass the bailout check.
e.memoizedProps=tg({},e.memoizedProps);var o=l_(e,1);null!==o&&fN(o,e,1,-1)}},pz=function(e,t,n){e.pendingProps=pG(e.memoizedProps,t,n),e.alternate&&(e.alternate.pendingProps=e.pendingProps);var r=l_(e,1);null!==r&&fN(r,e,1,-1)},pj=function(e,t){e.pendingProps=pH(e.memoizedProps,t),e.alternate&&(e.alternate.pendingProps=e.pendingProps);var n=l_(e,1);null!==n&&fN(n,e,1,-1)},pq=function(e,t,n){e.pendingProps=pQ(e.memoizedProps,t,n),e.alternate&&(e.alternate.pendingProps=e.pendingProps);var r=l_(e,1);null!==r&&fN(r,e,1,-1)},pB=function(e){var t=l_(e,1);null!==t&&fN(t,e,1,-1)},pV=function(e){pL=e},pW=function(e){pM=e};/* global reportError */var pJ="function"==typeof reportError?reportError:function(e){// In older browsers and test environments, fallback to console.error.
// eslint-disable-next-line react-internal/no-production-logging
...
e=tg({},e,{getLaneLabelMap:rj,injectProfilingHooks:rz}),rN=t.inject(e),rL=t}catch(e){eL("React instrumentation encountered an error: %s.",e)}return!!t.checkDCE}({bundleType:t.bundleType,version:t.version,rendererPackageName:t.rendererPackageName,rendererConfig:t.rendererConfig,overrideHookState:pA,overrideHookStateDeletePath:pU,overrideHookStateRenamePath:pF,overrideProps:pz,overridePropsDeletePath:pj,overridePropsRenamePath:pq,setErrorHandler:pV,setSuspenseHandler:pW,scheduleUpdate:pB,currentDispatcherRef:m,findHostInstanceByFiber:function(e){var t=rb(e);return null===t?null:t.stateNode},findFiberByHostInstance:n||function(e){return null},// React Refresh
...
var T=[],O=[],R=1,P=null,I=3,D=!1,N=!1,L=!1,M="function"==typeof setTimeout?setTimeout:null,A="function"==typeof clearTimeout?clearTimeout:null,U="undefined"!=typeof setImmediate?setImmediate:null;function F(r){for(// Check for tasks that are no longer delayed and add them to the queue.
var a=t(O);null!==a;){if(null===a.callback)n(O);else{if(!(a.startTime<=r))return;// Timer fired. Transfer to the task queue.
n(O),a.sortIndex=a.expirationTime,e(T,a)}a=t(O)}}function z(e){if(L=!1,F(e),!N){if(null!==t(T))N=!0,G(j);else{var n=t(O);null!==n&&X(z,n.startTime-e)}}}function j(e,a){N=!1,L&&(// We scheduled a timeout but it's no longer needed. Cancel it.
L=!1,A(V),V=-1),D=!0;var i=I;try{return function(e,a){var i=a;for(F(i),P=t(T);null!==P&&!(P.expirationTime>i&&(!e||H()));){var o=P.callback;if("function"==typeof o){P.callback=null,I=P.priorityLevel;var s=o(P.expirationTime<=i);i=r(),"function"==typeof s?P.callback=s:P===t(T)&&n(T),F(i)}else n(T);P=t(T)}// Return whether there's additional work
if(null!==P)return!0;var l=t(O);return null!==l&&X(z,l.startTime-i),!1}(e,a)}finally{P=null,I=i,D=!1}}"undefined"!=typeof navigator&&void 0!==navigator.scheduling&&void 0!==navigator.scheduling.isInputPending&&navigator.scheduling.isInputPending.bind(navigator.scheduling);var q=!1,B=null,V=-1,W=5,$=-1;function H(){return!(r()-$<W)}var Y=function(){if(null!==B){var e=r();// Keep track of the start time so we can measure how long the main thread
// has been blocked.
...
X(z,o-l))):(d.sortIndex=c,e(T,d),N||D||(N=!0,G(j))),d},w=H,_=function(e){var t=I;return function(){// This is a fork of runWithPriority, inlined for performance.
...
j.current=null,function(){if(0===F){/* eslint-disable react-internal/no-production-logging */t=console.log,n=console.info,o=console.warn,s=console.error,l=console.group,u=console.groupCollapsed,c=console.groupEnd;var e={configurable:!0,enumerable:!0,value:z,writable:!0};// $FlowFixMe Flow thinks console is immutable.
...
if(g--,--y<0||m[g]!==v[y]){// V8 adds a "new" prefix for native classes. Let's remove it to make it prettier.
var b="\n"+m[g].replace(" at new "," at ");// If our component frame is labeled "<anonymous>"
return e.displayName&&b.includes("<anonymous>")&&(b=b.replace("<anonymous>",e.displayName)),"function"==typeof e&&f.set(e,b),b}while(g>=1&&y>=0)break}}}finally{B=!1,j.current=i,function(){if(0==--F){/* eslint-disable react-internal/no-production-logging */var e={configurable:!0,enumerable:!0,writable:!0};// $FlowFixMe Flow thinks console is immutable.
Object.defineProperties(console,{log:U({},e,{value:t}),info:U({},e,{value:n}),warn:U({},e,{value:o}),error:U({},e,{value:s}),group:U({},e,{value:l}),groupCollapsed:U({},e,{value:u}),groupEnd:U({},e,{value:c})});/* eslint-enable react-internal/no-production-logging */}F<0&&L("disabledDepth fell below zero. This is a bug in React. Please file an issue.")}(),Error.prepareStackTrace=p}// Fallback to just using the name if we couldn't make it throw.
...
class ed extends X{constructor(e){super(),this.config=e||{},this.mutations=[],this.mutationId=0}build(e,t,n){let r=new eu({mutationCache:this,logger:e.getLogger(),mutationId:++this.mutationId,options:e.defaultMutationOptions(t),state:n,defaultOptions:t.mutationKey?e.getMutationDefaults(t.mutationKey):void 0});return this.add(r),r}add(e){this.mutations.push(e),this.notify({type:"added",mutation:e})}remove(e){this.mutations=this.mutations.filter(t=>t!==e),this.notify({type:"removed",mutation:e})}clear(){G.batch(()=>{this.mutations.forEach(e=>{this.remove(e)})})}getAll(){return this.mutations}find(e){return void 0===e.exact&&(e.exact=!0),this.mutations.find(t=>z(e,t))}findAll(e){return this.mutations.filter(t=>z(e,t))}notify(e){G.batch(()=>{this.listeners.forEach(({listener:t})=>{t(e)})})}resumePausedMutations(){var e;return this.resuming=(null!=(e=this.resuming)?e:Promise.resolve()).then(()=>{let e=this.mutations.filter(e=>e.state.isPaused);return G.batch(()=>e.reduce((e,t)=>e.then(()=>t.continue().catch(M)),Promise.resolve()))}).then(()=>{this.resuming=void 0}),this.resuming}}function ef(e,t){return null==e.getNextPageParam?void 0:e.getNextPageParam(t[t.length-1],t)}var D=I("exYeM");let ep=/*#__PURE__*/D.createContext(void 0),eh=/*#__PURE__*/D.createContext(!1);// Otherwise, if contextSharing is on, we share the first and at least one
// instance of the context across the window
// to ensure that if React Query is used across
// different bundles or microfrontends they will
// all use the same **instance** of context, regardless
// of module scoping.
function em(e,t){return e||(t&&"undefined"!=typeof window?(window.ReactQueryClientContext||(window.ReactQueryClientContext=ep),window.ReactQueryClientContext):ep)}let ev=({context:e}={})=>{let t=D.useContext(em(e,D.useContext(eh)));if(!t)throw Error("No QueryClient set, use QueryClientProvider to set one");return t},eg=({client:e,children:t,context:n,contextSharing:r=!1})=>{D.useEffect(()=>(e.mount(),()=>{e.unmount()}),[e]),r&&e.getLogger().error("The contextSharing option has been deprecated and will be removed in the next major version");let a=em(n,r);return /*#__PURE__*/D.createElement(eh.Provider,{value:!n&&r},/*#__PURE__*/D.createElement(a.Provider,{value:e},t))};var D=(I("exYeM"),I("exYeM"));let ey=(0,D.createContext)(null),eb={didCatch:!1,error:null};class ew extends D.Component{constructor(e){super(e),this.resetErrorBoundary=this.resetErrorBoundary.bind(this),this.state=eb}static getDerivedStateFromError(e){return{didCatch:!0,error:e}}resetErrorBoundary(){let{error:e}=this.state;if(null!==e){for(var t,n,r=arguments.length,a=Array(r),i=0;i<r;i++)a[i]=arguments[i];null===(t=(n=this.props).onReset)||void 0===t||t.call(n,{args:a,reason:"imperative-api"}),this.setState(eb)}}componentDidCatch(e,t){var n,r;null===(n=(r=this.props).onError)||void 0===n||n.call(r,e,t)}componentDidUpdate(e,t){let{didCatch:n}=this.state,{resetKeys:r}=this.props;// There's an edge case where if the thing that triggered the error happens to *also* be in the resetKeys array,
// we'd end up resetting the error boundary immediately.
// This would likely trigger a second error to be thrown.
// So we make sure that we don't check the resetKeys on the first call of cDU after the error is set.
if(n&&null!==t.error&&function(){let e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:[],t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:[];return e.length!==t.length||e.some((e,n)=>!Object.is(e,t[n]))}(e.resetKeys,r)){var a,i;null===(a=(i=this.props).onReset)||void 0===a||a.call(i,{next:r,prev:e.resetKeys,reason:"keys"}),this.setState(eb)}}render(){let{children:e,fallbackRender:t,FallbackComponent:n,fallback:r}=this.props,{didCatch:a,error:i}=this.state,o=e;if(a){let e={error:i,resetErrorBoundary:this.resetErrorBoundary};if((0,D.isValidElement)(r))o=r;else if("function"==typeof t)o=t(e);else if(n)o=(0,D.createElement)(n,e);else throw i}return(0,D.createElement)(ey.Provider,{value:{didCatch:a,error:i,resetErrorBoundary:this.resetErrorBoundary}},o)}}var D=(I("exYeM"),I("exYeM"),I("exYeM")),e_={};Object.defineProperty(e_,"__esModule",{value:!0});var D=I("exYeM"),ek=(a=D)&&"object"==typeof a&&"default"in a?a.default:a,ex=I("cV6nb"),eS=new ex,eE=eS.getBrowser(),eC=eS.getCPU(),eT=eS.getDevice(),eO=eS.getEngine(),eR=eS.getOS(),eP=eS.getUA(),eI=function(e){return eS.setUA(e)},eD=function(e){if(!e){console.error("No userAgent string was provided");return}var t=new ex(e);return{UA:t,browser:t.getBrowser(),cpu:t.getCPU(),device:t.getDevice(),engine:t.getEngine(),os:t.getOS(),ua:t.getUA(),setUserAgent:function(e){return t.setUA(e)}}},eN=/*#__PURE__*/Object.freeze({ClientUAInstance:eS,browser:eE,cpu:eC,device:eT,engine:eO,os:eR,ua:eP,setUa:eI,parseUserAgent:eD});function eL(e,t){var n=Object.keys(e);if(Object.getOwnPropertySymbols){var r=Object.getOwnPropertySymbols(e);t&&(r=r.filter(function(t){return Object.getOwnPropertyDescriptor(e,t).enumerable})),n.push.apply(n,r)}return n}function eM(e){return(eM="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e})(e)}function eA(e,t){for(var n=0;n<t.length;n++){var r=t[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}function eU(){return(eU=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e}).apply(this,arguments)}function eF(e){return(eF=Object.setPrototypeOf?Object.getPrototypeOf:function(e){return e.__proto__||Object.getPrototypeOf(e)})(e)}function ez(e,t){return(ez=Object.setPrototypeOf||function(e,t){return e.__proto__=t,e})(e,t)}function ej(e,t){if(null==e)return{};var n,r,a=function(e,t){if(null==e)return{};var n,r,a={},i=Object.keys(e);for(r=0;r<i.length;r++)n=i[r],t.indexOf(n)>=0||(a[n]=e[n]);return a}(e,t);if(Object.getOwnPropertySymbols){var i=Object.getOwnPropertySymbols(e);for(r=0;r<i.length;r++)n=i[r],!(t.indexOf(n)>=0)&&Object.prototype.propertyIsEnumerable.call(e,n)&&(a[n]=e[n])}return a}function eq(e){if(void 0===e)throw ReferenceError("this hasn't been initialised - super() hasn't been called");return e}function eB(e,t){(null==t||t>e.length)&&(t=e.length);for(var n=0,r=Array(t);n<t;n++)r[n]=e[n];return r}var eV={Mobile:"mobile",Tablet:"tablet",SmartTv:"smarttv",Console:"console",Wearable:"wearable",Embedded:"embedded",Browser:void 0},eW={Chrome:"Chrome",Firefox:"Firefox",Opera:"Opera",Yandex:"Yandex",Safari:"Safari",InternetExplorer:"Internet Explorer",Edge:"Edge",Chromium:"Chromium",Ie:"IE",MobileSafari:"Mobile Safari",EdgeChromium:"Edge Chromium",MIUI:"MIUI Browser",SamsungBrowser:"Samsung Browser"},e$={IOS:"iOS",Android:"Android",WindowsPhone:"Windows Phone",Windows:"Windows",MAC_OS:"Mac OS"},eH={isMobile:!1,isTablet:!1,isBrowser:!1,isSmartTV:!1,isConsole:!1,isWearable:!1},eY=function(e){switch(e){case eV.Mobile:return{isMobile:!0};case eV.Tablet:return{isTablet:!0};case eV.SmartTv:return{isSmartTV:!0};case eV.Console:return{isConsole:!0};case eV.Wearable:return{isWearable:!0};case eV.Browser:return{isBrowser:!0};case eV.Embedded:return{isEmbedded:!0};default:return eH}},eQ=function(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:"none";return e||t},eK=function(){return!!("undefined"!=typeof window&&(window.navigator||navigator))&&(window.navigator||navigator)},eG=function(e){var t=eK();return t&&t.platform&&(-1!==t.platform.indexOf(e)||"MacIntel"===t.platform&&t.maxTouchPoints>1&&!window.MSStream)},eX=function(e){return e.type===eV.Mobile},eJ=function(e){return e.type===eV.Tablet},eZ=function(e){var t=e.type;return t===eV.Mobile||t===eV.Tablet},e0=function(e){return e.type===eV.SmartTv},e1=function(e){return e.type===eV.Browser},e2=function(e){return e.type===eV.Wearable},e3=function(e){return e.type===eV.Console},e5=function(e){return e.type===eV.Embedded},e4=function(e){return eQ(e.vendor)},e6=function(e){return eQ(e.model)},e8=function(e){return eQ(e.type,"browser")},e7=function(e){return e.name===e$.Android},e9=function(e){return e.name===e$.Windows},te=function(e){return e.name===e$.MAC_OS},tt=function(e){return e.name===e$.WindowsPhone},tn=function(e){return e.name===e$.IOS},tr=function(e){return eQ(e.version)},ta=function(e){return eQ(e.name)},ti=function(e){return e.name===eW.Chrome},to=function(e){return e.name===eW.Firefox},ts=function(e){return e.name===eW.Chromium},tl=function(e){return e.name===eW.Edge},tu=function(e){return e.name===eW.Yandex},tc=function(e){var t=e.name;return t===eW.Safari||t===eW.MobileSafari},td=function(e){return e.name===eW.MobileSafari},tf=function(e){return e.name===eW.Opera},tp=function(e){var t=e.name;return t===eW.InternetExplorer||t===eW.Ie},th=function(e){return e.name===eW.MIUI},tm=function(e){return e.name===eW.SamsungBrowser},tv=function(e){return eQ(e.version)},tg=function(e){return eQ(e.major)},ty=function(e){return eQ(e.name)},tb=function(e){return eQ(e.name)},tw=function(e){return eQ(e.version)},t_=function(){var e=eK(),t=e&&e.userAgent&&e.userAgent.toLowerCase();return"string"==typeof t&&/electron/.test(t)},tk=function(e){return"string"==typeof e&&-1!==e.indexOf("Edg/")},tx=function(){var e=eK();return e&&(/iPad|iPhone|iPod/.test(e.platform)||"MacIntel"===e.platform&&e.maxTouchPoints>1)&&!window.MSStream},tS=function(){return eG("iPad")},tE=function(){return eG("iPhone")},tC=function(){return eG("iPod")},tT=function(e){return eQ(e)};function tO(e){var t=e||eN,n=t.device,r=t.browser,a=t.os,i=t.engine,o=t.ua;return{isSmartTV:e0(n),isConsole:e3(n),isWearable:e2(n),isEmbedded:e5(n),isMobileSafari:td(r)||tS(),isChromium:ts(r),isMobile:eZ(n)||tS(),isMobileOnly:eX(n),isTablet:eJ(n)||tS(),isBrowser:e1(n),isDesktop:e1(n),isAndroid:e7(a),isWinPhone:tt(a),isIOS:tn(a)||tS(),isChrome:ti(r),isFirefox:to(r),isSafari:tc(r),isOpera:tf(r),isIE:tp(r),osVersion:tr(a),osName:ta(a),fullBrowserVersion:tv(r),browserVersion:tg(r),browserName:ty(r),mobileVendor:e4(n),mobileModel:e6(n),engineName:tb(i),engineVersion:tw(i),getUA:tT(o),isEdge:tl(r)||tk(o),isYandex:tu(r),deviceType:e8(n),isIOS13:tx(),isIPad13:tS(),isIPhone13:tE(),isIPod13:tC(),isElectron:t_(),isEdgeChromium:tk(o),isLegacyEdge:tl(r)&&!tk(o),isWindows:e9(a),isMacOs:te(a),isMIUI:th(r),isSamsungBrowser:tm(r)}}var tR=e0(eT),tP=e3(eT),tI=e2(eT),tD=e5(eT),tN=td(eE)||tS(),tL=ts(eE),tM=eZ(eT)||tS(),tA=eX(eT),tU=eJ(eT)||tS(),tF=e1(eT),tz=e1(eT),tj=e7(eR),tq=tt(eR),tB=tn(eR)||tS(),tV=ti(eE),tW=to(eE),t$=tc(eE),tH=tf(eE),tY=tp(eE),tQ=tr(eR),tK=ta(eR),tG=tv(eE),tX=tg(eE),tJ=ty(eE),tZ=e4(eT),t0=e6(eT),t1=tb(eO),t2=tw(eO),t3=tT(eP),t5=tl(eE)||tk(eP),t4=tu(eE),t6=e8(eT),t8=tx(),t7=tS(),t9=tE(),ne=tC(),nt=t_(),nn=tk(eP),nr=tl(eE)&&!tk(eP),na=e9(eR),ni=te(eR),no=th(eE),ns=tm(eE);function nl(e){return eD(e||window.navigator.userAgent)}e_.AndroidView=function(e){var t=e.renderWithFragment,n=e.children,r=ej(e,["renderWithFragment","children"]);return tj?t?ek.createElement(D.Fragment,null,n):ek.createElement("div",r,n):null},e_.BrowserTypes=eW,e_.BrowserView=function(e){var t=e.renderWithFragment,n=e.children,r=ej(e,["renderWithFragment","children"]);return tF?t?ek.createElement(D.Fragment,null,n):ek.createElement("div",r,n):null},e_.ConsoleView=function(e){var t=e.renderWithFragment,n=e.children,r=ej(e,["renderWithFragment","children"]);return tP?t?ek.createElement(D.Fragment,null,n):ek.createElement("div",r,n):null},e_.CustomView=function(e){var t=e.renderWithFragment,n=e.children,r=(e.viewClassName,e.style,e.condition),a=ej(e,["renderWithFragment","children","viewClassName","style","condition"]);return r?t?ek.createElement(D.Fragment,null,n):ek.createElement("div",a,n):null},e_.IEView=function(e){var t=e.renderWithFragment,n=e.children,r=ej(e,["renderWithFragment","children"]);return tY?t?ek.createElement(D.Fragment,null,n):ek.createElement("div",r,n):null},e_.IOSView=function(e){var t=e.renderWithFragment,n=e.children,r=ej(e,["renderWithFragment","children"]);return tB?t?ek.createElement(D.Fragment,null,n):ek.createElement("div",r,n):null},e_.MobileOnlyView=function(e){var t=e.renderWithFragment,n=e.children,r=(e.viewClassName,e.style,ej(e,["renderWithFragment","children","viewClassName","style"]));return tA?t?ek.createElement(D.Fragment,null,n):ek.createElement("div",r,n):null},e_.MobileView=function(e){var t=e.renderWithFragment,n=e.children,r=ej(e,["renderWithFragment","children"]);return tM?t?ek.createElement(D.Fragment,null,n):ek.createElement("div",r,n):null},e_.OsTypes=e$,e_.SmartTVView=function(e){var t=e.renderWithFragment,n=e.children,r=ej(e,["renderWithFragment","children"]);return tR?t?ek.createElement(D.Fragment,null,n):ek.createElement("div",r,n):null},e_.TabletView=function(e){var t=e.renderWithFragment,n=e.children,r=ej(e,["renderWithFragment","children"]);return tU?t?ek.createElement(D.Fragment,null,n):ek.createElement("div",r,n):null},e_.WearableView=function(e){var t=e.renderWithFragment,n=e.children,r=ej(e,["renderWithFragment","children"]);return tI?t?ek.createElement(D.Fragment,null,n):ek.createElement("div",r,n):null},e_.WinPhoneView=function(e){var t=e.renderWithFragment,n=e.children,r=ej(e,["renderWithFragment","children"]);return tq?t?ek.createElement(D.Fragment,null,n):ek.createElement("div",r,n):null},e_.browserName=tJ,e_.browserVersion=tX,e_.deviceDetect=function(e){var t=e?eD(e):eN,n=t.device,r=t.browser,a=t.engine,i=t.os,o=t.ua,s=eY(n.type),l=s.isBrowser,u=s.isMobile,c=s.isTablet,d=s.isSmartTV,f=s.isConsole,p=s.isWearable,h=s.isEmbedded;return l?{isBrowser:l,browserMajorVersion:eQ(r.major),browserFullVersion:eQ(r.version),browserName:eQ(r.name),engineName:eQ(a.name),engineVersion:eQ(a.version),osName:eQ(i.name),osVersion:eQ(i.version),userAgent:eQ(o)}:d?{isSmartTV:d,engineName:eQ(a.name),engineVersion:eQ(a.version),osName:eQ(i.name),osVersion:eQ(i.version),userAgent:eQ(o)}:f?{isConsole:f,engineName:eQ(a.name),engineVersion:eQ(a.version),osName:eQ(i.name),osVersion:eQ(i.version),userAgent:eQ(o)}:u||c?function(e){for(var t=1;t<arguments.length;t++){var n=null!=arguments[t]?arguments[t]:{};t%2?eL(Object(n),!0).forEach(function(t){var r;r=n[t],t in e?Object.defineProperty(e,t,{value:r,enumerable:!0,configurable:!0,writable:!0}):e[t]=r}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(n)):eL(Object(n)).forEach(function(t){Object.defineProperty(e,t,Object.getOwnPropertyDescriptor(n,t))})}return e}({},s,{vendor:eQ(n.vendor),model:eQ(n.model),os:eQ(i.name),osVersion:eQ(i.version),ua:eQ(o)}):p?{isWearable:p,engineName:eQ(a.name),engineVersion:eQ(a.version),osName:eQ(i.name),osVersion:eQ(i.version),userAgent:eQ(o)}:h?{isEmbedded:h,vendor:eQ(n.vendor),model:eQ(n.model),engineName:eQ(a.name),engineVersion:eQ(a.version),osName:eQ(i.name),osVersion:eQ(i.version),userAgent:eQ(o)}:void 0},e_.deviceType=t6,e_.engineName=t1,e_.engineVersion=t2,e_.fullBrowserVersion=tG,e_.getSelectorsByUserAgent=function(e){if(!e||"string"!=typeof e){console.error("No valid user agent string was provided");return}var t=eD(e);return tO({device:t.device,browser:t.browser,os:t.os,engine:t.engine,ua:t.ua})},e_.getUA=t3,e_.isAndroid=tj,e_.isBrowser=tF,e_.isChrome=tV,e_.isChromium=tL,e_.isConsole=tP,e_.isDesktop=tz,e_.isEdge=t5,e_.isEdgeChromium=nn,e_.isElectron=nt,e_.isEmbedded=tD,e_.isFirefox=tW,e_.isIE=tY,e_.isIOS=tB,e_.isIOS13=t8,e_.isIPad13=t7,e_.isIPhone13=t9,e_.isIPod13=ne,e_.isLegacyEdge=nr,e_.isMIUI=no,e_.isMacOs=ni,e_.isMobile=tM,e_.isMobileOnly=tA,e_.isMobileSafari=tN,e_.isOpera=tH,e_.isSafari=t$,e_.isSamsungBrowser=ns,e_.isSmartTV=tR,e_.isTablet=tU,e_.isWearable=tI,e_.isWinPhone=tq,e_.isWindows=na,e_.isYandex=t4,e_.mobileModel=t0,e_.mobileVendor=tZ,e_.osName=tK,e_.osVersion=tQ,e_.parseUserAgent=eD,e_.setUserAgent=function(e){return eI(e)},e_.useDeviceData=nl,e_.useDeviceSelectors=function(e){var t=nl(e||window.navigator.userAgent);return[tO(t),t]},e_.useMobileOrientation=function(){var e,t=function(e){if(Array.isArray(e))return e}(e=D.useState(function(){var e=window.innerWidth>window.innerHeight?90:0;return{isPortrait:0===e,isLandscape:90===e,orientation:0===e?"portrait":"landscape"}}))||function(e,t){var n,r,a=null==e?null:"undefined"!=typeof Symbol&&e[Symbol.iterator]||e["@@iterator"];if(null!=a){var i=[],o=!0,s=!1;try{for(a=a.call(e);!(o=(n=a.next()).done)&&(i.push(n.value),!t||i.length!==t);o=!0);}catch(e){s=!0,r=e}finally{try{o||null==a.return||a.return()}finally{if(s)throw r}}return i}}(e,2)||function(e,t){if(e){if("string"==typeof e)return eB(e,t);var n=Object.prototype.toString.call(e).slice(8,-1);if("Object"===n&&e.constructor&&(n=e.constructor.name),"Map"===n||"Set"===n)return Array.from(e);if("Arguments"===n||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n))return eB(e,t)}}(e,2)||function(){throw TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}(),n=t[0],r=t[1],a=D.useCallback(function(){var e=window.innerWidth>window.innerHeight?90:0,t={isPortrait:0===e,isLandscape:90===e,orientation:0===e?"portrait":"landscape"};n.orientation!==t.orientation&&r(t)},[n.orientation]);return D.useEffect(function(){return("undefined"==typeof window?"undefined":eM(window))!==void 0&&tM&&(a(),window.addEventListener("load",a,!1),window.addEventListener("resize",a,!1)),function(){window.removeEventListener("resize",a,!1),window.removeEventListener("load",a,!1)}},[a]),n},e_.withOrientationChange=function(e){return /*#__PURE__*/function(t){var n,r;function a(e){var t;return function(e,t){if(!(e instanceof t))throw TypeError("Cannot call a class as a function")}(this,a),(t=function(e,t){if(t&&("object"==typeof t||"function"==typeof t))return t;if(void 0!==t)throw TypeError("Derived constructors may only return object or undefined");return eq(e)}(this,eF(a).call(this,e))).isEventListenerAdded=!1,t.handleOrientationChange=t.handleOrientationChange.bind(eq(t)),t.onOrientationChange=t.onOrientationChange.bind(eq(t)),t.onPageLoad=t.onPageLoad.bind(eq(t)),t.state={isLandscape:!1,isPortrait:!1},t}return function(e,t){if("function"!=typeof t&&null!==t)throw TypeError("Super expression must either be null or a function");e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,writable:!0,configurable:!0}}),t&&ez(e,t)}(a,t),n=[{key:"handleOrientationChange",value:function(){this.isEventListenerAdded||(this.isEventListenerAdded=!0);var e=window.innerWidth>window.innerHeight?90:0;this.setState({isPortrait:0===e,isLandscape:90===e})}},{key:"onOrientationChange",value:function(){this.handleOrientationChange()}},{key:"onPageLoad",value:function(){this.handleOrientationChange()}},{key:"componentDidMount",value:function(){("undefined"==typeof window?"undefined":eM(window))!==void 0&&tM&&(this.isEventListenerAdded?window.removeEventListener("load",this.onPageLoad,!1):(this.handleOrientationChange(),window.addEventListener("load",this.onPageLoad,!1)),window.addEventListener("resize",this.onOrientationChange,!1))}},{key:"componentWillUnmount",value:function(){window.removeEventListener("resize",this.onOrientationChange,!1)}},{key:"render",value:function(){return ek.createElement(e,eU({},this.props,{isLandscape:this.state.isLandscape,isPortrait:this.state.isPortrait}))}}],eA(a.prototype,n),r&&eA(a,r),a}(ek.Component)};var D=I("exYeM"),nu={};nu=I("bd4iG");var nc=Object.create,nd=Object.defineProperty,nf=Object.getOwnPropertyDescriptor,np=Object.getOwnPropertyNames,nh=Object.getPrototypeOf,nm=Object.prototype.hasOwnProperty,nv=(i=(e,t)=>{var n,r;n=e,r=function(e){var t,n=void 0===Number.MAX_SAFE_INTEGER?9007199254740991:Number.MAX_SAFE_INTEGER,r=new WeakMap,a=(t=function(e,t){return r.set(e,t),t},function(e){var a=r.get(e),i=void 0===a?e.size:a<1073741824?a+1:0;if(!e.has(i))return t(e,i);if(e.size<536870912){for(;e.has(i);)i=Math.floor(1073741824*Math.random());return t(e,i)}if(e.size>n)throw Error("Congratulations, you created a collection of unique numbers which uses all available integers!");for(;e.has(i);)i=Math.floor(Math.random()*n);return t(e,i)});e.addUniqueNumber=function(e){var t=a(e);return e.add(t),t},e.generateUniqueNumber=a},"object"==typeof e&&"u">typeof t?r(e):"function"==typeof define&&define.amd?define(["exports"],r):r((n="u">typeof globalThis?globalThis:n||self).fastUniqueNumbers={})},()=>(o||i((o={exports:{}}).exports,o),o.exports));D.Component;var ng=(l=null!=(s=nv())?nc(nh(s)):{},((e,t,n,r)=>{if(t&&"object"==typeof t||"function"==typeof t)for(let n of np(t))nm.call(e,n)||void 0===n||nd(e,n,{get:()=>t[n],enumerable:!(r=nf(t,n))||r.enumerable});return e})(s&&s.__esModule?l:nd(l,"default",{value:s,enumerable:!0}),s)),ny=e=>void 0!==e.method&&"call"===e.method,nb=e=>null===e.error&&"number"==typeof e.id;u=e=>{let t=new Map([[0,()=>{}]]),n=new Map([[0,()=>{}]]),r=new Map,a=new Worker(e);return a.addEventListener("message",({data:e})=>{if(ny(e)){let{params:{timerId:a,timerType:i}}=e;if("interval"===i){let e=t.get(a);if("number"==typeof e){let t=r.get(e);if(void 0===t||t.timerId!==a||t.timerType!==i)throw Error("The timer is in an undefined state.")}else if("u">typeof e)e();else throw Error("The timer is in an undefined state.")}else if("timeout"===i){let e=n.get(a);if("number"==typeof e){let t=r.get(e);if(void 0===t||t.timerId!==a||t.timerType!==i)throw Error("The timer is in an undefined state.")}else if("u">typeof e)e(),n.delete(a);else throw Error("The timer is in an undefined state.")}}else if(nb(e)){let{id:a}=e,i=r.get(a);if(void 0===i)throw Error("The timer is in an undefined state.");let{timerId:o,timerType:s}=i;r.delete(a),"interval"===s?t.delete(o):n.delete(o)}else{let{error:{message:t}}=e;throw Error(t)}}),{clearInterval:e=>{let n=(0,ng.generateUniqueNumber)(r);r.set(n,{timerId:e,timerType:"interval"}),t.set(e,n),a.postMessage({id:n,method:"clear",params:{timerId:e,timerType:"interval"}})},clearTimeout:e=>{let t=(0,ng.generateUniqueNumber)(r);r.set(t,{timerId:e,timerType:"timeout"}),n.set(e,t),a.postMessage({id:t,method:"clear",params:{timerId:e,timerType:"timeout"}})},setInterval:(e,n)=>{let r=(0,ng.generateUniqueNumber)(t);return t.set(r,()=>{e(),"function"==typeof t.get(r)&&a.postMessage({id:null,method:"set",params:{delay:n,now:performance.now(),timerId:r,timerType:"interval"}})}),a.postMessage({id:null,method:"set",params:{delay:n,now:performance.now(),timerId:r,timerType:"interval"}}),r},setTimeout:(e,t)=>{let r=(0,ng.generateUniqueNumber)(n);return n.set(r,e),a.postMessage({id:null,method:"set",params:{delay:t,now:performance.now(),timerId:r,timerType:"timeout"}}),r}}},t=null,()=>{if(null!==t)return t;let e=new Blob(['(()=>{"use strict";const e=new Map,t=new Map,r=(e,t)=>{let r,o;const i=performance.now();r=i,o=e-Math.max(0,i-t);return{expected:r+o,remainingDelay:o}},o=(e,t,r,i)=>{const s=performance.now();s>r?postMessage({id:null,method:"call",params:{timerId:t,timerType:i}}):e.set(t,setTimeout(o,r-s,e,t,r,i))};addEventListener("message",(i=>{let{data:s}=i;try{if("clear"===s.method){const{id:r,params:{timerId:o,timerType:i}}=s;if("interval"===i)(t=>{const r=e.get(t);if(void 0===r)throw new Error(\'There is no interval scheduled with the given id "\'.concat(t,\'".\'));clearTimeout(r),e.delete(t)})(o),postMessage({error:null,id:r});else{if("timeout"!==i)throw new Error(\'The given type "\'.concat(i,\'" is not supported\'));(e=>{const r=t.get(e);if(void 0===r)throw new Error(\'There is no timeout scheduled with the given id "\'.concat(e,\'".\'));clearTimeout(r),t.delete(e)})(o),postMessage({error:null,id:r})}}else{if("set"!==s.method)throw new Error(\'The given method "\'.concat(s.method,\'" is not supported\'));{const{params:{delay:i,now:n,timerId:a,timerType:d}}=s;if("interval"===d)((t,i,s)=>{const{expected:n,remainingDelay:a}=r(t,s);e.set(i,setTimeout(o,a,e,i,n,"interval"))})(i,a,n);else{if("timeout"!==d)throw new Error(\'The given type "\'.concat(d,\'" is not supported\'));((e,i,s)=>{const{expected:n,remainingDelay:a}=r(e,s);t.set(i,setTimeout(o,a,t,i,n,"timeout"))})(i,a,n)}}}}catch(e){postMessage({error:{message:e.message},id:s.id,result:null})}}))})();'],{type:"application/javascript; charset=utf-8"}),n=URL.createObjectURL(e);return t=u(n),setTimeout(()=>URL.revokeObjectURL(n)),t};var nw=(typeof window>"u"?"undefined":typeof window)=="object",n_={setTimeout:nw?setTimeout.bind(window):setTimeout,clearTimeout:nw?clearTimeout.bind(window):clearTimeout,setInterval:nw?setInterval.bind(window):setInterval,clearInterval:nw?clearInterval.bind(window):clearInterval},nk={},nx=class{name;closed=!1;mc=new MessageChannel;constructor(e){this.name=e,nk[e]=nk[e]||[],nk[e].push(this),this.mc.port1.start(),this.mc.port2.start(),this.onStorage=this.onStorage.bind(this),window.addEventListener("storage",this.onStorage)}onStorage(e){if(e.storageArea!==window.localStorage||e.key.substring(0,this.name.length)!==this.name||null===e.newValue)return;let t=JSON.parse(e.newValue);this.mc.port2.postMessage(t)}postMessage(e){if(this.closed)throw Error("InvalidStateError");let t=JSON.stringify(e),n=`${this.name}:${String(Date.now())}${String(Math.random())}`;window.localStorage.setItem(n,t),n_.setTimeout(()=>{window.localStorage.removeItem(n)},500),nk[this.name].forEach(e=>{e!==this&&e.mc.port2.postMessage(JSON.parse(t))})}close(){if(this.closed)return;this.closed=!0,this.mc.port1.close(),this.mc.port2.close(),window.removeEventListener("storage",this.onStorage);let e=nk[this.name].indexOf(this);nk[this.name].splice(e,1)}get onmessage(){return this.mc.port1.onmessage}set onmessage(e){this.mc.port1.onmessage=e}get onmessageerror(){return this.mc.port1.onmessageerror}set onmessageerror(e){this.mc.port1.onmessageerror=e}addEventListener(e,t){return this.mc.port1.addEventListener(e,t)}removeEventListener(e,t){return this.mc.port1.removeEventListener(e,t)}dispatchEvent(e){return this.mc.port1.dispatchEvent(e)}},nS=typeof window>"u"?void 0:"function"==typeof window.BroadcastChannel?window.BroadcastChannel:nx;function nE(){return Math.random().toString(36).substring(2)}var nC=class{options;channel;token=nE();isLeader=!1;isDead=!1;isApplying=!1;reApply=!1;intervals=[];listeners=[];deferred;constructor(e,t){this.channel=e,this.options=t,this.apply=this.apply.bind(this),this.awaitLeadership=this.awaitLeadership.bind(this),this.sendAction=this.sendAction.bind(this)}async apply(){if(this.isLeader||this.isDead)return!1;if(this.isApplying)return this.reApply=!0,!1;this.isApplying=!0;let e=!1,t=t=>{let{token:n,action:r}=t.data;n!==this.token&&(0===r&&n>this.token&&(e=!0),1===r&&(e=!0))};this.channel.addEventListener("message",t);try{return this.sendAction(0),await function(e=0){return new Promise(t=>n_.setTimeout(t,e))}(this.options.responseTime),this.channel.removeEventListener("message",t),this.isApplying=!1,e?!!this.reApply&&this.apply():(this.assumeLead(),!0)}catch{return!1}}awaitLeadership(){if(this.isLeader)return Promise.resolve();let e=!1,t=null;return new Promise(n=>{let r=()=>{if(e)return;e=!0;try{n_.clearInterval(t)}catch{}let r=this.intervals.indexOf(t);r>=0&&this.intervals.splice(r,1),this.channel.removeEventListener("message",a),n()};t=n_.setInterval(()=>{this.apply().then(()=>{this.isLeader&&r()})},this.options.fallbackInterval),this.intervals.push(t);let a=e=>{let{action:t}=e.data;2===t&&this.apply().then(()=>{this.isLeader&&r()})};this.channel.addEventListener("message",a)})}sendAction(e){this.channel.postMessage({action:e,token:this.token})}assumeLead(){this.isLeader=!0;let e=e=>{let{action:t}=e.data;0===t&&this.sendAction(1)};return this.channel.addEventListener("message",e),this.listeners.push(e),this.sendAction(1)}waitForLeadership(){return this.deferred||(this.deferred=this.awaitLeadership()),this.deferred}close(){if(!this.isDead){this.isDead=!0,this.isLeader=!1,this.sendAction(2);try{this.listeners.forEach(e=>this.channel.removeEventListener("message",e)),this.intervals.forEach(e=>n_.clearInterval(e))}catch{}}}},nT=class{channel;options;elector;token=nE();registry=new Map;allIdle=!1;isLastActive=!1;constructor(e){let{channelName:t}=e;this.options=e,this.channel=new nS(t),this.registry.set(this.token,1),e.leaderElection&&(this.elector=new nC(this.channel,{fallbackInterval:2e3,responseTime:100}),this.elector.waitForLeadership()),this.channel.addEventListener("message",e=>{let{action:t,token:n,data:r}=e.data;switch(t){case 3:this.registry.set(n,2);break;case 4:this.registry.delete(n);break;case 5:this.idle(n);break;case 6:this.active(n);break;case 7:this.prompt(n);break;case 8:this.start(n);break;case 9:this.reset(n);break;case 10:this.activate(n);break;case 11:this.pause(n);break;case 12:this.resume(n);break;case 13:this.options.onMessage(r)}}),this.send(3)}get isLeader(){if(!this.elector)throw Error('❌ Leader election is not enabled. To Enable it set the "leaderElection" property to true.');return this.elector.isLeader}prompt(e=this.token){this.registry.set(e,0);let t=[...this.registry.values()].every(e=>0===e);e===this.token&&this.send(7),t&&this.options.onPrompt()}idle(e=this.token){this.registry.set(e,2);let t=[...this.registry.values()].every(e=>2===e);e===this.token&&this.send(5),!this.allIdle&&t&&(this.allIdle=!0,this.options.onIdle())}active(e=this.token){this.allIdle=!1,this.registry.set(e,1);let t=[...this.registry.values()].some(e=>1===e);e===this.token&&this.send(6),t&&this.options.onActive(),this.isLastActive=e===this.token}start(e=this.token){this.allIdle=!1,this.registry.set(e,1),e===this.token?this.send(8):this.options.start(!0),this.isLastActive=e===this.token}reset(e=this.token){this.allIdle=!1,this.registry.set(e,1),e===this.token?this.send(9):this.options.reset(!0),this.isLastActive=e===this.token}activate(e=this.token){this.allIdle=!1,this.registry.set(e,1),e===this.token?this.send(10):this.options.activate(!0),this.isLastActive=e===this.token}pause(e=this.token){e===this.token?this.send(11):this.options.pause(!0)}resume(e=this.token){e===this.token?this.send(12):this.options.resume(!0)}message(e){try{this.channel.postMessage({action:13,token:this.token,data:e})}catch{}}send(e){try{this.channel.postMessage({action:e,token:this.token})}catch{}}close(){this.options.leaderElection&&this.elector.close(),this.send(4),this.channel.close()}},nO=nw?document:null,nR=["mousemove","keydown","wheel","DOMMouseScroll","mousewheel","mousedown","touchstart","touchmove","MSPointerDown","MSPointerMove","visibilitychange","focus"];function nP(e,t){let n=0;return function(...r){let a=new Date().getTime();if(!(a-n<t))return n=a,e(...r)}}var nI=()=>Date.now(),nD=(0,D.createContext)(null);function nN(e){let t=function({timeout:e=12e5,promptTimeout:t=0,promptBeforeIdle:n=0,element:r=nO,events:a=nR,timers:i,immediateEvents:o=[],onPresenceChange:s=()=>{},onPrompt:l=()=>{},onIdle:u=()=>{},onActive:c=()=>{},onAction:d=()=>{},onMessage:f=()=>{},debounce:p=0,throttle:h=0,eventsThrottle:m=200,startOnMount:v=!0,startManually:g=!1,stopOnIdle:y=!1,crossTab:b=!1,name:w="idle-timer",syncTimers:_=0,leaderElection:k=!1,disabled:x=!1}={}){let S=(0,D.useRef)(nI()),E=(0,D.useRef)(nI()),C=(0,D.useRef)(null),T=(0,D.useRef)(null),O=(0,D.useRef)(0),R=(0,D.useRef)(0),P=(0,D.useRef)(0),I=(0,D.useRef)(0),N=(0,D.useRef)(!1),L=(0,D.useRef)(!1),M=(0,D.useRef)(!1),A=(0,D.useRef)(!0),U=(0,D.useRef)(!1),F=(0,D.useRef)(null),z=(0,D.useRef)(null),j=(0,D.useRef)(e),q=(0,D.useRef)(0);(0,D.useEffect)(()=>{if(t&&console.warn("⚠️ IdleTimer -- The `promptTimeout` property has been deprecated in favor of `promptBeforeIdle`. It will be removed in the next major release."),n&&t)throw Error("❌ Both promptTimeout and promptBeforeIdle can not be set. The promptTimeout property will be deprecated in a future version.");if(e>=2147483647)throw Error(`\u274C The value for the timeout property must fit in a 32 bit signed integer, 2147483647.`);if(t>=2147483647)throw Error(`\u274C The value for the promptTimeout property must fit in a 32 bit signed integer, 2147483647.`);if(n>=2147483647)throw Error(`\u274C The value for the promptBeforeIdle property must fit in a 32 bit signed integer, 2147483647.`);if(n>=e)throw Error(`\u274C The value for the promptBeforeIdle property must be less than the timeout property, ${e}.`);if(n?(j.current=e-n,q.current=n):(j.current=e,q.current=t),!A.current){if(g||x)return;N.current&&(G.current(null,eI),z.current&&z.current.active()),ed()}},[e,t,n,g,x]);let B=(0,D.useRef)(y);(0,D.useEffect)(()=>{B.current=y},[y]);let V=(0,D.useRef)(o),W=(0,D.useRef)(r),$=(0,D.useRef)([...new Set([...a,...o]).values()]),H=(0,D.useRef)(x);(0,D.useEffect)(()=>{H.current=x,!A.current&&(x?eh():g||ed())},[x]);let Y=(0,D.useRef)(s);(0,D.useEffect)(()=>{Y.current=s},[s]);let Q=(0,D.useRef)(l);(0,D.useEffect)(()=>{Q.current=l},[l]);let K=(0,D.useRef)(u);(0,D.useEffect)(()=>{K.current=u},[u]);let G=(0,D.useRef)(c);(0,D.useEffect)(()=>{G.current=c},[c]);let X=(0,D.useRef)(d);(0,D.useEffect)(()=>{X.current=d},[d]);let J=(0,D.useRef)(f);(0,D.useEffect)(()=>{J.current=f},[f]);let Z=(0,D.useMemo)(()=>{let e=(e,t)=>X.current(e,t);return p>0?function(e,t){let n;function r(...a){n&&clearTimeout(n),n=setTimeout(()=>{e(...a),n=null},t)}return r.cancel=function(){clearTimeout(n)},r}(e,p):h>0?nP(e,h):e},[h,p]),ee=(0,D.useRef)();(0,D.useEffect)(()=>{b&&_&&(ee.current=nP(()=>{z.current.active()},_))},[b,_]);let et=()=>{null!==F.current&&(n_.clearTimeout(F.current),F.current=null)},en=(e,t=!0)=>{et(),F.current=n_.setTimeout(eo,e||j.current),t&&(T.current=nI())},er=e=>{L.current||N.current||(Q.current(e,eI),Y.current({type:"active",prompted:!0},eI)),I.current=0,P.current=nI(),L.current=!0,en(q.current,!1)},ea=()=>{et(),N.current||(K.current(null,eI),Y.current({type:"idle"},eI)),N.current=!0,C.current=nI(),B.current?ec():L.current&&(P.current=0,L.current=!1)},ei=e=>{et(),(N.current||L.current)&&(G.current(e,eI),Y.current({type:"active",prompted:!1},eI)),L.current=!1,P.current=0,N.current=!1,O.current+=nI()-C.current,R.current+=nI()-C.current,eu(),en()},eo=e=>{if(!N.current){Z.cancel&&Z.cancel();let t=nI()-T.current;if(!(j.current+q.current<t)&&q.current>0&&!L.current){z.current?z.current.prompt():er(e);return}z.current?z.current.idle():ea();return}z.current?z.current.active():ei(e)},es=e=>{if(v||T.current||(T.current=nI(),G.current(null,eI)),Z(e,eI),L.current)return;if(et(),!N.current&&V.current.includes(e.type)){eo(e);return}let t=nI()-T.current;if(N.current&&!y||!N.current&&t>=j.current){eo(e);return}M.current=!1,I.current=0,P.current=0,en(),b&&_&&ee.current()},el=(0,D.useRef)(es);(0,D.useEffect)(()=>{let e=U.current;e&&ec(),m>0?el.current=nP(es,m):el.current=es,e&&eu()},[m,h,p,X,b,_]);let eu=()=>{nw&&W.current&&(U.current||($.current.forEach(e=>{W.current.addEventListener(e,el.current,{capture:!0,passive:!0})}),U.current=!0))},ec=(e=!1)=>{nw&&W.current&&(U.current||e)&&($.current.forEach(e=>{W.current.removeEventListener(e,el.current,{capture:!0})}),U.current=!1)},ed=(0,D.useCallback)(e=>!H.current&&(et(),eu(),N.current=!1,L.current=!1,M.current=!1,I.current=0,P.current=0,z.current&&!e&&z.current.start(),en(),!0),[F,N,H,j,z]),ef=(0,D.useCallback)(e=>!H.current&&(et(),eu(),E.current=nI(),O.current+=nI()-C.current,R.current+=nI()-C.current,O.current=0,N.current=!1,L.current=!1,M.current=!1,I.current=0,P.current=0,z.current&&!e&&z.current.reset(),g||en(),!0),[F,N,j,g,H,z]),ep=(0,D.useCallback)(e=>!H.current&&(et(),eu(),(N.current||L.current)&&ei(),N.current=!1,L.current=!1,M.current=!1,I.current=0,P.current=0,E.current=nI(),z.current&&!e&&z.current.activate(),en(),!0),[F,N,L,H,j,z]),eh=(0,D.useCallback)((e=!1)=>!H.current&&!M.current&&(I.current=ek(),M.current=!0,ec(),et(),z.current&&!e&&z.current.pause(),!0),[F,H,z]),em=(0,D.useCallback)((e=!1)=>!H.current&&!!M.current&&(M.current=!1,L.current||eu(),N.current||en(I.current),P.current&&(P.current=nI()),z.current&&!e&&z.current.resume(),!0),[F,j,H,I,z]),ev=(0,D.useCallback)((e,t)=>(z.current?(t&&J.current(e,eI),z.current.message(e)):t&&J.current(e,eI),!0),[f]),eg=(0,D.useCallback)(()=>N.current,[N]),ey=(0,D.useCallback)(()=>L.current,[L]),eb=(0,D.useCallback)(()=>z.current?z.current.isLeader:null,[z]),ew=(0,D.useCallback)(()=>z.current?z.current.isLastActive:null,[z]),e_=(0,D.useCallback)(()=>z.current?z.current.token:null,[z]),ek=(0,D.useCallback)(()=>{if(M.current)return I.current;let e=Math.floor((I.current?I.current:q.current+j.current)-(T.current?nI()-T.current:0));return e<0?0:Math.abs(e)},[j,q,L,I,T]),ex=(0,D.useCallback)(()=>Math.round(nI()-E.current),[E]),eS=(0,D.useCallback)(()=>Math.round(nI()-S.current),[S]),eE=(0,D.useCallback)(()=>C.current?new Date(C.current):null,[C]),eC=(0,D.useCallback)(()=>T.current?new Date(T.current):null,[T]),eT=(0,D.useCallback)(()=>N.current?Math.round(nI()-C.current+O.current):Math.round(O.current),[C,O]),eO=(0,D.useCallback)(()=>N.current?Math.round(nI()-C.current+R.current):Math.round(R.current),[C,R]),eR=(0,D.useCallback)(()=>{let e=Math.round(ex()-eT());return e>=0?e:0},[C,O]),eP=(0,D.useCallback)(()=>{let e=Math.round(eS()-eO());return e>=0?e:0},[C,O]);(0,D.useEffect)(()=>{if(p>0&&h>0)throw Error("❌ onAction can either be throttled or debounced, not both.");i&&(n_.setTimeout=i.setTimeout,n_.clearTimeout=i.clearTimeout,n_.setInterval=i.setInterval,n_.clearInterval=i.clearInterval);let e=()=>{z.current&&z.current.close(),Z.cancel&&Z.cancel(),et(),ec(!0)};return nw&&window.addEventListener("beforeunload",e),()=>{nw&&window.removeEventListener("beforeunload",e),z.current&&z.current.close(),Z.cancel&&Z.cancel(),et(),ec(!0)}},[]),(0,D.useEffect)(()=>{z.current&&z.current.close(),b?z.current=new nT({channelName:w,leaderElection:k,onPrompt:()=>{er()},onIdle:()=>{ea()},onActive:()=>{ei()},onMessage:e=>{J.current(e,eI)},start:ed,reset:ef,activate:ep,pause:eh,resume:em}):z.current=null},[b,w,k,Q,K,G,J,ed,ef,eh,em]),(0,D.useEffect)(()=>{A.current||(et(),ec(!0)),g||x||(v?ed():eu())},[g,v,x,A]),(0,D.useEffect)(()=>{if(!A.current){let e=[...new Set([...a,...o]).values()];ec(),$.current=e,W.current=r,V.current=o,g||x||(v?ed():eu())}},[r,JSON.stringify(a),JSON.stringify(o),A,x,g,v]),(0,D.useEffect)(()=>{A.current&&(A.current=!1)},[A]);let eI={message:ev,start:ed,reset:ef,activate:ep,pause:eh,resume:em,isIdle:eg,isPrompted:ey,isLeader:eb,isLastActiveTab:ew,getTabId:e_,getRemainingTime:ek,getElapsedTime:ex,getTotalElapsedTime:eS,getLastIdleTime:eE,getLastActiveTime:eC,getIdleTime:eT,getTotalIdleTime:eO,getActiveTime:eR,getTotalActiveTime:eP,setOnPresenceChange:e=>{s=e,Y.current=e},setOnPrompt:e=>{l=e,Q.current=e},setOnIdle:e=>{u=e,K.current=e},setOnActive:e=>{c=e,G.current=e},setOnAction:e=>{d=e,X.current=e},setOnMessage:e=>{f=e,J.current=e}};return eI}(e);return(0,nu.jsx)(nD.Provider,{value:t,children:e.children})}nD.Consumer;var D=I("exYeM");function nL(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)e[r]=n[r]}return e}var nM=function e(t,n){function r(e,r,a){if(!(typeof document>"u")){"number"==typeof(a=nL({},n,a)).expires&&(a.expires=new Date(Date.now()+864e5*a.expires)),a.expires&&(a.expires=a.expires.toUTCString()),e=encodeURIComponent(e).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape);var i="";for(var o in a)a[o]&&(i+="; "+o,!0===a[o]||(i+="="+a[o].split(";")[0]));return document.cookie=e+"="+t.write(r,e)+i}}return Object.create({set:r,get:function(e){if(!(typeof document>"u"||arguments.length&&!e)){for(var n=document.cookie?document.cookie.split("; "):[],r={},a=0;a<n.length;a++){var i=n[a].split("="),o=i.slice(1).join("=");try{var s=decodeURIComponent(i[0]);if(r[s]=t.read(o,s),e===s)break}catch{}}return e?r[e]:r}},remove:function(e,t){r(e,"",nL({},t,{expires:-1}))},withAttributes:function(t){return e(this.converter,nL({},this.attributes,t))},withConverter:function(t){return e(nL({},this.converter,t),this.attributes)}},{attributes:{value:Object.freeze(n)},converter:{value:Object.freeze(t)}})}({read:function(e){return'"'===e[0]&&(e=e.slice(1,-1)),e.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent)},write:function(e){return encodeURIComponent(e).replace(/%(2[346BF]|3[AC-F]|40|5[BDE]|60|7[BCD])/g,decodeURIComponent)}},{path:"/"});function nA(){return"u">typeof window}function nU(){if(nA())return window.matchMedia("(hover: none)").matches||navigator.userAgent.toLowerCase().includes("mobile")}function nF(){if(nA())return!nU()}function nz(e){var t,n;let r=null==(t=e.context)?void 0:t.includes("onDesktop"),a=null==(n=e.context)?void 0:n.includes("onMobile");r||a||e.handler(),r&&nF()&&e.handler(),a&&nU()&&e.handler()}function nj(e){nq(e),window.addEventListener("load",e,!0),window.addEventListener("mousemove",e,!0),window.addEventListener("mousedown",e,!0),window.addEventListener("keydown",e,!0),window.addEventListener("touchstart",e,!0),window.addEventListener("click",e,!0),window.addEventListener("scroll",e,!0)}function nq(e){window.removeEventListener("load",e,!0),window.removeEventListener("mousemove",e,!0),window.removeEventListener("mousedown",e,!0),window.removeEventListener("keydown",e,!0),window.removeEventListener("touchstart",e,!0),window.removeEventListener("click",e,!0),window.removeEventListener("scroll",e,!0)}function nB(e,t=200){let n;return{execute(r){clearTimeout(n),n=setTimeout(()=>e(r),t)},abort(){clearTimeout(n)}}}let nV={onMobile:"onMobile",onTrigger:"onTrigger",onDesktop:"onDesktop",onUnsubscribe:"onUnsubscribe"},nW={cookie:{daysToExpire:30,key:"exit-intent"},desktop:{triggerOnIdle:!1,useBeforeUnload:!1,triggerOnMouseLeave:!0,delayInSecondsToTrigger:10},mobile:{triggerOnIdle:!0,delayInSecondsToTrigger:10}};var n$=Object.defineProperty,nH=Object.defineProperties,nY=Object.getOwnPropertyDescriptors,nQ=Object.getOwnPropertySymbols,nK=Object.prototype.hasOwnProperty,nG=Object.prototype.propertyIsEnumerable,nX=(e,t,n)=>t in e?n$(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n,nJ=(e,t)=>{for(var n in t||(t={}))nK.call(t,n)&&nX(e,n,t[n]);if(nQ)for(var n of nQ(t))nG.call(t,n)&&nX(e,n,t[n]);return e},nZ=(e,t)=>nH(e,nY(t)),D=I("exYeM");// CLASS
class n0 extends X{constructor(e,t){super(),this.client=e,this.setOptions(t),this.bindMethods(),this.updateResult()}bindMethods(){this.mutate=this.mutate.bind(this),this.reset=this.reset.bind(this)}setOptions(e){var t;let n=this.options;this.options=this.client.defaultMutationOptions(e),!/**
...
e.listeners&&this.listeners.forEach(({listener:e})=>{e(this.currentResult)})})}}var n1={};n1=I("lrVh9");let n2=n1.useSyncExternalStore;function n3(){}let n5={"Content-Type":"application/json"},n4={get:async(e,t)=>await fetch(e+"?"+new URLSearchParams(t),{method:"GET",headers:n5}),post:async(e,t)=>await fetch(e,{method:"POST",headers:n5,body:JSON.stringify(t)}),patch:async(e,t)=>await fetch(e,{method:"PATCH",headers:n5,body:JSON.stringify(t)}),put:async(e,t)=>await fetch(e,{method:"PUT",headers:n5,body:JSON.stringify(t)}),delete:async e=>await fetch(e,{method:"DELETE",headers:n5})};var D=I("exYeM");let n6=({debug:e,children:t})=>{let n=(...t)=>{e&&console.log(...t)};return(0,D.useEffect)(()=>{e&&n("LoggingProvider: In Debug Mode")}),/*@__PURE__*/r(D).createElement(n8.Provider,{value:{log:n,warn:(...t)=>{e&&console.warn(...t)},error:(...t)=>{e&&console.error(...t);// throw new Error(...message)
},info:(...t)=>{e&&console.info(...t)}}},t)},n8=/*#__PURE__*/(0,D.createContext)({log:()=>{},warn:()=>{},error:()=>{},info:()=>{}}),n7=()=>(0,D.useContext)(n8),n9=()=>{let{log:e,error:t}=n7();return function(e,t,n){var r,a;let i=H(e)?"function"==typeof t?{mutationKey:e,mutationFn:t}:{...t,mutationKey:e}:"function"==typeof e?{...t,mutationFn:e}:{...e},o=ev({context:i.context}),[s]=D.useState(()=>new n0(o,i));D.useEffect(()=>{s.setOptions(i)},[s,i]);let l=n2(D.useCallback(e=>s.subscribe(G.batchCalls(e)),[s]),()=>s.getCurrentResult(),()=>s.getCurrentResult()),u=D.useCallback((e,t)=>{s.mutate(e,t).catch(n3)},[s]);if(l.error&&(r=s.options.useErrorBoundary,a=[l.error],// Allow useErrorBoundary function to override throwing behavior on a per-error basis
...
// ...
(o+="="+i[s].split(";")[0]));return document.cookie=t+"="+n.write(a,t)+o}}return Object.create({set:a,get:function(e){if("undefined"!=typeof document&&(!arguments.length||e)){for(var t=document.cookie?document.cookie.split("; "):[],r={},a=0;a<t.length;a++){var i=t[a].split("="),o=i.slice(1).join("=");try{var s=decodeURIComponent(i[0]);if(r[s]=n.read(o,s),e===s)break}catch(e){}}return e?r[e]:r}},remove:function(t,n){a(t,"",e({},n,{expires:-1}))},withAttributes:function(n){return t(this.converter,e({},this.attributes,n))},withConverter:function(n){return t(e({},this.converter,n),this.attributes)}},{attributes:{value:Object.freeze(r)},converter:{value:Object.freeze(n)}})}({read:function(e){return'"'===e[0]&&(e=e.slice(1,-1)),e.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent)},write:function(e){return encodeURIComponent(e).replace(/%(2[346BF]|3[AC-F]|40|5[BDE]|60|7[BCD])/g,decodeURIComponent)}},{path:"/"})}();let rn=(e,t,n)=>/*@__PURE__*/r(rt).set(e,t,{expires:n||365,sameSite:"strict"}),rr=e=>/*@__PURE__*/r(rt).get(e),ra=({appId:e,setSession:t})=>{let n={firstVisit:void 0};if(!rr("_cm")||rr("_cm")!==e){rn("_cm",e,365),t(n);return}rr("_cm")&&rr("_cm")===e&&(n.firstVisit=!1,t(n))},ri="undefined"!=typeof crypto&&crypto.randomUUID&&crypto.randomUUID.bind(crypto);var ro={randomUUID:ri};let rs=new Uint8Array(16);var rl=/^(?:[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}|00000000-0000-0000-0000-000000000000)$/i,ru=function(e){return"string"==typeof e&&rl.test(e)};/**
 * Convert array of 16 byte values to UUID string format of the form:
 * XXXXXXXX-XXXX-XXXX-XXXX-XXXXXXXXXXXX
 */let rc=[];for(let e=0;e<256;++e)rc.push((e+256).toString(16).slice(1));var rd=function(t,n,r){if(ro.randomUUID&&!n&&!t)return ro.randomUUID();t=t||{};let a=t.random||(t.rng||function(){// lazy load so that environments that need to polyfill have a chance to do so
if(!e&&!// getRandomValues needs to be invoked in a context where "this" is a Crypto implementation.
(e="undefined"!=typeof crypto&&crypto.getRandomValues&&crypto.getRandomValues.bind(crypto)))throw Error("crypto.getRandomValues() not supported. See https://github.com/uuidjs/uuid#getrandomvalues-not-supported");return e(rs)})();// Per 4.4, set bits for version and `clock_seq_hi_and_reserved`
...
return rc[e[t+0]]+rc[e[t+1]]+rc[e[t+2]]+rc[e[t+3]]+"-"+rc[e[t+4]]+rc[e[t+5]]+"-"+rc[e[t+6]]+rc[e[t+7]]+"-"+rc[e[t+8]]+rc[e[t+9]]+"-"+rc[e[t+10]]+rc[e[t+11]]+rc[e[t+12]]+rc[e[t+13]]+rc[e[t+14]]+rc[e[t+15]]}(a)},rf=function(e){if(!ru(e))throw TypeError("Invalid UUID");return parseInt(e.slice(14,15),16)};let rp=e=>ru(e)&&4===rf(e),rh=e=>rp(e),rm=({setVisitor:e})=>{let t={id:void 0};if(!rr("_cm_id")||!rh(rr("_cm_id"))){let n=rd();rn("_cm_id",n,365),t.id=n,e(t);return}rr("_cm_id")&&(t.id=rr("_cm_id"),e(t))},rv=({children:e})=>{let{appId:t,booted:n}=re(),{log:a}=n7(),[i,o]=(0,D.useState)({}),[s,l]=(0,D.useState)({});return(0,D.useEffect)(()=>{if(!n){a("VisitorProvider: not booted");return}a("VisitorProvider: booting");let e=async()=>{await ra({appId:t,setSession:o}),await rm({setVisitor:l})};e(),a("VisitorProvider: booted",i,s)},[t,n]),/*@__PURE__*/r(D).createElement(rg.Provider,{value:{session:i,visitor:s}},e)},rg=/*#__PURE__*/(0,D.createContext)({session:{},visitor:{}}),ry=()=>(0,D.useContext)(rg);var rb={},rw={DEBUG:!1,LIB_VERSION:"2.47.0"};if("undefined"==typeof window){var r_={hostname:""};E={navigator:{userAgent:""},document:{location:r_,referrer:""},screen:{width:0,height:0},location:r_}}else E=window;/*
 * Saved references to long variable names, so that closure compiler can
 * minimize file size.
 */var rk=Array.prototype,rx=Function.prototype,rS=Object.prototype,rE=rk.slice,rC=rS.toString,rT=rS.hasOwnProperty,rO=E.console,rR=E.navigator,rP=E.document,rI=E.opera,rD=E.screen,rN=rR.userAgent,rL=rx.bind,rM=rk.forEach,rA=rk.indexOf,rU=rk.map,rF=Array.isArray,rz={},rj={trim:function(e){// https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String/Trim#Polyfill
return e.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,"")}},rq={/** @type {function(...*)} */log:function(){if(rw.DEBUG&&!rj.isUndefined(rO)&&rO)try{rO.log.apply(rO,arguments)}catch(e){rj.each(arguments,function(e){rO.log(e)})}},/** @type {function(...*)} */warn:function(){if(rw.DEBUG&&!rj.isUndefined(rO)&&rO){var e=["Mixpanel warning:"].concat(rj.toArray(arguments));try{rO.warn.apply(rO,e)}catch(t){rj.each(e,function(e){rO.warn(e)})}}},/** @type {function(...*)} */error:function(){if(rw.DEBUG&&!rj.isUndefined(rO)&&rO){var e=["Mixpanel error:"].concat(rj.toArray(arguments));try{rO.error.apply(rO,e)}catch(t){rj.each(e,function(e){rO.error(e)})}}},/** @type {function(...*)} */critical:function(){if(!rj.isUndefined(rO)&&rO){var e=["Mixpanel error:"].concat(rj.toArray(arguments));try{rO.error.apply(rO,e)}catch(t){rj.each(e,function(e){rO.error(e)})}}}},rB=function(e,t){return function(){return arguments[0]="["+t+"] "+arguments[0],e.apply(rq,arguments)}},rV=function(e){return{log:rB(rq.log,e),error:rB(rq.error,e),critical:rB(rq.critical,e)}};// UNDERSCORE
// Embed part of the Underscore Library
rj.bind=function(e,t){var n,r;if(rL&&e.bind===rL)return rL.apply(e,rE.call(arguments,1));if(!rj.isFunction(e))throw TypeError();return n=rE.call(arguments,2),r=function(){if(!(this instanceof r))return e.apply(t,n.concat(rE.call(arguments)));var a={};a.prototype=e.prototype;var i=new a;a.prototype=null;var o=e.apply(i,n.concat(rE.call(arguments)));return Object(o)===o?o:i}},/**
 * @param {*=} obj
 * @param {function(...*)=} iterator
 * @param {Object=} context
 */rj.each=function(e,t,n){if(null!=e){if(rM&&e.forEach===rM)e.forEach(t,n);else if(e.length===+e.length){for(var r=0,a=e.length;r<a;r++)if(r in e&&t.call(n,e[r],r,e)===rz)return}else for(var i in e)if(rT.call(e,i)&&t.call(n,e[i],i,e)===rz)return}},rj.extend=function(e){return rj.each(rE.call(arguments,1),function(t){for(var n in t)void 0!==t[n]&&(e[n]=t[n])}),e},rj.isArray=rF||function(e){return"[object Array]"===rC.call(e)},// from a comment on http://dbj.org/dbj/?p=286
// fails on only one very rare and deliberate custom object:
// var bomb = { toString : undefined, valueOf: function(o) { return "function BOMBA!"; }};
rj.isFunction=function(e){try{return/^\s*\bfunction\b/.test(e)}catch(e){return!1}},rj.isArguments=function(e){return!!(e&&rT.call(e,"callee"))},rj.toArray=function(e){return e?e.toArray?e.toArray():rj.isArray(e)||rj.isArguments(e)?rE.call(e):rj.values(e):[]},rj.map=function(e,t,n){if(rU&&e.map===rU)return e.map(t,n);var r=[];return rj.each(e,function(e){r.push(t.call(n,e))}),r},rj.keys=function(e){var t=[];return null===e||rj.each(e,function(e,n){t[t.length]=n}),t},rj.values=function(e){var t=[];return null===e||rj.each(e,function(e){t[t.length]=e}),t},rj.include=function(e,t){var n=!1;return null===e?n:rA&&e.indexOf===rA?-1!=e.indexOf(t):(rj.each(e,function(e){if(n||(n=e===t))return rz}),n)},rj.includes=function(e,t){return -1!==e.indexOf(t)},// Underscore Addons
rj.inherit=function(e,t){return e.prototype=new t,e.prototype.constructor=e,e.superclass=t.prototype,e},rj.isObject=function(e){return e===Object(e)&&!rj.isArray(e)},rj.isEmptyObject=function(e){if(rj.isObject(e)){for(var t in e)if(rT.call(e,t))return!1;return!0}return!1},rj.isUndefined=function(e){return void 0===e},rj.isString=function(e){return"[object String]"==rC.call(e)},rj.isDate=function(e){return"[object Date]"==rC.call(e)},rj.isNumber=function(e){return"[object Number]"==rC.call(e)},rj.isElement=function(e){return!!(e&&1===e.nodeType)},rj.encodeDates=function(e){return rj.each(e,function(t,n){rj.isDate(t)?e[n]=rj.formatDate(t):rj.isObject(t)&&(e[n]=rj.encodeDates(t));// recurse
}),e},rj.timestamp=function(){return Date.now=Date.now||function(){return+new Date},Date.now()},rj.formatDate=function(e){// YYYY-MM-DDTHH:MM:SS in UTC
function t(e){return e<10?"0"+e:e}return e.getUTCFullYear()+"-"+t(e.getUTCMonth()+1)+"-"+t(e.getUTCDate())+"T"+t(e.getUTCHours())+":"+t(e.getUTCMinutes())+":"+t(e.getUTCSeconds())},rj.strip_empty_properties=function(e){var t={};return rj.each(e,function(e,n){rj.isString(e)&&e.length>0&&(t[n]=e)}),t},/*
 * this function returns a copy of object after truncating it.  If
 * passed an Array or Object it will iterate through obj and
 * truncate all the values recursively.
 */rj.truncate=function(e,t){var n;return"string"==typeof e?n=e.slice(0,t):rj.isArray(e)?(n=[],rj.each(e,function(e){n.push(rj.truncate(e,t))})):rj.isObject(e)?(n={},rj.each(e,function(e,r){n[r]=rj.truncate(e,t)})):n=e,n},rj.JSONEncode=function(e){var t=function(e){var t=/[\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,n={"\b":"\\b","	":"\\t","\n":"\\n","\f":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"};// eslint-disable-line no-control-regex
...
a+="    ",c=[],"[object Array]"===rC.apply(d)){for(i=0,// The value is an array. Stringify every element. Use null as a placeholder
// for non-JSON values.
...
for(o in d)rT.call(d,o)&&(s=n(o,d))&&c.push(t(o)+(a?": ":":")+s);return(// Join all of the member texts together, separated with commas,
 ...
 */rj.JSONDecode=(h={'"':'"',"\\":"\\","/":"/",b:"\b",f:"\f",n:"\n",r:"\r",t:"	"},m=function(e){var t=SyntaxError(e);throw t.at=c,t.text=f,t},v=function(e){return e&&e!==d&&m("Expected '"+e+"' instead of '"+d+"'"),// Get the next character. When there are no more characters,
// return the empty string.
d=f.charAt(c),c+=1,d},g=function(){// Parse a number value.
var e,t="";for("-"===d&&(t="-",v("-"));d>="0"&&d<="9";)t+=d,v();if("."===d)for(t+=".";v()&&d>="0"&&d<="9";)t+=d;if("e"===d||"E"===d)for(t+=d,v(),("-"===d||"+"===d)&&(t+=d,v());d>="0"&&d<="9";)t+=d,v();if(isFinite(e=+t))return e;m("Bad number")},y=function(){// Parse a string value.
var e,t,n,r="";// When parsing for string values, we must look for " and \ characters.
if('"'===d)for(;v();){if('"'===d)return v(),r;if("\\"===d){if(v(),"u"===d){for(t=0,n=0;t<4&&isFinite(e=parseInt(v(),16));t+=1)n=16*n+e;r+=String.fromCharCode(n)}else if("string"==typeof h[d])r+=h[d];else break}else r+=d}m("Bad string")},b=function(){// Skip whitespace.
for(;d&&d<=" ";)v()},w=function(){// true, false, or null.
switch(d){case"t":return v("t"),v("r"),v("u"),v("e"),!0;case"f":return v("f"),v("a"),v("l"),v("s"),v("e"),!1;case"n":return v("n"),v("u"),v("l"),v("l"),null}m('Unexpected "'+d+'"')},_=function(){// Parse an array value.
var e=[];if("["===d){if(v("["),b(),"]"===d)return v("]"),e;// empty array
for(;d;){if(e.push(p()),b(),"]"===d)return v("]"),e;v(","),b()}}m("Bad array")},k=function(){// Parse an object value.
var e,t={};if("{"===d){if(v("{"),b(),"}"===d)return v("}"),t;// empty object
for(;d;){if(e=y(),b(),v(":"),Object.hasOwnProperty.call(t,e)&&m('Duplicate key "'+e+'"'),t[e]=p(),b(),"}"===d)return v("}"),t;v(","),b()}}m("Bad object")},p=function(){switch(// Parse a JSON value. It could be an object, an array, a string,
// a number, or a word.
b(),d){case"{":return k();case"[":return _();case'"':return y();case"-":return g();default:return d>="0"&&d<="9"?g():w()}},function(e){var t;return f=e,c=0,d=" ",t=p(),b(),d&&m("Syntax error"),t}),rj.base64Encode=function(e){var t,n,r,a,i,o="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",s=0,l=0,u="",c=[];if(!e)return e;e=rj.utf8Encode(e);do t=(i=e.charCodeAt(s++)<<16|e.charCodeAt(s++)<<8|e.charCodeAt(s++))>>18&63,n=i>>12&63,r=i>>6&63,a=63&i,// use hexets to index into b64, and append result to encoded string
c[l++]=o.charAt(t)+o.charAt(n)+o.charAt(r)+o.charAt(a);while(s<e.length)switch(u=c.join(""),e.length%3){case 1:u=u.slice(0,-2)+"==";break;case 2:u=u.slice(0,-1)+"="}return u},rj.utf8Encode=function(e){e=(e+"").replace(/\r\n/g,"\n").replace(/\r/g,"\n");var t,n,r,a="",i=0;for(r=0,t=n=0,i=e.length;r<i;r++){var o=e.charCodeAt(r),s=null;o<128?n++:s=o>127&&o<2048?String.fromCharCode(o>>6|192,63&o|128):String.fromCharCode(o>>12|224,o>>6&63|128,63&o|128),null!==s&&(n>t&&(a+=e.substring(t,n)),a+=s,t=n=r+1)}return n>t&&(a+=e.substring(t,e.length)),a},rj.UUID=(x=function(){var e,t=1*new Date;// cross-browser version of Date.now()
...
e=0;t==1*new Date;)e++;return t.toString(16)+Math.floor(e).toString(16)},S=function(){var e,t,n=[],r=0;function a(e,t){var r,a=0;for(r=0;r<t.length;r++)a|=n[r]<<8*r;return e^a}for(e=0;e<rN.length;e++)t=rN.charCodeAt(e),n.unshift(255&t),n.length>=4&&(r=a(r,n),n=[]);return n.length>0&&(r=a(r,n)),r.toString(16)},function(){var e=(rD.height*rD.width).toString(16);return x()+"-"+Math.random().toString(16).replace(".","")+"-"+S()+"-"+e+"-"+x()});// _.isBlockedUA()
// This is to block various web spiders from executing our JS and
// sending false tracking data
var rW=["ahrefsbot","baiduspider","bingbot","bingpreview","facebookexternal","petalbot","pinterest","screaming frog","yahoo! slurp","yandexbot",// a whole bunch of goog-specific crawlers
// https://developers.google.com/search/docs/advanced/crawling/overview-google-crawlers
"adsbot-google","apis-google","duplexweb-google","feedfetcher-google","google favicon","google web preview","google-read-aloud","googlebot","googleweblight","mediapartners-google","storebot-google"];rj.isBlockedUA=function(e){var t;for(t=0,e=e.toLowerCase();t<rW.length;t++)if(-1!==e.indexOf(rW[t]))return!0;return!1},/**
 * @param {Object=} formdata
 * @param {string=} arg_separator
 */rj.HTTPBuildQuery=function(e,t){var n,r,a=[];return rj.isUndefined(t)&&(t="&"),rj.each(e,function(e,t){n=encodeURIComponent(e.toString()),r=encodeURIComponent(t),a[a.length]=r+"="+n}),a.join(t)},rj.getQueryParam=function(e,t){var n="[\\?&]"+// Expects a raw URL
(t=t.replace(/[[]/,"\\[").replace(/[\]]/,"\\]"))+"=([^&#]*)",r=new RegExp(n).exec(e);if(null===r||r&&"string"!=typeof r[1]&&r[1].length)return"";var a=r[1];try{a=decodeURIComponent(a)}catch(e){rq.error("Skipping decoding for malformed query param: "+a)}return a.replace(/\+/g," ")},// _.cookie
// Methods partially borrowed from quirksmode.org/js/cookies.html
rj.cookie={get:function(e){for(var t=e+"=",n=rP.cookie.split(";"),r=0;r<n.length;r++){for(var a=n[r];" "==a.charAt(0);)a=a.substring(1,a.length);if(0===a.indexOf(t))return decodeURIComponent(a.substring(t.length,a.length))}return null},parse:function(e){var t;try{t=rj.JSONDecode(rj.cookie.get(e))||{}}catch(e){// noop
}return t},set_seconds:function(e,t,n,r,a,i,o){var s="",l="",u="";if(o)s="; domain="+o;else if(r){var c=rZ(rP.location.hostname);s=c?"; domain=."+c:""}if(n){var d=new Date;d.setTime(d.getTime()+1e3*n),l="; expires="+d.toGMTString()}i&&(a=!0,u="; SameSite=None"),a&&(u+="; secure"),rP.cookie=e+"="+encodeURIComponent(t)+l+"; path=/"+s+u},set:function(e,t,n,r,a,i,o){var s="",l="",u="";if(o)s="; domain="+o;else if(r){var c=rZ(rP.location.hostname);s=c?"; domain=."+c:""}if(n){var d=new Date;d.setTime(d.getTime()+864e5*n),l="; expires="+d.toGMTString()}i&&(a=!0,u="; SameSite=None"),a&&(u+="; secure");var f=e+"="+encodeURIComponent(t)+l+"; path=/"+s+u;return rP.cookie=f,f},remove:function(e,t,n){rj.cookie.set(e,"",-1,t,!1,!1,n)}};var r$=null,rH=function(e,t){if(null!==r$&&!t)return r$;var n=!0;try{e=e||window.localStorage;var r="__mplss_"+rG(8);e.setItem(r,"xyz"),"xyz"!==e.getItem(r)&&(n=!1),e.removeItem(r)}catch(e){n=!1}return r$=n,n};// _.localStorage
rj.localStorage={is_supported:function(e){var t=rH(null,e);return t||rq.error("localStorage unsupported; falling back to cookie store"),t},error:function(e){rq.error("localStorage error: "+e)},get:function(e){try{return window.localStorage.getItem(e)}catch(e){rj.localStorage.error(e)}return null},parse:function(e){try{return rj.JSONDecode(rj.localStorage.get(e))||{}}catch(e){// noop
}return null},set:function(e,t){try{window.localStorage.setItem(e,t)}catch(e){rj.localStorage.error(e)}},remove:function(e){try{window.localStorage.removeItem(e)}catch(e){rj.localStorage.error(e)}}},rj.register_event=function(){function e(t){return t&&(t.preventDefault=e.preventDefault,t.stopPropagation=e.stopPropagation),t}return e.preventDefault=function(){this.returnValue=!1},e.stopPropagation=function(){this.cancelBubble=!0},function(t,n,r,a,i){if(!t){rq.error("No valid element provided to register_event");return}if(t.addEventListener&&!a)t.addEventListener(n,r,!!i);else{var o="on"+n,s=t[o];t[o]=function(n){// this basically happens in firefox whenever another script
// overwrites the onload callback and doesn't pass the event
// object to previously defined callbacks.  All the browsers
// that don't define window.event implement addEventListener
// so the dom_loaded handler will still be fired as usual.
if(n=n||e(window.event)){var a,i,o=!0;return rj.isFunction(s)&&(a=s(n)),i=r.call(t,n),(!1===a||!1===i)&&(o=!1),o}}}}}();var rY=RegExp('^(\\w*)\\[(\\w+)([=~\\|\\^\\$\\*]?)=?"?([^\\]"]*)"?\\]$');rj.dom_query=function(){/* document.getElementsBySelector(selector)
...
if(!rP.getElementsByTagName)return[];// Split selector in to tokens
var r=n.split(" "),a=[rP];for(h=0;h<r.length;h++){if((u=r[h].replace(/^\s+/,"").replace(/\s+$/,"")).indexOf("#")>-1){d=// Token is an ID selector
(c=u.split("#"))[0];var i=c[1],o=rP.getElementById(i);if(!o||d&&o.nodeName.toLowerCase()!=d)return[];// Set currentContext to contain just this element
...
f=[],p=0,m=0;m<a.length;m++)for(v=0,g="*"==d?e(a[m]):a[m].getElementsByTagName(d);v<g.length;v++)f[p++]=g[v];for(m=0,a=[],y=0;m<f.length;m++)f[m].className&&rj.isString(f[m].className)&&(" "+f[m].className+" ").replace(t," ").indexOf(" "+s+" ")>=0&&(a[y++]=f[m]);continue;// Skip to next token
}// Code to deal with attribute selectors
var l=u.match(rY);if(l){d=l[1];var u,c,d,f,p,h,m,v,g,y,b,w=l[2],_=l[3],k=l[4];for(d||(d="*"),// Grab all of the tagName elements within current context
...
d=u,f=[],p=0;m<a.length;m++)for(v=0,g=a[m].getElementsByTagName(d);v<g.length;v++)f[p++]=g[v];a=f}return a}return function(e){return rj.isElement(e)?[e]:rj.isObject(e)&&!rj.isUndefined(e.length)?e:n.call(this,e)}}();var rQ=["utm_source","utm_medium","utm_campaign","utm_content","utm_term"],rK=["dclid","fbclid","gclid","ko_click_id","li_fat_id","msclkid","ttclid","twclid","wbraid"];rj.info={campaignParams:function(e){var t="",n={};return rj.each(rQ,function(r){(t=rj.getQueryParam(rP.URL,r)).length?n[r]=t:void 0!==e&&(n[r]=e)}),n},clickParams:function(){var e="",t={};return rj.each(rK,function(n){(e=rj.getQueryParam(rP.URL,n)).length&&(t[n]=e)}),t},marketingParams:function(){return rj.extend(rj.info.campaignParams(),rj.info.clickParams())},searchEngine:function(e){return 0===e.search("https?://(.*)google.([^/?]*)")?"google":0===e.search("https?://(.*)bing.com")?"bing":0===e.search("https?://(.*)yahoo.com")?"yahoo":0===e.search("https?://(.*)duckduckgo.com")?"duckduckgo":null},searchInfo:function(e){var t=rj.info.searchEngine(e),n="yahoo"!=t?"q":"p",r={};if(null!==t){r.$search_engine=t;var a=rj.getQueryParam(e,n);a.length&&(r.mp_keyword=a)}return r},/**
     * This function detects which browser is running this script.
     * The order of the checks are important since many user agents
     * include key words used in later checks.
     */browser:function(e,t,n){if(t=t||"",n||rj.includes(e," OPR/"))return rj.includes(e,"Mini")?"Opera Mini":"Opera";if(/(BlackBerry|PlayBook|BB10)/i.test(e))return"BlackBerry";if(rj.includes(e,"IEMobile")||rj.includes(e,"WPDesktop"))return"Internet Explorer Mobile";if(rj.includes(e,"SamsungBrowser/"))return"Samsung Internet";if(rj.includes(e,"Edge")||rj.includes(e,"Edg/"))return"Microsoft Edge";if(rj.includes(e,"FBIOS"))return"Facebook Mobile";if(rj.includes(e,"Chrome"))return"Chrome";else if(rj.includes(e,"CriOS"))return"Chrome iOS";else if(rj.includes(e,"UCWEB")||rj.includes(e,"UCBrowser"))return"UC Browser";else if(rj.includes(e,"FxiOS"))return"Firefox iOS";else if(rj.includes(t,"Apple"))return rj.includes(e,"Mobile")?"Mobile Safari":"Safari";else if(rj.includes(e,"Android"))return"Android Mobile";else if(rj.includes(e,"Konqueror"))return"Konqueror";else if(rj.includes(e,"Firefox"))return"Firefox";else if(rj.includes(e,"MSIE")||rj.includes(e,"Trident/"))return"Internet Explorer";else if(rj.includes(e,"Gecko"))return"Mozilla";else return""},/**
     * This function detects which browser version is running this script,
     * parsing major and minor version (e.g., 42.1). User agent strings from:
     * http://www.useragentstring.com/pages/useragentstring.php
     */browserVersion:function(e,t,n){var r={"Internet Explorer Mobile":/rv:(\d+(\.\d+)?)/,"Microsoft Edge":/Edge?\/(\d+(\.\d+)?)/,Chrome:/Chrome\/(\d+(\.\d+)?)/,"Chrome iOS":/CriOS\/(\d+(\.\d+)?)/,"UC Browser":/(UCBrowser|UCWEB)\/(\d+(\.\d+)?)/,Safari:/Version\/(\d+(\.\d+)?)/,"Mobile Safari":/Version\/(\d+(\.\d+)?)/,Opera:/(Opera|OPR)\/(\d+(\.\d+)?)/,Firefox:/Firefox\/(\d+(\.\d+)?)/,"Firefox iOS":/FxiOS\/(\d+(\.\d+)?)/,Konqueror:/Konqueror:(\d+(\.\d+)?)/,BlackBerry:/BlackBerry (\d+(\.\d+)?)/,"Android Mobile":/android\s(\d+(\.\d+)?)/,"Samsung Internet":/SamsungBrowser\/(\d+(\.\d+)?)/,"Internet Explorer":/(rv:|MSIE )(\d+(\.\d+)?)/,Mozilla:/rv:(\d+(\.\d+)?)/}[rj.info.browser(e,t,n)];if(void 0===r)return null;var a=e.match(r);return a?parseFloat(a[a.length-2]):null},os:function(){if(/Windows/i.test(rN))return/Phone/.test(rN)||/WPDesktop/.test(rN)?"Windows Phone":"Windows";if(/(iPhone|iPad|iPod)/.test(rN))return"iOS";if(/Android/.test(rN))return"Android";if(/(BlackBerry|PlayBook|BB10)/i.test(rN))return"BlackBerry";if(/Mac/i.test(rN))return"Mac OS X";if(/Linux/.test(rN))return"Linux";if(/CrOS/.test(rN))return"Chrome OS";else return""},device:function(e){return/Windows Phone/i.test(e)||/WPDesktop/.test(e)?"Windows Phone":/iPad/.test(e)?"iPad":/iPod/.test(e)?"iPod Touch":/iPhone/.test(e)?"iPhone":/(BlackBerry|PlayBook|BB10)/i.test(e)?"BlackBerry":/Android/.test(e)?"Android":""},referringDomain:function(e){var t=e.split("/");return t.length>=3?t[2]:""},properties:function(){return rj.extend(rj.strip_empty_properties({$os:rj.info.os(),$browser:rj.info.browser(rN,rR.vendor,rI),$referrer:rP.referrer,$referring_domain:rj.info.referringDomain(rP.referrer),$device:rj.info.device(rN)}),{$current_url:E.location.href,$browser_version:rj.info.browserVersion(rN,rR.vendor,rI),$screen_height:rD.height,$screen_width:rD.width,mp_lib:"web",$lib_version:rw.LIB_VERSION,$insert_id:rG(),time:rj.timestamp()/1e3// epoch time in seconds
})},people_properties:function(){return rj.extend(rj.strip_empty_properties({$os:rj.info.os(),$browser:rj.info.browser(rN,rR.vendor,rI)}),{$browser_version:rj.info.browserVersion(rN,rR.vendor,rI)})},mpPageViewProperties:function(){return rj.strip_empty_properties({current_page_title:rP.title,current_domain:E.location.hostname,current_url_path:E.location.pathname,current_url_protocol:E.location.protocol,current_url_search:E.location.search})}};var rG=function(e){var t=Math.random().toString(36).substring(2,10)+Math.random().toString(36).substring(2,10);return e?t.substring(0,e):t},rX=/[a-z0-9][a-z0-9-]*\.[a-z]+$/i,rJ=/[a-z0-9][a-z0-9-]+\.[a-z.]{2,6}$/i,rZ=function(e){var t=rJ,n=e.split("."),r=n[n.length-1];(r.length>4||"com"===r||"org"===r)&&(t=rX);var a=e.match(t);return a?a[0]:""},r0=null,r1=null;"undefined"!=typeof JSON&&(r0=JSON.stringify,r1=JSON.parse),r0=r0||rj.JSONEncode,r1=r1||rj.JSONDecode,// EXPORTS (for closure compiler)
rj.toArray=rj.toArray,rj.isObject=rj.isObject,rj.JSONEncode=rj.JSONEncode,rj.JSONDecode=rj.JSONDecode,rj.isBlockedUA=rj.isBlockedUA,rj.isEmptyObject=rj.isEmptyObject,rj.info=rj.info,rj.info.device=rj.info.device,rj.info.browser=rj.info.browser,rj.info.browserVersion=rj.info.browserVersion,rj.info.properties=rj.info.properties;/**
 * DomTracker Object
 * @constructor
 */var r2=function(){};// interface
r2.prototype.create_properties=function(){},r2.prototype.event_handler=function(){},r2.prototype.after_track_handler=function(){},r2.prototype.init=function(e){return this.mp=e,this},/**
 * @param {Object|string} query
 * @param {string} event_name
 * @param {Object=} properties
 * @param {function=} user_callback
 */r2.prototype.track=function(e,t,n,r){var a=this,i=rj.dom_query(e);if(0===i.length){rq.error("The DOM query ("+e+") returned 0 elements");return}return rj.each(i,function(e){rj.register_event(e,this.override_event,function(e){var i={},o=a.create_properties(n,this),s=a.mp.get_config("track_links_timeout");a.event_handler(e,this,i),// in case the mixpanel servers don't get back to us in time
window.setTimeout(a.track_callback(r,o,i,!0),s),// fire the tracking event
a.mp.track(t,o,a.track_callback(r,o,i))})},this),!0},/**
 * @param {function} user_callback
 * @param {Object} props
 * @param {boolean=} timeout_occured
 */r2.prototype.track_callback=function(e,t,n,r){r=r||!1;var a=this;return function(){// options is referenced from both callbacks, so we can have
// a 'lock' of sorts to ensure only one fires
!n.callback_fired&&(n.callback_fired=!0,e&&!1===e(r,t)||a.after_track_handler(t,n,r))}},r2.prototype.create_properties=function(e,t){return"function"==typeof e?e(t):rj.extend({},e)};/**
 * LinkTracker Object
 * @constructor
 * @extends DomTracker
 */var r3=function(){this.override_event="click"};rj.inherit(r3,r2),r3.prototype.create_properties=function(e,t){var n=r3.superclass.create_properties.apply(this,arguments);return t.href&&(n.url=t.href),n},r3.prototype.event_handler=function(e,t,n){n.new_tab=2===e.which||e.metaKey||e.ctrlKey||"_blank"===t.target,n.href=t.href,n.new_tab||e.preventDefault()},r3.prototype.after_track_handler=function(e,t){t.new_tab||setTimeout(function(){window.location=t.href},0)};/**
 * FormTracker Object
 * @constructor
 * @extends DomTracker
 */var r5=function(){this.override_event="submit"};rj.inherit(r5,r2),r5.prototype.event_handler=function(e,t,n){n.element=t,e.preventDefault()},r5.prototype.after_track_handler=function(e,t){setTimeout(function(){t.element.submit()},0)};// eslint-disable-line camelcase
var r4=rV("lock"),r6=function(e,t){t=t||{},this.storageKey=e,this.storage=t.storage||window.localStorage,this.pollIntervalMS=t.pollIntervalMS||100,this.timeoutMS=t.timeoutMS||2e3};// pass in a specific pid to test contention scenarios; otherwise
// it is chosen randomly for each acquisition attempt
r6.prototype.withLock=function(e,t,n){n||"function"==typeof t||(n=t,t=null);var r=n||new Date().getTime()+"|"+Math.random(),a=new Date().getTime(),i=this.storageKey,o=this.pollIntervalMS,s=this.timeoutMS,l=this.storage,u=i+":X",c=i+":Y",d=i+":Z",f=function(e){t&&t(e)},p=function(e){if(new Date().getTime()-a>s){r4.error("Timeout waiting for mutex on "+i+"; clearing lock. ["+r+"]"),l.removeItem(d),l.removeItem(c),v();return}setTimeout(function(){try{e()}catch(e){f(e)}},o*(Math.random()+.1))},h=function(e,t){e()?t():p(function(){h(e,t)})},m=function(){var e=l.getItem(c);if(e&&e!==r)return!1;if(l.setItem(c,r),l.getItem(c)===r)return!0;if(!rH(l,!0))throw Error("localStorage support dropped while acquiring lock");return!1},v=function(){l.setItem(u,r),h(m,function(){if(l.getItem(u)===r){g();return}p(function(){if(l.getItem(c)!==r){v();return}h(function(){return!l.getItem(d)},g)})})},g=function(){l.setItem(d,"1");try{e()}finally{l.removeItem(d),l.getItem(c)===r&&l.removeItem(c),l.getItem(u)===r&&l.removeItem(u)}};try{if(rH(l,!0))v();else throw Error("localStorage support check failed")}catch(e){f(e)}};// eslint-disable-line camelcase
var r8=rV("batch"),r7=function(e,t){t=t||{},this.storageKey=e,this.storage=t.storage||window.localStorage,this.reportError=t.errorReporter||rj.bind(r8.error,r8),this.lock=new r6(e,{storage:this.storage}),this.pid=t.pid||null,this.memQueue=[]};/**
 ...
 */r7.prototype.enqueue=function(e,t,n){var r={id:rG(),flushAfter:new Date().getTime()+2*t,payload:e};this.lock.withLock(rj.bind(function(){var t;try{var a=this.readFromStorage();a.push(r),(t=this.saveToStorage(a))&&this.memQueue.push(r)}catch(n){this.reportError("Error enqueueing item",e),t=!1}n&&n(t)},this),rj.bind(function(e){this.reportError("Error acquiring storage lock",e),n&&n(!1)},this),this.pid)},/**
 * Read out the given number of queue entries. If this.memQueue
 * has fewer than batchSize items, then look for "orphaned" items
 * in the persisted queue (items where the 'flushAfter' time has
 * already passed).
 */r7.prototype.fillBatch=function(e){var t=this.memQueue.slice(0,e);if(t.length<e){// don't need lock just to read events; localStorage is thread-safe
...
rj.each(t,function(e){r[e.id]=!0});for(var a=0;a<n.length;a++){var i=n[a];if(new Date().getTime()>i.flushAfter&&!r[i.id]&&(i.orphaned=!0,t.push(i),t.length>=e))break}}}return t};/**
 * Remove items with matching 'id' from array (immutably)
 * also remove any item without a valid id (e.g., malformed
 * storage entries).
 */var r9=function(e,t){var n=[];return rj.each(e,function(e){e.id&&!t[e.id]&&n.push(e)}),n};/**
 * Remove items with matching IDs from both in-memory queue
 * and persisted queue
 */r7.prototype.removeItemsByID=function(e,t){var n={};// poor man's Set
rj.each(e,function(e){n[e]=!0}),this.memQueue=r9(this.memQueue,n);var r=rj.bind(function(){var t;try{var r=this.readFromStorage();// an extra check: did storage report success but somehow
// the items are still there?
if(r=r9(r,n),t=this.saveToStorage(r)){r=this.readFromStorage();for(var a=0;a<r.length;a++){var i=r[a];if(i.id&&n[i.id])return this.reportError("Item not removed from storage"),!1}}}catch(n){this.reportError("Error removing items",e),t=!1}return t},this);this.lock.withLock(function(){var e=r();t&&t(e)},rj.bind(function(e){var n=!1;if(this.reportError("Error acquiring storage lock",e),!rH(this.storage,!0)&&!// Looks like localStorage writes have stopped working sometime after
...
var ae=function(e,t){var n=[];return rj.each(e,function(e){var r=e.id;if(r in t){var a=t[r];null!==a&&(e.payload=a,n.push(e))}else n.push(e)}),n};/**
 * Update payloads of given items in both in-memory queue and
 * persisted queue. Items set to null are removed from queues.
 */r7.prototype.updatePayloads=function(e,t){this.memQueue=ae(this.memQueue,e),this.lock.withLock(rj.bind(function(){var n;try{var r=this.readFromStorage();r=ae(r,e),n=this.saveToStorage(r)}catch(t){this.reportError("Error updating items",e),n=!1}t&&t(n)},this),rj.bind(function(e){this.reportError("Error acquiring storage lock",e),t&&t(!1)},this),this.pid)},/**
 * Read and parse items array from localStorage entry, handling
 * malformed/missing data if necessary.
 */r7.prototype.readFromStorage=function(){var e;try{(e=this.storage.getItem(this.storageKey))&&(e=r1(e),rj.isArray(e)||(this.reportError("Invalid storage entry:",e),e=null))}catch(t){this.reportError("Error retrieving queue",t),e=null}return e||[]},/**
 * Serialize the given items array to localStorage.
 */r7.prototype.saveToStorage=function(e){try{return this.storage.setItem(this.storageKey,r0(e)),!0}catch(e){return this.reportError("Error saving queue",e),!1}},/**
 * Clear out queues (memory and localStorage).
 */r7.prototype.clear=function(){this.memQueue=[],this.storage.removeItem(this.storageKey)};var at=rV("batch"),an=function(e,t){this.errorReporter=t.errorReporter,this.queue=new r7(e,{errorReporter:rj.bind(this.reportError,this),storage:t.storage}),this.libConfig=t.libConfig,this.sendRequest=t.sendRequestFunc,this.beforeSendHook=t.beforeSendHook,this.stopAllBatching=t.stopAllBatchingFunc,// seed variable batch size + flush interval with configured values
 ...
 */function ai(e,t){return"1"===ap(e,t)}/**
 ...
 */function(e){if(e&&e.ignoreDnt)return!1;var t=e&&e.window||E,n=t.navigator||{},r=!1;return rj.each([n.doNotTrack,n.msDoNotTrack,t.doNotTrack],function(e){rj.includes([!0,1,"1","yes"],e)&&(r=!0)}),r}(t))return rq.warn('This browser has "Do Not Track" enabled. This will prevent the Mixpanel SDK from sending any data. To ignore the "Do Not Track" browser setting, initialize the Mixpanel instance with the config "ignore_dnt: true"'),!0;var n="0"===ap(e,t);return n&&rq.warn("You are opted out of Mixpanel tracking. This will prevent the Mixpanel SDK from sending any data."),n}/**
 * Wrap a MixpanelLib method with a check for whether the user is opted out of data tracking and cookies/localstorage for the given token
 * If the user has opted out, return early instead of executing the method.
 * If a callback argument was provided, execute it passing the 0 error code.
 * @param {function} method - wrapped method to be executed if the user has not opted out
 * @returns {*} the result of executing method OR undefined if the user has opted out
 */function as(e){return am(e,function(e){return this.get_config(e)})}/**
 * Wrap a MixpanelPeople method with a check for whether the user is opted out of data tracking and cookies/localstorage for the given token
 * If the user has opted out, return early instead of executing the method.
 * If a callback argument was provided, execute it passing the 0 error code.
 * @param {function} method - wrapped method to be executed if the user has not opted out
 * @returns {*} the result of executing method OR undefined if the user has opted out
 */function al(e){return am(e,function(e){return this._get_config(e)})}/**
 * Wrap a MixpanelGroup method with a check for whether the user is opted out of data tracking and cookies/localstorage for the given token
 * If the user has opted out, return early instead of executing the method.
 * If a callback argument was provided, execute it passing the 0 error code.
 * @param {function} method - wrapped method to be executed if the user has not opted out
 * @returns {*} the result of executing method OR undefined if the user has opted out
 */function au(e){return am(e,function(e){return this._get_config(e)})}/**
 ...
 * @param {boolean} [options.crossSubdomainCookie] - whether the opt-in cookie is set as cross-subdomain or not
 * @param {boolean} [options.secureCookie] - whether the opt-in cookie is set as secure or not
 */function ac(e,t){ad(t=t||{}).remove(af(e,t),!!t.crossSubdomainCookie,t.cookieDomain)}/** Private **//**
 * Get storage util
 * @param {Object} [options]
 * @param {string} [options.persistenceType]
 * @returns {object} either _.cookie or _.localstorage
 */function ad(e){return"localStorage"===(e=e||{}).persistenceType?rj.localStorage:rj.cookie}/**
 * Get the name of the cookie that is used for the given opt type (tracking, cookie, etc.)
 * @param {string} token - Mixpanel project tracking token
 * @param {Object} [options]
 * @param {string} [options.persistencePrefix=__mp_opt_in_out] - custom prefix to be used in the cookie/localstorage name
 * @returns {string} the name of the cookie for the given opt type
 */function af(e,t){return((t=t||{}).persistencePrefix||"__mp_opt_in_out_")+e}/**
 * Get the value of the cookie that is used for the given opt type (tracking, cookie, etc.)
 * @param {string} token - Mixpanel project tracking token
 * @param {Object} [options]
 * @param {string} [options.persistencePrefix=__mp_opt_in_out] - custom prefix to be used in the cookie/localstorage name
 * @returns {string} the value of the cookie for the given opt type
 */function ap(e,t){return ad(t).get(af(e,t))}/**
 ...
 * @param {boolean} [options.crossSubdomainCookie] - whether the opt-in cookie is set as cross-subdomain or not
 * @param {boolean} [options.secureCookie] - whether the opt-in cookie is set as secure or not
 */function ah(e,t,n){if(!rj.isString(t)||!t.length){rq.error("gdpr."+(e?"optIn":"optOut")+" called with an invalid token");return}ad(n=n||{}).set(af(t,n),e?1:0,rj.isNumber(n.cookieExpiration)?n.cookieExpiration:null,!!n.crossSubdomainCookie,!!n.secureCookie,!!n.crossSiteCookie,n.cookieDomain),n.track&&e&&n.track(n.trackEventName||"$opt_in",n.trackProperties,{send_immediately:!0})}/**
 ...
 * @returns {*} the result of executing method OR undefined if the user has opted out
 */function am(e,t){return function(){var n=!1;try{var r=t.call(this,"token"),a=t.call(this,"ignore_dnt"),i=t.call(this,"opt_out_tracking_persistence_type"),o=t.call(this,"opt_out_tracking_cookie_prefix"),s=t.call(this,"window");r&&(n=ao(r,{ignoreDnt:a,persistenceType:i,persistencePrefix:o,window:s}))}catch(e){rq.error("Unexpected error when checking tracking opt-out status: "+e)}if(!n)return e.apply(this,arguments);var l=arguments[arguments.length-1];"function"==typeof l&&l(0)}}/**
 * Add one item to queue.
 */an.prototype.enqueue=function(e,t){this.queue.enqueue(e,this.flushInterval,t)},/**
 * Start flushing batches at the configured time interval. Must call
 * this method upon SDK init in order to send anything over the network.
 */an.prototype.start=function(){this.stopped=!1,this.consecutiveRemovalFailures=0,this.flush()},/**
 * Stop flushing batches. Can be restarted by calling start().
 */an.prototype.stop=function(){this.stopped=!0,this.timeoutID&&(clearTimeout(this.timeoutID),this.timeoutID=null)},/**
 * Clear out queue.
 */an.prototype.clear=function(){this.queue.clear()},/**
 * Restore batch size configuration to whatever is set in the main SDK.
 */an.prototype.resetBatchSize=function(){this.batchSize=this.libConfig.batch_size},/**
 * Restore flush interval time configuration to whatever is set in the main SDK.
 */an.prototype.resetFlush=function(){this.scheduleFlush(this.libConfig.batch_flush_interval_ms)},/**
 * Schedule the next flush in the given number of milliseconds.
 */an.prototype.scheduleFlush=function(e){this.flushInterval=e,this.stopped||(this.timeoutID=setTimeout(rj.bind(this.flush,this),this.flushInterval))},/**
 ...
 */an.prototype.flush=function(e){try{if(this.requestInProgress){at.log("Flush: Request already in progress");return}e=e||{};var t=this.libConfig.batch_request_timeout_ms,n=new Date().getTime(),r=this.batchSize,a=this.queue.fillBatch(r),i=[],o={};if(rj.each(a,function(e){var t=e.payload;if(this.beforeSendHook&&!e.orphaned&&(t=this.beforeSendHook(t)),t){t.event&&t.properties&&(t.properties=rj.extend({},t.properties,{mp_sent_by_lib_version:rw.LIB_VERSION}));var n=!0,r=e.id;r?(this.itemIdsSentSuccessfully[r]||0)>5&&(this.reportError("[dupe] item ID sent too many times, not sending",{item:e,batchSize:a.length,timesSent:this.itemIdsSentSuccessfully[r]}),n=!1):this.reportError("[dupe] found item with no ID",{item:e}),n&&i.push(t)}o[e.id]=t},this),i.length<1){this.resetFlush();return;// nothing to do
}this.requestInProgress=!0;var s=rj.bind(function(i){this.requestInProgress=!1;try{// handle API response in a try-catch to make sure we can reset the
// flush operation if something goes wrong
var s=!1;if(e.unloading)this.queue.updatePayloads(o);else if(rj.isObject(i)&&"timeout"===i.error&&new Date().getTime()-n>=t)this.reportError("Network timeout; retrying"),this.flush();else if(rj.isObject(i)&&i.xhr_req&&(i.xhr_req.status>=500||429===i.xhr_req.status||"timeout"===i.error)){// network or API error, or 429 Too Many Requests, retry
var l=2*this.flushInterval,u=i.xhr_req.responseHeaders;if(u){var c=u["Retry-After"];c&&(l=1e3*parseInt(c,10)||l)}l=Math.min(6e5,l),this.reportError("Error; retry in "+l+" ms"),this.scheduleFlush(l)}else if(rj.isObject(i)&&i.xhr_req&&413===i.xhr_req.status){// 413 Payload Too Large
...
s=!0;s&&(this.queue.removeItemsByID(rj.map(a,function(e){return e.id}),rj.bind(function(e){e?(this.consecutiveRemovalFailures=0,this.flush()):(this.reportError("Failed to remove items from queue"),++this.consecutiveRemovalFailures>5?(this.reportError("Too many queue failures; disabling batching system."),this.stopAllBatching()):this.resetFlush())},this)),// client-side dedupe
rj.each(a,rj.bind(function(e){var t=e.id;t?(this.itemIdsSentSuccessfully[t]=this.itemIdsSentSuccessfully[t]||0,this.itemIdsSentSuccessfully[t]++,this.itemIdsSentSuccessfully[t]>5&&this.reportError("[dupe] item ID sent too many times",{item:e,batchSize:a.length,timesSent:this.itemIdsSentSuccessfully[t]})):this.reportError("[dupe] found item with no ID while removing",{item:e})},this)))}catch(e){this.reportError("Error handling API response",e),this.resetFlush()}},this),l={method:"POST",verbose:!0,ignore_json_errors:!0,timeout_ms:t// eslint-disable-line camelcase
};e.unloading&&(l.transport="sendBeacon"),at.log("MIXPANEL REQUEST:",i),this.sendRequest(i,l,s)}catch(e){this.reportError("Error flushing request queue",e),this.resetFlush()}},/**
 * Log error to global logger and optional user-defined logger.
 */an.prototype.reportError=function(e,t){if(at.error.apply(at.error,arguments),this.errorReporter)try{t instanceof Error||(t=Error(e)),this.errorReporter(e,t)}catch(e){at.error(e)}};/** @const */var av="$set",ag="$set_once",ay="$unset",ab="$add",aw="$append",a_="$union",ak="$remove",ax={set_action:function(e,t){var n={},r={};return rj.isObject(e)?rj.each(e,function(e,t){this._is_reserved_property(t)||(r[t]=e)},this):r[e]=t,n[av]=r,n},unset_action:function(e){var t={},n=[];return rj.isArray(e)||(e=[e]),rj.each(e,function(e){this._is_reserved_property(e)||n.push(e)},this),t[ay]=n,t},set_once_action:function(e,t){var n={},r={};return rj.isObject(e)?rj.each(e,function(e,t){this._is_reserved_property(t)||(r[t]=e)},this):r[e]=t,n[ag]=r,n},union_action:function(e,t){var n={},r={};return rj.isObject(e)?rj.each(e,function(e,t){this._is_reserved_property(t)||(r[t]=rj.isArray(e)?e:[e])},this):r[e]=rj.isArray(t)?t:[t],n[a_]=r,n},append_action:function(e,t){var n={},r={};return rj.isObject(e)?rj.each(e,function(e,t){this._is_reserved_property(t)||(r[t]=e)},this):r[e]=t,n[aw]=r,n},remove_action:function(e,t){var n={},r={};return rj.isObject(e)?rj.each(e,function(e,t){this._is_reserved_property(t)||(r[t]=e)},this):r[e]=t,n[ak]=r,n},delete_action:function(){var e={};return e.$delete="",e}},aS=function(){};rj.extend(aS.prototype,ax),aS.prototype._init=function(e,t,n){this._mixpanel=e,this._group_key=t,this._group_id=n},/**
 ...
 */aS.prototype.set=au(function(e,t,n){var r=this.set_action(e,t);return rj.isObject(e)&&(n=t),this._send_request(r,n)}),/**
 ...
 * @param {*} [to] A value to set on the given property name
 * @param {Function} [callback] If provided, the callback will be called after the tracking event
 */aS.prototype.set_once=au(function(e,t,n){var r=this.set_once_action(e,t);return rj.isObject(e)&&(n=t),this._send_request(r,n)}),/**
 ...
 * @param {Function} [callback] If provided, the callback will be called after the tracking event
 */aS.prototype.unset=au(function(e,t){var n=this.unset_action(e);return this._send_request(n,t)}),/**
 ...
 * @param {Function} [callback] If provided, the callback will be called after the tracking event
 */aS.prototype.union=au(function(e,t,n){rj.isObject(e)&&(n=t);var r=this.union_action(e,t);return this._send_request(r,n)}),/**
 ...
 *
 * @param {Function} [callback] If provided, the callback will be called after the tracking event
 */aS.prototype.delete=au(function(e){// bracket notation above prevents a minification error related to reserved words
 ...
 * @param {Function} [callback] If provided, the callback will be called after the tracking event
 */aS.prototype.remove=au(function(e,t,n){var r=this.remove_action(e,t);return this._send_request(r,n)}),aS.prototype._send_request=function(e,t){e.$group_key=this._group_key,e.$group_id=this._group_id,e.$token=this._get_config("token");var n=rj.encodeDates(e);return this._mixpanel._track_or_batch({type:"groups",data:n,endpoint:this._get_config("api_host")+"/groups/",batcher:this._mixpanel.request_batchers.groups},t)},aS.prototype._is_reserved_property=function(e){return"$group_key"===e||"$group_id"===e},aS.prototype._get_config=function(e){return this._mixpanel.get_config(e)},aS.prototype.toString=function(){return this._mixpanel.toString()+".group."+this._group_key+"."+this._group_id},// MixpanelGroup Exports
aS.prototype.remove=aS.prototype.remove,aS.prototype.set=aS.prototype.set,aS.prototype.set_once=aS.prototype.set_once,aS.prototype.union=aS.prototype.union,aS.prototype.unset=aS.prototype.unset,aS.prototype.toString=aS.prototype.toString;/**
 * Mixpanel People Object
 * @constructor
 */var aE=function(){};rj.extend(aE.prototype,ax),aE.prototype._init=function(e){this._mixpanel=e},/*
...
*/aE.prototype.set=al(function(e,t,n){var r=this.set_action(e,t);return rj.isObject(e)&&(n=t),this._get_config("save_referrer")&&this._mixpanel.persistence.update_referrer_info(document.referrer),// update $set object with default people properties
r[av]=rj.extend({},rj.info.people_properties(),this._mixpanel.persistence.get_referrer_info(),r[av]),this._send_request(r,n)}),/*
...
* @param {*} [to] A value to set on the given property name
* @param {Function} [callback] If provided, the callback will be called after tracking the event.
*/aE.prototype.set_once=al(function(e,t,n){var r=this.set_once_action(e,t);return rj.isObject(e)&&(n=t),this._send_request(r,n)}),/*
...
* @param {Function} [callback] If provided, the callback will be called after tracking the event.
*/aE.prototype.unset=al(function(e,t){var n=this.unset_action(e);return this._send_request(n,t)}),/*
...
* @param {Function} [callback] If provided, the callback will be called after tracking the event.
*/aE.prototype.increment=al(function(e,t,n){var r={},a={};return rj.isObject(e)?(rj.each(e,function(e,t){if(!this._is_reserved_property(t)){if(isNaN(parseFloat(e))){rq.error("Invalid increment value passed to mixpanel.people.increment - must be a number");return}a[t]=e}},this),n=t):(rj.isUndefined(t)&&(t=1),a[e]=t),r[ab]=a,this._send_request(r,n)}),/*
...
* @param {Function} [callback] If provided, the callback will be called after tracking the event.
*/aE.prototype.append=al(function(e,t,n){rj.isObject(e)&&(n=t);var r=this.append_action(e,t);return this._send_request(r,n)}),/*
...
* @param {Function} [callback] If provided, the callback will be called after tracking the event.
*/aE.prototype.remove=al(function(e,t,n){rj.isObject(e)&&(n=t);var r=this.remove_action(e,t);return this._send_request(r,n)}),/*
...
* @param {Function} [callback] If provided, the callback will be called after tracking the event.
*/aE.prototype.union=al(function(e,t,n){rj.isObject(e)&&(n=t);var r=this.union_action(e,t);return this._send_request(r,n)}),/*
 ...
 * @deprecated
 */aE.prototype.track_charge=al(function(e,t,n){if(!rj.isNumber(e)&&isNaN(e=parseFloat(e))){rq.error("Invalid value passed to mixpanel.people.track_charge - must be a number");return}return this.append("$transactions",rj.extend({$amount:e},t),n)}),/*
 ...
 * @param {Function} [callback] If provided, the callback will be called after tracking the event.
 * @deprecated
 */aE.prototype.clear_charges=function(e){return this.set("$transactions",[],e)},/*
...
*
*/aE.prototype.delete_user=function(){if(!this._identify_called()){rq.error("mixpanel.people.delete_user() requires you to call identify() first");return}var e={$delete:this._mixpanel.get_distinct_id()};return this._send_request(e)},aE.prototype.toString=function(){return this._mixpanel.toString()+".people"},aE.prototype._send_request=function(e,t){e.$token=this._get_config("token"),e.$distinct_id=this._mixpanel.get_distinct_id();var n=this._mixpanel.get_property("$device_id"),r=this._mixpanel.get_property("$user_id"),a=this._mixpanel.get_property("$had_persisted_distinct_id");n&&(e.$device_id=n),r&&(e.$user_id=r),a&&(e.$had_persisted_distinct_id=a);var i=rj.encodeDates(e);return this._identify_called()?this._mixpanel._track_or_batch({type:"people",data:i,endpoint:this._get_config("api_host")+"/engage/",batcher:this._mixpanel.request_batchers.people},t):(this._enqueue(e),rj.isUndefined(t)||t(this._get_config("verbose")?{status:-1,error:null}:-1),rj.truncate(i,255))},aE.prototype._get_config=function(e){return this._mixpanel.get_config(e)},aE.prototype._identify_called=function(){return!0===this._mixpanel._flags.identify_called},// Queue up engage operations if identify hasn't been called yet.
aE.prototype._enqueue=function(e){av in e?this._mixpanel.persistence._add_to_people_queue(av,e):ag in e?this._mixpanel.persistence._add_to_people_queue(ag,e):ay in e?this._mixpanel.persistence._add_to_people_queue(ay,e):ab in e?this._mixpanel.persistence._add_to_people_queue(ab,e):aw in e?this._mixpanel.persistence._add_to_people_queue(aw,e):ak in e?this._mixpanel.persistence._add_to_people_queue(ak,e):a_ in e?this._mixpanel.persistence._add_to_people_queue(a_,e):rq.error("Invalid call to _enqueue():",e)},aE.prototype._flush_one_queue=function(e,t,n,r){var a=this,i=rj.extend({},this._mixpanel.persistence._get_queue(e)),o=i;!rj.isUndefined(i)&&rj.isObject(i)&&!rj.isEmptyObject(i)&&(a._mixpanel.persistence._pop_from_people_queue(e,i),r&&(o=r(i)),t.call(a,o,function(t,r){0===t&&a._mixpanel.persistence._add_to_people_queue(e,i),rj.isUndefined(n)||n(t,r)}))},// Flush queued engage operations - order does not matter,
// and there are network level race conditions anyway
aE.prototype._flush=function(e,t,n,r,a,i,o){var s=this,l=this._mixpanel.persistence._get_queue(aw),u=this._mixpanel.persistence._get_queue(ak);// we have to fire off each $append individually since there is
// no concat method server side
if(this._flush_one_queue(av,this.set,e),this._flush_one_queue(ag,this.set_once,r),this._flush_one_queue(ay,this.unset,i,function(e){return rj.keys(e)}),this._flush_one_queue(ab,this.increment,t),this._flush_one_queue(a_,this.union,a),!rj.isUndefined(l)&&rj.isArray(l)&&l.length){for(var c,d=function(e,t){0===e&&s._mixpanel.persistence._add_to_people_queue(aw,c),rj.isUndefined(n)||n(e,t)},f=l.length-1;f>=0;f--)c=l.pop(),rj.isEmptyObject(c)||s.append(c,d);// Save the shortened append queue
s._mixpanel.persistence.save()}// same for $remove
if(!rj.isUndefined(u)&&rj.isArray(u)&&u.length){for(var p,h=function(e,t){0===e&&s._mixpanel.persistence._add_to_people_queue(ak,p),rj.isUndefined(o)||o(e,t)},m=u.length-1;m>=0;m--)p=u.pop(),rj.isEmptyObject(p)||s.remove(p,h);s._mixpanel.persistence.save()}},aE.prototype._is_reserved_property=function(e){return"$distinct_id"===e||"$token"===e||"$device_id"===e||"$user_id"===e||"$had_persisted_distinct_id"===e},// MixpanelPeople Exports
aE.prototype.set=aE.prototype.set,aE.prototype.set_once=aE.prototype.set_once,aE.prototype.unset=aE.prototype.unset,aE.prototype.increment=aE.prototype.increment,aE.prototype.append=aE.prototype.append,aE.prototype.remove=aE.prototype.remove,aE.prototype.union=aE.prototype.union,aE.prototype.track_charge=aE.prototype.track_charge,aE.prototype.clear_charges=aE.prototype.clear_charges,aE.prototype.delete_user=aE.prototype.delete_user,aE.prototype.toString=aE.prototype.toString;/*
 * Constants
 *//** @const */var aC="__mps",aT="__mpso",aO="__mpus",aR="__mpa",aP="__mpap",aI="__mpr",aD="__mpu",aN="$people_distinct_id",aL="__alias",aM="__timers",aA=[aC,aT,aO,aR,aP,aI,aD,aN,aL,aM],aU=function(e){this.props={},this.campaign_params_saved=!1,e.persistence_name?this.name="mp_"+e.persistence_name:this.name="mp_"+e.token+"_mixpanel";var t=e.persistence;"cookie"!==t&&"localStorage"!==t&&(rq.critical("Unknown persistence type "+t+"; falling back to cookie"),t=e.persistence="cookie"),"localStorage"===t&&rj.localStorage.is_supported()?this.storage=rj.localStorage:this.storage=rj.cookie,this.load(),this.update_config(e),this.upgrade(e),this.save()};aU.prototype.properties=function(){var e={};return(// Filter out reserved properties
rj.each(this.props,function(t,n){rj.include(aA,n)||(e[n]=t)}),e)},aU.prototype.load=function(){if(!this.disabled){var e=this.storage.parse(this.name);e&&(this.props=rj.extend({},e))}},aU.prototype.upgrade=function(e){var t,n,r=e.upgrade;r&&(t="mp_super_properties","string"==typeof r&&(t=r),n=this.storage.parse(t),// remove the cookie
this.storage.remove(t),this.storage.remove(t,!0),n&&(this.props=rj.extend(this.props,n.all,n.events))),!e.cookie_name&&"mixpanel"!==e.name&&(// special case to handle people with cookies of the form
...
this.register_once(n))),this.storage===rj.localStorage&&(n=rj.cookie.parse(this.name),rj.cookie.remove(this.name),rj.cookie.remove(this.name,!0),n&&this.register_once(n))},aU.prototype.save=function(){this.disabled||this.storage.set(this.name,rj.JSONEncode(this.props),this.expire_days,this.cross_subdomain,this.secure,this.cross_site,this.cookie_domain)},aU.prototype.remove=function(){// remove both domain and subdomain cookies
...
aU.prototype.clear=function(){this.remove(),this.props={}},/**
* @param {Object} props
* @param {*=} default_value
* @param {number=} days
*/aU.prototype.register_once=function(e,t,n){return!!rj.isObject(e)&&(void 0===t&&(t="None"),this.expire_days=void 0===n?this.default_expiry:n,rj.each(e,function(e,n){this.props.hasOwnProperty(n)&&this.props[n]!==t||(this.props[n]=e)},this),this.save(),!0)},/**
* @param {Object} props
* @param {number=} days
*/aU.prototype.register=function(e,t){return!!rj.isObject(e)&&(this.expire_days=void 0===t?this.default_expiry:t,rj.extend(this.props,e),this.save(),!0)},aU.prototype.unregister=function(e){e in this.props&&(delete this.props[e],this.save())},aU.prototype.update_search_keyword=function(e){this.register(rj.info.searchInfo(e))},// EXPORTED METHOD, we test this directly.
aU.prototype.update_referrer_info=function(e){// If referrer doesn't exist, we want to note the fact that it was type-in traffic.
this.register_once({$initial_referrer:e||"$direct",$initial_referring_domain:rj.info.referringDomain(e)||"$direct"},"")},aU.prototype.get_referrer_info=function(){return rj.strip_empty_properties({$initial_referrer:this.props.$initial_referrer,$initial_referring_domain:this.props.$initial_referring_domain})},// safely fills the passed in object with stored properties,
// does not override any properties defined in both
// returns the passed in object
aU.prototype.safe_merge=function(e){return rj.each(this.props,function(t,n){n in e||(e[n]=t)}),e},aU.prototype.update_config=function(e){this.default_expiry=this.expire_days=e.cookie_expiration,this.set_disabled(e.disable_persistence),this.set_cookie_domain(e.cookie_domain),this.set_cross_site(e.cross_site_cookie),this.set_cross_subdomain(e.cross_subdomain_cookie),this.set_secure(e.secure_cookie)},aU.prototype.set_disabled=function(e){this.disabled=e,this.disabled?this.remove():this.save()},aU.prototype.set_cookie_domain=function(e){e!==this.cookie_domain&&(this.remove(),this.cookie_domain=e,this.save())},aU.prototype.set_cross_site=function(e){e!==this.cross_site&&(this.cross_site=e,this.remove(),this.save())},aU.prototype.set_cross_subdomain=function(e){e!==this.cross_subdomain&&(this.cross_subdomain=e,this.remove(),this.save())},aU.prototype.get_cross_subdomain=function(){return this.cross_subdomain},aU.prototype.set_secure=function(e){e!==this.secure&&(this.secure=!!e,this.remove(),this.save())},aU.prototype._add_to_people_queue=function(e,t){var n=this._get_queue_key(e),r=t[e],a=this._get_or_create_queue(av),i=this._get_or_create_queue(ag),o=this._get_or_create_queue(ay),s=this._get_or_create_queue(ab),l=this._get_or_create_queue(a_),u=this._get_or_create_queue(ak,[]),c=this._get_or_create_queue(aw,[]);n===aC?(// Update the set queue - we can override any existing values
rj.extend(a,r),// if there was a pending increment, override it
// with the set.
this._pop_from_people_queue(ab,r),// if there was a pending union, override it
// with the set.
this._pop_from_people_queue(a_,r),this._pop_from_people_queue(ay,r)):n===aT?(// only queue the data if there is not already a set_once call for it.
rj.each(r,function(e,t){t in i||(i[t]=e)}),this._pop_from_people_queue(ay,r)):n===aO?rj.each(r,function(e){// undo previously-queued actions on this key
rj.each([a,i,s,l],function(t){e in t&&delete t[e]}),rj.each(c,function(t){e in t&&delete t[e]}),o[e]=!0}):n===aR?(rj.each(r,function(e,t){// If it exists in the set queue, increment
// the value
t in a?a[t]+=e:(t in s||(s[t]=0),s[t]+=e)},this),this._pop_from_people_queue(ay,r)):n===aD?(rj.each(r,function(e,t){rj.isArray(e)&&(t in l||(l[t]=[]),// We may send duplicates, the server will dedup them.
l[t]=l[t].concat(e))}),this._pop_from_people_queue(ay,r)):n===aI?(u.push(r),this._pop_from_people_queue(aw,r)):n===aP&&(c.push(r),this._pop_from_people_queue(ay,r)),rq.log("MIXPANEL PEOPLE REQUEST (QUEUED, PENDING IDENTIFY):"),rq.log(t),this.save()},aU.prototype._pop_from_people_queue=function(e,t){var n=this._get_queue(e);rj.isUndefined(n)||(rj.each(t,function(t,r){e===aw||e===ak?// e.g. remove should not override append in a case like
// append({foo: 'bar'}); remove({foo: 'qux'})
rj.each(n,function(e){e[r]===t&&delete e[r]}):delete n[r]},this),this.save())},aU.prototype._get_queue_key=function(e){return e===av?aC:e===ag?aT:e===ay?aO:e===ab?aR:e===aw?aP:e===ak?aI:e===a_?aD:void rq.error("Invalid queue:",e)},aU.prototype._get_queue=function(e){return this.props[this._get_queue_key(e)]},aU.prototype._get_or_create_queue=function(e,t){var n=this._get_queue_key(e);return t=rj.isUndefined(t)?{}:t,this.props[n]||(this.props[n]=t)},aU.prototype.set_event_timer=function(e,t){var n=this.props[aM]||{};n[e]=t,this.props[aM]=n,this.save()},aU.prototype.remove_event_timer=function(e){var t=(this.props[aM]||{})[e];return rj.isUndefined(t)||(delete this.props[aM][e],this.save()),t};var aF=function(e){return e},az=function(){},aj="mixpanel",aq="base64",aB="$device:",aV=E.XMLHttpRequest&&"withCredentials"in new XMLHttpRequest,aW=!aV&&-1===rN.indexOf("MSIE")&&-1===rN.indexOf("Mozilla"),a$=null;rR.sendBeacon&&(a$=function(){// late reference to navigator.sendBeacon to allow patching/spying
return rR.sendBeacon.apply(rR,arguments)});/*
 * Module-level globals
 */var aH={api_host:"https://api-js.mixpanel.com",api_method:"POST",api_transport:"XHR",api_payload_format:aq,app_host:"https://mixpanel.com",cdn:"https://cdn.mxpnl.com",cross_site_cookie:!1,cross_subdomain_cookie:!0,error_reporter:az,persistence:"cookie",persistence_name:"",cookie_domain:"",cookie_name:"",loaded:az,track_marketing:!0,track_pageview:!1,skip_first_touch_marketing:!1,store_google:!0,save_referrer:!0,test:!1,verbose:!1,img:!1,debug:!1,track_links_timeout:300,cookie_expiration:365,upgrade:!1,disable_persistence:!1,disable_cookie:!1,secure_cookie:!1,ip:!0,opt_out_tracking_by_default:!1,opt_out_persistence_by_default:!1,opt_out_tracking_persistence_type:"localStorage",opt_out_tracking_cookie_prefix:null,property_blacklist:[],xhr_headers:{},ignore_dnt:!1,batch_requests:!0,batch_size:50,batch_flush_interval_ms:5e3,batch_request_timeout_ms:9e4,batch_autostart:!0,hooks:{}},aY=!1,aQ=function(){},aK=function(e,t,n){var r,a=n===aj?T:T[n];if(a&&0===C)r=a;else{if(a&&!rj.isArray(a)){rq.error("You have already initialized "+n);return}r=new aQ}if(r._cached_groups={},r._init(e,t,n),r.people=new aE,r.people._init(r),!r.get_config("skip_first_touch_marketing")){// We need null UTM params in the object because
// UTM parameters act as a tuple. If any UTM param
// is present, then we set all UTM params including
// empty ones together
var i=rj.info.campaignParams(null),o={},s=!1;rj.each(i,function(e,t){o["initial_"+t]=e,e&&(s=!0)}),s&&r.people.set_once(o)}return(// if any instance on the page has debug = true, we set the
// global debug to be true
rw.DEBUG=rw.DEBUG||r.get_config("debug"),!rj.isUndefined(a)&&rj.isArray(a)&&(// Crunch through the people queue first - we queue this data up &
 ...
 */aQ.prototype.init=function(e,t,n){if(rj.isUndefined(n)){this.report_error("You must name your new library: init(token, config, name)");return}if(n===aj){this.report_error("You must initialize the main mixpanel object right after you include the Mixpanel js snippet");return}var r=aK(e,t,n);return T[n]=r,r._loaded(),r},// mixpanel._init(token:string, config:object, name:string)
//
...
//
aQ.prototype._init=function(e,t,n){t=t||{},this.__loaded=!0,this.config={};var r={};if(!("api_payload_format"in t)&&(t.api_host||aH.api_host).match(/\.mixpanel\.com/)&&(r.api_payload_format="json"),this.set_config(rj.extend({},aH,r,t,{name:n,token:e,callback_fn:(n===aj?n:aj+"."+n)+"._jsc"})),this._jsc=az,this.__dom_loaded_queue=[],this.__request_queue=[],this.__disabled_events=[],this._flags={disable_all_events:!1,identify_called:!1},// set up request queueing/batching
this.request_batchers={},this._batch_requests=this.get_config("batch_requests"),this._batch_requests){if(rj.localStorage.is_supported(!0)&&aV){if(this.init_batchers(),a$&&E.addEventListener){// Before page closes or hides (user tabs away etc), attempt to flush any events
...
var a=rj.bind(function(){this.request_batchers.events.stopped||this.request_batchers.events.flush({unloading:!0})},this);E.addEventListener("pagehide",function(e){e.persisted&&a()}),E.addEventListener("visibilitychange",function(){"hidden"===rP.visibilityState&&a()})}}else this._batch_requests=!1,rq.log("Turning off Mixpanel request-queueing; needs XHR and localStorage support")}this.persistence=this.cookie=new aU(this.config),this.unpersisted_superprops={},this._gdpr_init();var i=rj.UUID();this.get_distinct_id()||// or the device id if something was already stored
// in the persitence
this.register_once({distinct_id:aB+i,$device_id:i},""),this.get_config("track_pageview")&&this.track_pageview()},// Private methods
aQ.prototype._loaded=function(){this.get_config("loaded")(this),this._set_default_superprops()},// update persistence with info on referrer, UTM params, etc
aQ.prototype._set_default_superprops=function(){this.persistence.update_search_keyword(rP.referrer),this.get_config("store_google")&&this.register(rj.info.campaignParams(),{persistent:!1}),this.get_config("save_referrer")&&this.persistence.update_referrer_info(rP.referrer)},aQ.prototype._dom_loaded=function(){rj.each(this.__dom_loaded_queue,function(e){this._track_dom.apply(this,e)},this),this.has_opted_out_tracking()||rj.each(this.__request_queue,function(e){this._send_request.apply(this,e)},this),delete this.__dom_loaded_queue,delete this.__request_queue},aQ.prototype._track_dom=function(e,t){if(this.get_config("img"))return this.report_error("You can't use DOM tracking functions with img = true."),!1;if(!aY)return this.__dom_loaded_queue.push([e,t]),!1;var n=new e().init(this);return n.track.apply(n,t)},/**
 ...
 * callback GET param.
 */aQ.prototype._prepare_callback=function(e,t){if(rj.isUndefined(e))return null;if(aV)return function(n){e(n,t)};// if the user gives us a callback, we store as a random
// property on this instances jsc function and update our
// callback string to reflect that.
var n=this._jsc,r=""+Math.floor(1e8*Math.random()),a=this.get_config("callback_fn")+"["+r+"]";return n[r]=function(a){delete n[r],e(a,t)},a},aQ.prototype._send_request=function(e,t,n,r){var a=!0;if(aW)return this.__request_queue.push(arguments),a;var i={method:this.get_config("api_method"),transport:this.get_config("api_transport"),verbose:this.get_config("verbose")},o=null;!r&&(rj.isFunction(n)||"string"==typeof n)&&(r=n,n=null),n=rj.extend(i,n||{}),aV||(n.method="GET");var s="POST"===n.method,l=a$&&s&&"sendbeacon"===n.transport.toLowerCase(),u=n.verbose;t.verbose&&(u=!0),this.get_config("test")&&(t.test=1),u&&(t.verbose=1),this.get_config("img")&&(t.img=1),!aV&&(r?t.callback=r:(u||this.get_config("test"))&&// which by itself is not valid javascript. Without a callback, this verbose output will
// cause an error when returned via jsonp, so we force a no-op callback param.
// See the ECMA script spec: http://www.ecma-international.org/ecma-262/5.1/#sec-12.4
(t.callback="(function(){})")),t.ip=this.get_config("ip")?1:0,t._=new Date().getTime().toString(),s&&(o="data="+encodeURIComponent(t.data),delete t.data),e+="?"+rj.HTTPBuildQuery(t);var c=this;if("img"in t){var d=rP.createElement("img");d.src=e,rP.body.appendChild(d)}else if(l){try{a=a$(e,o)}catch(e){c.report_error(e),a=!1}try{r&&r(a?1:0)}catch(e){c.report_error(e)}}else if(aV)try{var f=new XMLHttpRequest;f.open(n.method,e,!0);var p=this.get_config("xhr_headers");if(s&&(p["Content-Type"]="application/x-www-form-urlencoded"),rj.each(p,function(e,t){f.setRequestHeader(t,e)}),n.timeout_ms&&void 0!==f.timeout){f.timeout=n.timeout_ms;var h=new Date().getTime()}// send the mp_optout cookie
// withCredentials cannot be modified until after calling .open on Android and Mobile Safari
f.withCredentials=!0,f.onreadystatechange=function(){if(4===f.readyState){var e,t;if(200===f.status){if(r){if(u){try{e=rj.JSONDecode(f.responseText)}catch(t){if(c.report_error(t),!n.ignore_json_errors)return;e=f.responseText}r(e)}else r(Number(f.responseText))}}else t=f.timeout&&!f.status&&new Date().getTime()-h>=f.timeout?"timeout":"Bad HTTP status: "+f.status+" "+f.statusText,c.report_error(t),r&&(u?r({status:0,error:t,xhr_req:f}):r(0))}},f.send(o)}catch(e){c.report_error(e),a=!1}else{var m=rP.createElement("script");m.type="text/javascript",m.async=!0,m.defer=!0,m.src=e;var v=rP.getElementsByTagName("script")[0];v.parentNode.insertBefore(m,v)}return a},/**
 ...
 *
 * @param {Array} array
 */aQ.prototype._execute_array=function(e){var t,n=[],r=[],a=[];rj.each(e,function(e){e&&(t=e[0],rj.isArray(t)?a.push(e):"function"==typeof e?e.call(this):rj.isArray(e)&&"alias"===t?n.push(e):rj.isArray(e)&&-1!==t.indexOf("track")&&"function"==typeof this[t]?a.push(e):r.push(e))},this);var i=function(e,t){rj.each(e,function(e){if(rj.isArray(e[0])){// chained call
var n=t;rj.each(e,function(e){n=n[e[0]].apply(n,e.slice(1))})}else this[e[0]].apply(this,e.slice(1))},t)};i(n,this),i(r,this),i(a,this)},// request queueing utils
aQ.prototype.are_batchers_initialized=function(){return!!this.request_batchers.events},aQ.prototype.init_batchers=function(){var e=this.get_config("token");if(!this.are_batchers_initialized()){var t=rj.bind(function(t){return new an("__mpq_"+e+t.queue_suffix,{libConfig:this.config,sendRequestFunc:rj.bind(function(e,n,r){this._send_request(this.get_config("api_host")+t.endpoint,this._encode_data_for_request(e),n,this._prepare_callback(r,e))},this),beforeSendHook:rj.bind(function(e){return this._run_hook("before_send_"+t.type,e)},this),errorReporter:this.get_config("error_reporter"),stopAllBatchingFunc:rj.bind(this.stop_batch_senders,this)})},this);this.request_batchers={events:t({type:"events",endpoint:"/track/",queue_suffix:"_ev"}),people:t({type:"people",endpoint:"/engage/",queue_suffix:"_pp"}),groups:t({type:"groups",endpoint:"/groups/",queue_suffix:"_gr"})}}this.get_config("batch_autostart")&&this.start_batch_senders()},aQ.prototype.start_batch_senders=function(){this.are_batchers_initialized()&&(this._batch_requests=!0,rj.each(this.request_batchers,function(e){e.start()}))},aQ.prototype.stop_batch_senders=function(){this._batch_requests=!1,rj.each(this.request_batchers,function(e){e.stop(),e.clear()})},/**
 ...
 */aQ.prototype.push=function(e){this._execute_array([e])},/**
 ...
 */aQ.prototype.disable=function(e){void 0===e?this._flags.disable_all_events=!0:this.__disabled_events=this.__disabled_events.concat(e)},aQ.prototype._encode_data_for_request=function(e){var t=rj.JSONEncode(e);return this.get_config("api_payload_format")===aq&&(t=rj.base64Encode(t)),{data:t}},// internal method for handling track vs batch-enqueue logic
aQ.prototype._track_or_batch=function(e,t){var n=rj.truncate(e.data,255),r=e.endpoint,a=e.batcher,i=e.should_send_immediately,o=e.send_request_options||{};t=t||az;var s=!0,l=rj.bind(function(){return(o.skip_hooks||(n=this._run_hook("before_send_"+e.type,n)),n)?(rq.log("MIXPANEL REQUEST:"),rq.log(n),this._send_request(r,this._encode_data_for_request(n),o,this._prepare_callback(t,n))):null},this);return this._batch_requests&&!i?a.enqueue(n,function(e){e?t(1,n):l()}):s=l(),s&&n},/**
 ...
 */aQ.prototype.track=as(function(e,t,n,r){r||"function"!=typeof n||(r=n,n=null);var a=(n=n||{}).transport;// external API, don't minify 'transport' prop
a&&(n.transport=a);var i=n.send_immediately;if("function"!=typeof r&&(r=az),rj.isUndefined(e)){this.report_error("No event name provided to mixpanel.track");return}if(this._event_is_disabled(e)){r(0);return}// set defaults
(t=t||{}).token=this.get_config("token");// set $duration if time_event was previously called for this event
var o=this.persistence.remove_event_timer(e);if(!rj.isUndefined(o)){var s=new Date().getTime()-o;t.$duration=parseFloat((s/1e3).toFixed(3))}this._set_default_superprops();var l=this.get_config("track_marketing")?rj.info.marketingParams():{};// note: extend writes to the first object, so lets make sure we
// don't write to the persistence properties object and info
// properties object by passing in a new object
// update properties with pageview info and super-properties
t=rj.extend({},rj.info.properties(),l,this.persistence.properties(),this.unpersisted_superprops,t);var u=this.get_config("property_blacklist");rj.isArray(u)?rj.each(u,function(e){delete t[e]}):this.report_error("Invalid value for property_blacklist config: "+u);var c={event:e,properties:t};return this._track_or_batch({type:"events",data:c,endpoint:this.get_config("api_host")+"/track/",batcher:this.request_batchers.events,should_send_immediately:i,send_request_options:n},r)}),/**
 ...
 * @param {Function} [callback] If provided, the callback will be called after tracking the event.
 *
 */aQ.prototype.set_group=as(function(e,t,n){rj.isArray(t)||(t=[t]);var r={};return r[e]=t,this.register(r),this.people.set(e,t,n)}),/**
 ...
 * @param {Function} [callback] If provided, the callback will be called after tracking the event.
 */aQ.prototype.add_group=as(function(e,t,n){var r=this.get_property(e);if(void 0===r){var a={};a[e]=[t],this.register(a)}else -1===r.indexOf(t)&&(r.push(t),this.register(a));return this.people.union(e,t,n)}),/**
 ...
 * @param {*} group_id A valid Mixpanel property type
 * @param {Function} [callback] If provided, the callback will be called after tracking the event.
 */aQ.prototype.remove_group=as(function(e,t,n){var r=this.get_property(e);// if the value doesn't exist, the persistent store is unchanged
 ...
 * @param {Function} [callback] If provided, the callback will be called after tracking the event.
 */aQ.prototype.track_with_groups=as(function(e,t,n,r){var a=rj.extend({},t||{});return rj.each(n,function(e,t){null!=e&&(a[t]=e)}),this.track(e,a,r)}),aQ.prototype._create_map_key=function(e,t){return e+"_"+JSON.stringify(t)},aQ.prototype._remove_group_from_cache=function(e,t){delete this._cached_groups[this._create_map_key(e,t)]},/**
 ...
 */aQ.prototype.get_group=function(e,t){var n=this._create_map_key(e,t),r=this._cached_groups[n];return(void 0===r||r._group_key!==e||r._group_id!==t)&&((r=new aS)._init(this,e,t),this._cached_groups[n]=r),r},/**
 ...
 * @returns {Boolean|Object} If the tracking request was successfully initiated/queued, an object
 * with the tracking payload sent to the API server is returned; otherwise false.
 */aQ.prototype.track_pageview=as(function(e,t){"object"!=typeof e&&(e={});var n=(t=t||{}).event_name||"$mp_web_page_view",r=rj.extend(rj.info.mpPageViewProperties(),rj.info.campaignParams(),rj.info.clickParams()),a=rj.extend({},r,e);return this.track(n,a)}),/**
 ...
 */aQ.prototype.track_links=function(){return this._track_dom.call(this,r3,arguments)},/**
 ...
 */aQ.prototype.track_forms=function(){return this._track_dom.call(this,r5,arguments)},/**
 ...
 */aQ.prototype.time_event=function(e){if(rj.isUndefined(e)){this.report_error("No event name provided to mixpanel.time_event");return}this._event_is_disabled(e)||this.persistence.set_event_timer(e,new Date().getTime())};var aG={persistent:!0},aX=function(e){var t;return t=rj.isObject(e)?e:rj.isUndefined(e)?{}:{days:e},rj.extend({},aG,t)};/**
 ...
 */aQ.prototype.register=function(e,t){var n=aX(t);n.persistent?this.persistence.register(e,n.days):rj.extend(this.unpersisted_superprops,e)},/**
 ...
 * @param {boolean} [days_or_options.days] - number of days since the user's last visit to store the super properties (only valid for persisted props)
 * @param {boolean} [days_or_options.persistent=true] - whether to put in persistent storage (cookie/localStorage)
 */aQ.prototype.register_once=function(e,t,n){var r=aX(n);r.persistent?this.persistence.register_once(e,t,r.days):(void 0===t&&(t="None"),rj.each(e,function(e,n){this.unpersisted_superprops.hasOwnProperty(n)&&this.unpersisted_superprops[n]!==t||(this.unpersisted_superprops[n]=e)},this))},/**
 * Delete a super property stored with the current user.
 *
 * @param {String} property The name of the super property to remove
 * @param {Object} [options]
 * @param {boolean} [options.persistent=true] - whether to look in persistent storage (cookie/localStorage)
 */aQ.prototype.unregister=function(e,t){(t=aX(t)).persistent?this.persistence.unregister(e):delete this.unpersisted_superprops[e]},aQ.prototype._register_single=function(e,t){var n={};n[e]=t,this.register(n)},/**
 ...
 */aQ.prototype.identify=function(e,t,n,r,a,i,o,s){// Optional Parameters
 ...
 */aQ.prototype.reset=function(){this.persistence.clear(),this._flags.identify_called=!1;var e=rj.UUID();this.register_once({distinct_id:aB+e,$device_id:e},"")},/**
 ...
 *         }
 *     });
 */aQ.prototype.get_distinct_id=function(){return this.get_property("distinct_id")},/**
 ...
 */aQ.prototype.alias=function(e,t){// If the $people_distinct_id key exists in persistence, there has been a previous
// mixpanel.people.identify() call made for this user. It is VERY BAD to make an alias with
// this ID, as it will duplicate users.
if(e===this.get_property(aN))return this.report_error("Attempting to create alias for existing People user - aborting."),-2;var n=this;return(rj.isUndefined(t)&&(t=this.get_distinct_id()),e!==t)?(this._register_single(aL,e),this.track("$create_alias",{alias:e,distinct_id:t},{skip_hooks:!0},function(){// Flush the people queue
 ...
 * @deprecated
 */aQ.prototype.name_tag=function(e){this._register_single("mp_name_tag",e)},/**
 ...
 */aQ.prototype.set_config=function(e){rj.isObject(e)&&(rj.extend(this.config,e),e.batch_size&&rj.each(this.request_batchers,function(e){e.resetBatchSize()}),this.get_config("persistence_name")||(this.config.persistence_name=this.config.cookie_name),this.get_config("disable_persistence")||(this.config.disable_persistence=this.config.disable_cookie),this.persistence&&this.persistence.update_config(this.config),rw.DEBUG=rw.DEBUG||this.get_config("debug"))},/**
 * returns the current config object for the library.
 */aQ.prototype.get_config=function(e){return this.config[e]},/**
 * Fetch a hook function from config, with safe default, and run it
 * against the given arguments
 * @param {string} hook_name which hook to retrieve
 * @returns {any|null} return value of user-provided hook, or null if nothing was returned
 */aQ.prototype._run_hook=function(e){var t=(this.config.hooks[e]||aF).apply(this,rE.call(arguments,1));return void 0===t&&(this.report_error(e+" hook did not return a value"),t=null),t},/**
 ...
 */aQ.prototype.get_property=function(e){return this.persistence.props[e]},aQ.prototype.toString=function(){var e=this.get_config("name");return e!==aj&&(e=aj+"."+e),e},aQ.prototype._event_is_disabled=function(e){return rj.isBlockedUA(rN)||this._flags.disable_all_events||rj.include(this.__disabled_events,e)},// perform some housekeeping around GDPR opt-in/out state
aQ.prototype._gdpr_init=function(){"localStorage"===this.get_config("opt_out_tracking_persistence_type")&&rj.localStorage.is_supported()&&(!this.has_opted_in_tracking()&&this.has_opted_in_tracking({persistence_type:"cookie"})&&this.opt_in_tracking({enable_persistence:!1}),!this.has_opted_out_tracking()&&this.has_opted_out_tracking({persistence_type:"cookie"})&&this.opt_out_tracking({clear_persistence:!1}),this.clear_opt_in_out_tracking({persistence_type:"cookie",enable_persistence:!1})),this.has_opted_out_tracking()?this._gdpr_update_persistence({clear_persistence:!0}):!this.has_opted_in_tracking()&&(this.get_config("opt_out_tracking_by_default")||rj.cookie.get("mp_optout"))&&(rj.cookie.remove("mp_optout"),this.opt_out_tracking({clear_persistence:this.get_config("opt_out_persistence_by_default")}))},/**
 * Enable or disable persistence based on options
 * only enable/disable if persistence is not already in this state
 * @param {boolean} [options.clear_persistence] If true, will delete all data stored by the sdk in persistence and disable it
 * @param {boolean} [options.enable_persistence] If true, will re-enable sdk persistence
 */aQ.prototype._gdpr_update_persistence=function(e){var t;if(e&&e.clear_persistence)t=!0;else{if(!e||!e.enable_persistence)return;t=!1}this.get_config("disable_persistence")||this.persistence.disabled===t||this.persistence.set_disabled(t),t&&rj.each(this.request_batchers,function(e){e.clear()})},// call a base gdpr function after constructing the appropriate token and options args
aQ.prototype._gdpr_call_func=function(e,t){return t=rj.extend({track:rj.bind(this.track,this),persistence_type:this.get_config("opt_out_tracking_persistence_type"),cookie_prefix:this.get_config("opt_out_tracking_cookie_prefix"),cookie_expiration:this.get_config("cookie_expiration"),cross_site_cookie:this.get_config("cross_site_cookie"),cross_subdomain_cookie:this.get_config("cross_subdomain_cookie"),cookie_domain:this.get_config("cookie_domain"),secure_cookie:this.get_config("secure_cookie"),ignore_dnt:this.get_config("ignore_dnt")},t),rj.localStorage.is_supported()||(t.persistence_type="cookie"),e(this.get_config("token"),{track:t.track,trackEventName:t.track_event_name,trackProperties:t.track_properties,persistenceType:t.persistence_type,persistencePrefix:t.cookie_prefix,cookieDomain:t.cookie_domain,cookieExpiration:t.cookie_expiration,crossSiteCookie:t.cross_site_cookie,crossSubdomainCookie:t.cross_subdomain_cookie,secureCookie:t.secure_cookie,ignoreDnt:t.ignore_dnt})},/**
 ...
 */aQ.prototype.opt_in_tracking=function(e){e=rj.extend({enable_persistence:!0},e),this._gdpr_call_func(ar,e),this._gdpr_update_persistence(e)},/**
 ...
 * @param {boolean} [options.cross_subdomain_cookie] Whether the opt-in cookie is set as cross-subdomain or not (overrides value specified in this Mixpanel instance's config)
 * @param {boolean} [options.secure_cookie] Whether the opt-in cookie is set as secure or not (overrides value specified in this Mixpanel instance's config)
 */aQ.prototype.opt_out_tracking=function(e){(e=rj.extend({clear_persistence:!0,delete_user:!0},e)).delete_user&&this.people&&this.people._identify_called()&&(this.people.delete_user(),this.people.clear_charges()),this._gdpr_call_func(aa,e),this._gdpr_update_persistence(e)},/**
 ...
 */aQ.prototype.has_opted_in_tracking=function(e){return this._gdpr_call_func(ai,e)},/**
 ...
 */aQ.prototype.has_opted_out_tracking=function(e){return this._gdpr_call_func(ao,e)},/**
 ...
 * @param {boolean} [options.cross_subdomain_cookie] Whether the opt-in cookie is set as cross-subdomain or not (overrides value specified in this Mixpanel instance's config)
 * @param {boolean} [options.secure_cookie] Whether the opt-in cookie is set as secure or not (overrides value specified in this Mixpanel instance's config)
 */aQ.prototype.clear_opt_in_out_tracking=function(e){e=rj.extend({enable_persistence:!0},e),this._gdpr_call_func(ac,e),this._gdpr_update_persistence(e)},aQ.prototype.report_error=function(e,t){rq.error.apply(rq.error,arguments);try{t||e instanceof Error||(e=Error(e)),this.get_config("error_reporter")(e,t)}catch(e){rq.error(e)}},// EXPORTS (for closure compiler)
// MixpanelLib Exports
aQ.prototype.init=aQ.prototype.init,aQ.prototype.reset=aQ.prototype.reset,aQ.prototype.disable=aQ.prototype.disable,aQ.prototype.time_event=aQ.prototype.time_event,aQ.prototype.track=aQ.prototype.track,aQ.prototype.track_links=aQ.prototype.track_links,aQ.prototype.track_forms=aQ.prototype.track_forms,aQ.prototype.track_pageview=aQ.prototype.track_pageview,aQ.prototype.register=aQ.prototype.register,aQ.prototype.register_once=aQ.prototype.register_once,aQ.prototype.unregister=aQ.prototype.unregister,aQ.prototype.identify=aQ.prototype.identify,aQ.prototype.alias=aQ.prototype.alias,aQ.prototype.name_tag=aQ.prototype.name_tag,aQ.prototype.set_config=aQ.prototype.set_config,aQ.prototype.get_config=aQ.prototype.get_config,aQ.prototype.get_property=aQ.prototype.get_property,aQ.prototype.get_distinct_id=aQ.prototype.get_distinct_id,aQ.prototype.toString=aQ.prototype.toString,aQ.prototype.opt_out_tracking=aQ.prototype.opt_out_tracking,aQ.prototype.opt_in_tracking=aQ.prototype.opt_in_tracking,aQ.prototype.has_opted_out_tracking=aQ.prototype.has_opted_out_tracking,aQ.prototype.has_opted_in_tracking=aQ.prototype.has_opted_in_tracking,aQ.prototype.clear_opt_in_out_tracking=aQ.prototype.clear_opt_in_out_tracking,aQ.prototype.get_group=aQ.prototype.get_group,aQ.prototype.set_group=aQ.prototype.set_group,aQ.prototype.add_group=aQ.prototype.add_group,aQ.prototype.remove_group=aQ.prototype.remove_group,aQ.prototype.track_with_groups=aQ.prototype.track_with_groups,aQ.prototype.start_batch_senders=aQ.prototype.start_batch_senders,aQ.prototype.stop_batch_senders=aQ.prototype.stop_batch_senders,// MixpanelPersistence Exports
aU.prototype.properties=aU.prototype.properties,aU.prototype.update_search_keyword=aU.prototype.update_search_keyword,aU.prototype.update_referrer_info=aU.prototype.update_referrer_info,aU.prototype.get_cross_subdomain=aU.prototype.get_cross_subdomain,aU.prototype.clear=aU.prototype.clear;var aJ={},aZ=function(){// add all the sub mixpanel instances
rj.each(aJ,function(e,t){t!==aj&&(T[t]=e)}),// add private functions as _
T._=rj};C=0,// we override the snippets init function to handle the case where a
// user initializes the mixpanel library after the script loads & runs
(T=new aQ).init=function(e,t,n){if(n)return T[n]||(T[n]=aJ[n]=aK(e,t,n),T[n]._loaded()),T[n];var r=T;aJ[aj]?r=aJ[aj]:e&&(// intialize the main mixpanel lib
(r=aK(e,t,aj))._loaded(),aJ[aj]=r),T=r,1===C&&(E[aj]=T),aZ()},T.init(),function(){// Cross browser DOM Loaded support
function e(){// function flag since we only want to execute this once
e.done||(e.done=!0,aY=!0,aW=!1,rj.each(aJ,function(e){e._dom_loaded()}))}if(rP.addEventListener)"complete"===rP.readyState?// external JS (including this file). you will see some copypasta
// on the internet that checks for 'complete' and 'loaded', but
// 'loaded' is an IE thing
e():rP.addEventListener("DOMContentLoaded",e,!1);else if(rP.attachEvent){// IE
rP.attachEvent("onreadystatechange",e);// check to make sure we arn't in a frame
var t=!1;try{t=null===E.frameElement}catch(e){// noop
}rP.documentElement.doScroll&&t&&function t(){try{rP.documentElement.doScroll("left")}catch(e){setTimeout(t,1);return}e()}()}// fallback handler, always will work
rj.register_event(E,"load",e,!0)}(),rb=T;let a0=e=>{/*@__PURE__*/r(rb).init("d122fa924e1ea97d6b98569440c65a95",{debug:e.debug,track_pageview:!0,persistence:"localStorage"})},a1=(e,t,n)=>/*@__PURE__*/r(rb).track(e,t,n),a2=({children:e})=>{let{appId:t}=re(),{visitor:n}=ry(),{log:a}=n7();return(0,D.useEffect)(()=>{t&&n.id&&(a("MixpanelProvider: booting"),a0({debug:!0}),a("MixpanelProvider: registering visitor "+n.id+" to mixpanel"),/*@__PURE__*/r(rb).identify(n.id))},[t,n?.id]),/*@__PURE__*/r(D).createElement(a3.Provider,{value:{trackEvent:a1}},e)},a3=/*#__PURE__*/(0,D.createContext)({trackEvent:()=>{}}),a5=()=>(0,D.useContext)(a3),a4=({children:e,handlers:t})=>{let{log:n,error:a}=n7(),{appId:i,booted:o,initialDelay:s,exitIntentTriggers:l,idleTriggers:u}=re(),{visitor:c}=ry(),{trackEvent:d}=a5(),{mutateAsync:f}=n9(),{registerHandler:p}=function(e={}){let t=nZ(nJ({},nW),{cookie:nJ(nJ({},nW.cookie),e?.cookie),desktop:nJ(nJ({},nW.desktop),e?.desktop),mobile:nJ(nJ({},nW.mobile),e?.mobile)}),[n,r]=(0,D.useState)(t),[a,i]=(0,D.useState)(!1),[o,s]=(0,D.useState)(!1),l=(0,D.useRef)([]).current,u=(0,D.useRef)(!1),{mobile:c,desktop:d,cookie:f}=n;u.current=o||a;let p=(0,D.useCallback)(()=>{u.current||(i(!0),l.filter(e=>{var t,n;return(null==(t=e.context)?void 0:t.filter(e=>e!==nV.onDesktop&&e!==nV.onMobile).length)===0||(null==(n=e.context)?void 0:n.includes(nV.onTrigger))}).forEach(nz))},[]),h=(0,D.useCallback)(()=>{nM.set(f.key,"true",{expires:f.daysToExpire,sameSite:"Strict"}),l.filter(e=>{var t;return null==(t=e.context)?void 0:t.includes(nV.onUnsubscribe)}).forEach(nz),s(!0)},[f?.key]),m=(0,D.useCallback)(()=>{nM.remove(f?.key,{sameSite:"Strict"}),window.onbeforeunload=null,i(!1),s(!1)},[f?.key]),v=(0,D.useCallback)(()=>{m(),r(t)},[]),g=(0,D.useCallback)(e=>{let t=l.find(t=>t.id===e.id),n=nZ(nJ({},e),{context:e?.context||[]});if(t){l[l.indexOf(t)]=n;return}l.push(n)},[]),y=(0,D.useCallback)((e=nW)=>{m(),r(t=>nZ(nJ(nJ({},t||{}),e||{}),{cookie:nJ(nJ({},t?.cookie||{}),e?.cookie||{}),desktop:nJ(nJ({},t?.desktop||{}),e?.desktop||{}),mobile:nJ(nJ({},t?.mobile||{}),e?.mobile||{})}))},[n]);return(0,D.useEffect)(()=>{s("true"===nM.get(f.key))},[]),(0,D.useEffect)(()=>{if(nU()){let{execute:e,abort:t}=nB(p,1e3*c?.delayInSecondsToTrigger);if(u.current){nq(e);return}return nU()&&c?.triggerOnIdle&&(nq(e),nj(e)),()=>{t(),nq(e)}}if(nF()){let{execute:e,abort:t}=nB(p,1e3*d?.delayInSecondsToTrigger);return null!=d&&d.triggerOnIdle&&nj(e),null!=d&&d.triggerOnMouseLeave&&document.body.addEventListener("mouseleave",p),null!=d&&d.useBeforeUnload&&(window.onbeforeunload=()=>{if(!u.current)return p(),""}),()=>{t(),nq(e),document.body.removeEventListener("mouseleave",p)}}}),{settings:n,resetState:m,isTriggered:a,unsubscribe:h,resetSettings:v,updateSettings:y,isUnsubscribed:o,registerHandler:g,willBeTriggered:!(o||a)}}({cookie:{key:"_cm_exit",daysToExpire:0}}),[h,m]=(0,D.useState)(5e3),[v,g]=(0,D.useState)([]),[y,b]=(0,D.useState)(void 0),[w,_]=(0,D.useState)(null),[k,x]=(0,D.useState)(!1);n("CollectorProvider: user is on mobile?",e_.isMobile),// Removes the intently overlay, if intently is false
...
let i=t?.find(e=>e.behaviour===r.behaviour);if(n("CollectorProvider: attempting to show trigger",r,i),!i)return a("No handler found for trigger",r),null;if(!i.invoke||(d("trigger_displayed",{triggerId:r.id,triggerType:r.invocation,triggerBehaviour:r.behaviour}),!i.invoke))return a("No invoke method found for handler",i),null;if(i.delay){let e=setTimeout(()=>i.invoke?.(r),i.delay);return _(e),null}return i.invoke(r)},E=(0,D.useCallback)(()=>{!y&&u&&(n("CollectorProvider: attempting to fire idle trigger"),b("INVOCATION_IDLE_TIME"))},[v,y]),C=(0,D.useCallback)(()=>{n("CollectorProvider: attempting to fire exit trigger"),b("INVOCATION_EXIT_INTENT")},[]);(0,D.useEffect)(()=>{l&&(e_.isMobile||(n("CollectorProvider: attempting to register exit trigger"),p({id:"clientTrigger",handler:C})))},[]);let T=(0,D.useCallback)(()=>{n("CollectorProvider: resetting displayTrigger"),b(void 0)},[]);// @todo this should be invoked when booted
...
m(5e3),g(t?.pageTriggers?.filter(e=>e_.isMobile&&"INVOCATION_IDLE_TIME"===e.invocation||!e_.isMobile&&"INVOCATION_EXIT_INTENT"===e.invocation)||[]),t.intently?(// show intently overlay here
n("CollectorProvider: user is in Intently cohort"),x(!0),d("user_cohort",{cohort:"intently"})):(// remove intently overlay here
n("CollectorProvider: user is in Fingerprint cohort"),x(!1),d("user_cohort",{cohort:"fingerprint"}))}).catch(e=>{a("failed to store collected data",e)}),n("CollectorProvider: collected data")},s);return()=>{clearTimeout(e)}},[o,c]),(0,D.useEffect)(()=>{if(w)return()=>clearTimeout(w)},[w]);let O=/*@__PURE__*/r(D).useMemo(()=>S(y),[S,y]);return /*@__PURE__*/r(D).createElement(nN,{timeout:h,onPresenceChange:e=>{"active"===e.type&&(// clear interval regardless a value is present or not.
// @ts-ignore
clearTimeout(w),_(null)),n("presence changed",e)},onIdle:E},/*@__PURE__*/r(D).createElement(a6.Provider,{value:{resetDisplayTrigger:T,setTrigger:e=>{n("CollectorProvider: manually setting trigger",e),g([...v,e]),b(e.invocation)},trackEvent:d}},e,O))},a6=/*#__PURE__*/(0,D.createContext)({resetDisplayTrigger:()=>{},setTrigger:()=>{},trackEvent:()=>{}}),a8=()=>(0,D.useContext)(a6),a7=({trigger:e})=>{let{resetDisplayTrigger:t}=a8(),[n,a]=(0,D.useState)(!0),[i,o]=(0,D.useState)(!1),s=()=>{t(),a(!1)};return((0,D.useEffect)(()=>{let e=`
  @charset "UTF-8";
...
t.length>1&&this.logger.error("[QueryClient] Several mutation defaults match with key '"+JSON.stringify(e)+"'. The first matching mutation defaults are used. Please check how mutation defaults are registered. Order does matter here. cf. https://react-query.tanstack.com/reference/QueryClient#queryclientsetmutationdefaults.")}return null==t?void 0:t.defaultOptions}defaultQueryOptions(e){if(null!=e&&e._defaulted)return e;let t={...this.defaultOptions.queries,...this.getQueryDefaults(null==e?void 0:e.queryKey),...e,_defaulted:!0};return!t.queryHash&&t.queryKey&&(t.queryHash=j(t.queryKey,t)),void 0===t.refetchOnReconnect&&(t.refetchOnReconnect="always"!==t.networkMode),void 0===t.useErrorBoundary&&(t.useErrorBoundary=!!t.suspense),t}defaultMutationOptions(e){return null!=e&&e._defaulted?e:{...this.defaultOptions.mutations,...this.getMutationDefaults(null==e?void 0:e.mutationKey),...e,_defaulted:!0}}clear(){this.queryCache.clear(),this.mutationCache.clear()}},od=({appId:e,children:t,consent:n=!1,consentCallback:a,debug:i,defaultHandlers:o,initialDelay:s=0,exitIntentTriggers:l=!0,idleTriggers:u=!0})=>{let[c,d]=(0,D.useState)(n),[f,p]=(0,D.useState)(!1),[h,m]=(0,D.useState)(o||ou),v=/*@__PURE__*/r(D).useCallback(e=>{m(t=>[...t,e])},[m]);return(/**
   ...
   */(0,D.useEffect)(()=>{if(n){d(n);return}if(console.log("Fingerprint Widget Consent: ",n),!a)return;let e=a(),t=setInterval(()=>{d(n)},1e3);// clear on onmount
