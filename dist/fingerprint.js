...
isBatchingLegacy:!1,didScheduleLegacyUpdate:!1},L={/**
   * @internal
   * @type {ReactComponent}
   */current:null},N={},A=null;N.setExtraStackFrame=function(e){A=e},N.getCurrentStack=null,N.getStackAddendum=function(){var e="";// Add an extra top frame while an element is being validated
A&&(e+=A);// Delegate to the injected renderer-specific implementation
var t=N.getCurrentStack;return t&&(e+=t()||""),e};var U={ReactCurrentDispatcher:I,ReactCurrentBatchConfig:D,ReactCurrentOwner:L};// by calls to these methods by a Babel plugin.
//
// In PROD (or in packages without access to React internals),
// they are left as they are instead.
function F(e){for(var t=arguments.length,n=Array(t>1?t-1:0),r=1;r<t;r++)n[r-1]=arguments[r];z("warn",e,n)}function j(e){for(var t=arguments.length,n=Array(t>1?t-1:0),r=1;r<t;r++)n[r-1]=arguments[r];z("error",e,n)}function z(e,t,n){var r=U.ReactDebugCurrentFrame.getStackAddendum();""!==r&&(t+="%s",n=n.concat([r]));var o=n.map(function(e){return String(e)});// Careful: RN currently depends on this prefix
o.unshift("Warning: "+t),// breaks IE9: https://github.com/facebook/react/issues/13610
// eslint-disable-next-line react-internal/no-production-logging
Function.prototype.apply.call(console[e],console,o)}U.ReactDebugCurrentFrame=N,U.ReactCurrentActQueue=M;var q={};function B(e,t){var n=e.constructor,r=n&&(n.displayName||n.name)||"ReactClass",o=r+"."+t;q[o]||(j("Can't call %s on a component that is not yet mounted. This is a no-op, but it might indicate a bug in your application. Instead, assign to `this.state` directly or define a `state = {};` class property with the desired state in the %s component.",t,r),q[o]=!0)}/**
 ...
 * @final
 * @protected
 */H.prototype.forceUpdate=function(e){this.updater.enqueueForceUpdate(this,e,"forceUpdate")};var Y={isMounted:["isMounted","Instead, make sure to clean up subscriptions and pending requests in componentWillUnmount to prevent memory leaks."],replaceState:["replaceState","Refactor your code to use setState instead (see https://github.com/facebook/react/issues/3236)."]},Q=function(e,t){Object.defineProperty(H.prototype,e,{get:function(){F("%s(...) is deprecated in plain JavaScript React classes. %s",t[0],t[1])}})};for(var K in Y)Y.hasOwnProperty(K)&&Q(K,Y[K]);function G(){}/**
...
function ee(e){if(function(e){try{return!1}catch(e){return!0}}(e))return j("The provided key is an unsupported type %s. This value must be coerced to a string before before using it here.","function"==typeof Symbol&&Symbol.toStringTag&&e[Symbol.toStringTag]||e.constructor.name||"Object"),""+e;// throw (to help callers find troubleshooting comments)
...
function en(e){if(null==e)return null;if("number"==typeof e.tag&&j("Received an unexpected object in getComponentNameFromType(). This is likely a bug in React. Please file an issue."),"function"==typeof e)return e.displayName||e.name||null;if("string"==typeof e)return e;switch(e){case y:return"Fragment";case v:return"Portal";case _:return"Profiler";case b:return"StrictMode";case x:return"Suspense";case E:return"SuspenseList"}if("object"==typeof e)switch(e.$$typeof){case k:return et(e)+".Consumer";case w:return et(e._context)+".Provider";case S:return function(e,t,n){var r=e.displayName;if(r)return r;var o=t.displayName||t.name||"";return""!==o?n+"("+o+")":n}// Keep in sync with react-reconciler/getComponentNameFromFiber
...
if(e&&e.defaultProps){var m=e.defaultProps;for(a in m)void 0===s[a]&&(s[a]=m[a])}if(u||l){var g,v,y="function"==typeof e?e.displayName||e.name||"Unknown":e;u&&((g=function(){n||(n=!0,j("%s: `key` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)",y))}).isReactWarning=!0,Object.defineProperty(s,"key",{get:g,configurable:!0})),l&&((v=function(){r||(r=!0,j("%s: `ref` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)",y))}).isReactWarning=!0,Object.defineProperty(s,"ref",{get:v,configurable:!0}))}return es(e,u,l,c,d,L.current,s)}/**
 * Clone and return a new ReactElement using element as the starting point.
 * See https://reactjs.org/docs/react-api.html#cloneelement
 */function el(e,t,n){if(null==e)throw Error("React.cloneElement(...): The argument must be a React element, but you passed "+e+".");var r,o,i=W({},e.props),a=e.key,s=e.ref,u=e._self,l=e._source,c=e._owner;// Reserved names are extracted
if(null!=t)for(r in ei(t)&&(// Silently steal the ref from the parent.
s=t.ref,c=L.current),ea(t)&&(ee(t.key),a=""+t.key),e.type&&e.type.defaultProps&&(o=e.type.defaultProps),t)er.call(t,r)&&!eo.hasOwnProperty(r)&&(void 0===t[r]&&void 0!==o?i[r]=o[r]:i[r]=t[r]);// Children can be more than one argument, and those are transferred onto
// the newly allocated props object.
...
if(Z(t))for(var y=0;y<t.length;y++)w=m+eh(_=t[y],y),h+=e(_,n,r,w,i);else{var b=P(t);if("function"==typeof b){var _,w,k,S=t;// Warn about using Maps as children
b===S.entries&&(ed||F("Using Maps as children is not supported. Use an array of keyed ReactElements instead."),ed=!0);for(var x=b.call(S),E=0;!(k=x.next()).done;)w=m+eh(_=k.value,E++),h+=e(_,n,r,w,i)}else if("object"===a){// eslint-disable-next-line react-internal/safe-string-coercion
...
t.then(function(t){(0===e._status||-1===e._status)&&(e._status=1,e._result=t)},function(t){(0===e._status||-1===e._status)&&(e._status=2,e._result=t)}),-1===e._status&&(e._status=0,e._result=t)}if(1===e._status){var n=e._result;return void 0===n&&j("lazy: Expected the result of a dynamic import() call. Instead received: %s\n\nYour code should look like: \n  const MyComponent = lazy(() => import('./MyComponent'))\n\nDid you accidentally put curly braces around the import?",n),"default"in n||j("lazy: Expected the result of a dynamic import() call. Instead received: %s\n\nYour code should look like: \n  const MyComponent = lazy(() => import('./MyComponent'))",n),n.default}throw e._result}function ev(e){return"string"==typeof e||"function"==typeof e||e===y||e===_||e===b||e===x||e===E||e===O||"object"==typeof e&&null!==e&&(e.$$typeof===T||e.$$typeof===C||e.$$typeof===w||e.$$typeof===k||e.$$typeof===S||// This needs to include all possible module reference object
...
Error.prepareStackTrace=void 0,r=ew.current,// for warnings.
ew.current=null,function(){if(0===eb){/* eslint-disable react-internal/no-production-logging */a=console.log,s=console.info,u=console.warn,l=console.error,c=console.group,d=console.groupCollapsed,f=console.groupEnd;var e={configurable:!0,enumerable:!0,value:e_,writable:!0};// $FlowFixMe Flow thinks console is immutable.
...
return e.displayName&&b.includes("<anonymous>")&&(b=b.replace("<anonymous>",e.displayName)),"function"==typeof e&&h.set(e,b),b}while(v>=1&&y>=0)break}}}finally{eS=!1,ew.current=r,function(){if(0==--eb){/* eslint-disable react-internal/no-production-logging */var e={configurable:!0,enumerable:!0,writable:!0};// $FlowFixMe Flow thinks console is immutable.
Object.defineProperties(console,{log:W({},e,{value:a}),info:W({},e,{value:s}),warn:W({},e,{value:u}),error:W({},e,{value:l}),group:W({},e,{value:c}),groupCollapsed:W({},e,{value:d}),groupEnd:W({},e,{value:f})});/* eslint-enable react-internal/no-production-logging */}eb<0&&j("disabledDepth fell below zero. This is a bug in React. Please file an issue.")}(),Error.prepareStackTrace=i}// Fallback to just using the name if we couldn't make it throw.
var _=e?e.displayName||e.name:"",w=_?ek(_):"";return"function"==typeof e&&h.set(e,w),w}function eE(e,t,n){if(null==e)return"";if("function"==typeof e)return ex(e,!!((r=e.prototype)&&r.isReactComponent));if("string"==typeof e)return ek(e);switch(e){case x:return ek("Suspense");case E:return ek("SuspenseList")}if("object"==typeof e)switch(e.$$typeof){case S:return ex(e.render,!1);case C:// Memo may contain any component type so we recursively resolve it.
...
// assigning it a key.
var r="";e&&e._owner&&e._owner!==L.current&&(r=" It was passed a child from "+en(e._owner.type)+"."),eR(e),j('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.',n,r),eR(null)}}}/**
 ...
 */function eL(e){var t,n=e.type;if(null!=n&&"string"!=typeof n){if("function"==typeof n)t=n.propTypes;else{if("object"!=typeof n||n.$$typeof!==S&&// Note: Memo only checks outer props here.
 ...
 */function(e){for(var t=Object.keys(e.props),n=0;n<t.length;n++){var r=t[n];if("children"!==r&&"key"!==r){eR(e),j("Invalid prop `%s` supplied to `React.Fragment`. React.Fragment can only have `key` and `children` props.",r),eR(null);break}}null!==e.ref&&(eR(e),j("Invalid attribute `ref` supplied to `React.Fragment`."),eR(null))}(s):eL(s),s}var eA=!1,eU=!1,eF=null,ej=0,ez=!1;function eq(e){e!==ej-1&&j("You seem to have overlapping act() calls, this is not supported. Be sure to await previous act() calls before making a new one. "),ej=e}function eB(t,n,r){var o=M.current;if(null!==o)try{eW(o),function(t){if(null===eF)try{// read require off the module object to get around the bundlers.
// we don't want them to detect a require and bundle a Node polyfill.
var n=("require"+Math.random()).slice(0,7);// version of setImmediate, bypassing fake timers if any.
eF=(e&&e[n]).call(e,"timers").setImmediate}catch(e){// we're in a browser
// we can't use regular timers because they may still be faked
// so we try MessageChannel+postMessage instead
eF=function(e){!1===eU&&(eU=!0,"undefined"==typeof MessageChannel&&j("This browser does not have a MessageChannel implementation, so enqueuing tasks via await act(async () => ...) will fail. Please file an issue at https://github.com/facebook/react/issues if you encounter this warning."));var t=new MessageChannel;t.port1.onmessage=e,t.port2.postMessage(void 0)}}eF(t)}(function(){0===o.length?(// No additional work was scheduled. Finish.
M.current=null,n(t)):eB(t,n,r)})}catch(e){r(e)}else n(t)}var eV=!1;function eW(e){if(!eV){// Prevent re-entrance.
...
_defaultValue:null,_globalName:null};t.Provider={$$typeof:w,_context:t};var n=!1,r=!1,o=!1,i={$$typeof:k,_context:t};return Object.defineProperties(i,{Provider:{get:function(){return r||(r=!0,j("Rendering <Context.Consumer.Provider> is not supported and will be removed in a future major release. Did you mean to render <Context.Provider> instead?")),t.Provider},set:function(e){t.Provider=e}},_currentValue:{get:function(){return t._currentValue},set:function(e){t._currentValue=e}},_currentValue2:{get:function(){return t._currentValue2},set:function(e){t._currentValue2=e}},_threadCount:{get:function(){return t._threadCount},set:function(e){t._threadCount=e}},Consumer:{get:function(){return n||(n=!0,j("Rendering <Context.Consumer.Consumer> is not supported and will be removed in a future major release. Did you mean to render <Context.Consumer> instead?")),t.Consumer}},displayName:{get:function(){return t.displayName},set:function(e){o||(F("Setting `displayName` on Context.Consumer has no effect. You should set it directly on the context with Context.displayName = '%s'.",e),o=!0)}}}),t.Consumer=i,t._currentRenderer=null,t._currentRenderer2=null,t},t.createElement=eN,t.createFactory=function(e){var t=eN.bind(null,e);return t.type=e,eA||(eA=!0,F("React.createFactory() is deprecated and will be removed in a future major release. Consider using JSX or use React.createElement() directly instead.")),Object.defineProperty(t,"type",{enumerable:!1,get:function(){return F("Factory.type is deprecated. Access the class directly before passing it to createFactory."),Object.defineProperty(this,"type",{value:e}),e}}),t},t.createRef=// an immutable object with a single mutable value
function(){var e={current:null};return Object.seal(e),e},t.forwardRef=function(e){null!=e&&e.$$typeof===C?j("forwardRef requires a render function but received a `memo` component. Instead of forwardRef(memo(...)), use memo(forwardRef(...))."):"function"!=typeof e?j("forwardRef requires a render function but was given %s.",null===e?"null":typeof e):0!==e.length&&2!==e.length&&j("forwardRef render functions accept exactly two parameters: props and ref. %s",1===e.length?"Did you forget to use the ref parameter?":"Any additional parameter will be undefined."),null!=e&&(null!=e.defaultProps||null!=e.propTypes)&&j("forwardRef render functions do not support propTypes or defaultProps. Did you accidentally pass a React component?");var t,n={$$typeof:S,render:e};return Object.defineProperty(n,"displayName",{enumerable:!1,configurable:!0,get:function(){return t},set:function(n){t=n,e.name||e.displayName||(e.displayName=n)}}),n},t.isValidElement=ec,t.lazy=function(e){var t,n,r={$$typeof:T,_payload:{// We use these fields to store the result.
_status:-1,_result:e},_init:eg};return Object.defineProperties(r,{defaultProps:{configurable:!0,get:function(){return t},set:function(e){j("React.lazy(...): It is not supported to assign `defaultProps` to a lazy component import. Either specify them where the component is defined, or create a wrapping component around it."),t=e,// $FlowFixMe
Object.defineProperty(r,"defaultProps",{enumerable:!0})}},propTypes:{configurable:!0,get:function(){return n},set:function(e){j("React.lazy(...): It is not supported to assign `propTypes` to a lazy component import. Either specify them where the component is defined, or create a wrapping component around it."),n=e,// $FlowFixMe
Object.defineProperty(r,"propTypes",{enumerable:!0})}}}),r},t.memo=function(e,t){ev(e)||j("memo: The first argument must be a component. Instead received: %s",null===e?"null":typeof e);var n,r={$$typeof:C,type:e,compare:void 0===t?null:t};return Object.defineProperty(r,"displayName",{enumerable:!1,configurable:!0,get:function(){return n},set:function(t){n=t,e.name||e.displayName||(e.displayName=t)}}),r},t.startTransition=function(e,t){var n=D.transition;D.transition={};var r=D.transition;D.transition._updatedFibers=new Set;try{e()}finally{D.transition=n,null===n&&r._updatedFibers&&(r._updatedFibers.size>10&&F("Detected a large number of updates inside startTransition. If this is due to a subscription please re-write it to use React provided hooks. Otherwise concurrent mode guarantees are off the table."),r._updatedFibers.clear())}},t.unstable_act=function(e){// `act` calls can be nested, so we track the depth. This represents the
// number of `act` scopes on the stack.
var t,n=ej;ej++,null===M.current&&// will detect the queue and use it instead of Scheduler.
...
M.isBatchingLegacy=!0,t=e(),!r&&M.didScheduleLegacyUpdate){var o=M.current;null!==o&&(M.didScheduleLegacyUpdate=!1,eW(o))}}catch(e){throw eq(n),e}finally{M.isBatchingLegacy=r}if(null!==t&&"object"==typeof t&&"function"==typeof t.then){var i=t,a=!1;// The callback is an async function (i.e. returned a promise). Wait
return ez||"undefined"==typeof Promise||Promise.resolve().then(function(){}).then(function(){a||(ez=!0,j("You called act(async () => ...) without await. This could lead to unexpected testing behaviour, interleaving multiple act calls and mixing their scopes. You should - await act(async () => ...);"))}),{then:function(e,t){a=!0,i.then(function(r){eq(n),0===ej?// queue until there's no remaining work.
...
eq(n),0!==ej)return{then:function(e,t){e(s)}};// Exiting the outermost act scope. Flush the queue.
var u=M.current;return null!==u&&(eW(u),M.current=null),{then:function(e,t){// Confirm we haven't re-entered another `act` scope, in case
 ...
 */function te(e,t,n,r){if(eJ(t)){if(!e.hasAttribute(t))return void 0===n?void 0:null;var o=e.getAttribute(t);return(e$(n,t),o===""+n)?n:o}}/**
 * Sets the value for a property on a node.
 *
 * @param {DOMElement} node
 * @param {string} name
 * @param {*} value
 */function tt(e,t,n,r){var o=e2(t);if(!eZ(t,o,r)){if(e1(t,n,o,r)&&(n=null),r||null===o){eJ(t)&&(null===n?e.removeAttribute(t):(e$(n,t),e.setAttribute(t,""+n)));return}if(o.mustUseProperty){var i=o.propertyName;if(null===n){var a=o.type;e[i]=3!==a&&""}else // `toString`ed by IE8/9.
...
Error.prepareStackTrace=void 0,r=t_.current,// for warnings.
t_.current=null,function(){if(0===ty){/* eslint-disable react-internal/no-production-logging */g=console.log,v=console.info,y=console.warn,b=console.error,_=console.group,w=console.groupCollapsed,k=console.groupEnd;var e={configurable:!0,enumerable:!0,value:tb,writable:!0};// $FlowFixMe Flow thinks console is immutable.
...
return e.displayName&&d.includes("<anonymous>")&&(d=d.replace("<anonymous>",e.displayName)),"function"==typeof e&&x.set(e,d),d}while(l>=1&&c>=0)break}}}finally{tk=!1,t_.current=r,function(){if(0==--ty){/* eslint-disable react-internal/no-production-logging */var e={configurable:!0,enumerable:!0,writable:!0};// $FlowFixMe Flow thinks console is immutable.
Object.defineProperties(console,{log:tv({},e,{value:g}),info:tv({},e,{value:v}),warn:tv({},e,{value:y}),error:tv({},e,{value:b}),group:tv({},e,{value:_}),groupCollapsed:tv({},e,{value:w}),groupEnd:tv({},e,{value:k})});/* eslint-enable react-internal/no-production-logging */}ty<0&&eL("disabledDepth fell below zero. This is a bug in React. Please file an issue.")}(),Error.prepareStackTrace=i}// Fallback to just using the name if we couldn't make it throw.
var f=e?e.displayName||e.name:"",p=f?tw(f):"";return"function"==typeof e&&x.set(e,p),p}function tx(e){try{var t="",n=e;do t+=function(e){switch(e._debugOwner&&e._debugOwner.type,e._debugSource,e.tag){case 5:return tw(e.type);case 16:return tw("Lazy");case 13:return tw("Suspense");case 19:return tw("SuspenseList");case 0:case 2:case 15:return tS(e.type,!1);case 11:return tS(e.type.render,!1);case 1:return tS(e.type,!0);default:return""}}(n),n=n.return;while(n)return t}catch(e){return"\nError generating stack: "+e.message+"\n"+e.stack}}function tE(e){return e.displayName||"Context"}// Note that the reconciler package should generally prefer to use getComponentNameFromFiber() instead.
function tC(e){if(null==e)return null;if("number"==typeof e.tag&&eL("Received an unexpected object in getComponentNameFromType(). This is likely a bug in React. Please file an issue."),"function"==typeof e)return e.displayName||e.name||null;if("string"==typeof e)return e;switch(e){case to:return"Fragment";case tr:return"Portal";case ta:return"Profiler";case ti:return"StrictMode";case tc:return"Suspense";case td:return"SuspenseList"}if("object"==typeof e)switch(e.$$typeof){case tu:return tE(e)+".Consumer";case ts:return tE(e._context)+".Provider";case tl:return function(e,t,n){var r=e.displayName;if(r)return r;var o=t.displayName||t.name||"";return""!==o?n+"("+o+")":n}// Keep in sync with react-reconciler/getComponentNameFromFiber
...
case 1:case 0:case 17:case 2:case 14:case 15:if("function"==typeof i)return i.displayName||i.name||null;if("string"==typeof i)return i}return null}x=new("function"==typeof WeakMap?WeakMap:Map);var tR=eI.ReactDebugCurrentFrame,tP=null,tI=!1;function tD(){if(null===tP)return null;var e=tP._debugOwner;return null!=e?tO(e):null}function tM(){return null===tP?"":tx(tP)}function tL(){tR.getCurrentStack=null,tP=null,tI=!1}function tN(e){tR.getCurrentStack=null===e?null:tM,tP=e,tI=!1}function tA(e){switch(typeof e){case"boolean":case"number":case"string":case"undefined":return e;case"object":return eH(e),e;default:// function, symbol are assigned as empty strings
return""}}var tU={button:!0,checkbox:!0,image:!0,hidden:!0,radio:!0,reset:!0,submit:!0};function tF(e,t){tU[t.type]||t.onChange||t.onInput||t.readOnly||t.disabled||null==t.value||eL("You provided a `value` prop to a form field without an `onChange` handler. This will render a read-only field. If the field should be mutable use `defaultValue`. Otherwise, set either `onChange` or `readOnly`."),t.onChange||t.readOnly||t.disabled||null==t.checked||eL("You provided a `checked` prop to a form field without an `onChange` handler. This will render a read-only field. If the field should be mutable use `defaultChecked`. Otherwise, set either `onChange` or `readOnly`.")}function tj(e){var t=e.type,n=e.nodeName;return n&&"input"===n.toLowerCase()&&("checkbox"===t||"radio"===t)}function tz(e){return e._valueTracker}function tq(e){tz(e)||// TODO: Once it's just Fiber we can move this to node._wrapperState
(e._valueTracker=function(e){var t=tj(e)?"checked":"value",n=Object.getOwnPropertyDescriptor(e.constructor.prototype,t);eH(e[t]);var r=""+e[t];// if someone has already defined a value or Safari, then bail
 ...
 */(function(e){tF("select",e);for(var t=0;t<t8.length;t++){var n=t8[t];if(null!=e[n]){var r=t6(e[n]);e.multiple&&!r?eL("The `%s` prop supplied to <select> must be an array if `multiple` is true.%s",n,t5()):!e.multiple&&r&&eL("The `%s` prop supplied to <select> must be a scalar value if `multiple` is false.%s",n,t5())}}})(t),e._wrapperState={wasMultiple:!!t.multiple},void 0===t.value||void 0===t.defaultValue||E||(eL("Select elements must be either controlled or uncontrolled (specify either the value prop, or the defaultValue prop, but not both). Decide between using a controlled or uncontrolled select element and remove one of these props. More info: https://reactjs.org/link/controlled-components"),E=!0)}var nt=!1;/**
 ...
 */function nn(e,t){if(null!=t.dangerouslySetInnerHTML)throw Error("`dangerouslySetInnerHTML` does not make sense on <textarea>.");return tv({},t,{value:void 0,defaultValue:void 0,children:""+e._wrapperState.initialValue})}function nr(e,t){tF("textarea",t),void 0===t.value||void 0===t.defaultValue||nt||(eL("%s contains a textarea with both value and defaultValue props. Textarea elements must be either controlled or uncontrolled (specify either the value prop, or the defaultValue prop, but not both). Decide between using a controlled or uncontrolled textarea and remove one of these props. More info: https://reactjs.org/link/controlled-components",tD()||"A component"),nt=!0);var n=t.value;// Only bother fetching default value if we're going to use it
if(null==n){var r=t.children,o=t.defaultValue;if(null!=r){if(eL("Use the `defaultValue` or `value` props instead of setting children on <textarea>."),null!=o)throw Error("If you supply `defaultValue` on a <textarea>, do not pass children.");if(t6(r)){if(r.length>1)throw Error("<textarea> can only have at most one child.");r=r[0]}o=r}null==o&&(o=""),n=o}e._wrapperState={initialValue:tA(n)}}function no(e,t){var n=tA(t.value),r=tA(t.defaultValue);if(null!=n){// Cast `value` to a string to ensure the value is set correctly. While
...
Object.keys(np).forEach(function(e){nh.forEach(function(t){np[t+e.charAt(0).toUpperCase()+e.substring(1)]=np[e]})});var ng=/([A-Z])/g,nv=/^ms-/,ny=/^(?:webkit|moz|o)[A-Z]/,nb=/^-ms-/,n_=/-(.)/g,nw=/;\s*$/,nk={},nS={},nx=!1,nE=!1,nC=function(e){nk.hasOwnProperty(e)&&nk[e]||(nk[e]=!0,eL("Unsupported style property %s. Did you mean %s?",e,e.replace(nb,"ms-").replace(n_,function(e,t){return t.toUpperCase()})))},nT=function(e){nk.hasOwnProperty(e)&&nk[e]||(nk[e]=!0,eL("Unsupported vendor-prefixed style property %s. Did you mean %s?",e,e.charAt(0).toUpperCase()+e.slice(1)))},nO=function(e,t){nS.hasOwnProperty(t)&&nS[t]||(nS[t]=!0,eL('Style property values shouldn\'t contain a semicolon. Try "%s: %s" instead.',e,t.replace(nw,"")))},nR=function(e,t){nx||(nx=!0,eL("`NaN` is an invalid value for the `%s` css style property.",e))},nP=function(e,t){nE||(nE=!0,eL("`Infinity` is an invalid value for the `%s` css style property.",e))},nI=function(e,t){e.indexOf("-")>-1?nC(e):ny.test(e)?nT(e):nw.test(t)&&nO(e,t),"number"!=typeof t||(isNaN(t)?nR(e,t):isFinite(t)||nP(e,t))};/**
...
var nL=tv({menuitem:!0},{area:!0,base:!0,br:!0,col:!0,embed:!0,hr:!0,img:!0,input:!0,keygen:!0,link:!0,meta:!0,param:!0,source:!0,track:!0,wbr:!0// NOTE: menuitem's close tag should be omitted, but that causes problems.
});function nN(e,t){if(t){// Note the use of `==` which checks for null or undefined.
...
// in the stack.
rr.removeEventListener(w,v,!1),void 0!==window.event&&window.hasOwnProperty("event")&&(window.event=p)}// Create an event handler for our fake event. We will synchronously
...
var y=!1,b=!1;function _(e){if(l=e.error,y=!0,null===l&&0===e.colno&&0===e.lineno&&(b=!0),e.defaultPrevented&&null!=l&&"object"==typeof l)try{l._suppressLogging=!0}catch(e){}}// Create a fake event type.
var w="react-"+(e||"invokeguardedcallback");// Attach our event handlers
if(window.addEventListener("error",_),rr.addEventListener(w,v,!1),// errors, it will trigger our global error handler.
c.initEvent(w,!1,!1),rr.dispatchEvent(c),h&&Object.defineProperty(window,"event",h),d&&f&&(y?b&&(l=Error("A cross-origin error was thrown. React doesn't have access to the actual error object in development. See https://reactjs.org/link/crossorigin-error for more information.")):// eslint-disable-next-line react-internal/prod-error-codes
l=Error("An error was thrown inside one of your components, but React doesn't know what it was. This is likely due to browser flakiness. React does its best to preserve the \"Pause on exceptions\" behavior of the DevTools, which requires some DEV-mode only tricks. It's possible that these don't work in your browser. Try triggering the error in production mode, or switching to a modern browser. If you suspect that this is actually an issue with React, please file an issue."),this.onError(l)),window.removeEventListener("error",_),!d)return(// Something went really wrong, and our event was not dispatched.
...
var r_=eP.unstable_scheduleCallback,rw=eP.unstable_cancelCallback,rk=eP.unstable_shouldYield,rS=eP.unstable_requestPaint,rx=eP.unstable_now,rE=eP.unstable_getCurrentPriorityLevel,rC=eP.unstable_ImmediatePriority,rT=eP.unstable_UserBlockingPriority,rO=eP.unstable_NormalPriority,rR=eP.unstable_LowPriority,rP=eP.unstable_IdlePriority,rI=eP.unstable_yieldValue,rD=eP.unstable_setDisableYieldValue,rM=null,rL=null,rN=null,rA=!1,rU="undefined"!=typeof __REACT_DEVTOOLS_GLOBAL_HOOK__;function rF(e){if("function"==typeof rI&&(// We're in a test because Scheduler.unstable_yieldValue only exists
// in SchedulerMock. To reduce the noise in strict mode tests,
// suppress warnings and disable scheduler yielding during the double render
rD(e),eD=e),rL&&"function"==typeof rL.setStrictMode)try{rL.setStrictMode(rM,e)}catch(e){rA||(rA=!0,eL("React instrumentation encountered an error: %s",e))}}// Profiler API hooks
function rj(e){rN=e}function rz(){for(var e=new Map,t=1,n=0;n<rJ;n++){var r,o=/*                        */1&(r=t)?"Sync":/*    */2&r?"InputContinuousHydration":/*             */4&r?"InputContinuous":/*            */8&r?"DefaultHydration":/*                     */16&r?"Default":/*                */32&r?"TransitionHydration":/*                       */4194240&r?"Transition":/*                            */130023424&r?"Retry":/*          */134217728&r?"SelectiveHydration":/*               */268435456&r?"IdleHydration":/*                        */536870912&r?"Idle":/*                   */1073741824&r?"Offscreen":void 0;e.set(t,o),t*=2}return e}function rq(){null!==rN&&"function"==typeof rN.markCommitStopped&&rN.markCommitStopped()}function rB(e){null!==rN&&"function"==typeof rN.markComponentRenderStarted&&rN.markComponentRenderStarted(e)}function rV(){null!==rN&&"function"==typeof rN.markComponentRenderStopped&&rN.markComponentRenderStopped()}function rW(e){null!==rN&&"function"==typeof rN.markComponentLayoutEffectUnmountStarted&&rN.markComponentLayoutEffectUnmountStarted(e)}function r$(){null!==rN&&"function"==typeof rN.markComponentLayoutEffectUnmountStopped&&rN.markComponentLayoutEffectUnmountStopped()}function rH(e){null!==rN&&"function"==typeof rN.markRenderStarted&&rN.markRenderStarted(e)}function rY(){null!==rN&&"function"==typeof rN.markRenderStopped&&rN.markRenderStopped()}function rQ(e,t){null!==rN&&"function"==typeof rN.markStateUpdateScheduled&&rN.markStateUpdateScheduled(e,t)}// TODO: This is pretty well supported by browsers. Maybe we can drop it.
...
e.eventSystemFlags|=r;var s=e.targetContainers;return null!==o&&-1===s.indexOf(o)&&s.push(o),e}function o_(e){// TODO: This function shares a lot of logic with findInstanceBlockingEvent.
...
return}}}e.blockedOn=null}function ow(e){if(null!==e.blockedOn)return!1;for(var t=e.targetContainers;t.length>0;){var n=t[0],r=oD(e.domEventName,e.eventSystemFlags,n,e.nativeEvent);if(null===r){var o=e.nativeEvent,i=new o.constructor(o.type,o);null!==nG&&eL("Expected currently replaying event to be null. This error is likely caused by a bug in React. Please file an issue."),nG=i,o.target.dispatchEvent(i),null===nG&&eL("Expected currently replaying event to not be null. This error is likely caused by a bug in React. Please file an issue."),nG=null}else{// We're still blocked. Try again later.
var a=a1(r);return null!==a&&O(a),e.blockedOn=r,!1}// This target container was successfully dispatched. Try the next.
t.shift()}return!0}function ok(e,t,n){ow(e)&&n.delete(t)}function oS(){ol=!1,null!==od&&ow(od)&&(od=null),null!==of&&ow(of)&&(of=null),null!==op&&ow(op)&&(op=null),oh.forEach(ok),om.forEach(ok)}function ox(e,t){e.blockedOn!==t||(e.blockedOn=null,ol||(ol=!0,// now unblocked. This first might not actually be unblocked yet.
...
for(var t=1;t<oc.length;t++){var n=oc[t];n.blockedOn===e&&(n.blockedOn=null)}}null!==od&&ox(od,e),null!==of&&ox(of,e),null!==op&&ox(op,e);var r=function(t){return ox(t,e)};oh.forEach(r),om.forEach(r);for(var o=0;o<og.length;o++){var i=og[o];i.blockedOn===e&&(i.blockedOn=null)}for(;og.length>0;){var a=og[0];if(null!==a.blockedOn)break;o_(a),null===a.blockedOn&&og.shift()}}var oC=eI.ReactCurrentBatchConfig,oT=!0;// TODO: can we stop exporting these?
 ...
 *
 *
 */var oL=null,oN=null,oA=null;function oU(){if(oA)return oA;var e,t,n=oN,r=n.length,o=oF(),i=o.length;for(e=0;e<r&&n[e]===o[e];e++);var a=r-e;for(t=1;t<=a&&n[r-t]===o[i-t];t++);var s=t>1?1-t:void 0;return oA=o.slice(e,s)}function oF(){return"value"in oL?oL.value:oL.textContent}/**
 ...
 */function oj(e){var t,n=e.keyCode;return(// Some non-printable keys are reported in `charCode`/`keyCode`, discard them.
 ...
 */var oV={eventPhase:0,bubbles:0,cancelable:0,timeStamp:function(e){return e.timeStamp||Date.now()},defaultPrevented:0,isTrusted:0},oW=oB(oV),o$=tv({},oV,{view:0,detail:0}),oH=oB(o$),oY=tv({},o$,{screenX:0,screenY:0,clientX:0,clientY:0,pageX:0,pageY:0,ctrlKey:0,shiftKey:0,altKey:0,metaKey:0,getModifierState:o4,button:0,buttons:0,relatedTarget:function(e){return void 0===e.relatedTarget?e.fromElement===e.srcElement?e.toElement:e.fromElement:e.relatedTarget},movementX:function(e){return"movementX"in e?e.movementX:(e!==N&&(N&&"mousemove"===e.type?(M=e.screenX-N.screenX,L=e.screenY-N.screenY):(M=0,L=0),N=e),M)},movementY:function(e){return"movementY"in e?e.movementY:L}}),oQ=oB(oY),oK=oB(tv({},oY,{dataTransfer:0})),oG=oB(tv({},o$,{relatedTarget:0})),oX=oB(tv({},oV,{animationName:0,elapsedTime:0,pseudoElement:0})),oJ=oB(tv({},oV,{clipboardData:function(e){return"clipboardData"in e?e.clipboardData:window.clipboardData}})),oZ=oB(tv({},oV,{data:0})),o0={Esc:"Escape",Spacebar:" ",Left:"ArrowLeft",Up:"ArrowUp",Right:"ArrowRight",Down:"ArrowDown",Del:"Delete",Win:"OS",Menu:"ContextMenu",Apps:"ContextMenu",Scroll:"ScrollLock",MozPrintableKey:"Unidentified"},o1={8:"Backspace",9:"Tab",12:"Clear",13:"Enter",16:"Shift",17:"Control",18:"Alt",19:"Pause",20:"CapsLock",27:"Escape",32:" ",33:"PageUp",34:"PageDown",35:"End",36:"Home",37:"ArrowLeft",38:"ArrowUp",39:"ArrowRight",40:"ArrowDown",45:"Insert",46:"Delete",112:"F1",113:"F2",114:"F3",115:"F4",116:"F5",117:"F6",118:"F7",119:"F8",120:"F9",121:"F10",122:"F11",123:"F12",144:"NumLock",145:"ScrollLock",224:"Meta"},o2={Alt:"altKey",Control:"ctrlKey",Meta:"metaKey",Shift:"shiftKey"};// getModifierState. If getModifierState is not supported, we map it to a set of
// modifier keys exposed by the event. In this case, Lock-keys are not supported.
function o3(e){var t=this.nativeEvent;if(t.getModifierState)return t.getModifierState(e);var n=o2[e];return!!n&&!!t[n]}function o4(e){return o3}var o6=oB(tv({},o$,{key:/**
 * @param {object} nativeEvent Native browser event.
...
if("keypress"===e.type){var n=oj(e);// The enter-key is technically both printable and non-printable and can
...
"keypress"===e.type?oj(e):0)},keyCode:function(e){return(// `keyCode` is the result of a KeyDown/Up event and represents the value of
...
// type of the event.
"keypress"===e.type?oj(e):"keydown"===e.type||"keyup"===e.type?e.keyCode:0)}})),o5=oB(tv({},oY,{pointerId:0,width:0,height:0,pressure:0,tangentialPressure:0,tiltX:0,tiltY:0,twist:0,pointerType:0,isPrimary:0})),o8=oB(tv({},o$,{touches:0,targetTouches:0,changedTouches:0,altKey:0,metaKey:0,ctrlKey:0,shiftKey:0,getModifierState:o4})),o7=oB(tv({},oV,{propertyName:0,elapsedTime:0,pseudoElement:0})),o9=oB(tv({},oY,{deltaX:function(e){return"deltaX"in e?e.deltaX:"wheelDeltaX"in e?-e.wheelDeltaX:0},deltaY:function(e){return"deltaY"in e?e.deltaY:"wheelDeltaY"in e?-e.wheelDeltaY:"wheelDelta"in e?-e.wheelDelta:0},deltaZ:0,// Browsers without "deltaMode" is reporting in raw wheel delta where one
...
n2(r);var o=ae(t,"onChange");if(o.length>0){var i=new oW("onChange","change",null,n,r);e.push({event:i,listeners:o})}}/**
 * For IE shims
 ...
 * if any exists.
 */function iw(){im&&(im.detachEvent("onpropertychange",ik),im=null,ig=null)}/**
...
iw(),im=t,ig=n,im.attachEvent("onpropertychange",ik)):"focusout"===e&&iw()}// For IE8 and IE9.
 ...
 */function iM(e){var t=e&&e.nodeName&&e.nodeName.toLowerCase();return t&&("input"===t&&("text"===e.type||"search"===e.type||"tel"===e.type||"url"===e.type||"password"===e.type)||"textarea"===t||"true"===e.contentEditable)}var iL=eq&&"documentMode"in document&&document.documentMode<=11,iN=null,iA=null,iU=null,iF=!1;/**
 * Poll selection to see whether it's changed.
 *
 * @param {object} nativeEvent
 * @param {object} nativeEventTarget
 * @return {?SyntheticEvent}
 */function ij(e,t,n){// Ensure we have the right element, and that the user is not dragging a
// selection (this matches native `select` event behavior). In HTML5, select
// fires only on input and textarea thus if there's no focused element we
// won't dispatch.
var r=n.window===n?n.document:9===n.nodeType?n:n.ownerDocument;if(!iF&&null!=iN&&iN===tV(r)){// Only fire when selection has actually changed.
var o=/**
 * Get an object which is a unique representation of the current selection.
 *
 * The return value will not be consistent across nodes or browsers, but
 * two identical selections on the same node will return identical objects.
 */function(e){if("selectionStart"in e&&iM(e))return{start:e.selectionStart,end:e.selectionEnd};var t=(e.ownerDocument&&e.ownerDocument.defaultView||window).getSelection();return{anchorNode:t.anchorNode,anchorOffset:t.anchorOffset,focusNode:t.focusNode,focusOffset:t.focusOffset}}(iN);if(!iU||!iO(iU,o)){iU=o;var i=ae(iA,"onSelect");if(i.length>0){var a=new oW("onSelect","select",null,t,n);e.push({event:a,listeners:i}),a.target=iN}}}}/**
...
function(e,t,n,r,o,i,a){var s=iK.get(t);if(void 0!==s){var u=oW,l=t;switch(t){case"keypress":// Firefox creates a keypress event for function keys too. This removes
// the unwanted keypress events. Enter is however both printable and
// non-printable. One would expect Tab to be as well (but it isn't).
if(0===oj(r))return;/* falls through */case"keydown":case"keyup":u=o6;break;case"focusin":l="focus",u=oG;break;case"focusout":l="blur",u=oG;break;case"beforeblur":case"afterblur":u=oG;break;case"click":// Firefox creates a click event on right mouse clicks. This removes the
// unwanted click events.
if(2===r.button)return;/* falls through */case"auxclick":case"dblclick":case"mousedown":case"mousemove":case"mouseup":/* falls through */case"mouseout":case"mouseover":case"contextmenu":u=oQ;break;case"drag":case"dragend":case"dragenter":case"dragexit":case"dragleave":case"dragover":case"dragstart":case"drop":u=oK;break;case"touchcancel":case"touchend":case"touchmove":case"touchstart":u=o8;break;case i$:case iH:case iY:u=oX;break;case iQ:u=o7;break;case"scroll":u=oH;break;case"wheel":u=o9;break;case"copy":case"cut":case"paste":u=oJ;break;case"gotpointercapture":case"lostpointercapture":case"pointercancel":case"pointerdown":case"pointermove":case"pointerout":case"pointerover":case"pointerup":u=o5}var c=(4&i)!=0,d=!c&&// TODO: ideally, we'd eventually add all events from
...
u=null,l=n;if(u!==l){var g,v,y,b,_=oQ,w="onMouseLeave",k="onMouseEnter",S="mouse";("pointerout"===t||"pointerover"===t)&&(_=o5,w="onPointerLeave",k="onPointerEnter",S="pointer");var x=null==u?s:a2(u),E=null==l?s:a2(l),C=new _(w,S+"leave",u,r,o);C.target=x,C.relatedTarget=E;var T=null;// We should only process this nativeEvent if we are processing
if(a0(o)===n){var O=new _(k,S+"enter",l,r,o);O.target=E,O.relatedTarget=x,T=O}g=T,v=u,y=l,b=v&&y?/**
...
case"focusin":(ip(s)||"true"===s.contentEditable)&&(iN=s,iA=n,iU=null);break;case"focusout":iN=null,iA=null,iU=null;break;// Don't fire the event while the user is dragging. This matches the
// semantics of the native select event.
case"mousedown":iF=!0;break;case"contextmenu":case"mouseup":case"dragend":iF=!1,ij(e,r,o);break;// Chrome and IE fire non-standard event when selection is changed (and
...
if(ic){if("compositionend"===e||!it&&is(e,t)){var n=oU();return oL=null,oN=null,oA=null,ic=!1,n}return null}switch(e){case"paste":default:// If a paste event occurs after a keypress, throw out the input
...
webview:!0},U=function(e,t){nA(e,t)||function(e,t){var n=[];for(var r in t)!function(e,t){if(eB.call(nj,t)&&nj[t])return!0;if(nq.test(t)){var n="aria-"+t.slice(4).toLowerCase(),r=nF.hasOwnProperty(n)?n:null;// DOM properties, then it is an invalid aria-* attribute.
if(null==r)return eL("Invalid ARIA attribute `%s`. ARIA attributes follow the pattern aria-* and must be lowercase.",t),nj[t]=!0,!0;// aria-* attributes should be lowercase; suggest the lowercase version.
if(t!==r)return eL("Invalid ARIA attribute `%s`. Did you mean `%s`?",t,r),nj[t]=!0,!0}if(nz.test(t)){var o=t.toLowerCase(),i=nF.hasOwnProperty(o)?o:null;// DOM properties, then it is an invalid aria-* attribute.
if(null==i)return nj[t]=!0,!1;// aria-* attributes should be lowercase; suggest the lowercase version.
t!==i&&(eL("Unknown ARIA attribute `%s`. Did you mean `%s`?",t,i),nj[t]=!0)}return!0}(0,r)&&n.push(r);var o=n.map(function(e){return"`"+e+"`"}).join(", ");1===n.length?eL("Invalid aria prop %s on <%s> tag. For details, see https://reactjs.org/link/invalid-aria-props",o,e):n.length>1&&eL("Invalid aria props %s on <%s> tag. For details, see https://reactjs.org/link/invalid-aria-props",o,e)}(e,t),"input"!==e&&"textarea"!==e&&"select"!==e||null==t||null!==t.value||nB||(nB=!0,"select"===e&&t.multiple?eL("`value` prop on `%s` should not be null. Consider using an empty array when `multiple` is set to `true` to clear the component or `undefined` for uncontrolled components.",e):eL("`value` prop on `%s` should not be null. Consider using an empty string to clear the component or `undefined` for uncontrolled components.",e)),nA(e,t)||nK(e,t,{registrationNameDependencies:eU,possibleRegistrationNames:eF})},// browsers. It adds spaces and sorts the properties in some
...
q=eq&&!document.documentMode,F=function(e,t,n){if(!ar){var r=ap(n),o=ap(t);o!==r&&(ar=!0,eL("Prop `%s` did not match. Server: %s Client: %s",e,JSON.stringify(o),JSON.stringify(r)))}},j=function(e){if(!ar){ar=!0;var t=[];e.forEach(function(e){t.push(e)}),eL("Extra attributes from the server: %s",t)}},z=function(e,t){!1===t?eL("Expected `%s` listener to be a function, instead got `false`.\n\nIf you used to conditionally omit it with %s={condition && value}, pass %s={condition ? value : undefined} instead.",e,e,e):eL("Expected `%s` listener to be a function, instead got a value of `%s` type.",e,typeof t)},// can be used for comparison.
...
var ad=/\r\n?/g,af=/\u0000|\uFFFD/g;function ap(e){return eW(e)&&eL("The provided HTML markup uses a value of unsupported type %s. This value must be coerced to a string before before using it here.",eV(e)),("string"==typeof e?e:""+e).replace(ad,"\n").replace(af,"")}function ah(e,t,n,r){var o=ap(t),i=ap(e);if(i!==o&&(r&&!ar&&(ar=!0,eL('Text content did not match. Server: "%s" Client: "%s"',i,o)),n))// client rendering, up to the nearest Suspense boundary.
...
return t.aTagInScope;case"nobr":return t.nobrTagInScope}return null},aI={};ak=function(e,t,n){var r=(n=n||aO).current,o=r&&r.tag;null!=t&&(null!=e&&eL("validateDOMNesting: when childText is passed, childTag should be null"),e="#text");var i=aR(e,o)?null:r,a=i?null:aP(e,n),s=i||a;if(s){var u=s.tag,l=!!i+"|"+e+"|"+u;if(!aI[l]){aI[l]=!0;var c=e,d="";if("#text"===e?/\S/.test(t)?c="Text nodes":(c="Whitespace text nodes",d=" Make sure you don't have any extra whitespace between tags on each line of your source code."):c="<"+e+">",i){var f="";"table"===u&&"tr"===e&&(f+=" Add a <tbody>, <thead> or <tfoot> to your code to match the DOM tree generated by the browser."),eL("validateDOMNesting(...): %s cannot appear as a child of <%s>.%s%s",c,u,d,f)}else eL("validateDOMNesting(...): %s cannot appear as a descendant of <%s>.",c,u)}}};var aD="suppressHydrationWarning",aM=null,aL=null;function aN(e,t){return"textarea"===e||"noscript"===e||"string"==typeof t.children||"number"==typeof t.children||"object"==typeof t.dangerouslySetInnerHTML&&null!==t.dangerouslySetInnerHTML&&null!=t.dangerouslySetInnerHTML.__html}// if a component just imports ReactDOM (e.g. for findDOMNode).
// Some environments might not have setTimeout or clearTimeout.
var aA="function"==typeof setTimeout?setTimeout:void 0,aU="function"==typeof clearTimeout?clearTimeout:void 0,aF="function"==typeof Promise?Promise:void 0,aj="function"==typeof queueMicrotask?queueMicrotask:void 0!==aF?function(e){return aF.resolve(null).then(e).catch(az)}:aA;function az(e){setTimeout(function(){throw e})}// -------------------
...
oE(t)}function aB(e){return"$?"===e.data}function aV(e){return"$!"===e.data}function aW(e){// Skip non-hydratable nodes.
for(;null!=e;e=e.nextSibling){var t=e.nodeType;if(1===t||3===t)break;if(8===t){var n=e.data;if("$"===n||"$!"===n||"$?"===n)break;if("/$"===n)return null}}return e}function a$(e){return aW(e.nextSibling)}// SuspenseInstance. I.e. if its previous sibling is a Comment with
...
throw Error("getNodeFromInstance: Invalid argument.")}function a3(e){return e[aK]||null}var a4={},a6=eI.ReactDebugCurrentFrame;function a5(e){if(e){var t=e._owner,n=function e(t,n,r){if(null==t)return"";if("function"==typeof t)return tS(t,!!((o=t.prototype)&&o.isReactComponent));if("string"==typeof t)return tw(t);switch(t){case tc:return tw("Suspense");case td:return tw("SuspenseList")}if("object"==typeof t)switch(t.$$typeof){case tl:return tS(t.render,!1);case tf:// Memo may contain any component type so we recursively resolve it.
...
st(si,e),st(so,e),sn(so,o,e),sn(si,n,e)}else st(si,e),sn(si,n,e)}var sy=null,sb=!1,s_=!1;function sw(e){// Push this callback into an internal queue. We'll flush these either in
// the next tick, or earlier if something calls `flushSyncCallbackQueue`.
null===sy?sy=[e]:// we already scheduled one when we created the queue.
sy.push(e)}function sk(){if(!s_&&null!==sy){// Prevent re-entrance.
s_=!0;var e=0,t=oa;try{var n=sy;// TODO: Is this necessary anymore? The only user code that runs in this
...
r_(rC,sk),t}finally{oa=t,s_=!1}}return null}// TODO: Use the unified fiber stack module instead of this local one?
...
sU(),sS[sx++]=sC,sS[sx++]=sE,sE=e,sC=t}function sM(e,t,n){sU(),sT[sO++]=sP,sT[sO++]=sI,sT[sO++]=sR,sR=e;var r=sP,o=sI,i=sN(r)-1,a=r&~(1<<i),s=n+1,u=sN(t)+i;// consideration the leading 1 we use to mark the end of the sequence.
...
sP=1<<sN(t)+d|(s<<d|a>>l),sI=c+o}else sP=1<<u|(s<<i|a),sI=o}function sL(e){sU(),null!==e.return&&(sD(e,1),sM(e,1,0))}function sN(e){return 32-rK(e)}function sA(e){// Restore the previous values.
// This is a bit more complicated than other context-like modules in Fiber
// because the same Fiber may appear on the stack multiple times and for
// different reasons. We have to keep popping until the work-in-progress is
// no longer at the top of the stack.
for(;e===sE;)sE=sS[--sx],sS[sx]=null,sC=sS[--sx],sS[sx]=null;for(;e===sR;)sR=sT[--sO],sT[sO]=null,sI=sT[--sO],sT[sO]=null,sP=sT[--sO],sT[sO]=null}function sU(){sz||eL("Expected to be hydrating. This is a bug in React. Please file an issue.")}// This may have been an insertion or a hydration.
var sF=null,sj=null,sz=!1,sq=!1,sB=null;function sV(e,t){switch(e.tag){case 3:var n;n=e.stateNode.containerInfo,1===t.nodeType?ay(n,t):8===t.nodeType||ab(n,t);break;case 5:var r,o,i=(/*                 */1&e.mode)!=/*                         */0;e.type,r=e.memoizedProps,o=e.stateNode,(i||!0!==r[aD])&&(1===t.nodeType?ay(o,t):8===t.nodeType||ab(o,t));break;case 13:var a,s=e.memoizedState;null!==s.dehydrated&&null!==(a=s.dehydrated.parentNode)&&(1===t.nodeType?ay(a,t):8===t.nodeType||ab(a,t))}}function sW(e,t){sV(e,t);var n,r=((n=ph(5,null,null,0)).elementType="DELETED",n);r.stateNode=t,r.return=e;var o=e.deletions;null===o?(e.deletions=[r],e.flags|=/*                */16):o.push(r)}function s$(e,t){if(!sq)switch(e.tag){case 3:var n=e.stateNode.containerInfo;switch(t.tag){case 5:var r=t.type;t.pendingProps,a_(n,r);break;case 6:aw(n,t.pendingProps)}break;case 5:e.type;var o=e.memoizedProps,i=e.stateNode;switch(t.tag){case 5:var a=t.type;t.pendingProps,((1&e.mode)!=0||!0!==o[aD])&&a_(i,a);break;case 6:var s=t.pendingProps;((1&e.mode)!=0||!0!==o[aD])&&aw(i,s)}break;case 13:var u=e.memoizedState.dehydrated;if(null!==u)switch(t.tag){case 5:var l,c=t.type;t.pendingProps,null!==(l=u.parentNode)&&a_(l,c);break;case 6:var d,f=t.pendingProps;null!==(d=u.parentNode)&&aw(d,f)}break;default:return}}function sH(e,t){t.flags=-4097&t.flags|/*                    */2,s$(e,t)}function sY(e,t){switch(e.tag){case 5:var n=e.type;e.pendingProps;var r=1!==t.nodeType||n.toLowerCase()!==t.nodeName.toLowerCase()?null:t;if(null!==r)return e.stateNode=r,sF=e,sj=aW(r.firstChild),!0;return!1;case 6:var o=""===e.pendingProps||3!==t.nodeType?null:t;if(null!==o)return e.stateNode=o,sF=e,sj=null,!0;return!1;case 13:var i=8!==t.nodeType?null:t;if(null!==i){var a,s={dehydrated:i,treeContext:(sU(),null!==sR)?{id:sP,overflow:sI}:null,retryLane:1073741824};e.memoizedState=s;// This simplifies the code for getHostSibling and deleting nodes,
// since it doesn't have to consider all Suspense boundaries and
// check if they're dehydrated ones or not.
var u=((a=ph(18,null,null,0)).stateNode=i,a);return u.return=e,e.child=u,sF=e,// it during the first pass. Instead, we'll reenter it later.
sj=null,!0}return!1;default:return!1}}function sQ(e){return(1&e.mode)!=0&&(/*                   */128&e.flags)==0}function sK(e){throw Error("Hydration failed because the initial UI does not match what was rendered on the server.")}function sG(e){if(sz){var t=sj;if(!t){sQ(e)&&(s$(sF,e),sK()),sH(sF,e),sz=!1,sF=e;return}var n=t;if(!sY(e,t)){sQ(e)&&(s$(sF,e),sK()),// We use this as a heuristic. It's based on intuition and not data so it
// might be flawed or unnecessary.
t=a$(n);var r=sF;if(!t||!sY(e,t)){// Nothing to hydrate. Make it an insertion.
sH(sF,e),sz=!1,sF=e;return}// We matched the next one, we'll now assume that the first one was
// superfluous and we'll delete it. Since we can't eagerly delete it
// we'll have to schedule a deletion. To do that, this node needs a dummy
// fiber associated with it.
sW(r,n)}}}function sX(e){for(var t=e.return;null!==t&&5!==t.tag&&3!==t.tag&&13!==t.tag;)t=t.return;sF=t}function sJ(e){if(e!==sF)// tree.
...
if(3!==e.tag&&(5!==e.tag||"head"!==(t=e.type)&&"body"!==t&&!aN(e.type,e.memoizedProps))){var t,n=sj;if(n){if(sQ(e))sZ(e),sK();else for(;n;)sW(e,n),n=a$(n)}}return sX(e),sj=13===e.tag?function(e){var t=e.memoizedState,n=null!==t?t.dehydrated:null;if(!n)throw Error("Expected to have a hydrated suspense instance. This error is likely caused by a bug in React. Please file an issue.");return function(e){for(var t=e.nextSibling,n=0;t;){if(8===t.nodeType){var r=t.data;if("/$"===r){if(0===n)return a$(t);n--}else("$"===r||"$!"===r||"$?"===r)&&n++}t=t.nextSibling}// TODO: Warn, we didn't find the end comment boundary.
return null}// Returns the SuspenseInstance if this node is a direct child of a
(n)}(e):sF?a$(e.stateNode):null,!0}function sZ(e){for(var t=sj;t;)sV(e,t),t=a$(t)}function s0(){sF=null,sj=null,sz=!1,sq=!1}function s1(){null!==sB&&(// Successfully completed a forced client render. The errors that occurred
...
var e=new Set;s8.length>0&&(s8.forEach(function(t){e.add(tO(t)||"Component"),ur.add(t.type)}),s8=[]);var t=new Set;s7.length>0&&(s7.forEach(function(e){t.add(tO(e)||"Component"),ur.add(e.type)}),s7=[]);var n=new Set;s9.length>0&&(s9.forEach(function(e){n.add(tO(e)||"Component"),ur.add(e.type)}),s9=[]);var r=new Set;ue.length>0&&(ue.forEach(function(e){r.add(tO(e)||"Component"),ur.add(e.type)}),ue=[]);var o=new Set;ut.length>0&&(ut.forEach(function(e){o.add(tO(e)||"Component"),ur.add(e.type)}),ut=[]);var i=new Set;un.length>0&&(un.forEach(function(e){i.add(tO(e)||"Component"),ur.add(e.type)}),un=[]),t.size>0&&eL("Using UNSAFE_componentWillMount in strict mode is not recommended and may indicate bugs in your code. See https://reactjs.org/link/unsafe-component-lifecycles for details.\n\n* Move code with side effects to componentDidMount, and set initial state in the constructor.\n\nPlease update the following components: %s",s5(t)),r.size>0&&eL("Using UNSAFE_componentWillReceiveProps in strict mode is not recommended and may indicate bugs in your code. See https://reactjs.org/link/unsafe-component-lifecycles for details.\n\n* Move data fetching code or side effects to componentDidUpdate.\n* If you're updating state whenever props change, refactor your code to use memoization techniques or move it to static getDerivedStateFromProps. Learn more at: https://reactjs.org/link/derived-state\n\nPlease update the following components: %s",s5(r)),i.size>0&&eL("Using UNSAFE_componentWillUpdate in strict mode is not recommended and may indicate bugs in your code. See https://reactjs.org/link/unsafe-component-lifecycles for details.\n\n* Move data fetching code or side effects to componentDidUpdate.\n\nPlease update the following components: %s",s5(i)),e.size>0&&eM("componentWillMount has been renamed, and is not recommended for use. See https://reactjs.org/link/unsafe-component-lifecycles for details.\n\n* Move code with side effects to componentDidMount, and set initial state in the constructor.\n* Rename componentWillMount to UNSAFE_componentWillMount to suppress this warning in non-strict mode. In React 18.x, only the UNSAFE_ name will work. To rename all deprecated lifecycles to their new names, you can run `npx react-codemod rename-unsafe-lifecycles` in your project source folder.\n\nPlease update the following components: %s",s5(e)),n.size>0&&eM("componentWillReceiveProps has been renamed, and is not recommended for use. See https://reactjs.org/link/unsafe-component-lifecycles for details.\n\n* Move data fetching code or side effects to componentDidUpdate.\n* If you're updating state whenever props change, refactor your code to use memoization techniques or move it to static getDerivedStateFromProps. Learn more at: https://reactjs.org/link/derived-state\n* Rename componentWillReceiveProps to UNSAFE_componentWillReceiveProps to suppress this warning in non-strict mode. In React 18.x, only the UNSAFE_ name will work. To rename all deprecated lifecycles to their new names, you can run `npx react-codemod rename-unsafe-lifecycles` in your project source folder.\n\nPlease update the following components: %s",s5(n)),o.size>0&&eM("componentWillUpdate has been renamed, and is not recommended for use. See https://reactjs.org/link/unsafe-component-lifecycles for details.\n\n* Move data fetching code or side effects to componentDidUpdate.\n* Rename componentWillUpdate to UNSAFE_componentWillUpdate to suppress this warning in non-strict mode. In React 18.x, only the UNSAFE_ name will work. To rename all deprecated lifecycles to their new names, you can run `npx react-codemod rename-unsafe-lifecycles` in your project source folder.\n\nPlease update the following components: %s",s5(o))};var uo=new Map,ui=new Set;// Tracks components we have already warned about.
function ua(e,t){if(e&&e.defaultProps){// Resolve default props. Taken from ReactElement
var n=tv({},t),r=e.defaultProps;for(var o in r)void 0===n[o]&&(n[o]=r[o]);return n}return t}s4.recordLegacyContextWarning=function(e,t){var n=s6(e);if(null===n){eL("Expected to find a StrictMode component in a strict mode tree. This error is likely caused by a bug in React. Please file an issue.");return}// Dedup strategy: Warn once per component.
if(!ui.has(e.type)){var r=uo.get(n);(null!=e.type.contextTypes||null!=e.type.childContextTypes||null!==t&&"function"==typeof t.getChildContext)&&(void 0===r&&(r=[],uo.set(n,r)),r.push(e))}},s4.flushLegacyContextWarning=function(){uo.forEach(function(e,t){if(0!==e.length){var n=e[0],r=new Set;e.forEach(function(e){r.add(tO(e)||"Component"),ui.add(e.type)});var o=s5(r);try{tN(n),eL("Legacy context API has been detected within a strict-mode tree.\n\nThe old API will be supported in all 16.x releases, but applications using it should migrate to the new version.\n\nPlease update the following components: %s\n\nLearn more about this warning here: https://reactjs.org/link/legacy-context",o)}finally{tL()}}})},s4.discardPendingWarnings=function(){s8=[],s7=[],s9=[],ue=[],ut=[],un=[],uo=new Map};var us=se(null);// Use this to detect multiple renderers using the same context
$={};var uu=null,ul=null,uc=null,ud=!1;function uf(){// This is called right before React yields execution, to ensure `readContext`
// cannot be called outside the render phase.
uu=null,ul=null,uc=null,ud=!1}function up(e,t,n){sn(us,t._currentValue,e),t._currentValue=n,void 0!==t._currentRenderer&&null!==t._currentRenderer&&t._currentRenderer!==$&&eL("Detected multiple renderers concurrently rendering the same context provider. This is currently unsupported."),t._currentRenderer=$}function uh(e,t){var n=us.current;st(us,t),e._currentValue=n}function um(e,t,n){for(// Update the child lanes of all the ancestors, including the alternates.
var r=e;null!==r;){var o=r.alternate;if((r.childLanes&t)===t?null!==o&&(o.childLanes&t)!==t&&(o.childLanes=o.childLanes|t):(r.childLanes=r.childLanes|t,null!==o&&(o.childLanes=o.childLanes|t)),r===n)break;r=r.return}r!==n&&eL("Expected to find the propagation root when scheduling context work. This error is likely caused by a bug in React. Please file an issue.")}function ug(e,t){uu=e,ul=null,uc=null;var n=e.dependencies;null!==n&&null!==n.firstContext&&((n.lanes&t)!=0&&(c$=!0),// Reset the work-in-progress list
n.firstContext=null)}function uv(e){// This warning would fire if you read context inside a Hook like useMemo.
// Unlike the class check below, it's not enforced in production for perf.
ud&&eL("Context can only be read while React is rendering. In classes, you can read it in the render method or getDerivedStateFromProps. In function components, you can read it directly in the function body, but not inside Hooks like useReducer() or useMemo().");var t=e._currentValue;if(uc===e);else{var n={context:e,memoizedValue:t,next:null};if(null===ul){if(null===uu)throw Error("Context can only be read while React is rendering. In classes, you can read it in the render method or getDerivedStateFromProps. In function components, you can read it directly in the function body, but not inside Hooks like useReducer() or useMemo().");// This is the first dependency for this component. Create a new list.
...
// of the queue.
var uy=null;function ub(e){null===uy?uy=[e]:uy.push(e)}function u_(e,t,n,r){var o=t.interleaved;return null===o?(// This is the first update. Create a circular list.
n.next=n,// be transferred to the pending queue.
ub(t)):(n.next=o.next,o.next=n),t.interleaved=n,uw(e,r)}function uw(e,t){// Update the source fiber's lanes
...
var n=t.updateQueue,r=e.updateQueue;if(n===r){var o={baseState:r.baseState,firstBaseUpdate:r.firstBaseUpdate,lastBaseUpdate:r.lastBaseUpdate,shared:r.shared,effects:r.effects};t.updateQueue=o}}function uE(e,t){return{eventTime:e,lane:t,tag:0,payload:null,callback:null,next:null}}function uC(e,t,n){var r,o=e.updateQueue;if(null===o)return null;var i=o.shared;if(Y!==i||H||(eL("An update (setState, replaceState, or forceUpdate) was scheduled from inside an update function. Update functions should be pure, with zero side-effects. Consider using componentDidUpdate or a callback."),H=!0),(/*                */2&d5)!=/*             */0){// This is an unsafe render phase update. Add directly to the update
...
return null===a?t.next=t:(t.next=a.next,a.next=t),i.pending=t,uw(e,n)}return null===(r=i.interleaved)?(// This is the first update. Create a circular list.
t.next=t,// be transferred to the pending queue.
ub(i)):(t.next=r.next,r.next=t),i.interleaved=t,uw(e,n)}function uT(e,t,n){var r=t.updateQueue;if(null!==r){var o=r.shared;if(r5(n)){var i=o.lanes,a=// have finished. We can remove them from the shared queue, which represents
...
var p,h=o.baseState,m=0,g=null,v=null,y=null,b=i;;){var _=b.lane,w=b.eventTime;if((r&_)===_){// This update does have sufficient priority.
if(null!==y){var k={eventTime:w,// This update is going to be committed so we never want uncommit
// it. Using NoLane works because 0 is a subset of all bitmasks, so
// this will never be skipped by the check above.
lane:0,tag:b.tag,payload:b.payload,callback:b.callback,next:null};y=y.next=k}// Process this update.
if(h=function(e,t,n,r,o,i){switch(n.tag){case 1:var a=n.payload;if("function"==typeof a){ud=!0;var s=a.call(i,r,o);if(8&e.mode){rF(!0);try{a.call(i,r,o)}finally{rF(!1)}}return ud=!1,s}// State object
return a;case 3:e.flags=-65537&e.flags|128;// Intentional fallthrough
case 0:var u,l=n.payload;if("function"==typeof l){if(ud=!0,u=l.call(i,r,o),8&e.mode){rF(!0);try{l.call(i,r,o)}finally{rF(!1)}}ud=!1}else u=l;if(null==u)break;// Merge the partial state and the previous state.
...
// update/state.
var x={eventTime:w,lane:_,tag:b.tag,payload:b.payload,callback:b.callback,next:null};null===y?(v=y=x,g=h):y=y.next=x,// Update the remaining priority in the queue.
m|=_}if(null===(b=b.next)){if(null===(s=o.shared.pending))break;// An update was scheduled from inside a reducer. Add the new
...
Q=new Set,K=new Set,G=new Set,X=new Set,et=new Set,J=new Set,en=new Set,er=new Set;var uM=new Set;function uL(e,t,n,r){var o=e.memoizedState,i=n(r,o);if(8&e.mode){rF(!0);try{// Invoke the function an extra time to help detect side-effects.
i=n(r,o)}finally{rF(!1)}}Z(t,i);var a=null==i?o:tv({},o,i);e.memoizedState=a,0===e.lanes&&(e.updateQueue.baseState=a)}ee=function(e,t){if(null!==e&&"function"!=typeof e){var n=t+"_"+e;uM.has(n)||(uM.add(n),eL("%s(...): Expected the last optional `callback` argument to be a function. Instead received: %s.",t,e))}},Z=function(e,t){if(void 0===t){var n=tC(e)||"Component";J.has(n)||(J.add(n),eL("%s.getDerivedStateFromProps(): A valid state object (or null) must be returned. You have returned undefined.",n))}},// it causes problems. This is meant to give a nicer error message for
// ReactDOM15.unstable_renderSubtreeIntoContainer(reactDOM16Component,
// ...)) which otherwise throws a "_processChildContext is not a function"
// exception.
Object.defineProperty(uI,"_processChildContext",{enumerable:!1,value:function(){throw Error("_processChildContext is not available in React 16+. This likely means you have multiple copies of React and are attempting to nest a React 15 tree inside a React 16 tree using unstable_renderSubtreeIntoContainer, which isn't supported. Try to make sure you have only one copy of React (and ideally, switch to ReactDOM.createPortal).")}}),Object.freeze(uI);var uN={isMounted:function(e){var t=rp.current;if(null!==t&&1===t.tag){var n=t.stateNode;n._warnedAboutRefsInRender||eL("%s is accessing isMounted inside its render() function. render() should be a pure function of props and state. It should never access something that requires stale data from the previous render, such as refs. Move this logic to componentDidMount and componentDidUpdate instead.",tO(t)||"A component"),n._warnedAboutRefsInRender=!0}var r=rf(e);return!!r&&rh(r)===r},enqueueSetState:function(e,t,n){var r=rf(e),o=fI(),i=fD(r),a=uE(o,i);a.payload=t,null!=n&&(ee(n,"setState"),a.callback=n);var s=uC(r,a,i);null!==s&&(fM(s,r,i,o),uT(s,r,i)),rQ(r,i)},enqueueReplaceState:function(e,t,n){var r=rf(e),o=fI(),i=fD(r),a=uE(o,i);a.tag=1,a.payload=t,null!=n&&(ee(n,"replaceState"),a.callback=n);var s=uC(r,a,i);null!==s&&(fM(s,r,i,o),uT(s,r,i)),rQ(r,i)},enqueueForceUpdate:function(e,t){var n=rf(e),r=fI(),o=fD(n),i=uE(r,o);i.tag=2,null!=t&&(ee(t,"forceUpdate"),i.callback=t);var a=uC(n,i,o);null!==a&&(fM(a,n,o,r),uT(a,n,o)),null!==rN&&"function"==typeof rN.markForceUpdateScheduled&&rN.markForceUpdateScheduled(n,o)}};function uA(e,t,n,r,o,i,a){var s=e.stateNode;if("function"==typeof s.shouldComponentUpdate){var u=s.shouldComponentUpdate(r,i,a);if(8&e.mode){rF(!0);try{// Invoke the function an extra time to help detect side-effects.
u=s.shouldComponentUpdate(r,i,a)}finally{rF(!1)}}return void 0===u&&eL("%s.shouldComponentUpdate(): Returned undefined instead of a boolean value. Make sure to return true or false.",tC(t)||"Component"),u}return!t.prototype||!t.prototype.isPureReactComponent||!iO(n,r)||!iO(o,i)}function uU(e,t){t.updater=uN,e.stateNode=t,t._reactInternals=e,t._reactInternalInstance=uI}function uF(e,t,n){var r=!1,o=sr,i=sr,a=t.contextType;if("contextType"in t&&!(null===a||void 0!==a&&a.$$typeof===tu&&void 0===a._context)&&!er.has(t)){er.add(t);var s="";s=void 0===a?" However, it is set to undefined. This can be caused by a typo or by mixing up named and default imports. This can also happen due to a circular dependency, so try moving the createContext() call to a separate file.":"object"!=typeof a?" However, it is set to a "+typeof a+".":a.$$typeof===ts?" Did you accidentally pass the Context.Provider instead?":void 0!==a._context?" Did you accidentally pass the Context.Consumer instead?":" However, it is set to an object with keys {"+Object.keys(a).join(", ")+"}.",eL("%s defines an invalid contextType. contextType should point to the Context object returned by React.createContext().%s",tC(t)||"Component",s)}"object"==typeof a&&null!==a?i=uv(a):(o=ss(e,t,!0),i=(r=null!=t.contextTypes)?sl(e,o):sr);var u=new t(n,i);// Instantiate twice to help detect side-effects.
if(8&e.mode){rF(!0);try{u=new t(n,i);// eslint-disable-line no-new
}finally{rF(!1)}}var l=e.memoizedState=null!==u.state&&void 0!==u.state?u.state:null;if(uU(e,u),"function"==typeof t.getDerivedStateFromProps&&null===l){var c=tC(t)||"Component";K.has(c)||(K.add(c),eL("`%s` uses `getDerivedStateFromProps` but its initial state is %s. This is not recommended. Instead, define the initial state by assigning an object to `this.state` in the constructor of `%s`. This ensures that `getDerivedStateFromProps` arguments have a consistent shape.",c,null===u.state?"null":"undefined",c))}// If new component APIs are defined, "unsafe" lifecycles won't be called.
// Warn about these lifecycles if they are present.
// Don't warn about react-lifecycles-compat polyfilled methods though.
if("function"==typeof t.getDerivedStateFromProps||"function"==typeof u.getSnapshotBeforeUpdate){var d=null,f=null,p=null;if("function"==typeof u.componentWillMount&&!0!==u.componentWillMount.__suppressDeprecationWarning?d="componentWillMount":"function"==typeof u.UNSAFE_componentWillMount&&(d="UNSAFE_componentWillMount"),"function"==typeof u.componentWillReceiveProps&&!0!==u.componentWillReceiveProps.__suppressDeprecationWarning?f="componentWillReceiveProps":"function"==typeof u.UNSAFE_componentWillReceiveProps&&(f="UNSAFE_componentWillReceiveProps"),"function"==typeof u.componentWillUpdate&&!0!==u.componentWillUpdate.__suppressDeprecationWarning?p="componentWillUpdate":"function"==typeof u.UNSAFE_componentWillUpdate&&(p="UNSAFE_componentWillUpdate"),null!==d||null!==f||null!==p){var h=tC(t)||"Component",m="function"==typeof t.getDerivedStateFromProps?"getDerivedStateFromProps()":"getSnapshotBeforeUpdate()";X.has(h)||(X.add(h),eL("Unsafe legacy lifecycles will not be called for components using new component APIs.\n\n%s uses %s but also contains the following legacy lifecycles:%s%s%s\n\nThe above lifecycles should be removed. Learn more about this warning here:\nhttps://reactjs.org/link/unsafe-component-lifecycles",h,m,null!==d?"\n  "+d:"",null!==f?"\n  "+f:"",null!==p?"\n  "+p:""))}}return r&&su(e,o,i),u}function uj(e,t,n,r){var o=t.state;if("function"==typeof t.componentWillReceiveProps&&t.componentWillReceiveProps(n,r),"function"==typeof t.UNSAFE_componentWillReceiveProps&&t.UNSAFE_componentWillReceiveProps(n,r),t.state!==o){var i=tO(e)||"Component";Q.has(i)||(Q.add(i),eL("%s.componentWillReceiveProps(): Assigning directly to this.state is deprecated (except inside a component's constructor). Use setState instead.",i)),uN.enqueueReplaceState(t,t.state,null)}}// Invokes the mount life-cycles on a previously never rendered instance.
function uz(e,t,n,r){o=e.stateNode,i=tC(t)||"Component",o.render||(t.prototype&&"function"==typeof t.prototype.render?eL("%s(...): No `render` method found on the returned component instance: did you accidentally return an object from the constructor?",i):eL("%s(...): No `render` method found on the returned component instance: you may have forgotten to define `render`.",i)),!o.getInitialState||o.getInitialState.isReactClassApproved||o.state||eL("getInitialState was defined on %s, a plain JavaScript class. This is only supported for classes created using React.createClass. Did you mean to define a state property instead?",i),o.getDefaultProps&&!o.getDefaultProps.isReactClassApproved&&eL("getDefaultProps was defined on %s, a plain JavaScript class. This is only supported for classes created using React.createClass. Use a static property to define defaultProps instead.",i),o.propTypes&&eL("propTypes was defined as an instance property on %s. Use a static property to define propTypes instead.",i),o.contextType&&eL("contextType was defined as an instance property on %s. Use a static property to define contextType instead.",i),o.contextTypes&&eL("contextTypes was defined as an instance property on %s. Use a static property to define contextTypes instead.",i),t.contextType&&t.contextTypes&&!en.has(t)&&(en.add(t),eL("%s declares both contextTypes and contextType static properties. The legacy contextTypes property will be ignored.",i)),"function"==typeof o.componentShouldUpdate&&eL("%s has a method called componentShouldUpdate(). Did you mean shouldComponentUpdate()? The name is phrased as a question because the function is expected to return a value.",i),t.prototype&&t.prototype.isPureReactComponent&&void 0!==o.shouldComponentUpdate&&eL("%s has a method called shouldComponentUpdate(). shouldComponentUpdate should not be used when extending React.PureComponent. Please extend React.Component if shouldComponentUpdate is used.",tC(t)||"A pure component"),"function"==typeof o.componentDidUnmount&&eL("%s has a method called componentDidUnmount(). But there is no such lifecycle method. Did you mean componentWillUnmount()?",i),"function"==typeof o.componentDidReceiveProps&&eL("%s has a method called componentDidReceiveProps(). But there is no such lifecycle method. If you meant to update the state in response to changing props, use componentWillReceiveProps(). If you meant to fetch data or run side-effects or mutations after React has updated the UI, use componentDidUpdate().",i),"function"==typeof o.componentWillRecieveProps&&eL("%s has a method called componentWillRecieveProps(). Did you mean componentWillReceiveProps()?",i),"function"==typeof o.UNSAFE_componentWillRecieveProps&&eL("%s has a method called UNSAFE_componentWillRecieveProps(). Did you mean UNSAFE_componentWillReceiveProps()?",i),a=o.props!==n,void 0!==o.props&&a&&eL("%s(...): When calling super() in `%s`, make sure to pass up the same props that your component's constructor was passed.",i,i),o.defaultProps&&eL("Setting defaultProps as an instance property on %s is not supported and will be ignored. Instead, define defaultProps as a static property on %s.",i,i),"function"!=typeof o.getSnapshotBeforeUpdate||"function"==typeof o.componentDidUpdate||G.has(t)||(G.add(t),eL("%s: getSnapshotBeforeUpdate() should be used with componentDidUpdate(). This component defines getSnapshotBeforeUpdate() only.",tC(t))),"function"==typeof o.getDerivedStateFromProps&&eL("%s: getDerivedStateFromProps() is defined as an instance method and will be ignored. Instead, declare it as a static method.",i),"function"==typeof o.getDerivedStateFromError&&eL("%s: getDerivedStateFromError() is defined as an instance method and will be ignored. Instead, declare it as a static method.",i),"function"==typeof t.getSnapshotBeforeUpdate&&eL("%s: getSnapshotBeforeUpdate() is defined as a static method and will be ignored. Instead, declare it as an instance method.",i),(s=o.state)&&("object"!=typeof s||t6(s))&&eL("%s.state: must be set to an object or null",i),"function"==typeof o.getChildContext&&"object"!=typeof t.childContextTypes&&eL("%s.getChildContext(): childContextTypes must be defined in order to use getChildContext().",i);var o,i,a,s,u,l,c=e.stateNode;c.props=n,c.state=e.memoizedState,c.refs=uD,uS(e);var d=t.contextType;if("object"==typeof d&&null!==d)c.context=uv(d);else{var f=ss(e,t,!0);c.context=sl(e,f)}if(c.state===n){var p=tC(t)||"Component";et.has(p)||(et.add(p),eL("%s: It is not recommended to assign props directly to state because updates to props won't be reflected in state. In most cases, it is better to use props directly.",p))}8&e.mode&&s4.recordLegacyContextWarning(e,c),s4.recordUnsafeLifecycleWarnings(e,c),c.state=e.memoizedState;var h=t.getDerivedStateFromProps;"function"==typeof h&&(uL(e,t,h,n),c.state=e.memoizedState),"function"!=typeof t.getDerivedStateFromProps&&"function"!=typeof c.getSnapshotBeforeUpdate&&("function"==typeof c.UNSAFE_componentWillMount||"function"==typeof c.componentWillMount)&&(u=c.state,"function"==typeof c.componentWillMount&&c.componentWillMount(),"function"==typeof c.UNSAFE_componentWillMount&&c.UNSAFE_componentWillMount(),u!==c.state&&(eL("%s.componentWillMount(): Assigning directly to this.state is deprecated (except inside a component's constructor). Use setState instead.",tO(e)||"Component"),uN.enqueueReplaceState(c,c.state,null)),// process them now.
...
var i=pw(n,e.mode,r);return i.return=e,i}// Update
...
"object"==typeof i&&null!==i&&i.$$typeof===tp&&u$(i)===t.type)){// Move based on index
...
// node.
var r=pw(""+t,e.mode,n);return r.return=e,r}if("object"==typeof t&&null!==t){switch(t.$$typeof){case tn:var o=py(t,e.mode,n);return o.ref=uB(e,null,t),o.return=e,o;case tr:var i=pk(t,e.mode,n);return i.return=e,i;case tp:var a=t._payload;return d(e,(0,t._init)(a),n)}if(t6(t)||tg(t)){var s=pb(t,e.mode,n,null);return s.return=e,s}uV(e,t)}return"function"==typeof t&&uW(e),null}function f(e,t,n,r){// Update the fiber if the keys match, otherwise return null.
...
// because hot reloading has different semantics than prod because
// it doesn't resuspend. So we can't let the call below suspend.
"object"==typeof l&&null!==l&&l.$$typeof===tp&&u$(l)===u.type){n(e,u.sibling);var d=o(u,i.props);return d.ref=uB(e,u,i),d.return=e,d._debugSource=i._source,d._debugOwner=i._owner,d}// Didn't match.
...
var m=null,g=null,v=a,y=0,b=0,_=null;null!==v&&b<s.length;b++){v.index>b?(_=v,v=null):_=v.sibling;var w=f(o,v,s[b],u);if(null===w){// TODO: This breaks on empty slots like null children. That's
// unfortunate because it triggers the slow path all the time. We need
// a better way to communicate whether this was a miss or null,
// boolean, undefined, etc.
null===v&&(v=_);break}e&&v&&null===w.alternate&&// need to delete the existing child.
t(o,v),y=i(w,y,b),null===g?m=w:// I.e. if we had null values before, then we want to defer this
// for each null value. However, we also don't want to call updateSlot
// with the previous one.
g.sibling=w,g=w,v=_}if(b===s.length)return(// We've reached the end of the new children. We can delete the rest.
...
"Generator"===s[Symbol.toStringTag]&&(ei||eL("Using Generators as children is unsupported and will likely yield unexpected results because enumerating a generator mutates it. You may convert it to an array with `Array.from()` or the `[...spread]` operator before rendering. Keep in mind you might need to polyfill these features for older browsers."),ei=!0),s.entries===l&&(eo||eL("Using Maps as children is not supported. Use an array of keyed ReactElements instead."),eo=!0);// We'll get a different iterator later for the main pass.
var c=l.call(s);if(c)for(var m=null,g=c.next();!g.done;g=c.next())m=h(g.value,m,o);var v=l.call(s);if(null==v)throw Error("An iterable object provided no iterator.");for(var y=null,b=null,_=a,w=0,k=0,S=null,x=v.next();null!==_&&!x.done;k++,x=v.next()){_.index>k?(S=_,_=null):S=_.sibling;var E=f(o,_,x.value,u);if(null===E){// TODO: This breaks on empty slots like null children. That's
// unfortunate because it triggers the slow path all the time. We need
// a better way to communicate whether this was a miss or null,
// boolean, undefined, etc.
null===_&&(_=S);break}e&&_&&null===E.alternate&&// need to delete the existing child.
t(o,_),w=i(E,w,k),null===b?y=E:// I.e. if we had null values before, then we want to defer this
// for each null value. However, we also don't want to call updateSlot
// with the previous one.
b.sibling=E,b=E,_=S}if(x.done)return(// We've reached the end of the new children. We can delete the rest.
n(o,_),sz&&sD(o,k),y);if(null===_){// If we don't have any more existing children we can choose a fast path
// since the rest will all be insertions.
for(;!x.done;k++,x=v.next()){var C=d(o,x.value,u);null!==C&&(w=i(C,w,k),null===b?y=C:b.sibling=C,b=C)}return sz&&sD(o,k),y}// Add all children to a key map for quick lookups.
for(var T=r(o,_);!x.done;k++,x=v.next()){var O=p(T,o,k,x.value,u);null!==O&&(e&&null!==O.alternate&&// current, that means that we reused the fiber. We need to delete
// it from the child list so that we don't add it to the deletion
// list.
T.delete(null===O.key?k:O.key),w=i(O,w,k),null===b?y=O:b.sibling=O,b=O)}return e&&// to add them to the deletion list.
...
n(e,t);var s=pw(r,e.mode,i);return s.return=e,s}(u,l,""+c,m)):("function"==typeof c&&uW(u),n(u,l))})}eo=!1,ei=!1,ea={},/**
   * Warn if there's no key explicitly set on dynamic arrays of children or
   * object keys are not valid. This allows us to keep track of children between
   * updates.
   */es={},eu={},uq=function(e,t){if(null!==e&&"object"==typeof e&&e._store&&!e._store.validated&&null==e.key){if("object"!=typeof e._store)throw Error("React Component in warnForMissingKey should have a _store. This error is likely caused by a bug in React. Please file an issue.");e._store.validated=!0;var n=tO(t)||"Component";es[n]||(es[n]=!0,eL('Each child in a list should have a unique "key" prop. See https://reactjs.org/link/warning-keys for more information.'))}};var uY=uH(!0),uQ=uH(!1),uK={},uG=se(uK),uX=se(uK),uJ=se(uK);function uZ(e){if(e===uK)throw Error("Expected host context to exist. This error is likely caused by a bug in React. Please file an issue.");return e}function u0(){return uZ(uJ.current)}function u1(e,t){// Push current root instance onto the stack;
...
for(var o=lf[r],i=r===lp?e:o,a=r+1+". "+o;a.length<30;)a+=" ";a+=i+"\n",n+=a}eL("React has detected a change in the order of Hooks called by %s. This will lead to bugs and errors if not fixed. For more information, read the Rules of Hooks: https://reactjs.org/link/rules-of-hooks\n\n   Previous render            Next render\n   ------------------------------------------------------\n%s   ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^\n",t,n)}}(e)}function lv(e){null==e||t6(e)||// It's unlikely their type would change as usually you define them inline.
eL("%s received a final argument that is not an array (instead, received `%s`). When specified, the final argument must be an array.",ld,typeof e)}function ly(){throw Error("Invalid hook call. Hooks can only be called inside of the body of a function component. This could happen for one of the following reasons:\n1. You might have mismatching versions of React and the renderer (such as React DOM)\n2. You might be breaking the Rules of Hooks\n3. You might have more than one copy of React in the same app\nSee https://reactjs.org/link/invalid-hook-call for tips about how to debug and fix this problem.")}function lb(e,t){if(lh)return!1;if(null===t)return eL("%s received a final argument during this render, but not during the previous render. Even though the final argument is optional, its type cannot change between renders.",ld),!1;// Don't bother comparing lengths in prod because these arrays should be
// passed inline.
e.length!==t.length&&eL("The final argument passed to %s changed size between renders. The order and size of this array must remain constant.\n\nPrevious: %s\nIncoming: %s",ld,"["+t.join(", ")+"]","["+e.join(", ")+"]");for(var n=0;n<t.length&&n<e.length;n++)if(!iT(e[n],t[n]))return!1;return!0}function l_(e,t,n,r,o,i){lr=i,lo=t,lf=null!==e?e._debugHookTypes:null,lp=-1,lh=null!==e&&e.type!==t.type,t.memoizedState=null,t.updateQueue=null,t.lanes=0,null!==e&&null!==e.memoizedState?lt.current=cm:null!==lf?// but no stateful hooks have been used.
...
(1&e.mode)!=0&&eL("Internal React error: Expected static flag was missing. Please notify the React team."),ls=!1,u)throw Error("Rendered fewer hooks than expected. This may be caused by an accidental early return statement.");return a}function lw(){// This should be called immediately after every renderWithHooks call.
...
eL("Internal error: Expected work-in-progress queue to be a clone. This is a bug in React."),i.baseQueue=a=s,o.pending=null}if(null!==a){// We have a queue to process.
...
lo.lanes=lo.lanes|g,fi|=y=g}m=m.next}while(null!==m&&m!==c)null===h?f=d:h.next=p,iT(d,r.memoizedState)||(c$=!0),r.memoizedState=d,r.baseState=f,r.baseQueue=h,o.lastRenderedState=d}// Interleaved updates are stored on a separate queue. We aren't going to
// process them during this render, but we do need to track which lanes
// are remaining.
var _=o.interleaved;if(null!==_){var w=_;do{var k,S=w.lane;lo.lanes=lo.lanes|S,fi|=k=S,w=w.next}while(w!==_)}else null===a&&// zero once the queue is empty.
...
iT(s,r.memoizedState)||(c$=!0),r.memoizedState=s,null===r.baseQueue&&(r.baseState=s),o.lastRenderedState=s}return[s,i]}function lI(e,t,n){}function lD(e,t,n){}function lM(e,t,n){var r,o=lo,i=lx();if(sz){if(void 0===n)throw Error("Missing getServerSnapshot, which is required for server-rendered content. Will revert to client rendering.");r=n(),ec||r===n()||(eL("The result of getServerSnapshot should be cached to avoid an infinite loop"),ec=!0)}else{if(r=t(),ec||iT(r,t())||(eL("The result of getSnapshot should be cached to avoid an infinite loop"),ec=!0),null===d8)throw Error("Expected a work-in-progress root. This is a bug in React. Please file an issue.");(30&lr)!=0||lN(o,t,r)}// Read the current snapshot from the store on every render. This breaks the
...
o.flags|=/*                      */2048,lq(9,lA.bind(null,o,a,r,t),void 0,null),r}function lL(e,t,n){var r=lo,o=lE(),i=t();ec||iT(i,t())||(eL("The result of getSnapshot should be cached to avoid an infinite loop"),ec=!0);var a=!iT(o.memoizedState,i);a&&(o.memoizedState=i,c$=!0);var s=o.queue;// commit phase if there was an interleaved mutation. In concurrent mode
...
null!==la&&/* */1&la.memoizedState.tag){if(r.flags|=2048,lq(9,lA.bind(null,r,s,i,t),void 0,null),null===d8)throw Error("Expected a work-in-progress root. This is a bug in React. Please file an issue.");(30&lr)!=0||lN(r,t,i)}return i}function lN(e,t,n){e.flags|=/*             */16384;var r={getSnapshot:t,value:n},o=lo.updateQueue;if(null===o)o=lC(),lo.updateQueue=o,o.stores=[r];else{var i=o.stores;null===i?o.stores=[r]:i.push(r)}}function lA(e,t,n,r){// These are updated in the passive phase
t.value=n,t.getSnapshot=r,lF(t)&&lj(e)}function lU(e,t,n){return n(function(){// The store changed. Check if the snapshot changed since the last time we
// read from the store.
lF(t)&&lj(e)})}function lF(e){var t=e.getSnapshot,n=e.value;try{var r=t();return!iT(n,r)}catch(e){return!0}}function lj(e){var t=uw(e,1);null!==t&&fM(t,e,1,-1)}function lz(e){var t=lx();"function"==typeof e&&(e=e()),t.memoizedState=t.baseState=e;var n={pending:null,interleaved:null,lanes:0,dispatch:null,lastRenderedReducer:lT,lastRenderedState:e};t.queue=n;var r=n.dispatch=cu.bind(null,lo,n);return[t.memoizedState,r]}function lq(e,t,n,r){var o={tag:e,create:t,destroy:n,deps:r,// Circular
next:null},i=lo.updateQueue;if(null===i)i=lC(),lo.updateQueue=i,i.lastEffect=o.next=o;else{var a=i.lastEffect;if(null===a)i.lastEffect=o.next=o;else{var s=a.next;a.next=o,o.next=s,i.lastEffect=o}}return o}function lB(e){var t=lx(),n={current:e};return t.memoizedState=n,n}function lV(e){return lE().memoizedState}function lW(e,t,n,r){var o=lx(),i=void 0===r?null:r;lo.flags|=e,o.memoizedState=lq(1|t,n,void 0,i)}function l$(e,t,n,r){var o=lE(),i=void 0===r?null:r,a=void 0;if(null!==li){var s=li.memoizedState;if(a=s.destroy,null!==i&&lb(i,s.deps)){o.memoizedState=lq(t,n,a,i);return}}lo.flags|=e,o.memoizedState=lq(1|t,n,a,i)}function lH(e,t){return(16&lo.mode)!=0?lW(41945088,/*   */8,e,t):lW(8390656,8,e,t)}function lY(e,t){return l$(2048,8,e,t)}function lQ(e,t){return lW(/*                       */4,/*  */2,e,t)}function lK(e,t){return l$(4,2,e,t)}function lG(e,t){var n;return n=4194308,(16&lo.mode)!=0&&(n|=16777216),lW(n,/*    */4,e,t)}function lX(e,t){return l$(4,4,e,t)}function lJ(e,t){if("function"==typeof t)return t(e()),function(){t(null)};if(null!=t){t.hasOwnProperty("current")||eL("Expected useImperativeHandle() first argument to either be a ref callback or React.createRef() object. Instead received: %s.","an object with keys {"+Object.keys(t).join(", ")+"}");var n=e();return t.current=n,function(){t.current=null}}}function lZ(e,t,n){"function"!=typeof t&&eL("Expected useImperativeHandle() second argument to be a function that creates a handle. Instead received: %s.",null!==t?typeof t:"null");var r,o=null!=n?n.concat([e]):null;return r=4194308,(16&lo.mode)!=0&&(r|=16777216),lW(r,4,lJ.bind(null,t,e),o)}function l0(e,t,n){"function"!=typeof t&&eL("Expected useImperativeHandle() second argument to be a function that creates a handle. Instead received: %s.",null!==t?typeof t:"null");var r=null!=n?n.concat([e]):null;return l$(4,4,lJ.bind(null,t,e),r)}function l1(e,t){// The react-debug-hooks package injects its own implementation
...
return lx().memoizedState=r,[t,r]}function cn(){return[lR(lT)[0],lE().memoizedState]}function cr(){return[lP(lT)[0],lE().memoizedState]}var co=!1;function ci(){var e,t=lx(),n=d8.identifierPrefix;if(sz){e=":"+n+"R"+(r=sI,((o=sP)&~(1<<sN(o)-1)).toString(32)+r);// that represents the position of this useId hook among all the useId
// hooks for this fiber.
var r,o,i=ll++;i>0&&(e+="H"+i.toString(32)),e+=":"}else e=":"+n+"r"+(lc++).toString(32)+":";return t.memoizedState=e,e}function ca(){return lE().memoizedState}function cs(e,t,n){"function"==typeof arguments[3]&&eL("State updates from the useState() and useReducer() Hooks don't support the second callback argument. To execute a side effect after rendering, declare it in the component body with useEffect().");var r=fD(e),o={lane:r,action:n,hasEagerState:!1,eagerState:null,next:null};if(cl(e))cc(t,o);else{var i=u_(e,t,o,r);null!==i&&(fM(i,e,r,fI()),cd(i,t,r))}rQ(e,r)}function cu(e,t,n){"function"==typeof arguments[3]&&eL("State updates from the useState() and useReducer() Hooks don't support the second callback argument. To execute a side effect after rendering, declare it in the component body with useEffect().");var r=fD(e),o={lane:r,action:n,hasEagerState:!1,eagerState:null,next:null};if(cl(e))cc(t,o);else{var i=e.alternate;if(0===e.lanes&&(null===i||0===i.lanes)){// The queue is currently empty, which means we can eagerly compute the
...
ub(t)):(o.next=u.next,u.next=o),t.interleaved=o;return}}catch(e){}finally{lt.current=a}}}var d=u_(e,t,o,r);null!==d&&(fM(d,e,r,fI()),cd(d,t,r))}rQ(e,r)}function cl(e){var t=e.alternate;return e===lo||null!==t&&t===lo}function cc(e,t){// This is a render phase update. Stash it in a lazily-created map of
...
(o.passiveEffectDuration+=t);return}n=n.return}}}function cM(){cx=ck()}function cL(e){for(// Transfer time spent rendering these children so we don't lose it
// after we rerender. This is used as a helper in special cases
// where we should count the work of multiple passes.
var t=e.child;t;)e.actualDuration+=t.actualDuration,t=t.sibling}function cN(e,t){// If the value is an error, call this function immediately after it is thrown
...
setTimeout(function(){throw e})}}var cF="function"==typeof WeakMap?WeakMap:Map;function cj(e,t,n){var r=uE(-1,n);// Unmount the root by rendering null.
...
var r,o=e.pingCache;if(null===o?(o=e.pingCache=new cF,r=new Set,o.set(t,r)):void 0===(r=o.get(t))&&(r=new Set,o.set(t,r)),!r.has(n)){// Memoize using the thread ID to prevent redundant listeners.
...
e.lanes=o,e)}var cW=eI.ReactCurrentOwner,c$=!1;function cH(e,t,n,r){null===e?// won't update its child set by applying minimal side-effects. Instead,
...
var i,a,s=n.propTypes;s&&a8(s,r,"prop",tC(n))}var u=n.render,l=t.ref;if(ug(t,o),rB(t),cW.current=t,tI=!0,i=l_(e,t,u,r,l,o),a=lw(),8&t.mode){rF(!0);try{i=l_(e,t,u,r,l,o),a=lw()}finally{rF(!1)}}return(tI=!1,rV(),null===e||c$)?(sz&&a&&sL(t),// React DevTools reads this flag.
...
var l=i&&i.propTypes;l&&a8(l,r,"prop",tC(i))}}if(null!==e){var c=e.memoizedProps;if(iO(c,r)&&e.ref===t.ref&&t.type===e.type){if(c$=!1,// would during a normal fiber bailout.
//
...
(c$=!0)}}return cJ(e,t,n,r,o)}function cG(e,t,n){var r,o,i=t.pendingProps,a=i.children,s=null!==e?e.memoizedState:null;if("hidden"===i.mode){// Rendering a hidden tree.
...
// because they're only guaranteed to be resolved here.
var i,a,s,u=n.propTypes;u&&a8(u,r,"prop",tC(n))}var l=ss(t,n,!0);if(i=sl(t,l),ug(t,o),rB(t),cW.current=t,tI=!0,a=l_(e,t,n,r,i,o),s=lw(),8&t.mode){rF(!0);try{a=l_(e,t,n,r,i,o),s=lw()}finally{rF(!1)}}return(tI=!1,rV(),null===e||c$)?(sz&&s&&sL(t),// React DevTools reads this flag.
...
switch(pL(t)){case!1:var i,a,s=t.stateNode,u=new t.type(t.memoizedProps,s.context).state;s.updater.enqueueSetState(s,u,null);break;case!0:t.flags|=128,t.flags|=65536;var l,c=Error("Simulated error coming from DevTools"),d=(l=o)&-l;t.lanes=t.lanes|d;var f=cz(t,cN(c,t),d);uO(t,f)}if(t.type!==t.elementType){// Lazy component props can't be validated in createElement
// because they're only guaranteed to be resolved here.
var p=n.propTypes;p&&a8(p,r,"prop",tC(n))}sd(n)?(i=!0,sg(t)):i=!1,ug(t,o),null===t.stateNode?(ds(e,t),uF(t,n,r),uz(t,n,r,o),a=!0):a=null===e?function(e,t,n,r){var o,i,a,s=e.stateNode,u=e.memoizedProps;s.props=u;var l=s.context,c=t.contextType,d=sr;if("object"==typeof c&&null!==c)d=uv(c);else{var f=ss(e,t,!0);d=sl(e,f)}var p=t.getDerivedStateFromProps,h="function"==typeof p||"function"==typeof s.getSnapshotBeforeUpdate;h||"function"!=typeof s.UNSAFE_componentWillReceiveProps&&"function"!=typeof s.componentWillReceiveProps||u===n&&l===d||uj(e,s,n,d),uk=!1;var m=e.memoizedState,g=s.state=m;if(uR(e,n,s,r),g=e.memoizedState,u===n&&m===g&&!sc()&&!uk)return"function"==typeof s.componentDidMount&&(o=4194308,(16&e.mode)!=0&&(o|=16777216),e.flags|=o),!1;"function"==typeof p&&(uL(e,t,p,n),g=e.memoizedState);var v=uk||uA(e,t,u,n,m,g,d);return v?(h||"function"!=typeof s.UNSAFE_componentWillMount&&"function"!=typeof s.componentWillMount||("function"==typeof s.componentWillMount&&s.componentWillMount(),"function"==typeof s.UNSAFE_componentWillMount&&s.UNSAFE_componentWillMount()),"function"==typeof s.componentDidMount&&(i=4194308,(16&e.mode)!=0&&(i|=16777216),e.flags|=i)):("function"==typeof s.componentDidMount&&(a=4194308,(16&e.mode)!=0&&(a|=16777216),e.flags|=a),// memoized state to indicate that this work can be reused.
...
s0(),s2(o),t.flags|=/*            */256,cH(e,t,n,r),t.child)}function c3(e,t){if(t&&t.childContextTypes&&eL("%s(...): childContextTypes cannot be defined on a function component.",t.displayName||t.name||"Component"),null!==e.ref){var n="",r=tD();r&&(n+="\n\nCheck the render method of `"+r+"`.");var o=r||"",i=e._debugSource;i&&(o=i.fileName+":"+i.lineNumber),em[o]||(em[o]=!0,eL("Function components cannot be given refs. Attempts to access this ref will fail. Did you mean to use React.forwardRef()?%s",n))}if("function"==typeof t.getDerivedStateFromProps){var a=tC(t)||"Unknown";eh[a]||(eL("%s: Function components do not support getDerivedStateFromProps.",a),eh[a]=!0)}if("object"==typeof t.contextType&&null!==t.contextType){var s=tC(t)||"Unknown";ep[s]||(eL("%s: Function components do not support contextType.",s),ep[s]=!0)}}ed={},ef={},ep={},eh={},em={},eg=!1,ev={},ey={};var c4={dehydrated:null,treeContext:null,retryLane:0};function c6(e){return{baseLanes:e,cachePool:null,transitions:null}}function c5(e,t,n){var r=t.pendingProps;// This is used by DevTools to force a boundary to suspend.
pN(t)&&(t.flags|=128);var o=u5.current,i=!1,a=(128&t.flags)!=0;// boundary's children. This involves some custom reconciliation logic. Two
...
var s,u,l,c,d,f,p=t.memoizedState;if(null!==p){var h=p.dehydrated;if(null!==h)return(1&t.mode)==0?(eL("Cannot hydrate Suspense in legacy mode. Switch from ReactDOM.hydrate(element, container) to ReactDOMClient.hydrateRoot(container, <App />).render(element) or remove the Suspense components from the server rendered components."),t.lanes=1):aV(h)?// for this, we need to schedule that at a higher priority based on when it would
...
uY(t,e.child,null,a),f);return t.child.memoizedState=c6(a),t.memoizedState=c4,m}if(sz&&eL("We should not be hydrating here. This is a bug in React. Please file a bug."),(1&t.mode)==0)return c9(e,t,a,// de-opt to client rendering should have an error message.
null);if(aV(o)){var g,v,y,b,_,w,k,S=((b=o.nextSibling&&o.nextSibling.dataset)&&(g=b.dgst,v=b.msg,y=b.stck),{message:v,digest:g,stack:y});return _=S.digest,w=S.message,k=S.stack,c9(e,t,a,cA(w?Error(w):Error("The server could not finish this Suspense boundary, likely due to an error during server rendering. Switched to client rendering."),_,k))}// any context has changed, we need to treat is as if the input might have changed.
var x=(a&e.childLanes)!=0;if(c$||x){// This boundary has changed since the first render. This means that we are now unable to
...
i.retryLane=C,uw(e,C),fM(E,e,C,-1))}// If we have scheduled higher pri work above, this will probably just abort the render
...
t.flags|=128,t.child=e.child;var T=f6.bind(null,e);return o._reactRetry=T,null}s=t,u=o,l=i.treeContext,sj=aW(u.nextSibling),sF=s,sz=!0,sB=null,sq=!1,null!==l&&(sU(),sT[sO++]=sP,sT[sO++]=sI,sT[sO++]=sR,sP=l.id,sI=l.overflow,sR=s);var O=c8(t,r.children);// Mark the children as hydrating. This is a fast path to know whether this
...
O.flags|=/*                    */4096,O)}(e,t,a,r,b,y,n)}if(i){var _,w,k,S,x,E,C,T=r.fallback,O=(_=r.children,S=t.mode,E=(x=e.child).sibling,C={mode:"hidden",children:_},(1&S)==0&&// Make sure we're on the second pass, i.e. the primary child fragment was
// already cloned. In legacy mode, the only case where this isn't true is
// when DevTools forces us to display a fallback; we skip the first render
// pass entirely and go straight to rendering the fallback. (In Concurrent
// Mode, SuspenseList can also trigger this scenario, but this is a legacy-
// only codepath.)
t.child!==x?((w=t.child).childLanes=0,w.pendingProps=C,2&t.mode&&(// Reset the durations from the first pass so they aren't included in the
// final amounts. This seems counterintuitive, since we're intentionally
// not measuring part of the render phase, but this makes it match what we
// do in Concurrent Mode.
w.actualDuration=0,w.actualStartTime=-1,w.selfBaseDuration=x.selfBaseDuration,w.treeBaseDuration=x.treeBaseDuration),// However, since we're going to remain on the fallback, we no longer want
// to delete it.
t.deletions=null):// (We don't do this in legacy mode, because in legacy mode we don't re-use
// the current tree; see previous branch.)
(w=pg(x,C)).subtreeFlags=14680064&x.subtreeFlags,null!==E?k=pg(E,T):(k=pb(T,S,n,null),// mounted but this is a new fiber.
k.flags|=2),k.return=t,w.return=t,w.sibling=k,t.child=w,k),R=t.child,P=e.child.memoizedState;return R.memoizedState=null===P?c6(n):{baseLanes:P.baseLanes|n,cachePool:null,transitions:P.transitions},R.childLanes=e.childLanes&~n,t.memoizedState=c4,O}var I=function(e,t,n,r){var o=e.child,i=o.sibling,a=pg(o,{mode:"visible",children:n});if((1&t.mode)==0&&(a.lanes=r),a.return=t,a.sibling=null,null!==i){// Delete the fallback child fragment
...
function dr(e,t,n){var r=t.pendingProps,o=r.revealOrder,i=r.tail,a=r.children;(function(e){if(void 0!==e&&"forwards"!==e&&"backwards"!==e&&"together"!==e&&!ev[e]){if(ev[e]=!0,"string"==typeof e)switch(e.toLowerCase()){case"together":case"forwards":case"backwards":eL('"%s" is not a valid value for revealOrder on <SuspenseList />. Use lowercase "%s" instead.',e,e.toLowerCase());break;case"forward":case"backward":eL('"%s" is not a valid value for revealOrder on <SuspenseList />. React uses the -s suffix in the spelling. Use "%ss" instead.',e,e.toLowerCase());break;default:eL('"%s" is not a supported revealOrder on <SuspenseList />. Did you mean "together", "forwards" or "backwards"?',e)}else eL('%s is not a supported value for revealOrder on <SuspenseList />. Did you mean "together", "forwards" or "backwards"?',e)}})(o),void 0===i||ey[i]||("collapsed"!==i&&"hidden"!==i?(ey[i]=!0,eL('"%s" is not a supported value for tail on <SuspenseList />. Did you mean "collapsed" or "hidden"?',i)):"forwards"!==o&&"backwards"!==o&&(ey[i]=!0,eL('<SuspenseList tail="%s" /> is only valid if revealOrder is "forwards" or "backwards". Did you mean to specify revealOrder="forwards"?',i))),function(e,t){if(("forwards"===t||"backwards"===t)&&null!=e&&!1!==e){if(t6(e)){for(var n=0;n<e.length;n++)if(!dt(e[n],n))return}else{var r=tg(e);if("function"==typeof r){var o=r.call(e);if(o)for(var i=o.next(),a=0;!i.done;i=o.next()){if(!dt(i.value,a))return;a++}}else eL('A single row was passed to a <SuspenseList revealOrder="%s" />. This is not useful since it needs multiple rows. Did you mean to pass multiple children or an array?',t)}}}(a,o),cH(e,t,a,n);var s=u5.current;if((2&s)!=0?(s=1&s|2,t.flags|=128):(null!==e&&(128&e.flags)!=0&&// on any nested boundaries to let them know to try to render
...
c$=!0;else{if(!dl(e,n)&&// If this is the second pass of an error or suspense boundary, there
...
c$=(131072&e.flags)!=0}}else if(c$=!1,sz&&(sU(),(1048576&t.flags)!=0)){// Check if this child belongs to a list of muliple children in
// its parent.
//
...
var l=cN(Error("There was an error while hydrating. Because the error happened outside of a Suspense boundary, the entire root will switch to client rendering."),t);return c2(e,t,s,n,l)}if(s!==i){var c=cN(Error("This root received an early update, before anything was able hydrate. Switched the entire root to client rendering."),t);return c2(e,t,s,n,c)}// The outermost shell has not hydrated yet. Start hydrating.
sj=aW(t.stateNode.containerInfo.firstChild),sF=t,sz=!0,sB=null,sq=!1;var d=uQ(t,null,s,n);t.child=d;for(var f=d;f;)// Mark each child as hydrating. This is a fast path to know whether this
...
// already hydrated.
s0(),s===i)return du(e,t,n);cH(e,t,s,n)}return t.child}(e,t,n);case 5:return u4(t),null===e&&sG(t),w=t.type,k=t.pendingProps,S=null!==e?e.memoizedProps:null,x=k.children,aN(w,k)?// case. We won't handle it as a reified child. We will instead handle
// this in the host environment that also has access to this prop. That
// avoids allocating another HostText fiber and traversing it.
x=null:null!==S&&aN(w,S)&&// empty, we need to schedule the text content to be reset.
...
o=o.return}r=o}})(t,r,n)}return cH(e,t,o.children,n),t.child}(e,t,n);case 9:return void 0===(y=t.type)._context?y===y.Consumer||da||(da=!0,eL("Rendering <Context> directly is not supported and will be removed in a future major release. Did you mean to render <Context.Consumer> instead?")):y=y._context,"function"!=typeof(b=t.pendingProps.children)&&eL("A context consumer was rendered with multiple children, or a child that isn't a function. A context consumer expects a single child that is a function. If you did pass a function, make sure there is no trailing or leading whitespace around it."),ug(t,n),_=uv(y),rB(t),cW.current=t,tI=!0,v=b(_),tI=!1,rV(),t.flags|=1,cH(e,t,v,n),t.child;case 14:var h=t.type,m=ua(h,t.pendingProps);if(t.type!==t.elementType){var g=h.propTypes;g&&a8(g,m,"prop",tC(h))}return m=ua(h.type,m),cQ(e,t,h,m,n);case 15:return cK(e,t,t.type,t.pendingProps,n);case 17:var v,y,b,_,w,k,S,x,E,C,T,O,R,P,I=t.type,D=t.pendingProps,M=t.elementType===I?D:ua(I,D);return ds(e,t),t.tag=1,sd(I)?(P=!0,sg(t)):P=!1,ug(t,n),uF(t,I,M),uz(t,I,M,n),c0(null,t,I,!0,P,n);case 19:return dr(e,t,n);case 21:break;case 22:return cG(e,t,n)}throw Error("Unknown unit of work tag ("+t.tag+"). This error is likely caused by a bug in React. Please file an issue.")}function dd(e){// Tag the fiber with an update effect. This turns a Placement into
...
s1())),e_(e,t),dh(t),null;case 5:u6(t);var i=u0(),a=t.type;if(null!==e&&null!=t.stateNode)ew(e,t,a,r,i),e.ref!==t.ref&&df(t);else{if(!r){if(null===t.stateNode)throw Error("We must have new props for new mounts. This error is likely caused by a bug in React. Please file an issue.");return(// This can happen when we abort work.
...
i2("invalid",e)}nN(t,n),u=new Set;for(var c=e.attributes,d=0;d<c.length;d++)switch(c[d].name.toLowerCase()){// Controlled attributes are not validated
...
// TODO: Only ignore them on controlled tags.
"value"===p||"checked"===p||"selected"===p);else if(p===ao){var v=e.innerHTML,y=h?h[ac]:void 0;if(null!=y){var b=B(e,y);b!==v&&F(p,v,b)}}else if(p===al){if(// $FlowFixMe - Should be inferred as not undefined.
u.delete(p),q){var _=/**
 ...
 */function(e){var t="",n="";for(var r in e)if(e.hasOwnProperty(r)){var o=e[r];if(null!=o){var i=0===r.indexOf("--");t+=n+(i?r:r.replace(ng,"-$1").toLowerCase().replace(nv,"-ms-"))+":"+nm(r,o,i),n=";"}}return t||null}(h);_!==(m=e.getAttribute("style"))&&F(p,m,_)}}else if(s)// $FlowFixMe - Should be inferred as not undefined.
u.delete(p.toLowerCase()),m=te(e,p,h),h!==m&&F(p,m,h);else if(!eZ(p,g,s)&&!e1(p,h,g,s)){var w=!1;if(null!==g)// $FlowFixMe - Should be inferred as not undefined.
...
w=!0,u.delete(S)),u.delete(p)}m=te(e,p,h)}h===m||w||F(p,m,h)}}}switch(a&&u.size>0&&!0!==n[aa]&&j(u),t){case"input":// TODO: Make sure we check if this is still unmounted or do any clean
...
var o,i,a=am(n),s=r;if(s===na&&(s=nu(e)),s===na){if((o=nA(e,t))||e===e.toLowerCase()||eL("<%s /> is using incorrect casing. Use PascalCase for React components, or lowercase for HTML elements.",e),"script"===e){// Create the script via .innerHTML so its "parser-inserted" flag is
...
i2("invalid",e);break;default:i=n}switch(nN(t,i),function(e,t,n,r,o){for(var i in r)if(r.hasOwnProperty(i)){var a=r[i];if(i===al)a&&// mutated. We have already warned for this in the past.
...
var o=sF;if(null!==o)switch(o.tag){case 3:o.stateNode.containerInfo;var i=(1&o.mode)!=0;ah(t.nodeValue,n,i,!0);break;case 5:o.type;var a=o.memoizedProps,s=(o.stateNode,(1&o.mode)!=0);!0!==a[aD]&&ah(t.nodeValue,n,s,!0)}}return r}(t)&&dd(t):t.stateNode=(ak(null,r,y.ancestorInfo),(g=am(v).createTextNode(r))[aQ]=t,g)}return dh(t),null;case 13:st(u5,t);var b=t.memoizedState;// Special path for dehydrated boundaries. We may eventually move this
// to its own fiber type so that we can add other kinds of hydration
// boundaries that aren't associated with a Suspense tree. In anticipation
// of such a refactor, all the hydration logic is contained in
// this branch.
if((null===e||null!==e.memoizedState&&null!==e.memoizedState.dehydrated)&&!function(e,t,n){if(sz&&null!==sj&&(1&t.mode)!=0&&(128&t.flags)==0)return sZ(t),s0(),t.flags|=98560,!1;var r=sJ(t);if(null===n||null===n.dehydrated)return(// Successfully completed this tree. If this was a forced client render,
...
t.lanes=n,(2&t.mode)!=0&&cL(t),t);var _=null!==b;// a passive effect, which is when we process the transitions
if(_!==(null!==e&&null!==e.memoizedState)&&_){var w=t.child;// in the concurrent tree already suspended during this render.
// This is a known bug.
w.flags|=/*                   */8192,(1&t.mode)!=0&&((null!==e||(t.memoizedProps.unstable_avoidThisFallback,0))&&(1&u5.current)==0?// suspend for longer if possible.
fY():0===fn&&(fn=3))}if(null!==t.updateQueue&&// TODO: Move to passive phase
(t.flags|=4),dh(t),(2&t.mode)!=0&&_){// Don't count time spent in a timed out Suspense subtree as part of the base duration.
var k=t.child;null!==k&&(t.treeBaseDuration-=k.treeBaseDuration)}return null;case 4:return u2(t),e_(e,t),null===e&&i6(t.stateNode.containerInfo),dh(t),null;case 10:return uh(t.type._context,t),dh(t),null;case 19:st(u5,t);var S=t.memoizedState;if(null===S)return(// We're running in the default, "independent" mode.
...
return x?M=1&M|2:M&=1,u8(t,M),D}return dh(t),null;case 21:break;case 22:case 23:fV(t);var L=null!==t.memoizedState;return null!==e&&null!==e.memoizedState!==L&&(t.flags|=8192),L&&(1&t.mode)!=0?(1073741824&fe)!=0&&(dh(t),6&t.subtreeFlags&&(t.flags|=8192)):dh(t),null;case 24:case 25:return null}throw Error("Unknown unit of work tag ("+t.tag+"). This error is likely caused by a bug in React. Please file an issue.")}function dg(e,t,n){switch(// Note: This intentionally doesn't check if we're hydrating because comparing
...
var o=t.child;null!==o;){if(5===o.tag||6===o.tag)!function(e,t){e.appendChild(t)}(e,o.stateNode);else if(4===o.tag);else if(null!==o.child){o.child.return=o,o=o.child;continue}if(o===t)return;for(;null===o.sibling;){if(null===o.return||o.return===t)return;o=o.return}o.sibling.return=o.return,o=o.sibling}},e_=function(e,t){},ew=function(e,t,n,r,o){// If we have an alternate, that means this is an update and we need to
// schedule a side-effect to do the updates.
var i=e.memoizedProps;if(i!==r){// component is hitting the resume path. Figure out why. Possibly
// related to `hidden`.
var a=function(e,t,n,r,o,i){if(typeof r.children!=typeof n.children&&("string"==typeof r.children||"number"==typeof r.children)){var a=""+r.children,s=aS(i.ancestorInfo,t);ak(null,a,s)}return function(e,t,n,r,o){U(t,r);var i,a,s,u,l=null;switch(t){case"input":i=tK(e,n),a=tK(e,r),l=[];break;case"select":i=t9(e,n),a=t9(e,r),l=[];break;case"textarea":i=nn(e,n),a=nn(e,r),l=[];break;default:i=n,a=r,"function"!=typeof i.onClick&&"function"==typeof a.onClick&&av(e)}nN(t,a);var c=null;for(s in i)if(!a.hasOwnProperty(s)&&i.hasOwnProperty(s)&&null!=i[s]){if(s===al){var d=i[s];for(u in d)d.hasOwnProperty(u)&&(c||(c={}),c[u]="")}else s!==ao&&s!==au&&s!==ai&&s!==aa&&s!==as&&(eU.hasOwnProperty(s)?l||(l=[]):// the allowed property list in the commit phase instead.
 ...
 */function(e,t){if(t){var n=nM(e),r=nM(t),o={};for(var i in n){var a=n[i],s=r[i];if(s&&a!==s){var u,l=a+","+s;if(o[l])continue;o[l]=!0,eL("%s a style property during rerender (%s) when a conflicting property is set (%s) can lead to styling bugs. To avoid this, don't mix shorthand and non-shorthand properties for the same value; instead, replace the shorthand with separate values.",null==(u=e[a])||"boolean"==typeof u||""===u?"Removing":"Updating",a,s)}}}}(c,a[al]),(l=l||[]).push(al,c)),l}// Apply the diff.
...
var dy=!1,db=!1,d_="function"==typeof WeakSet?WeakSet:Set,dw=null,dk=null,dS=null,dx=function(e,t){if(t.props=e.memoizedProps,t.state=e.memoizedState,2&e.mode)try{cM(),t.componentWillUnmount()}finally{cI(e)}else t.componentWillUnmount()};function dE(e,t){try{dD(4,e)}catch(n){f2(e,t,n)}}// Capture errors so they don't interrupt unmounting.
function dC(e,t,n){try{dx(e,n)}catch(n){f2(e,t,n)}}// Capture errors so they don't interrupt mounting.
function dT(e,t){try{dM(e)}catch(n){f2(e,t,n)}}function dO(e,t){var n,r=e.ref;if(null!==r){if("function"==typeof r){try{if(2&e.mode)try{cM(),n=r(null)}finally{cI(e)}else n=r(null)}catch(n){f2(e,t,n)}"function"==typeof n&&eL("Unexpected return value from a callback ref in %s. A callback ref should not return a function.",tO(e))}else r.current=null}}function dR(e,t,n){try{n()}catch(n){f2(e,t,n)}}var dP=!1;function dI(e,t,n){var r=t.updateQueue,o=null!==r?r.lastEffect:null;if(null!==o){var i=o.next,a=i;do{if((a.tag&e)===e){// Unmount
var s=a.destroy;a.destroy=void 0,void 0!==s&&((8&e)!=/*   */0?null!==rN&&"function"==typeof rN.markComponentPassiveEffectUnmountStarted&&rN.markComponentPassiveEffectUnmountStarted(t):(4&e)!=0&&rW(t),(2&e)!=0&&(fP=!0),dR(t,n,s),(2&e)!=0&&(fP=!1),(8&e)!=0?null!==rN&&"function"==typeof rN.markComponentPassiveEffectUnmountStopped&&rN.markComponentPassiveEffectUnmountStopped():(4&e)!=0&&r$())}a=a.next}while(a!==i)}}function dD(e,t){var n=t.updateQueue,r=null!==n?n.lastEffect:null;if(null!==r){var o=r.next,i=o;do{if((i.tag&e)===e){(8&e)!=0?null!==rN&&"function"==typeof rN.markComponentPassiveEffectMountStarted&&rN.markComponentPassiveEffectMountStarted(t):(4&e)!=0&&null!==rN&&"function"==typeof rN.markComponentLayoutEffectMountStarted&&rN.markComponentLayoutEffectMountStarted(t);var a=i.create;(2&e)!=0&&(fP=!0),i.destroy=a(),(2&e)!=0&&(fP=!1),(8&e)!=0?null!==rN&&"function"==typeof rN.markComponentPassiveEffectMountStopped&&rN.markComponentPassiveEffectMountStopped():(4&e)!=0&&null!==rN&&"function"==typeof rN.markComponentLayoutEffectMountStopped&&rN.markComponentLayoutEffectMountStopped();var s=i.destroy;if(void 0!==s&&"function"!=typeof s){var u=void 0;u=(4&i.tag)!=0?"useLayoutEffect":(2&i.tag)!=0?"useInsertionEffect":"useEffect";var l=void 0;l=null===s?" You returned null. If your effect does not require clean up, return undefined (or nothing).":"function"==typeof s.then?"\n\nIt looks like you wrote "+u+"(async () => ...) or returned a Promise. Instead, write the async function inside your effect and call it immediately:\n\n"+u+"(() => {\n  async function fetchData() {\n    // You can await here\n    const response = await MyAPI.getData(someId);\n    // ...\n  }\n  fetchData();\n}, [someId]); // Or [] if effect doesn't need props or state\n\nLearn more about data fetching with Hooks: https://reactjs.org/link/hooks-data-fetching":" You returned: "+s,eL("%s must not return anything besides a function, which is used for clean-up.%s",u,l)}}i=i.next}while(i!==o)}}function dM(e){var t=e.ref;if(null!==t){var n,r=e.stateNode;if(e.tag,"function"==typeof t){if(2&e.mode)try{cM(),n=t(r)}finally{cI(e)}else n=t(r);"function"==typeof n&&eL("Unexpected return value from a callback ref in %s. A callback ref should not return a function.",tO(e))}else t.hasOwnProperty("current")||eL("Unexpected ref object provided for %s. Use either a ref-setter function or React.createRef().",tO(e)),t.current=r}}function dL(e){return 5===e.tag||3===e.tag||4===e.tag}function dN(e){// We're going to search forward into the tree until we find a sibling host
...
// a deletion.
var dA=null,dU=!1;function dF(e,t,n){for(// TODO: Use a static flag to skip trees that don't have unmount effects
var r=n.child;null!==r;)dj(e,t,r),r=r.sibling}function dj(e,t,n){// into their subtree. There are simpler cases in the inner switch
// that don't modify the stack.
switch(function(e){if(rL&&"function"==typeof rL.onCommitFiberUnmount)try{rL.onCommitFiberUnmount(rM,e)}catch(e){rA||(rA=!0,eL("React instrumentation encountered an error: %s",e))}}(n),n.tag){case 5:db||dO(n,t);// Intentional fallthrough to next branch
// eslint-disable-next-line-no-fallthrough
case 6:var r,o,i,a,s=dA,u=dU;dA=null,dF(e,t,n),dA=s,dU=u,null!==dA&&(dU?(i=dA,a=n.stateNode,8===i.nodeType?i.parentNode.removeChild(a):i.removeChild(a)):function(e,t){e.removeChild(t)}(dA,n.stateNode));return;case 18:null!==dA&&(dU?(r=dA,o=n.stateNode,8===r.nodeType?aq(r.parentNode,o):1===r.nodeType&&aq(r,o),// Retry if any event replaying was blocked on this.
oE(r)):aq(dA,n.stateNode));return;case 4:// When we go into a portal, it becomes the parent to remove from.
var l=dA,c=dU;dA=n.stateNode.containerInfo,dU=!0,dF(e,t,n),dA=l,dU=c;return;case 0:case 11:case 14:case 15:if(!db){var d=n.updateQueue;if(null!==d){var f=d.lastEffect;if(null!==f){var p=f.next,h=p;do{var m=h,g=m.destroy,v=m.tag;void 0!==g&&((2&v)!=0?dR(n,t,g):(4&v)!=0&&(rW(n),2&n.mode?(cM(),dR(n,t,g),cI(n)):dR(n,t,g),r$())),h=h.next}while(h!==p)}}}dF(e,t,n);return;case 1:if(!db){dO(n,t);var y=n.stateNode;"function"==typeof y.componentWillUnmount&&dC(n,t,y)}dF(e,t,n);return;case 21:default:dF(e,t,n);return;case 22:if(1&n.mode){// If this offscreen component is hidden, we already unmounted it. Before
...
var b=db;db=b||null!==n.memoizedState,dF(e,t,n),db=b}else dF(e,t,n)}}function dz(e){// If this boundary just timed out, then it will have a set of wakeables.
// For each wakeable, attach a listener so that when it resolves, React
// attempts to re-render the boundary in the primary (pre-timeout) state.
var t=e.updateQueue;if(null!==t){e.updateQueue=null;var n=e.stateNode;null===n&&(n=e.stateNode=new d_),t.forEach(function(t){// Memoize using the boundary fiber to prevent redundant listeners.
...
var r,o=t;n:for(;null!==o;){switch(o.tag){case 5:dA=o.stateNode,dU=!1;break n;case 3:case 4:dA=o.stateNode.containerInfo,dU=!0;break n}o=o.return}if(null===dA)throw Error("Expected to find a host parent. This error is likely caused by a bug in React. Please file an issue.");dj(e,t,n),dA=null,dU=!1,null!==(r=n.alternate)&&(r.return=null),n.return=null}(e,t,i)}catch(e){f2(i,t,e)}}var a=tP;if(12854&t.subtreeFlags)for(var s=t.child;null!==s;)tN(s),dB(s,e),s=s.sibling;tN(a)}function dB(e,t,n){var r,o=e.alternate,i=e.flags;// because the fiber tag is more specific. An exception is any flag related
...
// effects again.
var y=db;db=y||v,dq(t,e),db=y}else dq(t,e);if(dV(e),8192&i){var b=e.stateNode,_=null!==e.memoizedState;if(// read it during an event
b.isHidden=_,_&&!v&&(1&e.mode)!=0){dw=e;for(var w=e.child;null!==w;)dw=w,function(e){for(;null!==dw;){var t=dw,n=t.child;switch(t.tag){case 0:case 11:case 14:case 15:if(2&t.mode)try{cM(),dI(4,t,t.return)}finally{cI(t)}else dI(4,t,t.return);break;case 1:// TODO (Offscreen) Check: flags & RefStatic
...
switch(t.tag){case 5:var n=t.stateNode;32&t.flags&&(nd(n,""),t.flags&=-33);var r=dN(e);// We only have the top Fiber that was inserted but we need to recurse down its
// children to find all the terminal nodes.
...
e.flags&=-3}4096&t&&(e.flags&=-4097)}function dW(e,t,n){for(;null!==dw;){var r=dw;if((8772&r.flags)!=0){var o=r.alternate;tN(r);try{!function(e,t,n,r){if((8772&n.flags)!=0)switch(n.tag){case 0:case 11:case 15:if(!db){// At this point layout effects have already been destroyed (during mutation phase).
// This is done to prevent sibling component effects from interfering with each other,
// e.g. a destroy function in one component should never override a ref set
// by a create function in another component during the same commit.
if(2&n.mode)try{cM(),dD(5,n)}finally{cI(n)}else dD(5,n)}break;case 1:var o=n.stateNode;if(4&n.flags&&!db){if(null===t){if(n.type!==n.elementType||eg||(o.props!==n.memoizedProps&&eL("Expected %s props to match memoized props before componentDidMount. This might either be because of a bug in React, or because a component reassigns its own `this.props`. Please file an issue.",tO(n)||"instance"),o.state!==n.memoizedState&&eL("Expected %s state to match memoized state before componentDidMount. This might either be because of a bug in React, or because a component reassigns its own `this.state`. Please file an issue.",tO(n)||"instance")),2&n.mode)try{cM(),o.componentDidMount()}finally{cI(n)}else o.componentDidMount()}else{var i=n.elementType===n.type?t.memoizedProps:ua(n.type,t.memoizedProps),a=t.memoizedState;if(n.type!==n.elementType||eg||(o.props!==n.memoizedProps&&eL("Expected %s props to match memoized props before componentDidUpdate. This might either be because of a bug in React, or because a component reassigns its own `this.props`. Please file an issue.",tO(n)||"instance"),o.state!==n.memoizedState&&eL("Expected %s state to match memoized state before componentDidUpdate. This might either be because of a bug in React, or because a component reassigns its own `this.state`. Please file an issue.",tO(n)||"instance")),2&n.mode)try{cM(),o.componentDidUpdate(i,a,o.__reactInternalSnapshotBeforeUpdate)}finally{cI(n)}else o.componentDidUpdate(i,a,o.__reactInternalSnapshotBeforeUpdate)}}// TODO: I think this is now always non-null by the time it reaches the
// commit phase. Consider removing the type check.
var s=n.updateQueue;null!==s&&(n.type!==n.elementType||eg||(o.props!==n.memoizedProps&&eL("Expected %s props to match memoized props before processing the update queue. This might either be because of a bug in React, or because a component reassigns its own `this.props`. Please file an issue.",tO(n)||"instance"),o.state!==n.memoizedState&&eL("Expected %s state to match memoized state before processing the update queue. This might either be because of a bug in React, or because a component reassigns its own `this.state`. Please file an issue.",tO(n)||"instance")),// but instead we rely on them being set during last render.
...
oE(o)}}}})(0,n);break;default:throw Error("This unit of work tag should not have side-effects. This error is likely caused by a bug in React. Please file an issue.")}!db&&512&n.flags&&dM(n)}(0,o,r,0)}catch(e){f2(r,r.return,e)}tL()}if(r===e){dw=null;return}var i=r.sibling;if(null!==i){i.return=r.return,dw=i;return}dw=r.return}}function d$(e){for(;null!==dw;){var t=dw;if(t===e){dw=null;return}var n=t.sibling;if(null!==n){n.return=t.return,dw=n;return}dw=t.return}}function dH(e){for(;null!==dw;){var t=dw;// TODO (Offscreen) Check: flags & LayoutStatic
tN(t);try{!function(e){// Turn on layout effects in a tree that previously disappeared.
...
(e,e.return,t),dT(e,e.return);break;case 5:dT(e,e.return)}}(t)}catch(e){f2(t,t.return,e)}if(tL(),t===e){dw=null;return}var n=t.sibling;if(null!==n){// This node may have been reused from a previous render, so we can't
// assume its return pointer is correct.
n.return=t.return,dw=n;return}dw=t.return}}function dY(e){// We don't need to re-check StrictEffectsMode here.
...
ex.has(t)||(ex.add(t),eL("Cannot update a component (`%s`) while rendering a different component (`%s`). To locate the bad setState() call inside `%s`, follow the stack trace as described in https://reactjs.org/link/setstate-in-render",tO(e)||"Unknown",t,t));break;case 1:pt||(eL("Cannot update during an existing state transition (such as within `render`). Render methods should be a pure function of props and state."),pt=!0)}}(t):(rU&&oo(e,t,n),function(e){if(1&e.mode){if(!d0())return}else{var t;// Legacy mode has additional cases where we suppress a warning.
if(t="undefined"!=typeof IS_REACT_ACT_ENVIRONMENT?IS_REACT_ACT_ENVIRONMENT:void 0,"undefined"==typeof jest||!1===t||0!==d5||0!==e.tag&&11!==e.tag&&15!==e.tag)return}if(null===d6.current){var n=tP;try{tN(e),eL("An update to %s inside a test was not wrapped in act(...).\n\nWhen testing, code that causes React state updates should be wrapped into act(...):\n\nact(() => {\n  /* fire events that update state */\n});\n/* assert on the output */\n\nThis ensures that you're testing the behavior the user would see in the browser. Learn more at https://reactjs.org/link/wrap-tests-with-act",tO(e))}finally{n?tN(e):tL()}}}(t),e===d8&&((2&d5)==0&&(fa|=n),4===fn&&// definitely won't finish. Since we have a new update, let's mark it as
// suspended now, right before marking the incoming update. This has the
// effect of interrupting the current render and switching to the update.
// TODO: Make sure this doesn't override pings that happen while we've
// already started rendering.
fF(e,d9)),fL(e,r),1===n&&0===d5&&(1&t.mode)==0&&// Treat `act` as if it's inside `batchedUpdates`, even in legacy mode.
...
// exiting a task.
function fL(e,t){var n,r,o,i=e.callbackNode;// Check if any lanes are being starved by other work. If so, mark them as
...
return -1;default:return eL("Should have found matching lanes. This is a bug in React."),-1}}(u,t)):l<=t&&(e.expiredLanes|=u),a&=~u}}// This returns the highest priority pending lanes regardless of whether they
...
null==i&&1!==u&&eL("Expected scheduled callback to exist. This error is likely caused by a bug in React. Please file an issue.");return}if(null!=i&&pi(i),1===s)0===e.tag?(null!==d6.isBatchingLegacy&&(d6.didScheduleLegacyUpdate=!0),n=fj.bind(null,e),sb=!0,sw(n)):sw(fj.bind(null,e)),null!==d6.current?// at the end of the current scope even when using the sync version
// of `act`.
d6.current.push(sk):aj(function(){// In Safari, appending an iframe forces microtasks to run.
// https://github.com/facebook/react/issues/22459
// We don't support running callbacks in the middle of render
// or commit so we need to check against that.
(6&d5)==0&&// if this happens outside render or commit phase (e.g. in an event).
sk()}),r=null;else{switch(os(a)){case 1:o=rC;break;case 4:o=rT;break;case 16:default:o=rO;break;case 536870912:o=rP}r=po(o,fN.bind(null,e))}e.callbackPriority=s,e.callbackNode=r}// This is the entry point for every concurrent task, i.e. anything that
// goes through Scheduler.
function fN(e,t){if(cT=!1,cO=!1,// event time. The next update will compute a new event time.
...
oi(e,t)}ff=null,fp(),fW(e,t)}for(rH(t);;)try{/** @noinline */(function(){// Perform work until Scheduler asks us to yield
for(;null!==d7&&!rk();)fK(d7)})();break}catch(t){f$(e,t)}return(uf(),d2.current=r,d5=n,null!==d7)?(null!==rN&&"function"==typeof rN.markRenderYielded&&rN.markRenderYielded(),0):(rY(),d8=null,d9=0,fn)}(e,r);if(0!==o){if(2===o){// If something threw an error, try rendering one more time. We'll
// render synchronously to block concurrent data mutations, and we'll
// includes all pending updates are included. If it still fails after
// the second attempt, we'll give up and commit the resulting tree.
var i=r3(e);0!==i&&(r=i,o=fA(e,i))}if(1===o){var a=fr;throw fW(e,0),fF(e,r),fL(e,rx()),a}if(6===o)// cases where need to exit the current render without producing a
// consistent tree or committing.
//
// This should only happen during a concurrent render, not a discrete or
// synchronous update. We should have already checked for this when we
// unwound the stack.
fF(e,r);else{// The render completed.
...
(o=fQ(e,r))){var l=r3(e);0!==l&&(r=l,o=fA(e,l))}if(1===o){var c=fr;throw fW(e,0),fF(e,r),fL(e,rx()),c}}// We now have a consistent tree. The next step is either to commit it,
...
if(fF(e,n),r6(n)&&// do not delay if we're inside an act() scope
...
fX(e,fl,ff);break;case 4:if(fF(e,n),(4194240&n)===n)break;if(!pa()){// This is not a transition, but we did trigger an avoided state.
...
fX(e,fl,ff);break;default:throw Error("Unknown root exit status.")}}(e,o,r)}}return(fL(e,rx()),e.callbackNode===n)?fN.bind(null,e):null}function fA(e,t){// If an error occurred during hydration, discard server response and fall
...
// able to remove it.
eL("An error occurred during hydration. The server HTML was replaced with client content in <%s>.",e.containerInfo.nodeName.toLowerCase())}var o=fQ(e,t);if(2!==o){// Successfully finished rendering on retry
// The errors from the failed first attempt have been recovered. Add
// them to the collection of recoverable errors. We'll log them in the
// commit phase.
var i=fl;fl=n,null!==i&&fU(i)}return o}function fU(e){null===fl?fl=e:fl.push.apply(fl,e)}function fF(e,t){// When suspending, we should always exclude lanes that were pinged or (more
...
// through Scheduler
function fj(e){if(cT=cO,cO=!1,(6&d5)!=0)throw Error("Should not already be working.");fJ();var t=r2(e,0);if(!((1&t)!=0))return(// There's no remaining sync work left.
fL(e,rx()),null);var n=fQ(e,t);if(0!==e.tag&&2===n){// If something threw an error, try rendering one more time. We'll render
// synchronously to block concurrent data mutations, and we'll includes
// all pending updates are included. If it still fails after the second
// attempt, we'll give up and commit the resulting tree.
var r=r3(e);0!==r&&(t=r,n=fA(e,r))}if(1===n){var o=fr;throw fW(e,0),fF(e,t),fL(e,rx()),o}if(6===n)throw Error("Root did not complete. This is a bug in React.");// We now have a consistent tree. Because this is a sync render, we
// will commit it even if something suspended.
var i=e.current.alternate;return e.finishedWork=i,e.finishedLanes=t,fX(e,fl,ff),// pending level.
fL(e,rx()),null}function fz(e,t){var n=d5;d5|=/*               */1;try{return e(t)}finally{// most batchedUpdates-like method.
...
null!==fy&&0===fy.tag&&(6&d5)==0&&fJ();var t=d5;d5|=1;var n=d4.transition,r=oa;try{if(d4.transition=null,oa=1,e)return e();return}finally{oa=r,d4.transition=n,(6&(d5=t))==0&&sk()}}function fB(e,t){sn(ft,fe,e),fe|=t,fo|=t}function fV(e){fe=ft.current,st(ft,e)}function fW(e,t){e.finishedWork=null,e.finishedLanes=0;var n=e.timeoutHandle;if(-1!==n&&(// The root previous suspended and scheduled a timeout to commit a fallback
...
if(null!==uy){for(var e=0;e<uy.length;e++){var t=uy[e],n=t.interleaved;if(null!==n){t.interleaved=null;var r=n.next,o=t.pending;if(null!==o){var i=o.next;o.next=r,n.next=i}t.pending=n}}uy=null}}(),s4.discardPendingWarnings(),o}function f$(e,t){for(;;){var n=d7;try{if(// Reset module-level state that was set during the render phase.
uf(),lS(),tL(),// separate issue. Write a regression test using string refs.
...
// suspended render.
cP(n,!0),rV(),null!==t&&"object"==typeof t&&"function"==typeof t.then){var r,o,i,a,s,u=t;a=n,s=d9,null!==rN&&"function"==typeof rN.markComponentSuspended&&rN.markComponentSuspended(a,u,s)}else r=n,o=t,i=d9,null!==rN&&"function"==typeof rN.markComponentErrored&&rN.markComponentErrored(r,o,i);(function(e,t,n,r,o){if(// The source fiber did not complete.
...
s2(cN(r,n));return}}i=r=cN(r,n),4!==fn&&(fn=2),null===fu?fu=[i]:fu.push(i);// over and traverse parent path again, this time treating the exception
// as an error.
var l=t;do{switch(l.tag){case 3:var c,d=r;l.flags|=65536;var f=(c=o)&-c;l.lanes=l.lanes|f;var p=cj(l,d,f);uO(l,p);return;case 1:// Capture and retry
...
fF(d8,d9)}function fQ(e,t){var n=d5;d5|=2;var r=fH();// If the root or lanes have changed, throw out the existing stack
// and prepare a fresh one. Otherwise we'll continue where we left off.
if(d8!==e||d9!==t){if(rU){var o=e.memoizedUpdaters;o.size>0&&(pn(e,d9),o.clear()),// If we bailout on this work, we'll move them back (like above).
// It's important to move them now in case the work spawns more work at the same priority with different updaters.
// That way we can keep the current update and future updates separate.
oi(e,t)}ff=null,fW(e,t)}for(rH(t);;)try{/** @noinline */(function(){// Already timed out, so perform work without checking if we need to yield.
for(;null!==d7;)fK(d7)})();break}catch(t){f$(e,t)}if(uf(),d5=n,d2.current=r,null!==d7)throw Error("Cannot commit an incomplete root. This error is likely caused by a bug in React. Please file an issue.");return rY(),d8=null,d9=0,fn}// The work loop is an extremely hot path. Tell Closure not to inline it.
function fK(e){// The current, flushed, state of this fiber is the alternate. Ideally
// nothing should rely on this, but relying on it here means that we don't
// need an additional field on the work in progress.
var t,n=e.alternate;tN(e),(2&e.mode)!=0?(cR(e),t=eS(n,e,fe),cP(e,!0)):t=eS(n,e,fe),tL(),e.memoizedProps=e.pendingProps,null===t?fG(e):d7=t,d3.current=null}function fG(e){// Attempt to complete the current unit of work, then move to the next
// sibling. If there are no more siblings, return to the parent fiber.
var t=e;do{// The current, flushed, state of this fiber is the alternate. Ideally
// nothing should rely on this, but relying on it here means that we don't
// need an additional field on the work in progress.
var n=t.alternate,r=t.return;if((32768&t.flags)==0){tN(t);var o=void 0;if((2&t.mode)==0?o=dm(n,t,fe):(cR(t),o=dm(n,t,fe),cP(t,!1)),tL(),null!==o){// Completing this fiber spawned new work. Work on that next.
...
// Ideally we would have a special version of the work loop only
// for hydration.
sA(t),t.tag){case 1:sd(t.type)&&sf(t);var r=t.flags;if(65536&r)return t.flags=-65537&r|128,(2&t.mode)!=0&&cL(t),t;return null;case 3:t.stateNode,u2(t),sp(t),le();var o=t.flags;if((65536&o)!=0&&(128&o)==0)return(// There was an error during render that wasn't captured by a suspense
...
u6(t),null);case 13:st(u5,t);var i=t.memoizedState;if(null!==i&&null!==i.dehydrated){if(null===t.alternate)throw Error("Threw in newly mounted dehydrated component. This is likely a bug in React. Please file an issue.");s0()}var a=t.flags;if(65536&a)return t.flags=-65537&a|128,(2&t.mode)!=0&&cL(t),t;return null;case 19:// caught by a nested boundary. If not, it should bubble through.
...
fJ();while(null!==fy)if(s4.flushLegacyContextWarning(),s4.flushPendingUnsafeLifecycleWarnings(),(6&d5)!=0)throw Error("Should not already be working.");var o=e.finishedWork,i=e.finishedLanes;if(null!==rN&&"function"==typeof rN.markCommitStarted&&rN.markCommitStarted(i),null===o)return rq();if(0===i&&eL("root.finishedLanes should not be empty during a commit. This is a bug in React."),e.finishedWork=null,e.finishedLanes=0,o===e.current)throw Error("Cannot commit the same tree as before. This error is likely caused by a bug in React. Please file an issue.");// commitRoot never returns a continuation; it always finishes synchronously.
...
// with setTimeout
fw=n,po(rO,function(){// *after* passive effects fire to avoid freeing a cache pool that may
...
var s=(15990&o.subtreeFlags)!=0,u=(15990&o.flags)!=0;if(s||u){var l,c,d,f=d4.transition;d4.transition=null;var p=oa;oa=1;var h=d5;d5|=/*                */4,d3.current=null,e.containerInfo,aM=oT,aL={focusedElem:c=iD(),selectionRange:iM(c)?("selectionStart"in c?{start:c.selectionStart,end:c.selectionEnd}:/**
...
c=f}return -1===a||-1===s?null:{start:a,end:s}}(e,o,i,a,s))}(c))||{start:0,end:0}:null},oT=!1,dw=o,function(){for(;null!==dw;){var e=dw,t=e.child;// This phase is only used for beforeActiveInstanceBlur.
(1028&e.subtreeFlags)!=0&&null!==t?(t.return=e,dw=t):function(){for(;null!==dw;){var e=dw;tN(e);try{(function(e){var t=e.alternate;if((1024&e.flags)!=0){switch(tN(e),e.tag){case 0:case 11:case 15:case 5:case 6:case 4:case 17:break;case 1:if(null!==t){var n,r=t.memoizedProps,o=t.memoizedState,i=e.stateNode;e.type!==e.elementType||eg||(i.props!==e.memoizedProps&&eL("Expected %s props to match memoized props before getSnapshotBeforeUpdate. This might either be because of a bug in React, or because a component reassigns its own `this.props`. Please file an issue.",tO(e)||"instance"),i.state!==e.memoizedState&&eL("Expected %s state to match memoized state before getSnapshotBeforeUpdate. This might either be because of a bug in React, or because a component reassigns its own `this.state`. Please file an issue.",tO(e)||"instance"));var a=i.getSnapshotBeforeUpdate(e.elementType===e.type?r:ua(e.type,r),o),s=dv;void 0!==a||s.has(e.type)||(s.add(e.type),eL("%s.getSnapshotBeforeUpdate(): A snapshot value (or null) must be returned. You have returned undefined.",tO(e))),i.__reactInternalSnapshotBeforeUpdate=a}break;case 3:1===(n=e.stateNode.containerInfo).nodeType?n.textContent="":9===n.nodeType&&n.documentElement&&n.removeChild(n.documentElement);break;default:throw Error("This unit of work tag should not have side-effects. This error is likely caused by a bug in React. Please file an issue.")}tL()}})(e)}catch(t){f2(e,e.return,t)}tL();var t=e.sibling;if(null!==t){t.return=e.return,dw=t;return}dw=e.return}}()}}(),cS=ck(),dk=i,dS=e,tN(o),dB(o,e),tN(o),dk=null,dS=null,e.containerInfo,/**
...
var i,a,s=[],u=r;u=u.parentNode;)1===u.nodeType&&s.push({element:u,left:u.scrollLeft,top:u.scrollTop});"function"==typeof r.focus&&r.focus();for(var l=0;l<s.length;l++){var c=s[l];c.element.scrollLeft=c.left,c.element.scrollTop=c.top}}}(aL),oT=!!aM,aM=null,aL=null,// the mutation phase, so that the previous tree is still current during
// componentWillUnmount, but before the layout phase, so that the finished
// work is current during componentDidMount/Update.
e.current=o,null!==rN&&"function"==typeof rN.markLayoutEffectsStarted&&rN.markLayoutEffectsStarted(i),dk=i,dS=e,dw=o,function e(t,n,r){for(// Suspense layout effects semantics don't change for legacy roots.
var o=(1&t.mode)!=0;null!==dw;){var i=dw,a=i.child;if(22===i.tag&&o){var s=null!==i.memoizedState||dy;if(s){// The Offscreen tree is hidden. Skip over its layout effects.
...
// back on.
dw=i,function(e){for(;null!==dw;){var t=dw,n=t.child;if(22===t.tag&&null!==t.memoizedState){// Nested Offscreen tree is still hidden. Don't re-appear its effects.
...
// assume its return pointer is correct.
n.return=t,dw=n):dH(e)}}(i));for(var f=a;null!==f;)dw=f,e(f,n,r),f=f.sibling;// Restore Offscreen state and resume in our-progress traversal.
dw=i,dy=c,db=d,dW(t,n,r);continue}(8772&i.subtreeFlags)!=0&&null!==a?(a.return=i,dw=a):dW(t,n,r)}}(o,e,i),dk=null,dS=null,null!==rN&&"function"==typeof rN.markLayoutEffectsStopped&&rN.markLayoutEffectsStopped(),// opportunity to paint.
...
(fg=null),m||f8(e.current,!1),function(e,t){if(rL&&"function"==typeof rL.onCommitFiberRoot)try{var n,r=(128&e.current.flags)==128;switch(t){case 1:n=rC;break;case 4:n=rT;break;case 16:default:n=rO;break;case 536870912:n=rP}rL.onCommitFiberRoot(rM,e,n,r)}catch(e){rA||(rA=!0,eL("React instrumentation encountered an error: %s",e))}}(o.stateNode,r),rU&&e.memoizedUpdaters.clear(),dJ.forEach(function(e){return e()}),// additional work on this root is scheduled.
fL(e,rx()),null!==t)for(var g=e.onRecoverableError,v=0;v<t.length;v++){var y=t[v],b=y.stack,_=y.digest;g(y.value,{componentStack:b,digest:_})}if(fh){fh=!1;var w=fm;throw fm=null,w}// If the passive effects are the result of a discrete render, flush them
...
var e,t=fw;fw=null;var n=fy,r=fb;if(fy=null,// Figure out why and fix it. It's not causing any known issues (probably
// because it's only used for profiling), but it's a refactor hazard.
fb=0,(6&d5)!=0)throw Error("Cannot flush passive effects while already rendering.");fx=!0,fE=!1,null!==rN&&"function"==typeof rN.markPassiveEffectsStarted&&rN.markPassiveEffectsStarted(r);var o=d5;d5|=4,dw=n.current,function(){for(;null!==dw;){var e=dw,t=e.child;if((16&dw.flags)!=0){var n=e.deletions;if(null!==n){for(var r=0;r<n.length;r++){var o=n[r];dw=o,function(e,t){for(;null!==dw;){var n=dw;// Deletion effects fire in parent -> child order
// TODO: Check if fiber has a PassiveStatic flag
tN(n),function(e,t){switch(e.tag){case 0:case 11:case 15:2&e.mode?(cC=ck(),dI(8,e,t),cD(e)):dI(8,e,t)}}// TODO: Reuse reappearLayoutEffects traversal here?
(n,t),tL();var r=n.child;// TODO: Only traverse subtree if it has a PassiveStatic flag. (But, if we
null!==r?(r.return=n,dw=r):function(e){for(;null!==dw;){var t=dw,n=t.sibling,r=t.return;if(// Recursively traverse the entire deleted tree and clean up fiber fields.
...
t.return=null,t.dependencies=null,t.memoizedProps=null,t.memoizedState=null,t.pendingProps=null,t.stateNode=null,t.updateQueue=null}(t),t===e){dw=null;return}if(null!==n){n.return=r,dw=n;return}dw=r}}(e)}}(o,e)}// A fiber was deleted from this parent fiber, but it's still part of
...
var i=e.alternate;if(null!==i){var a=i.child;if(null!==a){i.child=null;do{var s=a.sibling;a.sibling=null,a=s}while(null!==a)}}dw=e}}(2064&e.subtreeFlags)!=0&&null!==t?(t.return=e,dw=t):function(){for(;null!==dw;){var e=dw;(2048&e.flags)!=0&&(tN(e),function(e){switch(e.tag){case 0:case 11:case 15:2&e.mode?(cC=ck(),dI(9,e,e.return),cD(e)):dI(9,e,e.return)}}(e),tL());var t=e.sibling;if(null!==t){t.return=e.return,dw=t;return}dw=e.return}}()}}(),dw=e=n.current,function(e,t,n,r){for(;null!==dw;){var o=dw,i=o.child;(2064&o.subtreeFlags)!=0&&null!==i?(i.return=o,dw=i):function(e,t,n,r){for(;null!==dw;){var o=dw;if((2048&o.flags)!=0){tN(o);try{(function(e,t,n,r){switch(t.tag){case 0:case 11:case 15:if(2&t.mode){cC=ck();try{dD(9,t)}finally{cD(t)}}else dD(9,t)}})(0,o,0,0)}catch(e){f2(o,o.return,e)}tL()}if(o===e){dw=null;return}var i=o.sibling;if(null!==i){i.return=o.return,dw=i;return}dw=o.return}}(e,0,0,0)}}(e,n,r,t);var i=f_;f_=[];for(var a=0;a<i.length;a++)!function(e,t){// Only Profilers with work in their subtree will have an Update effect scheduled.
...
var u=t.return;r:for(;null!==u;){switch(u.tag){case 3:var l=u.stateNode;l.passiveEffectDuration+=n;break r;case 12:var c=u.stateNode;c.passiveEffectDuration+=n;break r}u=u.return}}}(0,i[a]);null!==rN&&"function"==typeof rN.markPassiveEffectsStopped&&rN.markPassiveEffectsStopped(),f8(n.current,!0),d5=o,sk(),fE?n===fT?fC++:(fC=0,fT=n):fC=0,fx=!1,fE=!1,function(e){if(rL&&"function"==typeof rL.onPostCommitFiberRoot)try{rL.onPostCommitFiberRoot(rM,e)}catch(e){rA||(rA=!0,eL("React instrumentation encountered an error: %s",e))}}(n);var s=n.current.stateNode;return s.effectDuration=0,s.passiveEffectDuration=0,!0}()}finally{oa=n,d4.transition=t}}return!1}function fZ(e){return null!==fg&&fg.has(e)}var f0=function(e){fh||(fh=!0,fm=e)};function f1(e,t,n){var r=cj(e,cN(n,t),1),o=uC(e,r,1),i=fI();null!==o&&(ot(o,1,i),fL(o,i))}function f2(e,t,n){if(rc(null,function(){throw n}),rd(),fP=!1,3===e.tag){// Error was thrown at the root. There is no parent, so the root
// itself should capture it.
f1(e,e,n);return}var r=null;for(r=t;null!==r;){if(3===r.tag){f1(r,e,n);return}if(1===r.tag){var o=r.type,i=r.stateNode;if("function"==typeof o.getDerivedStateFromError||"function"==typeof i.componentDidCatch&&!fZ(i)){var a=cz(r,cN(n,e),1),s=uC(r,a,1),u=fI();null!==s&&(ot(s,1,u),fL(s,u));return}}r=r.return}// TODO: Until we re-land skipUnmountedBoundaries (see #20147), this warning
...
r.delete(t);var o=fI();on(e,n),0!==e.tag&&d0()&&null===d6.current&&eL("A suspended resource finished loading inside a test, but the event was not wrapped in act(...).\n\nWhen testing, code that resolves suspended data should be wrapped into act(...):\n\nact(() => {\n  /* finish loading suspended data */\n});\n/* assert on the output */\n\nThis ensures that you're testing the behavior the user would see in the browser. Learn more at https://reactjs.org/link/wrap-tests-with-act"),d8===e&&(d9&n)===n&&(4===fn||3===fn&&r6(d9)&&rx()-fc<500?fW(e,0):// opportunity later. So we mark this render as having a ping.
fs|=n),fL(e,o)}function f4(e,t){// The boundary fiber (a Suspense component or SuspenseList component)
...
var n,r=fI(),o=uw(e,t);null!==o&&(ot(o,t,r),fL(o,r))}function f6(e){var t=e.memoizedState,n=0;null!==t&&(n=t.retryLane),f4(e,n)}function f5(e,t){var n,r=0;// Default
...
tN(e),f7(e,16777216,dK),t&&f7(e,/*              */33554432,dG),f7(e,16777216,dY),t&&f7(e,33554432,dQ),tL()}function f7(e,t,n){for(// We don't need to re-check StrictEffectsMode here.
// This function is only called if that check has already passed.
...
var n=tO(e)||"ReactComponent";if(null!==f9){if(f9.has(n))return;f9.add(n)}else f9=new Set([n]);var r=tP;try{tN(e),eL("Can't perform a React state update on a component that hasn't mounted yet. This indicates that you have a side-effect in your render function that asynchronously later calls tries to update the component. Move this work to useEffect instead.")}finally{r?tN(e):tL()}}}}eS=function(e,t,n){// If a component throws an error, we replay it again in a synchronously
...
var n=d6.current;return null!==n?(n.push(t),pr):r_(e,t)}function pi(e){if(e!==pr)// In production, always call Scheduler. This function will be stripped out.
return rw(e)}function pa(){// Never force flush in production. This function should get stripped out.
...
var d=c.current,f=fI(),p=fD(d),h=uE(f,p);return h.callback=null!=t?t:null,uC(d,h,p),c.current.lanes=p,ot(c,p,f),fL(c,f),c}function pR(e,t,n,r){!function(e,t){if(rL&&"function"==typeof rL.onScheduleFiberRoot)try{rL.onScheduleFiberRoot(rM,e,t)}catch(e){rA||(rA=!0,eL("React instrumentation encountered an error: %s",e))}}(t,e);var o=t.current,i=fI(),a=fD(o);null!==rN&&"function"==typeof rN.markRenderScheduled&&rN.markRenderScheduled(a);var s=pT(n);null===t.context?t.context=s:t.pendingContext=s,tI&&null!==tP&&!eC&&(eC=!0,eL("Render methods should be a pure function of props and state; triggering nested component updates from render is not allowed. If necessary, trigger nested updates in componentDidUpdate.\n\nCheck the render method of %s.",tO(tP)||"Unknown"));var u=uE(i,a);// Caution: React DevTools currently depends on this property
...
e.memoizedProps=tv({},e.memoizedProps);var a=uw(e,1);null!==a&&fM(a,e,1,-1)}},pU=function(e,t,n){var r=pX(e,t);if(null!==r){var o=pH(r.memoizedState,n);r.memoizedState=o,r.baseState=o,// because there is no update we can add for useReducer hooks that won't trigger an error.
// (There's no appropriate action type for DevTools overrides.)
// As a result though, React will see the scheduled update as a noop and bailout.
// Shallow cloning props works as a workaround for now to bypass the bailout check.
e.memoizedProps=tv({},e.memoizedProps);var i=uw(e,1);null!==i&&fM(i,e,1,-1)}},pF=function(e,t,n,r){var o=pX(e,t);if(null!==o){var i=pQ(o.memoizedState,n,r);o.memoizedState=i,o.baseState=i,// because there is no update we can add for useReducer hooks that won't trigger an error.
// (There's no appropriate action type for DevTools overrides.)
// As a result though, React will see the scheduled update as a noop and bailout.
// Shallow cloning props works as a workaround for now to bypass the bailout check.
e.memoizedProps=tv({},e.memoizedProps);var a=uw(e,1);null!==a&&fM(a,e,1,-1)}},pj=function(e,t,n){e.pendingProps=pG(e.memoizedProps,t,n),e.alternate&&(e.alternate.pendingProps=e.pendingProps);var r=uw(e,1);null!==r&&fM(r,e,1,-1)},pz=function(e,t){e.pendingProps=pH(e.memoizedProps,t),e.alternate&&(e.alternate.pendingProps=e.pendingProps);var n=uw(e,1);null!==n&&fM(n,e,1,-1)},pq=function(e,t,n){e.pendingProps=pQ(e.memoizedProps,t,n),e.alternate&&(e.alternate.pendingProps=e.pendingProps);var r=uw(e,1);null!==r&&fM(r,e,1,-1)},pB=function(e){var t=uw(e,1);null!==t&&fM(t,e,1,-1)},pV=function(e){pL=e},pW=function(e){pN=e};/* global reportError */var pJ="function"==typeof reportError?reportError:function(e){// In older browsers and test environments, fallback to console.error.
// eslint-disable-next-line react-internal/no-production-logging
...
e$(n,"name");for(var o=r.querySelectorAll("input[name="+JSON.stringify(""+n)+'][type="radio"]'),i=0;i<o.length;i++){var a=o[i];if(a!==e&&a.form===e.form){// This will throw if radio buttons rendered by different copies of React
...
e=tv({},e,{getLaneLabelMap:rz,injectProfilingHooks:rj}),rM=t.inject(e),rL=t}catch(e){eL("React instrumentation encountered an error: %s.",e)}return!!t.checkDCE}({bundleType:t.bundleType,version:t.version,rendererPackageName:t.rendererPackageName,rendererConfig:t.rendererConfig,overrideHookState:pA,overrideHookStateDeletePath:pU,overrideHookStateRenamePath:pF,overrideProps:pj,overridePropsDeletePath:pz,overridePropsRenamePath:pq,setErrorHandler:pV,setSuspenseHandler:pW,scheduleUpdate:pB,currentDispatcherRef:m,findHostInstanceByFiber:function(e){var t=rb(e);return null===t?null:t.stateNode},findFiberByHostInstance:n||function(e){return null},// React Refresh
...
$$typeof:tr,key:null==r?null:""+r,children:e,containerInfo:t,implementation:null}}(e,t,null,n)},i=function(e,t){return p7.usingClientEntryPoint||eL('You are importing createRoot from "react-dom" which is not supported. You should instead import it from "react-dom/client".'),function(e,t){if(!p1(e))throw Error("createRoot(...): Target container is not a DOM element.");p3(e);var n,r=!1,o="",i=pJ;null!=t&&(t.hydrate?eM("hydrate through createRoot is deprecated. Use ReactDOMClient.hydrateRoot(container, <App />) instead."):"object"==typeof t&&null!==t&&t.$$typeof===tn&&eL("You passed a JSX element to createRoot. You probably meant to call root.render instead. Example usage:\n\n  let root = createRoot(domContainer);\n  root.render(<App />);"),!0===t.unstable_strictMode&&(r=!0),void 0!==t.identifierPrefix&&(o=t.identifierPrefix),void 0!==t.onRecoverableError&&(i=t.onRecoverableError),void 0!==t.transitionCallbacks&&t.transitionCallbacks);var a=pE(e,1,!1,null,null,r,!1,o,i);return n=a.current,e[aG]=n,i6(8===e.nodeType?e.parentNode:e),new pZ(a)}(e,t)},a=function(e){var t=p4.current;return(null!==t&&null!==t.stateNode&&(t.stateNode._warnedAboutRefsInRender||eL("%s is accessing findDOMNode inside its render(). render() should be a pure function of props and state. It should never access something that requires stale data from the previous render, such as refs. Move this logic to componentDidMount and componentDidUpdate instead.",tC(t.type)||"A component"),t.stateNode._warnedAboutRefsInRender=!0),null==e)?null:1===e.nodeType?e:function(e,t){var n=rf(e);if(void 0===n){if("function"==typeof e.render)throw Error("Unable to find node on an unmounted component.");throw Error("Argument appears to not be a ReactComponent. Keys: "+Object.keys(e).join(","))}var r=rb(n);if(null===r)return null;if(8&r.mode){var o=tO(n)||"Component";if(!eT[o]){eT[o]=!0;var i=tP;try{tN(r),8&n.mode?eL("%s is deprecated in StrictMode. %s was passed an instance of %s which is inside StrictMode. Instead, add a ref directly to the element you want to reference. Learn more about using refs safely here: https://reactjs.org/link/strict-mode-find-node",t,t,o):eL("%s is deprecated in StrictMode. %s was passed an instance of %s which renders StrictMode children. Instead, add a ref directly to the element you want to reference. Learn more about using refs safely here: https://reactjs.org/link/strict-mode-find-node",t,t,o)}finally{// Ideally this should reset to previous but this shouldn't be called in
// render and there's another warning for that anyway.
i?tN(i):tL()}}}return r.stateNode}(e,"findDOMNode")},s=// Warning, this opts-out of checking the function body.
// eslint-disable-next-line no-redeclare
function(e){return(6&d5)!=0&&eL("flushSync was called from inside a lifecycle method. React cannot flush when React is already rendering. Consider moving this call to a scheduler task or micro task."),fq(e)},u=function(e,t,n){if(eL("ReactDOM.hydrate is no longer supported in React 18. Use hydrateRoot instead. Until you switch to the new API, your app will behave as if it's running React 17. Learn more: https://reactjs.org/link/switch-to-createroot"),!p2(t))throw Error("Target container is not a DOM element.");return t[aG]&&void 0===t._reactRootContainer&&eL("You are calling ReactDOM.hydrate() on a container that was previously passed to ReactDOMClient.createRoot(). This is not supported. Did you mean to call hydrateRoot(container, element)?"),p8(null,e,t,!0,n)},l=function(e,t,n){return p7.usingClientEntryPoint||eL('You are importing hydrateRoot from "react-dom" which is not supported. You should instead import it from "react-dom/client".'),function(e,t,n){if(!p1(e))throw Error("hydrateRoot(...): Target container is not a DOM element.");p3(e),void 0===t&&eL("Must provide initial children as second argument to hydrateRoot. Example usage: hydrateRoot(domContainer, <App />)");// the hydration callbacks.
...
var T=[],O=[],R=1,P=null,I=3,D=!1,M=!1,L=!1,N="function"==typeof setTimeout?setTimeout:null,A="function"==typeof clearTimeout?clearTimeout:null,U="undefined"!=typeof setImmediate?setImmediate:null;function F(r){for(// Check for tasks that are no longer delayed and add them to the queue.
var o=t(O);null!==o;){if(null===o.callback)n(O);else{if(!(o.startTime<=r))return;// Timer fired. Transfer to the task queue.
n(O),o.sortIndex=o.expirationTime,e(T,o)}o=t(O)}}function j(e){if(L=!1,F(e),!M){if(null!==t(T))M=!0,G(z);else{var n=t(O);null!==n&&X(j,n.startTime-e)}}}function z(e,o){M=!1,L&&(// We scheduled a timeout but it's no longer needed. Cancel it.
L=!1,A(V),V=-1),D=!0;var i=I;try{return function(e,o){var i=o;for(F(i),P=t(T);null!==P&&!(P.expirationTime>i&&(!e||H()));){var a=P.callback;if("function"==typeof a){P.callback=null,I=P.priorityLevel;var s=a(P.expirationTime<=i);i=r(),"function"==typeof s?P.callback=s:P===t(T)&&n(T),F(i)}else n(T);P=t(T)}// Return whether there's additional work
if(null!==P)return!0;var u=t(O);return null!==u&&X(j,u.startTime-i),!1}(e,o)}finally{P=null,I=i,D=!1}}"undefined"!=typeof navigator&&void 0!==navigator.scheduling&&void 0!==navigator.scheduling.isInputPending&&navigator.scheduling.isInputPending.bind(navigator.scheduling);var q=!1,B=null,V=-1,W=5,$=-1;function H(){return!(r()-$<W)}var Y=function(){if(null!==B){var e=r();// Keep track of the start time so we can measure how long the main thread
// has been blocked.
...
var Q=new MessageChannel,K=Q.port2;Q.port1.onmessage=Y,S=function(){K.postMessage(null)}}else S=function(){N(Y,0)};function G(e){B=e,q||(q=!0,S())}function X(e,t){V=N(function(){e(r())},t)}o=5,i=1,a=4,s=3,u=null,l=2,c=function(e){// remove from the queue because you can't remove arbitrary nodes from an
 ...
 */function W(e,t){return e.has(t)}/**
 * Checks if `value` is a host object in IE < 9.
 *
 * @private
 * @param {*} value The value to check.
 * @returns {boolean} Returns `true` if `value` is a host object, else `false`.
 */function $(e){// Many host objects are `Object` objects that can coerce to strings
 ...
 */function Y(e){var t=-1,n=Array(e.size);return e.forEach(function(e){n[++t]=e}),n}/** Used for built-in method references. */var Q=Array.prototype,K=Function.prototype,G=Object.prototype,X=N["__core-js_shared__"],J=(n=/[^.]+$/.exec(X&&X.keys&&X.keys.IE_PROTO||""))?"Symbol(src)_1."+n:"",Z=K.toString,ee=G.hasOwnProperty,et=G.toString,en=RegExp("^"+Z.call(ee).replace(/[\\^$.*+?()[\]{}|]/g,"\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g,"$1.*?")+"$"),er=N.Symbol,eo=N.Uint8Array,ei=G.propertyIsEnumerable,ea=Q.splice,es=(r=Object.keys,o=Object,function(e){return r(o(e))}),eu=eL(N,"DataView"),el=eL(N,"Map"),ec=eL(N,"Promise"),ed=eL(N,"Set"),ef=eL(N,"WeakMap"),ep=eL(Object,"create"),eh=eq(eu),em=eq(el),eg=eq(ec),ev=eq(ed),ey=eq(ef),eb=er?er.prototype:void 0,e_=eb?eb.valueOf:void 0,ew=eb?eb.toString:void 0;/**
 ...
 */function eO(e,t){var n;t=eU(t,e)?[t]:e$(n=t)?n:ej(n);for(var r=0,o=t.length;null!=e&&r<o;)e=e[ez(t[r++])];return r&&r==o?e:void 0}/**
 ...
 */function(e,t,n,r,o,i){var a=e$(e),f=e$(t),g=u,w=u;a||(g=(g=eN(e))==s?m:g),f||(w=(w=eN(t))==s?m:w);var x=g==m&&!$(e),E=w==m&&!$(t),C=g==w;if(C&&!x)return i||(i=new eC),a||eJ(e)?eD(e,t,n,r,o,i):/**
...
a.set(e,t);var m=eD(s(e),s(t),r,o,i,a);return a.delete(e),m;case _:if(e_)return e_.call(e)==e_.call(t)}return!1}(e,t,g,n,r,o,i);if(!(2&o)){var T=x&&ee.call(e,"__wrapped__"),O=E&&ee.call(t,"__wrapped__");if(T||O){var R=T?e.value():e,P=O?t.value():t;return i||(i=new eC),n(R,P,r,o,i)}}return!!C&&(i||(i=new eC),/**
 ...
 */function eL(e,t){var n=null==e?void 0:e[t];return!(!eK(n)||J&&J in n)&&(eY(n)||$(n)?en:P).test(eq(n))?n:void 0}/**
 ...
 */function eU(e,t){if(e$(e))return!1;var n=typeof e;return!!("number"==n||"symbol"==n||"boolean"==n||null==e||eX(e))||E.test(e)||!x.test(e)||null!=t&&e in Object(t)}/**
 ...
 */function eF(e,t){return function(n){return null!=n&&n[e]===t&&(void 0!==t||e in Object(n))}}(eu&&eN(new eu(new ArrayBuffer(1)))!=S||el&&eN(new el)!=p||ec&&eN(ec.resolve())!=g||ed&&eN(new ed)!=y||ef&&eN(new ef)!=w)&&(eN=function(e){var t=et.call(e),n=t==m?e.constructor:void 0,r=n?eq(n):void 0;if(r)switch(r){case eh:return S;case em:return p;case eg:return g;case ev:return y;case ey:return w}return t});/**
 * Converts `string` to a property path array.
 *
 * @private
 * @param {string} string The string to convert.
 * @returns {Array} Returns the property path array.
 */var ej=eB(function(e){e=null==(t=e)?"":/**
...
if("string"==typeof e)return e;if(eX(e))return ew?ew.call(e):"";var t=e+"";return"0"==t&&1/e==-a?"-0":t}(t);var t,n=[];return C.test(e)&&n.push(""),e.replace(O,function(e,t,r,o){n.push(r?o.replace(R,"$1"):t||e)}),n});/**
 ...
 * _.isArguments([1, 2, 3]);
 * // => false
 */function eW(e){// Safari 8.1 makes `arguments.callee` enumerable in strict mode.
 ...
 * _.isSymbol('abc');
 * // => false
 */function eX(e){return"symbol"==typeof e||eG(e)&&et.call(e)==_}/**
 ...
 */function(e,t,n){t=eU(t,e)?[t]:e$(r=t)?r:ej(r);for(var r,o,i=-1,a=t.length;++i<a;){var s=ez(t[i]);if(!(o=null!=e&&n(e,s)))break;e=e[s]}if(o)return o;var a=e?e.length:0;return!!a&&eQ(a)&&eA(s,a)&&(e$(e)||eW(e))}(e,n,eR):eP(r,o,void 0,3)}):1==(i=/**
 * Gets the property names, values, and compare flags of `object`.
 *
 * @private
 * @param {Object} object The object to query.
 * @returns {Array} Returns the match data of `object`.
 */function(e){for(var t=eZ(e),n=t.length;n--;){var r=t[n],o=e[r];t[n]=[r,o,o==o&&!eK(o)]}return t}(t)).length&&i[0][2]?eF(i[0][0],i[0][1]):function(e){return e===t||/**
...
z.current=null,function(){if(0===F){/* eslint-disable react-internal/no-production-logging */t=console.log,n=console.info,a=console.warn,s=console.error,u=console.group,l=console.groupCollapsed,c=console.groupEnd;var e={configurable:!0,enumerable:!0,value:j,writable:!0};// $FlowFixMe Flow thinks console is immutable.
Object.defineProperties(console,{info:e,log:e,warn:e,error:e,group:e,groupCollapsed:e,groupEnd:e});/* eslint-enable react-internal/no-production-logging */}F++}();try{// This should throw.
...
if(v--,--y<0||m[v]!==g[y]){// V8 adds a "new" prefix for native classes. Let's remove it to make it prettier.
var b="\n"+m[v].replace(" at new "," at ");// If our component frame is labeled "<anonymous>"
return e.displayName&&b.includes("<anonymous>")&&(b=b.replace("<anonymous>",e.displayName)),"function"==typeof e&&f.set(e,b),b}while(v>=1&&y>=0)break}}}finally{B=!1,z.current=i,function(){if(0==--F){/* eslint-disable react-internal/no-production-logging */var e={configurable:!0,enumerable:!0,writable:!0};// $FlowFixMe Flow thinks console is immutable.
Object.defineProperties(console,{log:U({},e,{value:t}),info:U({},e,{value:n}),warn:U({},e,{value:a}),error:U({},e,{value:s}),group:U({},e,{value:u}),groupCollapsed:U({},e,{value:l}),groupEnd:U({},e,{value:c})});/* eslint-enable react-internal/no-production-logging */}F<0&&L("disabledDepth fell below zero. This is a bug in React. Please file an issue.")}(),Error.prepareStackTrace=p}// Fallback to just using the name if we couldn't make it throw.
var _=e?e.displayName||e.name:"",w=_?q(_):"";return"function"==typeof e&&f.set(e,w),w}function W(e,t,n){if(null==e)return"";if("function"==typeof e)return V(e,!!((r=e.prototype)&&r.isReactComponent));if("string"==typeof e)return q(e);switch(e){case C:return q("Suspense");case T:return q("SuspenseList")}if("object"==typeof e)switch(e.$$typeof){case E:return V(e.render,!1);case O:// Memo may contain any component type so we recursively resolve it.
return W(e.type,t,n);case R:var r,o=e._payload,i=e._init;try{// Lazy may contain any component type so we recursively resolve it.
return W(i(o),t,n)}catch(e){}}return""}f=new("function"==typeof WeakMap?WeakMap:Map);var $=Object.prototype.hasOwnProperty,H={},Y=M.ReactDebugCurrentFrame;function Q(e){if(e){var t=e._owner,n=W(e.type,e._source,t?t.type:null);Y.setExtraStackFrame(n)}else Y.setExtraStackFrame(null)}var K=Array.isArray;// eslint-disable-next-line no-redeclare
...
// ignores it.
Object.defineProperty(s._store,"validated",{configurable:!1,enumerable:!1,writable:!0,value:!1}),Object.defineProperty(s,"_self",{configurable:!1,enumerable:!1,writable:!1,value:r}),// equal for testing purposes and therefore we hide it from enumeration.
Object.defineProperty(s,"_source",{configurable:!1,enumerable:!1,writable:!1,value:o}),Object.freeze&&(Object.freeze(s.props),Object.freeze(s)),s)},ee=M.ReactCurrentOwner,et=M.ReactDebugCurrentFrame;function en(e){if(e){var t=e._owner,n=W(e.type,e._source,t?t.type:null);et.setExtraStackFrame(n)}else et.setExtraStackFrame(null)}/**
 * Verifies the object is a ReactElement.
 * See https://reactjs.org/docs/react-api.html#isvalidelement
 * @param {?object} object
 * @return {boolean} True if `object` is a ReactElement.
 ...
 * @param {ReactNode} node Statically passed child of any type.
 * @param {*} parentType node's parent's type.
 */function es(e,t){if("object"==typeof e){if(K(e))for(var n=0;n<e.length;n++){var r=e[n];er(r)&&ea(r,t)}else if(er(e))e._store&&(e._store.validated=!0);else if(e){var o=function(e){if(null===e||"object"!=typeof e)return null;var t=D&&e[D]||e["@@iterator"];return"function"==typeof t?t:null}(e);if("function"==typeof o&&o!==e.entries)for(var i,a=o.call(e);!(i=a.next()).done;)er(i.value)&&ea(i.value,t)}}}function eu(t,n,r,o,i,a){var s="string"==typeof t||"function"==typeof t||t===_||t===k||t===w||t===C||t===T||t===P||"object"==typeof t&&null!==t&&(t.$$typeof===R||t.$$typeof===O||t.$$typeof===S||t.$$typeof===x||t.$$typeof===E||// This needs to include all possible module reference object
// types supported by any Flight configuration anywhere since
// we don't know which Flight build this will end up being used
// with.
t.$$typeof===e||void 0!==t.getModuleId);// We warn in this case but don't throw. We expect the element creation to
// succeed and there will likely be errors in render.
if(!s){var u,l="";(void 0===t||"object"==typeof t&&null!==t&&0===Object.keys(t).length)&&(l+=" You likely forgot to export your component from the file it's defined in, or you might have mixed up default and named imports.");var c=void 0!==i?"\n\nCheck your code at "+i.fileName.replace(/^.*[\\\/]/,"")+":"+i.lineNumber+".":"";(c?l+=c:l+=eo(),null===t)?u="null":K(t)?u="array":void 0!==t&&t.$$typeof===y?(u="<"+(A(t.type)||"Unknown")+" />",l=" Did you accidentally export a JSX literal instead of a component?"):u=typeof t,L("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s",u,l)}var d=/**
 * https://github.com/reactjs/rfcs/pull/107
 * @param {*} type
 * @param {object} props
 * @param {string} key
 */function(e,t,n,r,o){var i,a={},s=null,u=null;for(i in void 0!==n&&(G(n),s=""+n),function(e){if($.call(e,"key")){var t=Object.getOwnPropertyDescriptor(e,"key").get;if(t&&t.isReactWarning)return!1}return void 0!==e.key}(t)&&(G(t.key),s=""+t.key),function(e){if($.call(e,"ref")){var t=Object.getOwnPropertyDescriptor(e,"ref").get;if(t&&t.isReactWarning)return!1}return void 0!==e.ref}(t)&&(u=t.ref,function(e,t){if("string"==typeof e.ref&&X.current&&t&&X.current.stateNode!==t){var n=A(X.current.type);m[n]||(L('Component "%s" contains the string ref "%s". Support for string refs will be removed in a future major release. This case cannot be automatically converted to an arrow function. We ask you to manually fix this case by using useRef() or createRef() instead. Learn more about using refs safely here: https://reactjs.org/link/strict-mode-string-ref',A(X.current.type),e.ref),m[n]=!0)}}(t,o)),t)$.call(t,i)&&!J.hasOwnProperty(i)&&(a[i]=t[i]);// Resolve default props
if(e&&e.defaultProps){var l=e.defaultProps;for(i in l)void 0===a[i]&&(a[i]=l[i])}if(s||u){var c,d,f="function"==typeof e?e.displayName||e.name||"Unknown":e;s&&((c=function(){p||(p=!0,L("%s: `key` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)",f))}).isReactWarning=!0,Object.defineProperty(a,"key",{get:c,configurable:!0})),u&&((d=function(){h||(h=!0,L("%s: `ref` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)",f))}).isReactWarning=!0,Object.defineProperty(a,"ref",{get:d,configurable:!0}))}return Z(e,s,u,o,r,X.current,a)}(t,n,r,i,a);// The result can be nullish if a mock or a custom function is used.
// TODO: Drop this when these are no longer allowed as the type argument.
...
// (Rendering will throw with a helpful message and as soon as the type is
// fixed, the key warnings will appear.)
if(s){var f=n.children;if(void 0!==f){if(o){if(K(f)){for(var v=0;v<f.length;v++)es(f[v],t);Object.freeze&&Object.freeze(f)}else L("React.jsx: Static children should always be an array. You are likely explicitly calling React.jsxs or React.jsxDEV. Use the Babel transform instead.")}else es(f,t)}}return t===_?/**
 * Given a fragment, validate that it can only be provided with fragment props
 * @param {ReactElement} fragment
...
// UTILS
let L="undefined"==typeof window||"Deno"in window;function N(){}function A(e,t,n){return H(e)?"function"==typeof t?{...n,queryKey:e,queryFn:t}:{...t,queryKey:e}:e}function U(e,t,n){return H(e)?[{...t,queryKey:e},n]:[e||{},t]}function F(e,t){let{type:n="all",exact:r,fetchStatus:o,predicate:i,queryKey:a,stale:s}=e;if(H(a)){if(r){if(t.queryHash!==z(a,t.options))return!1}else{if(!B(t.queryKey,a))return!1}}if("all"!==n){let e=t.isActive();if("active"===n&&!e||"inactive"===n&&e)return!1}return("boolean"!=typeof s||t.isStale()===s)&&(void 0===o||o===t.state.fetchStatus)&&(!i||!!i(t))}function j(e,t){let{exact:n,fetching:r,predicate:o,mutationKey:i}=e;if(H(i)){if(!t.options.mutationKey)return!1;if(n){if(q(t.options.mutationKey)!==q(i))return!1}else{if(!B(t.options.mutationKey,i))return!1}}return("boolean"!=typeof r||"loading"===t.state.status===r)&&(!o||!!o(t))}function z(e,t){let n=(null==t?void 0:t.queryKeyHashFn)||q;return n(e)}/**
 ...
 */function e(t,n){if(t===n)return t;let r=V(t)&&V(n);if(r||W(t)&&W(n)){let o=r?t.length:Object.keys(t).length,i=r?n:Object.keys(n),a=i.length,s=r?[]:{},u=0;for(let o=0;o<a;o++){let a=r?o:i[o];s[a]=e(t[a],n[a]),s[a]===t[a]&&u++}return o===a&&u===o?t:s}return n}(n,e):e);// Set data and mark it as cached
return this.dispatch({data:o,type:"success",dataUpdatedAt:null==t?void 0:t.updatedAt,manual:null==t?void 0:t.manual}),o}setState(e,t){this.dispatch({type:"setState",state:e,setStateOptions:t})}cancel(e){var t;let n=this.promise;return null==(t=this.retryer)||t.cancel(e),n?n.then(N).catch(N):Promise.resolve()}destroy(){super.destroy(),this.cancel({silent:!0})}reset(){this.destroy(),this.setState(this.initialState)}isActive(){return this.observers.some(e=>!1!==e.options.enabled)}isDisabled(){return this.getObserversCount()>0&&!this.isActive()}isStale(){return this.state.isInvalidated||!this.state.dataUpdatedAt||this.observers.some(e=>e.getCurrentResult().isStale)}isStaleByTime(e=0){return this.state.isInvalidated||!this.state.dataUpdatedAt||!Math.max(this.state.dataUpdatedAt+(e||0)-Date.now(),0)}onFocus(){var e;let t=this.observers.find(e=>e.shouldFetchOnWindowFocus());t&&t.refetch({cancelRefetch:!1}),null==// Continue fetch if currently paused
 ...
 * }
 * ```
 */function(e={}){let t=/*@__PURE__*/O(D).useRef(),n=/*@__PURE__*/O(D).useRef(),[r,o]=/*@__PURE__*/O(D).useState({isDirty:!1,isValidating:!1,isLoading:e0(e.defaultValues),isSubmitted:!1,isSubmitting:!1,isSubmitSuccessful:!1,isValid:!1,submitCount:0,dirtyFields:{},touchedFields:{},errors:{},defaultValues:e0(e.defaultValues)?void 0:e.defaultValues});t.current||(t.current={...function(e={},t){let n,r={...tw,...e},o={submitCount:0,isDirty:!1,isLoading:e0(r.defaultValues),isValidating:!1,isSubmitted:!1,isSubmitting:!1,isSubmitSuccessful:!1,isValid:!1,touchedFields:{},dirtyFields:{},errors:{}},i={},a=(eE(r.defaultValues)||eE(r.values))&&eI(r.defaultValues||r.values)||{},s=r.shouldUnregister?{}:eI(a),u={action:!1,mount:!1,watch:!1},l={mount:new Set,unMount:new Set,array:new Set,watch:new Set},c=0,d={isDirty:!1,dirtyFields:!1,touchedFields:!1,isValidating:!1,isValid:!1,errors:!1},f={values:to(),array:to(),state:to()},p=e.resetOptions&&e.resetOptions.keepDirtyValues,h=eG(r.mode),m=eG(r.reValidateMode),g=r.criteriaMode===eU.all,v=e=>t=>{clearTimeout(c),c=setTimeout(e,t)},y=async e=>{if(d.isValid||e){let e=r.resolver?ez((await x()).errors):await C(i,!0);e!==o.isValid&&f.state.next({isValid:e})}},b=e=>d.isValidating&&f.state.next({isValidating:e}),_=(e,t)=>{eY(o.errors,e,t),f.state.next({errors:o.errors})},w=(e,t,n,r)=>{let o=eL(i,e);if(o){let i=eL(s,e,eM(n)?eL(a,e):n);eM(i)||r&&r.defaultChecked||t?eY(s,e,t?i:th(o._f)):R(e,i),u.mount&&y()}},k=(e,t,n,r,i)=>{let s=!1,u=!1,l={name:e};if(!n||r){d.isDirty&&(u=o.isDirty,o.isDirty=l.isDirty=T(),s=u!==l.isDirty);let n=ta(eL(a,e),t);u=eL(o.dirtyFields,e),n?tr(o.dirtyFields,e):eY(o.dirtyFields,e,!0),l.dirtyFields=o.dirtyFields,s=s||d.dirtyFields&&!n!==u}if(n){let t=eL(o.touchedFields,e);t||(eY(o.touchedFields,e,n),l.touchedFields=o.touchedFields,s=s||d.touchedFields&&t!==n)}return s&&i&&f.state.next(l),s?l:{}},S=(t,r,i,a)=>{let s=eL(o.errors,t),u=d.isValid&&eN(r)&&o.isValid!==r;if(e.delayError&&i?(n=v(()=>_(t,i)))(e.delayError):(clearTimeout(c),n=null,i?eY(o.errors,t,i):tr(o.errors,t)),(i?!ta(s,i):s)||!ez(a)||u){let e={...a,...u&&eN(r)?{isValid:r}:{},errors:o.errors,name:t};o={...o,...e},f.state.next(e)}b(!1)},x=async e=>r.resolver(s,r.context,tm(e||l.mount,i,r.criteriaMode,r.shouldUseNativeValidation)),E=async e=>{let{errors:t}=await x(e);if(e)for(let n of e){let e=eL(t,n);e?eY(o.errors,n,e):tr(o.errors,n)}else o.errors=t;return t},C=async(e,t,n={valid:!0})=>{for(let i in e){let a=e[i];if(a){let{_f:e,...i}=a;if(e){let i=l.array.has(e.name),u=await tn(a,s,g,r.shouldUseNativeValidation&&!t,i);if(u[e.name]&&(n.valid=!1,t))break;t||(eL(u,e.name)?i?eJ(o.errors,u,e.name):eY(o.errors,e.name,u[e.name]):tr(o.errors,e.name))}i&&await C(i,t,n)}}return n.valid},T=(e,t)=>(e&&t&&eY(s,e,t),!ta(L(),a)),O=(e,t,n)=>eW(e,l,{...u.mount?s:eM(t)?a:eV(e)?{[e]:t}:t},n,t),R=(e,t,n={})=>{let r=eL(i,e),o=t;if(r){let n=r._f;n&&(n.disabled||eY(s,e,tp(t,n)),o=e1(n.ref)&&eS(t)?"":t,ts(n.ref)?[...n.ref.options].forEach(e=>e.selected=o.includes(e.value)):n.refs?ew(n.ref)?n.refs.length>1?n.refs.forEach(e=>(!e.defaultChecked||!e.disabled)&&(e.checked=Array.isArray(o)?!!o.find(t=>t===e.value):o===e.value)):n.refs[0]&&(n.refs[0].checked=!!o):n.refs.forEach(e=>e.checked=e.value===o):eZ(n.ref)?n.ref.value="":(n.ref.value=o,n.ref.type||f.values.next({name:e,values:{...s}})))}(n.shouldDirty||n.shouldTouch)&&k(e,o,n.shouldTouch,n.shouldDirty,!0),n.shouldValidate&&M(e)},P=(e,t,n)=>{for(let r in t){let o=t[r],a=`${e}.${r}`,s=eL(i,a);!l.array.has(e)&&ti(o)&&(!s||s._f)||ek(o)?R(a,o,n):P(a,o,n)}},I=(e,n,r={})=>{let c=eL(i,e),p=l.array.has(e),h=eI(n);eY(s,e,h),p?(f.array.next({name:e,values:{...s}}),(d.isDirty||d.dirtyFields)&&r.shouldDirty&&f.state.next({name:e,dirtyFields:tf(a,s),isDirty:T(e,h)})):!c||c._f||eS(h)?R(e,h,r):P(e,h,r),eX(e,l)&&f.state.next({...o}),f.values.next({name:e,values:{...s}}),u.mount||t()},D=async e=>{let t=e.target,a=t.name,u=!0,c=eL(i,a);if(c){let p,v;let _=t.type?th(c._f):eC(e),w=e.type===eA.BLUR||e.type===eA.FOCUS_OUT,E=!tv(c._f)&&!r.resolver&&!eL(o.errors,a)&&!c._f.deps||tb(w,eL(o.touchedFields,a),o.isSubmitted,m,h),T=eX(a,l,w);eY(s,a,_),w?(c._f.onBlur&&c._f.onBlur(e),n&&n(0)):c._f.onChange&&c._f.onChange(e);let O=k(a,_,w,!1),R=!ez(O)||T;if(w||f.values.next({name:a,type:e.type,values:{...s}}),E)return d.isValid&&y(),R&&f.state.next({name:a,...T?{}:O});if(!w&&T&&f.state.next({...o}),b(!0),r.resolver){let{errors:e}=await x([a]),t=ty(o.errors,i,a),n=ty(e,i,t.name||a);p=n.error,a=n.name,v=ez(e)}else p=(await tn(c,s,g,r.shouldUseNativeValidation))[a],(u=Number.isNaN(_)||_===eL(s,a,_))&&(p?v=!1:d.isValid&&(v=await C(i,!0)));u&&(c._f.deps&&M(c._f.deps),S(a,v,p,O))}},M=async(e,t={})=>{let n,a;let s=eB(e);if(b(!0),r.resolver){let t=await E(eM(e)?e:s);n=ez(t),a=e?!s.some(e=>eL(t,e)):n}else e?((a=(await Promise.all(s.map(async e=>{let t=eL(i,e);return await C(t&&t._f?{[e]:t}:t)}))).every(Boolean))||o.isValid)&&y():a=n=await C(i);return f.state.next({...!eV(e)||d.isValid&&n!==o.isValid?{}:{name:e},...r.resolver||!e?{isValid:n}:{},errors:o.errors,isValidating:!1}),t.shouldFocus&&!a&&eK(i,e=>e&&eL(o.errors,e),e?s:l.mount),a},L=e=>{let t={...a,...u.mount?s:{}};return eM(e)?t:eV(e)?eL(t,e):e.map(e=>eL(t,e))},N=(e,t)=>({invalid:!!eL((t||o).errors,e),isDirty:!!eL((t||o).dirtyFields,e),isTouched:!!eL((t||o).touchedFields,e),error:eL((t||o).errors,e)}),A=(e,t,n)=>{let r=(eL(i,e,{_f:{}})._f||{}).ref;eY(o.errors,e,{...t,ref:r}),f.state.next({name:e,errors:o.errors,isValid:!1}),n&&n.shouldFocus&&r&&r.focus&&r.focus()},U=(e,t={})=>{for(let n of e?eB(e):l.mount)l.mount.delete(n),l.array.delete(n),t.keepValue||(tr(i,n),tr(s,n)),t.keepError||tr(o.errors,n),t.keepDirty||tr(o.dirtyFields,n),t.keepTouched||tr(o.touchedFields,n),r.shouldUnregister||t.keepDefaultValue||tr(a,n);f.values.next({values:{...s}}),f.state.next({...o,...t.keepDirty?{isDirty:T()}:{}}),t.keepIsValid||y()},F=({disabled:e,name:t,field:n,fields:r})=>{if(eN(e)){let o=e?void 0:eL(s,t,th(n?n._f:eL(r,t)._f));eY(s,t,o),k(t,o,!1,!1,!0)}},j=(e,t={})=>{let n=eL(i,e),o=eN(t.disabled);return eY(i,e,{...n||{},_f:{...n&&n._f?n._f:{ref:{name:e}},name:e,mount:!0,...t}}),l.mount.add(e),n?F({field:n,disabled:t.disabled,name:e}):w(e,!0,t.value),{...o?{disabled:t.disabled}:{},...r.progressive?{required:!!t.required,min:tg(t.min),max:tg(t.max),minLength:tg(t.minLength),maxLength:tg(t.maxLength),pattern:tg(t.pattern)}:{},name:e,onChange:D,onBlur:D,ref:o=>{if(o){j(e,t),n=eL(i,e);let r=eM(o.value)&&o.querySelectorAll&&o.querySelectorAll("input,select,textarea")[0]||o,s=tu(r),u=n._f.refs||[];(s?u.find(e=>e===r):r===n._f.ref)||(eY(i,e,{_f:{...n._f,...s?{refs:[...u.filter(tl),r,...Array.isArray(eL(a,e))?[{}]:[]],ref:{type:r.type,name:e}}:{ref:r}}}),w(e,!1,void 0,r))}else(n=eL(i,e,{}))._f&&(n._f.mount=!1),(r.shouldUnregister||t.shouldUnregister)&&!(eO(l.array,e)&&u.action)&&l.unMount.add(e)}}},z=()=>r.shouldFocusError&&eK(i,e=>e&&eL(o.errors,e),l.mount),q=(e,t)=>async n=>{n&&(n.preventDefault&&n.preventDefault(),n.persist&&n.persist());let a=eI(s);if(f.state.next({isSubmitting:!0}),r.resolver){let{errors:e,values:t}=await x();o.errors=e,a=t}else await C(i);tr(o.errors,"root"),ez(o.errors)?(f.state.next({errors:{}}),await e(a,n)):(t&&await t({...o.errors},n),z(),setTimeout(z)),f.state.next({isSubmitted:!0,isSubmitting:!1,isSubmitSuccessful:ez(o.errors),submitCount:o.submitCount+1,errors:o.errors})},B=(n,r={})=>{let c=n?eI(n):a,h=eI(c),m=n&&!ez(n)?h:a;if(r.keepDefaultValues||(a=c),!r.keepValues){if(r.keepDirtyValues||p)for(let e of l.mount)eL(o.dirtyFields,e)?eY(m,e,eL(s,e)):I(e,eL(m,e));else{if(eP&&eM(n))for(let e of l.mount){let t=eL(i,e);if(t&&t._f){let e=Array.isArray(t._f.refs)?t._f.refs[0]:t._f.ref;if(e1(e)){let t=e.closest("form");if(t){t.reset();break}}}}i={}}s=e.shouldUnregister?r.keepDefaultValues?eI(a):{}:eI(m),f.array.next({values:{...m}}),f.values.next({values:{...m}})}l={mount:new Set,unMount:new Set,array:new Set,watch:new Set,watchAll:!1,focus:""},u.mount||t(),u.mount=!d.isValid||!!r.keepIsValid,u.watch=!!e.shouldUnregister,f.state.next({submitCount:r.keepSubmitCount?o.submitCount:0,isDirty:r.keepDirty?o.isDirty:!!(r.keepDefaultValues&&!ta(n,a)),isSubmitted:!!r.keepIsSubmitted&&o.isSubmitted,dirtyFields:r.keepDirtyValues?o.dirtyFields:r.keepDefaultValues&&n?tf(a,n):{},touchedFields:r.keepTouched?o.touchedFields:{},errors:r.keepErrors?o.errors:{},isSubmitSuccessful:!!r.keepIsSubmitSuccessful&&o.isSubmitSuccessful,isSubmitting:!1})},V=(e,t)=>B(e0(e)?e(s):e,t);return{control:{register:j,unregister:U,getFieldState:N,handleSubmit:q,setError:A,_executeSchema:x,_getWatch:O,_getDirty:T,_updateValid:y,_removeUnmounted:()=>{for(let e of l.unMount){let t=eL(i,e);t&&(t._f.refs?t._f.refs.every(e=>!tl(e)):!tl(t._f.ref))&&U(e)}l.unMount=new Set},_updateFieldArray:(e,t=[],n,r,l=!0,c=!0)=>{if(r&&n){if(u.action=!0,c&&Array.isArray(eL(i,e))){let t=n(eL(i,e),r.argA,r.argB);l&&eY(i,e,t)}if(c&&Array.isArray(eL(o.errors,e))){let t=n(eL(o.errors,e),r.argA,r.argB);l&&eY(o.errors,e,t),t_(o.errors,e)}if(d.touchedFields&&c&&Array.isArray(eL(o.touchedFields,e))){let t=n(eL(o.touchedFields,e),r.argA,r.argB);l&&eY(o.touchedFields,e,t)}d.dirtyFields&&(o.dirtyFields=tf(a,s)),f.state.next({name:e,isDirty:T(e,t),dirtyFields:o.dirtyFields,errors:o.errors,isValid:o.isValid})}else eY(s,e,t)},_updateDisabledField:F,_getFieldArray:t=>eD(eL(u.mount?s:a,t,e.shouldUnregister?eL(a,t,[]):[])),_reset:B,_resetDefaultValues:()=>e0(r.defaultValues)&&r.defaultValues().then(e=>{V(e,r.resetOptions),f.state.next({isLoading:!1})}),_updateFormState:e=>{o={...o,...e}},_subjects:f,_proxyFormState:d,get _fields(){return i},get _formValues(){return s},get _state(){return u},set _state(value){u=value},get _defaultValues(){return a},get _names(){return l},set _names(value){l=value},get _formState(){return o},set _formState(value){o=value},get _options(){return r},set _options(value){r={...r,...value}}},trigger:M,register:j,handleSubmit:q,watch:(e,t)=>e0(e)?f.values.subscribe({next:n=>e(O(void 0,t),n)}):O(e,t,!0),setValue:I,getValues:L,reset:V,resetField:(e,t={})=>{eL(i,e)&&(eM(t.defaultValue)?I(e,eL(a,e)):(I(e,t.defaultValue),eY(a,e,t.defaultValue)),t.keepTouched||tr(o.touchedFields,e),t.keepDirty||(tr(o.dirtyFields,e),o.isDirty=t.defaultValue?T(e,eL(a,e)):T()),!t.keepError&&(tr(o.errors,e),d.isValid&&y()),f.state.next({...o}))},clearErrors:e=>{e&&eB(e).forEach(e=>tr(o.errors,e)),f.state.next({errors:e?o.errors:{}})},unregister:U,setError:A,setFocus:(e,t={})=>{let n=eL(i,e),r=n&&n._f;if(r){let e=r.refs?r.refs[0]:r.ref;e.focus&&(e.focus(),t.shouldSelect&&e.select())}},getFieldState:N}}(e,()=>o(e=>({...e}))),formState:r});let i=t.current.control;return i._options=e,!function(e){let t=/*@__PURE__*/O(D).useRef(e);t.current=e,/*@__PURE__*/O(D).useEffect(()=>{let n=!e.disabled&&t.current.subject&&t.current.subject.subscribe({next:t.current.next});return()=>{n&&n.unsubscribe()}},[e.disabled])}({subject:i._subjects.state,next:e=>{eq(e,i._proxyFormState,i._updateFormState,!0)&&o({...i._formState})}}),/*@__PURE__*/O(D).useEffect(()=>{e.values&&!ta(e.values,n.current)?(i._reset(e.values,i._options.resetOptions),n.current=e.values):i._resetDefaultValues()},[e.values,i]),/*@__PURE__*/O(D).useEffect(()=>{i._state.mount||(i._updateValid(),i._state.mount=!0),i._state.watch&&(i._state.watch=!1,i._subjects.state.next({...i._formState})),i._removeUnmounted()}),t.current.formState=ej(r,i),t.current}(),[u,l]=D.useState({busy:!1,complete:!1,voucher:null,error:null,responseStatusCode:0});async function c(r){let o={...r,bookingLink:`${n?.origin}/${e?.slug}`},i=await fetch(tk(`campaigns/${t?.campaign}/voucher?locationID=${e?.identifier}`),{method:"POST",headers:{Accept:"application/json","Content-type":"application/json"},body:JSON.stringify(o)});i.json().then(e=>{i.ok?l({busy:!1,complete:!0,voucher:e.voucher}):l({busy:!1,error:e,responseStatusCode:i.status})})}async function d(n){// @ts-ignore
...
return tI[e[t+0]]+tI[e[t+1]]+tI[e[t+2]]+tI[e[t+3]]+"-"+tI[e[t+4]]+tI[e[t+5]]+"-"+tI[e[t+6]]+tI[e[t+7]]+"-"+tI[e[t+8]]+tI[e[t+9]]+"-"+tI[e[t+10]]+tI[e[t+11]]+tI[e[t+12]]+tI[e[t+13]]+tI[e[t+14]]+tI[e[t+15]]}(o)},D=I("exYeM");let tM=({debug:e,children:t})=>{let n=(...t)=>{e&&console.log(...t)};return(0,D.useEffect)(()=>{e&&n("LoggingProvider: In Debug Mode")}),/*@__PURE__*/O(D).createElement(tL.Provider,{value:{log:n,warn:(...t)=>{e&&console.warn(...t)},error:(...t)=>{e&&console.error(...t);// throw new Error(...message)
},info:(...t)=>{e&&console.info(...t)}}},t)},tL=/*#__PURE__*/(0,D.createContext)({log:()=>{},warn:()=>{},error:()=>{},info:()=>{}}),tN=()=>(0,D.useContext)(tL);var tA={},tU={DEBUG:!1,LIB_VERSION:"2.47.0"};if("undefined"==typeof window){var tF={hostname:""};x={navigator:{userAgent:""},document:{location:tF,referrer:""},screen:{width:0,height:0},location:tF}}else x=window;/*
 * Saved references to long variable names, so that closure compiler can
 * minimize file size.
 */var tj=Array.prototype,tz=Function.prototype,tq=Object.prototype,tB=tj.slice,tV=tq.toString,tW=tq.hasOwnProperty,t$=x.console,tH=x.navigator,tY=x.document,tQ=x.opera,tK=x.screen,tG=tH.userAgent,tX=tz.bind,tJ=tj.forEach,tZ=tj.indexOf,t0=tj.map,t1=Array.isArray,t2={},t3={trim:function(e){// https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String/Trim#Polyfill
return e.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,"")}},t4={/** @type {function(...*)} */log:function(){if(tU.DEBUG&&!t3.isUndefined(t$)&&t$)try{t$.log.apply(t$,arguments)}catch(e){t3.each(arguments,function(e){t$.log(e)})}},/** @type {function(...*)} */warn:function(){if(tU.DEBUG&&!t3.isUndefined(t$)&&t$){var e=["Mixpanel warning:"].concat(t3.toArray(arguments));try{t$.warn.apply(t$,e)}catch(t){t3.each(e,function(e){t$.warn(e)})}}},/** @type {function(...*)} */error:function(){if(tU.DEBUG&&!t3.isUndefined(t$)&&t$){var e=["Mixpanel error:"].concat(t3.toArray(arguments));try{t$.error.apply(t$,e)}catch(t){t3.each(e,function(e){t$.error(e)})}}},/** @type {function(...*)} */critical:function(){if(!t3.isUndefined(t$)&&t$){var e=["Mixpanel error:"].concat(t3.toArray(arguments));try{t$.error.apply(t$,e)}catch(t){t3.each(e,function(e){t$.error(e)})}}}},t6=function(e,t){return function(){return arguments[0]="["+t+"] "+arguments[0],e.apply(t4,arguments)}},t5=function(e){return{log:t6(t4.log,e),error:t6(t4.error,e),critical:t6(t4.critical,e)}};// UNDERSCORE
...
for(a in d)tW.call(d,a)&&(s=n(a,d))&&c.push(t(a)+(o?": ":":")+s);return(// Join all of the member texts together, separated with commas,
 ...
 */nb.prototype.reportError=function(e,t){if(ny.error.apply(ny.error,arguments),this.errorReporter)try{t instanceof Error||(t=Error(e)),this.errorReporter(e,t)}catch(e){ny.error(e)}};/** @const */var nM="$set",nL="$set_once",nN="$unset",nA="$add",nU="$append",nF="$union",nj="$remove",nz={set_action:function(e,t){var n={},r={};return t3.isObject(e)?t3.each(e,function(e,t){this._is_reserved_property(t)||(r[t]=e)},this):r[e]=t,n[nM]=r,n},unset_action:function(e){var t={},n=[];return t3.isArray(e)||(e=[e]),t3.each(e,function(e){this._is_reserved_property(e)||n.push(e)},this),t[nN]=n,t},set_once_action:function(e,t){var n={},r={};return t3.isObject(e)?t3.each(e,function(e,t){this._is_reserved_property(t)||(r[t]=e)},this):r[e]=t,n[nL]=r,n},union_action:function(e,t){var n={},r={};return t3.isObject(e)?t3.each(e,function(e,t){this._is_reserved_property(t)||(r[t]=t3.isArray(e)?e:[e])},this):r[e]=t3.isArray(t)?t:[t],n[nF]=r,n},append_action:function(e,t){var n={},r={};return t3.isObject(e)?t3.each(e,function(e,t){this._is_reserved_property(t)||(r[t]=e)},this):r[e]=t,n[nU]=r,n},remove_action:function(e,t){var n={},r={};return t3.isObject(e)?t3.each(e,function(e,t){this._is_reserved_property(t)||(r[t]=e)},this):r[e]=t,n[nj]=r,n},delete_action:function(){var e={};return e.$delete="",e}},nq=function(){};t3.extend(nq.prototype,nz),nq.prototype._init=function(e,t,n){this._mixpanel=e,this._group_key=t,this._group_id=n},/**
...
nB.prototype._enqueue=function(e){nM in e?this._mixpanel.persistence._add_to_people_queue(nM,e):nL in e?this._mixpanel.persistence._add_to_people_queue(nL,e):nN in e?this._mixpanel.persistence._add_to_people_queue(nN,e):nA in e?this._mixpanel.persistence._add_to_people_queue(nA,e):nU in e?this._mixpanel.persistence._add_to_people_queue(nU,e):nj in e?this._mixpanel.persistence._add_to_people_queue(nj,e):nF in e?this._mixpanel.persistence._add_to_people_queue(nF,e):t4.error("Invalid call to _enqueue():",e)},nB.prototype._flush_one_queue=function(e,t,n,r){var o=this,i=t3.extend({},this._mixpanel.persistence._get_queue(e)),a=i;!t3.isUndefined(i)&&t3.isObject(i)&&!t3.isEmptyObject(i)&&(o._mixpanel.persistence._pop_from_people_queue(e,i),r&&(a=r(i)),t.call(o,a,function(t,r){0===t&&o._mixpanel.persistence._add_to_people_queue(e,i),t3.isUndefined(n)||n(t,r)}))},// Flush queued engage operations - order does not matter,
// and there are network level race conditions anyway
nB.prototype._flush=function(e,t,n,r,o,i,a){var s=this,u=this._mixpanel.persistence._get_queue(nU),l=this._mixpanel.persistence._get_queue(nj);// we have to fire off each $append individually since there is
// no concat method server side
if(this._flush_one_queue(nM,this.set,e),this._flush_one_queue(nL,this.set_once,r),this._flush_one_queue(nN,this.unset,i,function(e){return t3.keys(e)}),this._flush_one_queue(nA,this.increment,t),this._flush_one_queue(nF,this.union,o),!t3.isUndefined(u)&&t3.isArray(u)&&u.length){for(var c,d=function(e,t){0===e&&s._mixpanel.persistence._add_to_people_queue(nU,c),t3.isUndefined(n)||n(e,t)},f=u.length-1;f>=0;f--)c=u.pop(),t3.isEmptyObject(c)||s.append(c,d);// Save the shortened append queue
s._mixpanel.persistence.save()}// same for $remove
if(!t3.isUndefined(l)&&t3.isArray(l)&&l.length){for(var p,h=function(e,t){0===e&&s._mixpanel.persistence._add_to_people_queue(nj,p),t3.isUndefined(a)||a(e,t)},m=l.length-1;m>=0;m--)p=l.pop(),t3.isEmptyObject(p)||s.remove(p,h);s._mixpanel.persistence.save()}},nB.prototype._is_reserved_property=function(e){return"$distinct_id"===e||"$token"===e||"$device_id"===e||"$user_id"===e||"$had_persisted_distinct_id"===e},// MixpanelPeople Exports
...
// with the set.
this._pop_from_people_queue(nF,r),this._pop_from_people_queue(nN,r)):n===nW?(// only queue the data if there is not already a set_once call for it.
t3.each(r,function(e,t){t in i||(i[t]=e)}),this._pop_from_people_queue(nN,r)):n===n$?t3.each(r,function(e){// undo previously-queued actions on this key
...
// the value
t in o?o[t]+=e:(t in s||(s[t]=0),s[t]+=e)},this),this._pop_from_people_queue(nN,r)):n===nK?(t3.each(r,function(e,t){t3.isArray(e)&&(t in u||(u[t]=[]),// We may send duplicates, the server will dedup them.
u[t]=u[t].concat(e))}),this._pop_from_people_queue(nN,r)):n===nQ?(l.push(r),this._pop_from_people_queue(nU,r)):n===nY&&(c.push(r),this._pop_from_people_queue(nN,r)),t4.log("MIXPANEL PEOPLE REQUEST (QUEUED, PENDING IDENTIFY):"),t4.log(t),this.save()},n0.prototype._pop_from_people_queue=function(e,t){var n=this._get_queue(e);t3.isUndefined(n)||(t3.each(t,function(t,r){e===nU||e===nj?// e.g. remove should not override append in a case like
// append({foo: 'bar'}); remove({foo: 'qux'})
t3.each(n,function(e){e[r]===t&&delete e[r]}):delete n[r]},this),this.save())},n0.prototype._get_queue_key=function(e){return e===nM?nV:e===nL?nW:e===nN?n$:e===nA?nH:e===nU?nY:e===nj?nQ:e===nF?nK:void t4.error("Invalid queue:",e)},n0.prototype._get_queue=function(e){return this.props[this._get_queue_key(e)]},n0.prototype._get_or_create_queue=function(e,t){var n=this._get_queue_key(e);return t=t3.isUndefined(t)?{}:t,this.props[n]||(this.props[n]=t)},n0.prototype.set_event_timer=function(e,t){var n=this.props[nJ]||{};n[e]=t,this.props[nJ]=n,this.save()},n0.prototype.remove_event_timer=function(e){var t=(this.props[nJ]||{})[e];return t3.isUndefined(t)||(delete this.props[nJ][e],this.save()),t};var n1=function(e){return e},n2=function(){},n3="mixpanel",n4="base64",n6="$device:",n5=x.XMLHttpRequest&&"withCredentials"in new XMLHttpRequest,n8=!n5&&-1===tG.indexOf("MSIE")&&-1===tG.indexOf("Mozilla"),n7=null;tH.sendBeacon&&(n7=function(){// late reference to navigator.sendBeacon to allow patching/spying
 ...
 */rt.prototype.opt_in_tracking=function(e){e=t3.extend({enable_persistence:!0},e),this._gdpr_call_func(n_,e),this._gdpr_update_persistence(e)},/**
 ...
 * @param {boolean} [options.cross_subdomain_cookie] Whether the opt-in cookie is set as cross-subdomain or not (overrides value specified in this Mixpanel instance's config)
 * @param {boolean} [options.secure_cookie] Whether the opt-in cookie is set as secure or not (overrides value specified in this Mixpanel instance's config)
 */rt.prototype.opt_out_tracking=function(e){(e=t3.extend({clear_persistence:!0,delete_user:!0},e)).delete_user&&this.people&&this.people._identify_called()&&(this.people.delete_user(),this.people.clear_charges()),this._gdpr_call_func(nw,e),this._gdpr_update_persistence(e)},/**
...
t3.register_event(x,"load",e,!0)}(),tA=C;var D=(I("exYeM"),I("exYeM"));let rs=()=>(0,D.useContext)(a_);function ru(){// TODO: temp hack for managing prod and dev env.
...
(n=>ai.post(ao+"/collector/"+n?.visitor?.id,n).then(t=>(e("Collector API response",t),t)).catch(e=>(t("Collector API error",e),e)),{onSuccess:()=>{}})};function as({children:e,handlers:t=[]}){let{log:n,error:r}=tN(),{appId:o,booted:i,initialDelay:a,exitIntentTriggers:s,idleTriggers:u,config:l}=rs(),{visitor:c,session:d}=rw(),{trackEvent:f}=rC(),{mutateAsync:p}=aa(),{registerHandler:h}=function(e={}){let t=i7(i8({},iZ),{cookie:i8(i8({},iZ.cookie),e?.cookie),desktop:i8(i8({},iZ.desktop),e?.desktop),mobile:i8(i8({},iZ.mobile),e?.mobile)}),[n,r]=(0,D.useState)(t),[o,i]=(0,D.useState)(!1),[a,s]=(0,D.useState)(!1),u=(0,D.useRef)([]).current,l=(0,D.useRef)(!1),{mobile:c,desktop:d,cookie:f}=n;l.current=a||o;let p=(0,D.useCallback)(()=>{l.current||(i(!0),u.filter(e=>{var t,n;return(null==(t=e.context)?void 0:t.filter(e=>e!==iJ.onDesktop&&e!==iJ.onMobile).length)===0||(null==(n=e.context)?void 0:n.includes(iJ.onTrigger))}).forEach(iQ))},[]),h=(0,D.useCallback)(()=>{iW.set(f.key,"true",{expires:f.daysToExpire,sameSite:"Strict"}),u.filter(e=>{var t;return null==(t=e.context)?void 0:t.includes(iJ.onUnsubscribe)}).forEach(iQ),s(!0)},[f?.key]),m=(0,D.useCallback)(()=>{iW.remove(f?.key,{sameSite:"Strict"}),window.onbeforeunload=null,i(!1),s(!1)},[f?.key]),g=(0,D.useCallback)(()=>{m(),r(t)},[]),v=(0,D.useCallback)(e=>{let t=u.find(t=>t.id===e.id),n=i7(i8({},e),{context:e?.context||[]});if(t){u[u.indexOf(t)]=n;return}u.push(n)},[]),y=(0,D.useCallback)((e=iZ)=>{m(),r(t=>i7(i8(i8({},t||{}),e||{}),{cookie:i8(i8({},t?.cookie||{}),e?.cookie||{}),desktop:i8(i8({},t?.desktop||{}),e?.desktop||{}),mobile:i8(i8({},t?.mobile||{}),e?.mobile||{})}))},[n]);return(0,D.useEffect)(()=>{s("true"===iW.get(f.key))},[]),(0,D.useEffect)(()=>{if(iH()){let{execute:e,abort:t}=iX(p,1e3*c?.delayInSecondsToTrigger);if(l.current){iG(e);return}return iH()&&c?.triggerOnIdle&&(iG(e),iK(e)),()=>{t(),iG(e)}}if(iY()){let{execute:e,abort:t}=iX(p,1e3*d?.delayInSecondsToTrigger);return null!=d&&d.triggerOnIdle&&iK(e),null!=d&&d.triggerOnMouseLeave&&document.body.addEventListener("mouseleave",p),null!=d&&d.useBeforeUnload&&(window.onbeforeunload=()=>{if(!l.current)return p(),""}),()=>{t(),iG(e),document.body.removeEventListener("mouseleave",p)}}}),{settings:n,resetState:m,isTriggered:o,unsubscribe:h,resetSettings:g,updateSettings:y,isUnsubscribed:a,registerHandler:v,willBeTriggered:!(a||o)}}({cookie:{key:"_cm_exit",daysToExpire:0}}),[m,g]=(0,D.useState)(l?.idleDelay||5e3),[v,y]=(0,D.useState)([]),[b,_]=(0,D.useState)(void 0),[w,k]=(0,D.useState)(!1),[S,x]=(0,D.useState)(new Map),E=e=>{y(t=>/*@__PURE__*/O(rT)([...t,...e||[]],"id"))};n("CollectorProvider: user is on mobile?",rO.isMobile);let C=rO.isMobile;// Removes the intently overlay, if intently is false
(0,D.useEffect)(()=>{if(w)return;n("CollectorProvider: removing intently overlay");let e=setInterval(()=>{let t=document.querySelectorAll("div[id^=smc-v5-overlay-]");Array.prototype.forEach.call(t,t=>{t.parentNode.removeChild(t),n("CollectorProvider: successfully removed intently overlay"),clearInterval(e)})},100);return()=>{clearInterval(e)}},[w,n]);let T=/*@__PURE__*/O(D).useCallback(()=>{let e;if(!b)return null;// TODO: UNDO
let o=v.find(n=>{let r=n.invocation===b,o=t?.find(e=>e.behaviour===n.behaviour);return e=o,r&&o});if(!o)return r("No trigger found for displayTrigger",b),null;if(n("CollectorProvider: available handlers include: ",t),n("CollectorProvider: trigger to match is: ",o),n("CollectorProvider: attempting to show trigger",o,e),!e)return n("No handler found for trigger",o),null;if(!e.invoke)return n("No invoke method found for handler",e),null;console.log("invokingggggggg ");let i=e.invoke?.(o);return i&&/*@__PURE__*/O(D).isValidElement(i)?i:null},[b,r,t,n,v,t]),R=(0,D.useCallback)(()=>{u&&C&&(n("CollectorProvider: attempting to fire idle trigger"),_("INVOCATION_IDLE_TIME"))},[u,n,C]),P=(0,D.useCallback)(()=>{n("CollectorProvider: attempting to fire exit trigger"),_("INVOCATION_EXIT_INTENT")},[n,s,_]);(0,D.useEffect)(()=>{s&&(n("CollectorProvider: attempting to register exit trigger"),h({id:"clientTrigger",handler:P}))},[s,P,n,h]);let I=(0,D.useCallback)(()=>{n("CollectorProvider: resetting displayTrigger"),_(void 0)},[n]);// @todo this should be invoked when booted
// and then on any window page URL changes.
// THIS FETCHES OUR CONFIG. DO NOT REMOVE ED
(0,D.useEffect)(()=>{if(!i){n("CollectorProvider: Not yet collecting, awaiting boot");return}let e=setTimeout(()=>{if(!c.id){n("CollectorProvider: Not yet collecting, awaiting visitor ID");return}n("CollectorProvider: collecting data");let e=new URLSearchParams(window.location.search).toString().split("&").reduce((e,t)=>{let[n,r]=t.split("=");return n&&(e[n]=r),e},{});p({appId:o,visitor:c,sessionId:d?.id,page:{url:window.location.href,path:window.location.pathname,title:document.title,params:e},referrer:{url:document.referrer,title:"",utm:{// eslint-disable-next-line camelcase
...
// @todo turn this into the dynamic value
g(5e3),E(t?.pageTriggers)}).catch(e=>{r("failed to store collected data",e)}),// unregister the watcher when the element is found
clearInterval(i))})},500);return i};(0,D.useEffect)(()=>{if(!c.id)return;let e=[M(".stage-5","")];// Cleanup all the watchers
return()=>{e.forEach(e=>clearInterval(e))}},[c]);let L=/*@__PURE__*/O(D).useCallback(e=>{n("CollectorProvider: manually setting trigger",e),E([e]),_(e.invocation)},[n,v,_,E]),N=/*@__PURE__*/O(D).useMemo(()=>({resetDisplayTrigger:I,setTrigger:L,trackEvent:f}),[I,L,f]);return /*@__PURE__*/O(D).createElement(iB,{timeout:m,onPresenceChange:e=>{n("presence changed",e)},onIdle:R},/*@__PURE__*/O(D).createElement(au.Provider,{value:N},e),/*@__PURE__*/O(D).createElement(T,null))}let au=/*#__PURE__*/(0,D.createContext)({resetDisplayTrigger:()=>{},setTrigger:()=>{},trackEvent:()=>{}}),al=()=>(0,D.useContext)(au),ac=({randomHash:e,text:t})=>/*@__PURE__*/O(D).createElement("svg",{xmlns:"http://www.w3.org/2000/svg",xmlnsXlink:"http://www.w3.org/1999/xlink",version:"1.1",viewBox:"0 0 500 500",className:"f"+e+"-curlyText"},/*@__PURE__*/O(D).createElement("defs",null,/*@__PURE__*/O(D).createElement("path",{id:"textPath",d:"M 0 500 A 175,100 0 0 1 500,500"})),/*@__PURE__*/O(D).createElement("text",{x:"0",y:"0",textAnchor:"middle"},/*@__PURE__*/O(D).createElement("textPath",{xlinkHref:"#textPath",fill:"white",startOffset:"50%"},t))),ad=({trigger:e})=>{let{log:t,error:n}=tN(),{resetDisplayTrigger:r}=al(),{trackEvent:o}=rC(),{appId:i}=rs(),{visitor:a}=rw(),[s,u]=(0,D.useState)(!0),[l,c]=(0,D.useState)(!1),d=t=>{t.preventDefault(),o("user_clicked_button",e),e?.data?.buttonURL&&window.open(e?.data?.buttonURL,"_self")},f=(0,D.useMemo)(()=>tD().split("-")[0],[]);return((0,D.useEffect)(()=>{if(s){try{ai.put(`${ao}/triggers/${i}/${a.id}/seen`,{seenTriggerIDs:[e.id]}).then(t)}catch(e){n(e)}o("trigger_displayed",{triggerId:e.id,triggerType:e.invocation})}},[s]),(0,D.useEffect)(()=>{let e=`
...
t.length>1&&this.logger.error("[QueryClient] Several mutation defaults match with key '"+JSON.stringify(e)+"'. The first matching mutation defaults are used. Please check how mutation defaults are registered. Order does matter here. cf. https://react-query.tanstack.com/reference/QueryClient#queryclientsetmutationdefaults.")}return null==t?void 0:t.defaultOptions}defaultQueryOptions(e){if(null!=e&&e._defaulted)return e;let t={...this.defaultOptions.queries,...this.getQueryDefaults(null==e?void 0:e.queryKey),...e,_defaulted:!0};return!t.queryHash&&t.queryKey&&(t.queryHash=z(t.queryKey,t)),void 0===t.refetchOnReconnect&&(t.refetchOnReconnect="always"!==t.networkMode),void 0===t.useErrorBoundary&&(t.useErrorBoundary=!!t.suspense),t}defaultMutationOptions(e){return null!=e&&e._defaulted?e:{...this.defaultOptions.mutations,...this.getMutationDefaults(null==e?void 0:e.mutationKey),...e,_defaulted:!0}}clear(){this.queryCache.clear(),this.mutationCache.clear()}},av="b2c_token",ay=(e,t)=>{let[n,r]=(0,D.useState)(e);return(/**
   ...
   */(0,D.useEffect)(()=>{if(e){r(e);return}if(console.log("Fingerprint Widget Consent: ",e),!t)return;let n=t(),o=setInterval(()=>{r(e)},1e3);// clear on onmount
return n&&clearInterval(o),()=>clearInterval(o)},[t,e]),n)},ab=({appId:e,children:t,consent:n=!1,consentCallback:r,debug:o,defaultHandlers:i,initialDelay:a=0,exitIntentTriggers:s=!0,idleTriggers:u=!0,config:l})=>{let[c,d]=(0,D.useState)(!1),[f,p]=(0,D.useState)(i||am),h=ay(n,r),m=/*@__PURE__*/O(D).useCallback(e=>{p(t=>[...t,e])},[p]);return((0,D.useEffect)(()=>{if(!e)throw Error("C&M Fingerprint: appId is required");if(c||!h)return;let t=async()=>{// @todo this should be invoked when booted.
...
d(!0)};t()},[h]),e)?h?/*@__PURE__*/O(D).createElement(tM,{debug:o},/*@__PURE__*/O(D).createElement(ev,{client:ag},/*@__PURE__*/O(D).createElement(a_.Provider,{value:{appId:e,booted:c,currentTrigger:{},registerHandler:m,trackEvent:()=>{alert("trackEvent not implemented")},trackPageView:()=>{alert("trackPageView not implemented")},unregisterHandler:()=>{alert("unregisterHandler not implemented")},initialDelay:a,idleTriggers:u,exitIntentTriggers:s,config:l}},/*@__PURE__*/O(D).createElement(rb,null,/*@__PURE__*/O(D).createElement(rx,null,/*@__PURE__*/O(D).createElement(as,{handlers:f},/*@__PURE__*/O(D).createElement(e_,{onError:(e,t)=>console.error(e,t),fallback:/*@__PURE__*/O(D).createElement("div",null,"An application error occurred.")},t))))))):t:null},a_=/*#__PURE__*/(0,D.createContext)({appId:"",booted:!1,consent:!1,currentTrigger:{},exitIntentTriggers:!1,idleTriggers:!1,initialDelay:0,registerHandler:()=>{},trackEvent:()=>{},trackPageView:()=>{},unregisterHandler:()=>{},config:{idleDelay:void 0,trackIdleOnDesktop:!1}}),aw=document.createElement("div");aw.id="fingerprint-widget",document.body.appendChild(aw),// Embeds widget styles
...
console.log("Fingerprint Widget Loaded"),/*@__PURE__*/O(M).render(/*@__PURE__*/O(D).createElement(/*@__PURE__*/O(D).StrictMode,null,/*@__PURE__*/O(D).createElement(({appId:e,consent:t,debug:n})=>/*@__PURE__*/O(D).createElement(ab,{appId:e,consent:t,debug:n}),{appId:document?.currentScript?.getAttribute("id")||"",consent:document?.currentScript?.getAttribute("data-consent")==="true",debug:document?.currentScript?.getAttribute("data-debug")==="false"})),document.getElementById("fingerprint-widget"))}();//# sourceMappingURL=fingerprint.js.map
