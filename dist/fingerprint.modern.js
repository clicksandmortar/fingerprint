...
const VisitorProvider = ({
  ...
  console.log('visitor rerendering');
  useEffect(() => {
    if (!booted) {
  ...
  registerHandler({
    ...
    handler: () => {
      ...
      setTrigger({
        ...
        behaviour: 'youtube',
        data: {
          url: 'https://www.youtube.com/embed/bj1BMpUnzT8?start=13&autoplay=1'
        }
      });
    }
  });
  ...
  return React.createElement(IdleTimerProvider, {
    ...
    onIdle: () => {
      ...
      setTrigger({
        ...
        behaviour: 'youtube',
        data: {
          url: 'https://www.youtube.com/embed/CSvFpBOe8eY?start=44&autoplay=1'
        }
      });
    }
...
const FingerprintProvider = ({
  ...
  console.log('FingerprintProvider rerendering');
